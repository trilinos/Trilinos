...
SET_DEFAULT_AND_FROM_ENV( CTEST_DUAL_CONFIGURE OFF )
...
SET(CTEST_COMMAND
  ...
  "\"${CTEST_EXECUTABLE_NAME}\" -D ${CTEST_TEST_TYPE}Submit -A \"${CTEST_BINARY_DIRECTORY}/CMakeCache.clean.txt\;${CTEST_SCRIPT_DIRECTORY}/${CTEST_SCRIPT_NAME}\""
  )
