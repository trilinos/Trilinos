#
# Base options for all hybrid GCC 4.6.1 C/C++ and Intel Fortran builds
#
...
SET(PETSC_INCLUDE_DIRS  /opt/gcc-4.6.1/tpls/petsc-3.1-p8/include  CACHE FILEPATH "")
SET(PETSC_LIBRARY_DIRS  /opt/gcc-4.6.1/tpls/petsc-3.1-p8/lib      CACHE FILEPATH "")
SET(HYPRE_INCLUDE_DIRS  /opt/gcc-4.6.1/tpls/hypre-2.8.0b/include  CACHE FILEPATH "")
SET(HYPRE_LIBRARY_DIRS  /opt/gcc-4.6.1/tpls/hypre-2.8.0b/lib      CACHE FILEPATH "")
