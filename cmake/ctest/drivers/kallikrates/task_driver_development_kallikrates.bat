...
set PATH=%PATH%;%BASEDIR%\SERIAL_OPT_DEV_SHARED\BUILD\packages\src\epetra;%BASEDIR%\SERIAL_OPT_DEV_SHARED\BUILD\packages\src\teuchos;%BASEDIR%\SERIAL_OPT_DEV_SHARED\BUILD\packages\src\anasazi
