...
set BRANCH=trilinos-release-10-4-branch
...
set PATH=%PATH%;%BASEDIR%\SERIAL_OPT_RELEASE_10.4.0_SHARED\BUILD\packages\epetra\src;%BASEDIR%\SERIAL_OPT_RELEASE_10.4.0_SHARED\BUILD\packages\teuchos\src;%BASEDIR%\SERIAL_OPT_RELEASE_10.4.0_SHARED\BUILD\packages\anasazi\src
