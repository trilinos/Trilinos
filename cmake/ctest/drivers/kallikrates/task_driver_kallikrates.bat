...
set PATH=%PATH%;%BASEDIR%\SERIAL_OPT_RELEASE_10.4_SHARED\BUILD\packages\epetra\src;%BASEDIR%\SERIAL_OPT_RELEASE_10.4_SHARED\BUILD\packages\teuchos\src;%BASEDIR%\SERIAL_OPT_RELEASE_10.4_SHARED\BUILD\packages\anasazi\src
