...
source /etc/bashrc
source $TRILINOS_DIR/cmake/load_sems_dev_env.sh "sems-gcc/6.1.0" "sems-openmpi/1.10.1"

export CTEST_DASHBOARD_ROOT=$PWD

ctest -V -S $DRIVER_SCRIPT_DIR/ctest-rol-mpi-release-gcc-latest.sems.cmake
