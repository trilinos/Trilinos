...
BASEDIR=/home/bmpersc/nightly/Trilinos.base/release_10.2
...
echo
echo "Starting nightly Trilinos Release 10.2 testing on trilinos-test: `date`"
echo
...
time ${CTEST_EXE} -S $DRIVER_SCRIPT_DIR/ctest_linux_nightly_mpi_release_trilinos-test.cmake -VV &> "MPI_RELEASE_10.2_$DATE.log"

echo
echo "Doing mpi optimized release 10.2  shared library build: `date`"
echo 

time ${CTEST_EXE} -S $DRIVER_SCRIPT_DIR/ctest_linux_nightly_mpi_release_shared_trilinos-test.cmake -VV &> "MPI_RELEASE_10.2_SHARED_$DATE.log"

echo
echo "Doing serial release 10.2 build: `date`"
echo

time ${CTEST_EXE} -S $DRIVER_SCRIPT_DIR/ctest_linux_nightly_serial_release_trilinos-test.cmake -VV &> "SERIAL_RELEASE_10.2_$DATE.log"
