...
set PATH=%NINJA_DIR%;C:\projects\sems\install\win-x86_64\compiler\Microsoft MPI\8.1.12438.1084\Bin\;C:\Windows\system32;C:\Windows;C:\Windows\System32\Wbem;C:\Windows\System32\WindowsPowerShell\v1.0\;C:\Program Files\Microsoft SQL Server\130\Tools\Binn\;C:\Users\mgploos\.dnx\bin;C:\Program Files\Microsoft DNX\Dnvm\;C:\projects\sems\install\win-x86_64\utility\git\2.13.0\cmd;C:\Program Files (x86)\Windows Kits\10\Windows Performance Toolkit\
