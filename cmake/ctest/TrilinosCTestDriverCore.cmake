...
FUNCTION(TRILINOS_CTEST_DRIVER)
  ...
  IF (CTEST_DO_UPDATES)
    ...
    FOREACH(EXTRAREPO_NAME ${Trilinos_EXTRA_REPOSITORIES})
      LIST(GET Trilinos_EXTRA_REPOSITORIES_DIRS ${EXTRAREPO_IDX}
        EXTRAREPO_DIR )
      LIST(GET Trilinos_EXTRA_REPOSITORIES_REPOTYPES ${EXTRAREPO_IDX}
        EXTRAREPO_REPOTYPE )
      LIST(GET Trilinos_EXTRA_REPOSITORIES_REPOURLS ${EXTRAREPO_IDX}
        EXTRAREPO_REPOURL )
