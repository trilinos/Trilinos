...
MACRO(TRILINOS_INSERT_STANDARD_PACAKGE_VARIABLES PACAKGE)
  ...
  SET( Trilinos_ENABLE_${PACKAGE} "DEFAULT" CACHE STRING
    "Enable the ${PACKAGE} package.")
  SET( ${PACKAGE}_ENABLE_TESTS "DEFAULT" CACHE STRING
    "Build ${PACKAGE} tests." )
  SET( ${PACKAGE}_ENABLE_EXAMPLES "DEFAULT" CACHE STRING
...
MACRO(TRILINOS_POSTPROCESS_STANDARD_PACAKGE_VARIABLE TRILINOS_VAR PACKAGE_VAR)
  ...
  IF (${PACKAGE_VAR} STREQUAL DEFAULT)
