...
FUNCTION(PACKAGE_ARCH_PRINT_ENABLED_PACKAGE_LIST DOCSTRING ENABLED_FLAG)
  PACKAGE_ARCH_GET_ENABLED_LIST( ${PROJECT_NAME}_PACKAGES ${PROJECT_NAME} ${ENABLED_FLAG}
    ${PROJECT_NAME}_ENABLED_PACKAGES NUM_ENABLED)
...
FUNCTION(PACKAGE_ARCH_PRINT_ENABLED_TPL_LIST DOCSTRING ENABLED_FLAG)
...
MACRO(PACKAGE_ARCH_PRIVATE_DISABLE_REQUIRED_PACKAGE_ENABLES FORWARD_DEP_PACKAGE_NAME PACKAGE_NAME LIBRARY_DEP)

  #MESSAGE("PACKAGE_ARCH_PRIVATE_DISABLE_REQUIRED_PACKAGE_ENABLES ${FORWARD_DEP_PACKAGE_NAME} ${LIBRARY_DEP}")  
  ...
  IF (${PROJECT_NAME}_ENABLE_${FORWARD_DEP_PACKAGE_NAME} OR ${PROJECT_NAME}_ENABLE_${FORWARD_DEP_PACKAGE_NAME} STREQUAL "")
    ...
    IF ("${LIBRARY_DEP}" STREQUAL "TRUE")
      ...
      MESSAGE(STATUS
        "Setting ${PROJECT_NAME}_ENABLE_${FORWARD_DEP_PACKAGE_NAME}=OFF because ${FORWARD_DEP_PACKAGE_NAME} has a required ${DEP_TYPE_STR} dependence on disabled package ${PACKAGE_NAME}")
...
MACRO(PACKAGE_ARCH_PRIVATE_DISABLE_OPTIONAL_PACKAGE_ENABLES FORWARD_DEP_PACKAGE_NAME PACKAGE_NAME)

  #MESSAGE("PACKAGE_ARCH_PRIVATE_DISABLE_OPTIONAL_PACKAGE_ENABLES ${FORWARD_DEP_PACKAGE_NAME} ${PACKAGE_NAME}")  
...
MACRO(PACKAGE_ARCH_DISABLE_FORWARD_REQUIRED_DEP_PACKAGES PACKAGE_NAME)
  ...
  IF ("${${PROJECT_NAME}_ENABLE_${PACKAGE}}" STREQUAL "OFF")
...
FUNCTION(PACKAGE_ARCH_WRITE_DEPS_TO_XML_FILE PACKAGE_NAME LIST_TYPE)
  ...
  IF (NOT DEPS)
    ...
    FILE(APPEND ${${PROJECT_NAME}_DEPS_XML_OUTPUT_FILE}
      "    <${LIST_TYPE}/>\n")
...
FUNCTION(PACKAGE_ARCH_DUMP_DEPS_XML_FILE)
  ...
  FILE(WRITE ${${PROJECT_NAME}_DEPS_XML_OUTPUT_FILE}
    "<PackageDependencies>\n" )
  ...
  FOREACH(PACKAGE_IDX RANGE ${${PROJECT_NAME}_LAST_PACKAGE_IDX})
    ...
    PACKAGE_ARCH_WRITE_DEPS_TO_XML_FILE(${PACKAGE} LIB_REQUIRED_DEP_PACKAGES)
    PACKAGE_ARCH_WRITE_DEPS_TO_XML_FILE(${PACKAGE} LIB_OPTIONAL_DEP_PACKAGES)
    PACKAGE_ARCH_WRITE_DEPS_TO_XML_FILE(${PACKAGE} TEST_REQUIRED_DEP_PACKAGES)
    PACKAGE_ARCH_WRITE_DEPS_TO_XML_FILE(${PACKAGE} TEST_OPTIONAL_DEP_PACKAGES)
    PACKAGE_ARCH_WRITE_DEPS_TO_XML_FILE(${PACKAGE} LIB_REQUIRED_DEP_TPLS)
    PACKAGE_ARCH_WRITE_DEPS_TO_XML_FILE(${PACKAGE} LIB_OPTIONAL_DEP_TPLS)
    PACKAGE_ARCH_WRITE_DEPS_TO_XML_FILE(${PACKAGE} TEST_REQUIRED_DEP_TPLS)
    PACKAGE_ARCH_WRITE_DEPS_TO_XML_FILE(${PACKAGE} TEST_OPTIONAL_DEP_TPLS)
