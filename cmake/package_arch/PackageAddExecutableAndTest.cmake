...
FUNCTION(PACKAGE_ADD_EXECUTABLE_AND_TEST EXE_NAME)
  ...
  PARSE_ARGUMENTS(
     ...
     PARSE
     #lists
     "SOURCES;DEPLIBS;NUM_MPI_PROCS;DIRECTORY;KEYWORDS;COMM;ARGS;NAME;PASS_REGULAR_EXPRESSION;HOST;XHOST;HOSTTYPE;XHOSTTYPE;FAIL_REGULAR_EXPRESSION;LINKER_LANGUAGE;DEFINES"
     #options
  ...
  ENDIF()
  IF (PARSE_DEFINES)
    SET(CALL_ARGS ${CALL_ARGS} DEFINES ${PARSE_DEFINES}) 
  ENDIF()
