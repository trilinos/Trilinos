...
For example, ATDM_CONFIG_CTEST_S_BUILD_NAME_PREFIX=Trilinos-atdm-weaver- and
<build-name-keysi>=cuda-9.2-release-debug gives the full build name
'Trilinos-atdm-weaver-cuda-9.2-release-debug'.
...
(e.g. <build-name-keysi>=Trilinos-atdm-weaver-9.2_fpic_opt) giving the
full script name:
