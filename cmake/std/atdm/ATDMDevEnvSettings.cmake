...
IF (COMMAND INSTALL AND NOT "${CMAKE_INSTALL_PREFIX}" STREQUAL "")
  ...
  SET(ATDM_CONFIG_KNOWN_SYSTEM_NAME $ENV{ATDM_CONFIG_KNOWN_SYSTEM_NAME})
  ...
  IF (ATDM_CUSTOM_CONFIG_DIR_PATH)
    SET(ATDM_CUSTOM_CONFIG_DIR_ARG
      "${ATDM_CONFIG_SCRIPTS_INSTALL_DIR}/${ATDM_CONFIG_KNOWN_SYSTEM_NAME}")
    INSTALL( DIRECTORY ${ATDM_CUSTOM_CONFIG_DIR_PATH}
      DESTINATION ${ATDM_CONFIG_SCRIPTS_INSTALL_DIR} )
  ELSE()
    SET(ATDM_CUSTOM_CONFIG_DIR_ARG)
    INSTALL( DIRECTORY "${CMAKE_CURRENT_LIST_DIR}/${ATDM_CONFIG_KNOWN_SYSTEM_NAME}"
      DESTINATION ${ATDM_CONFIG_SCRIPTS_INSTALL_DIR}
      PATTERN "*.cmake" EXCLUDE )
  ENDIF()
