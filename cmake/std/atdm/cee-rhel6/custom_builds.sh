...
if [[ $ATDM_CONFIG_BUILD_NAME == *"clang-5.0.1-openmpi-1.10.2"* ]] \
  ...
  ; then
  export ATDM_CONFIG_COMPILER=INTEL-17.0.1-INTELMPI-5.1.2
...
# ToDo: Add support for CUDA builds above
