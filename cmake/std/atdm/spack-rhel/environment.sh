...
if [ "$ATDM_CONFIG_COMPILER" == "GNU-7.2.0_OPENMPI-1.10.2" ]; then
  ...
  export ATDM_CONFIG_CXX_FLAGS="-I${GCC_ROOT}/include/c++/4.9.3 -I${GCC_ROOT}/include/c++/4.9.3/x86_64-unknown-linux-gnu"
  ...
  # gcc@4.9.3 that it was built with.  It looks like this got fixed in
  # https://github.com/spack/spack/pull/12381 merged 10/13/2019 but that will
  # require upgrading our Spack version to get that fix :-(
