...
class Test_parse_args(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.default_options = Namespace(dry_run=False,
                                         ...
                                         pullrequest_config_file=os.path.join(os.path.sep,
                                                                              'dev',
                                                                              'null',
                                                                              'Trilinos_clone',
                                                                              'pr_config',
        ...
        self.default_stdout = dedent('''\
                                        ...
                                        | - [O] pullrequest-config-file : /dev/null/Trilinos_clone/pr_config/pullrequest.ini
...
''')
        ...
        self.help_output = dedent('''\
                               usage: programName [-h] --source-repo-url SOURCE_REPO_URL --source-branch-name
                                                  ...
                                                  [--pullrequest-config-file PULLREQUEST_CONFIG_FILE]
...
''')
        self.usage_output = dedent('''\
                                usage: programName [-h] --source-repo-url SOURCE_REPO_URL --source-branch-name
                                                   ...
                                                   [--max-cores-allowed MAX_CORES_ALLOWED]
                                                   [--num-concurrent-tests NUM_CONCURRENT_TESTS] [--dry-run]
                                programName: error: the following arguments are required: --source-repo-url, --source-branch-name, --target-repo-url, --target-branch-name, --pullrequest-build-name, --pullrequest-number, --jenkins-job-number
''')
