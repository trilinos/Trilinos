...
echo -e "=========================================================================================="
echo -e "Parameters:"
echo -e "COMPILER_MODULE       : ${COMPILER_MODULE:?}"
echo -e "MPI_MODULE            : ${MPI_MODULE:?}"
echo -e "JENKINS_BUILD_TYPE    : ${JENKINS_BUILD_TYPE:?}"
echo -e "JENKINS_COMM_TYPE     : ${JENKINS_COMM_TYPE:?}"
echo -e "JENKINS_JOB_TYPE      : ${JENKINS_JOB_TYPE:?}"
echo -e "JENKINS_DO_COMPLEX    : ${JENKINS_DO_COMPLEX:?}"
echo -e ""
