...
echo -e "=========================================================================================="
echo -e "Parameters:"
echo -e "- COMPILER_MODULE    (unused) : ${COMPILER_MODULE}"
echo -e "- MPI_MODULE         (unused) : ${MPI_MODULE}"
echo -e "- JENKINS_BUILD_TYPE (unused) : ${JENKINS_BUILD_TYPE}"
echo -e "- JENKINS_COMM_TYPE  (unused) : ${JENKINS_COMM_TYPE}"
echo -e "- JENKINS_JOB_TYPE   (unused) : ${JENKINS_JOB_TYPE}"
echo -e "- JENKINS_DO_COMPLEX (unused) : ${JENKINS_DO_COMPLEX}"
echo -e ""
echo -e "- TRILINOS_SOURCE_BRANCH (req): ${TRILINOS_SOURCE_BRANCH:?}"
echo -e "- TRILINOS_SOURCE_REPO   (req): ${TRILINOS_SOURCE_REPO:?}"
echo -e "- TRILINOS_SOURCE_SHA    (req): ${TRILINOS_SOURCE_SHA:?}"
echo -e ""
echo -e "- TRILINOS_TARGET_BRANCH (req): ${TRILINOS_TARGET_BRANCH:?}"
echo -e "- TRILINOS_TARGET_REPO   (req): ${TRILINOS_TARGET_REPO:?}"
echo -e "- TRILINOS_TARGET_SHA    (req): ${TRILINOS_TARGET_SHA:?}"
echo -e ""
echo -e "- PULLREQUESTNUM         (req): ${PULLREQUESTNUM:?}"
echo -e ""
echo -e "=========================================================================================="
echo -e "Environment:"
echo -e ""
