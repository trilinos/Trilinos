...
FUNCTION (TRILINOS_ADD_TEST EXECUTABLE_DIR)
  PARSE_ARGUMENTS(
     PARSE   #prefix
     "COMM;NAME;ARGS;PASS_REGULAR_EXPRESSION;HOST;XHOST;FAIL_REGULAR_EXPRESSION;POSTFIX"  #lists
  ...
  IF(TRILINOS_ENABLE_MPI)
    ...
    IF(NOT ${DO_MPI_INDEX} EQUAL -1)
      ...
      FOREACH(PARSE_ARG ${PARSE_ARGS})
        ...
        LIST(GET PARSE_POSTFIX ${COUNTER} POSTFIX_VAL)
        MESSAGE("With POSTFIX: ${POSTFIX_VAL}")
