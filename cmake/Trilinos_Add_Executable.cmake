...
FUNCTION (TRILINOS_ADD_TEST EXE_NAME)
  PARSE_ARGUMENTS(
     PARSE   #prefix
     "NUM_MPI_PROCS;DIRECTORY;COMM;ARGS;NAME;PASS_REGULAR_EXPRESSION;HOST;XHOST;FAIL_REGULAR_EXPRESSION"  #lists
  ...
  IF(TRILINOS_ENABLE_MPI)
    ...
    IF(PARSE_NUM_MPI_PROCS)
      IF(${PARSE_NUM_MPI_PROCS} MATCHES [1-9]+-[1-9]+)
        #Parse out min and max values
        #IF(${PARSE_NUM_MPI_PROCS})
        #ENDIF()
        
      ELSE()
        IF(${PARSE_NUM_MPI_PROCS} LESS ${MPIEXEC_MAX_NUMPROCS})
          SET(NP ${PARSE_NUM_MPI_PROCS})
        ELSE()
