...
MACRO(TRILINOS_PACKAGE_CONFIGURE_FILE PACKAGE_NAME_CONFIG_FILE)
  ...
  FOREACH(DEP_PKG ${${PACKAGE_NAME}_LIB_OPTIONAL_DEP_PACAKGES})
    #MESSAGE("TRILINOS_PACKAGE_CONFIGURE_FILE: ${PACKAGE_NAME_CONFIG_FILE}")
    #MESSAGE("${PACKAGE_NAME}_ENABLE_${DEP_PKG} = ${${PACKAGE_NAME}_ENABLE_${DEP_PKG}}")
    #MESSAGE("${PACKAGE_NAME}_ENABLE_${DEP_PKG}_MACRO_DEFINE_NAME = ${${PACKAGE_NAME}_ENABLE_${DEP_PKG}_MACRO_DEFINE_NAME}")
    IF (${PACKAGE_NAME}_ENABLE_${DEP_PKG})
      SET(${${PACKAGE_NAME}_ENABLE_${DEP_PKG}_MACRO_DEFINE_NAME} ON)
    ENDIF()
  ENDFOREACH()
...
MACRO(TRILINOS_PACKAGE_ADD_LIBRARY LIBRARY_NAME)
  ...
  FOREACH(DEP_PKG ${${PACKAGE_NAME}_LIB_REQUIRED_DEP_PACAKGES})
