...
MACRO(TRILINOS_PACKAGE_EXPORT_DEPENDENCY_VARIABLES)
  ...
  SET(${PACKAGE_NAME}_INCLUDE_DIRS ${INCLUDE_DIRS_CURRENT}
    ${${PACKAGE_NAME}_INCLUDE_DIRS} CACHE INTERNAL "")
  GET_DIRECTORY_PROPERTY(LIBRARY_DIRS_CURRENT LINK_DIRECTORIES)
  SET(${PACKAGE_NAME}_LIBRARY_DIRS ${LIBRARY_DIRS_CURRENT}
    ${${PACKAGE_NAME}_LIBRARY_DIRS} CACHE INTERNAL "")
  SET(${PACKAGE_NAME}_LIBRARIES ${PRIVATE_PACKAGE_TARGET_LIBS}
