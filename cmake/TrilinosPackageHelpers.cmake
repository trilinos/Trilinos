...
MACRO(TRILINOS_PACKAGE PACKAGE_NAME_IN)
  ...
  TRILINOS_PRIVATE_ADD_DEP_PACKAGES_INCLUDES_AND_LIBS(${PACKAGE_NAME} "TEST_"
    TEST_REQUIRED_DEP_PACKAGES)
  TRILINOS_PRIVATE_ADD_DEP_PACKAGES_INCLUDES_AND_LIBS(${PACKAGE_NAME} "TEST_"
    TEST_OPTIONAL_DEP_PACKAGES)

  REMOVE_GLOBAL_DUPLICATES(${PACKAGE_NAME}_TEST_INCLUDE_DIRS)
  REMOVE_GLOBAL_DUPLICATES(${PACKAGE_NAME}_TEST_LIBRARY_DIRS)
  REMOVE_GLOBAL_DUPLICATES(${PACKAGE_NAME}_TEST_LIBRARIES)
  ...
  IF (Trilinos_VERBOSE_CONFIGURE)
    ...
    PRINT_VAR(${PACKAGE_NAME}_TEST_LIBRARIES)
  ENDIF()
