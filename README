...
- See `<trilinos_base_directory>/doc/build_ref/TrilinosBuildReferenceTemplate.rst` for
...
- Information on how to extend Trilinos with your own add-on packages in your
  own external repository see:
      ...
      `<trilinos_base_directory>/doc/build_ref/TrilinosBuildReferenceTemplate.rst`
