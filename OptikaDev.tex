...
After some deliberation, the following initial solutions were decided upon:
	...
	\begin{itemize}
		...
		Otherwise a line edit (figure~\ref{lineeditfig}) would be used. For booleans, a combo box (firgure~\ref{comboboxfig}) would
...
Adding support for multiple dependents was much harder. There was actually only one specific use case where multiple dependents were needed or even appropriate for that matter. Dr.
