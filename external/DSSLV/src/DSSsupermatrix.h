 ...
 ********************************************/
typedef enum {
    SLD_NR,        /* row-wize, no supernode */
    SLD_NC,        /* column-wise, no supernode */
    SLD_SC,        /* column-wise, supernode */
    SLD_SR,        /* row-wise, supernode */
    SLD_NCP,       /* column-wise, column-permuted, no supernode 
                  (The consecutive columns of nonzeros, after permutation,
		   may not be stored  contiguously.) */
    SLD_DN         /* Fortran style column-wise storage for dense matrix */
} SluDist_Stype_t;

typedef enum {
    SLS_NC,        /* column-wise, no supernode */
    SLS_NR,        /* row-wize, no supernode */
    SLS_SC,        /* column-wise, supernode */
    SLS_SR,        /* row-wise, supernode */
    SLS_NCP,       /* column-wise, column-permuted, no supernode 
                  (The consecutive columns of nonzeros, after permutation,
		   may not be stored  contiguously.) */
...
typedef enum {
  DSS_S,           /* single */
  DSS_D,         /* double */
  DSS_C,         /* single complex */
  DSS_Z          /* double complex */
} Dtype_t;
...
typedef struct {
	SluDist_Stype_t Stype; /* Storage type: interprets the storage structure 
		   	  pointed to by *Store. */
