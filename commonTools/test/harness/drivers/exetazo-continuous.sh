...
export CVS_RSH=ssh
export LD_LIBRARY_PATH=/usr/alt/lib:/home/jmwille/contInt/Trilinos/MPI/packages/PyTrilinos/shared
...
cd /home/jmwille/contInt/Trilinos/
cvs -q update -dP | grep -v "? " >& /home/jmwille/cronOutput/contIntCVS.out
diff /home/jmwille/cronOutput/contIntCVS.out /home/jmwille/contInt/Trilinos/commonTools/test/harness/drivers/cvs-update-out.txt > /home/jmwille/contInt/Trilinos/commonTools/test/harness/drivers/cvs-update-out-diff.txt
if test -s /home/jmwille/contInt/Trilinos/commonTools/test/harness/drivers/cvs-update-out-diff.txt ; then
...
rm -f /home/jmwille/contInt/Trilinos/commonTools/test/harness/drivers/cvs-update-out-diff.txt /home/jmwille/cronOutput/contIntCVS.out
