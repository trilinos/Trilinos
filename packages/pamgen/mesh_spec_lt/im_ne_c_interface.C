...
/*****************************************************************************/
{
  ...
  int * ebids = ms->getMSP(ms_lt::Mesh_Specification::ELEM_BLK_IDS_GLOBAL);
  int * ebcts = ms->getMSP(ms_lt::Mesh_Specification::ELEM_BLK_CNTS_GLOBAL);
...
/*****************************************************************************/
{
  ...
  int * int_el_arr = ms->getMSP(ms_lt::Mesh_Specification::INTERNAL_ELEMENTS);
  int * bor_el_arr = ms->getMSP(ms_lt::Mesh_Specification::BORDER_ELEMENTS);
...
/*****************************************************************************/
{
  ...
  int * int_nd_arr = ms->getMSP(ms_lt::Mesh_Specification::INTERNAL_NODES);
  int * bor_nd_arr = ms->getMSP(ms_lt::Mesh_Specification::BORDER_NODES);
  int * ext_nd_arr = ms->getMSP(ms_lt::Mesh_Specification::EXTERNAL_NODES);
...
/*****************************************************************************/
{
  ...
  int * nd_cmap_id_arr = ms->getMSP(ms_lt::Mesh_Specification::NODE_CMAP_IDS);
  const int * nd_cmap_ct_arr = ms->getMSP(ms_lt::Mesh_Specification::NODE_CMAP_NODE_CNTS);
  int * el_cmap_id_arr = ms->getMSP(ms_lt::Mesh_Specification::ELEM_CMAP_IDS);
  const int * el_cmap_ct_arr = ms->getMSP(ms_lt::Mesh_Specification::ELEM_CMAP_ELEM_CNTS);
...
/*****************************************************************************/
{
  ...
  int * const * nd_id_arr = ms->getMSPP(ms_lt::Mesh_Specification::COMM_NODE_IDS);//Comm_Node_Ids();
  int * const * nd_proc_arr = ms->getMSPP(ms_lt::Mesh_Specification::COMM_NODE_PROC_IDS);//Comm_Node_Proc_Ids();
...
/*****************************************************************************/
{
  ...
  // get the map index
  int num_elem_cmaps = ms->getMSI(ms_lt::Mesh_Specification::NUM_ELEM_COMM_MAPS);
  int * elem_cmap_id_arr = ms->getMSP(ms_lt::Mesh_Specification::ELEM_CMAP_IDS);
  ...
  int * const * el_id_arr = ms->getMSPP(ms_lt::Mesh_Specification::COMM_ELEM_IDS);
  int * const * el_side_arr = ms->getMSPP(ms_lt::Mesh_Specification::COMM_SIDE_IDS);
  int * const * el_proc_arr = ms->getMSPP(ms_lt::Mesh_Specification::COMM_ELEM_PROC_IDS);
...
/*****************************************************************************/
{
  ...
  const int * nsids = ms->getMSP(ms_lt::Mesh_Specification::NS_IDS_GLOBAL);
  const int * ncts = ms->getMSP(ms_lt::Mesh_Specification::NS_CNTS_GLOBAL);
  const int * dfs = ms->getMSP(ms_lt::Mesh_Specification::NS_DF_CNTS_GLOBAL);
  for(int i = 0; i < nns; i ++){
...
/*****************************************************************************/
{
  ...
  const int * nsids = ms->getMSP(ms_lt::Mesh_Specification::SS_IDS_GLOBAL);
  const int * ncts = ms->getMSP(ms_lt::Mesh_Specification::SS_CNTS_GLOBAL);
  const int * dfs = ms->getMSP(ms_lt::Mesh_Specification::SS_DF_CNTS_GLOBAL);
  for(int i = 0; i < nss; i ++){
