...
/*****************************************************************************/
{
  ...
  const int* the_map = ms->getMSP(ms_lt::Mesh_Specification::ELEM_ORDER_MAP);
...
/*****************************************************************************/
{
  ...
  int num_elem = ms->getMSI(ms_lt::Mesh_Specification::NUM_ELEMENTS);
  const int * gen = ms->getMSP(ms_lt::Mesh_Specification::GLOBAL_ELEMENT_NUMBERS);
...
/*****************************************************************************/
{
  ...
  int num_nds = ms->getMSI(ms_lt::Mesh_Specification::NUM_NODES);
  const int * gnn = ms->getMSP(ms_lt::Mesh_Specification::GLOBAL_NODE_NUMBERS);//Global_Node_Numbers();
...
/*****************************************************************************/
{
  ...
  const int * bid_arr = ms->getMSP(ms_lt::Mesh_Specification::BLOCK_ID);
...
/*****************************************************************************/
{
  ...
  const int * nbe = ms->getMSP(ms_lt::Mesh_Specification::ELEMENTS_IN_BLOCK);
  *num_elem_this_blk = nbe[el_blk_index];
  
  const int * nnpe = ms->getMSP(ms_lt::Mesh_Specification::NODES_PER_ELEMENT);
  *num_nodes_per_elem = nnpe[el_blk_index];

  const int * natr = ms->getMSP(ms_lt::Mesh_Specification::ELEMENT_ATTRIBUTES);
...
/*****************************************************************************/
{
  ...
  const int * const * enl = ms->getMSPP(ms_lt::Mesh_Specification::ELMT_NODE_LINKAGE);//Element_Node_Linkage();
  const int * nbe = ms->getMSP(ms_lt::Mesh_Specification::ELEMENTS_IN_BLOCK);
  const int * nnpe_arr = ms->getMSP(ms_lt::Mesh_Specification::NODES_PER_ELEMENT);
...
/*****************************************************************************/
{
  ...
  const int * ids_arr = ms->getMSP(ms_lt::Mesh_Specification::NODE_SET_ID);
...
/*****************************************************************************/
{
  ...
  const int * ids_arr = ms->getMSP(ms_lt::Mesh_Specification::SIDE_SET_ID);
  for(int i = 0; i < nss; i ++)
    if(ssid == ids_arr[i])
      return i;
...
/*****************************************************************************/
{
  ...
  const int * nn_in_set = ms->getMSP(ms_lt::Mesh_Specification::NUM_NODES_IN_NODE_SET);
  *num_nodes_in_set = nn_in_set[ns_index];
  
  const int * nn_df_in_set = ms->getMSP(ms_lt::Mesh_Specification::NUM_DF_IN_NODE_SET);
...
/*****************************************************************************/
{
  ...
  const int * ns_in_set = ms->getMSP(ms_lt::Mesh_Specification::NUM_ELEMENTS_IN_SIDE_SET);
  *num_side_in_set = ns_in_set[ss_index];
  
  const int * ss_df_in_set = ms->getMSP(ms_lt::Mesh_Specification::NUM_DF_IN_SIDE_SET);
...
/*****************************************************************************/
{
  ...
  const int * const * ns_arr = ms->getMSPP(ms_lt::Mesh_Specification::NODE_SET_NODES);//Node_Set_Nodes();
...
/*****************************************************************************/
{
  ...
  const int * ne_in_set = ms->getMSP(ms_lt::Mesh_Specification::NUM_ELEMENTS_IN_SIDE_SET);
  int num_fcs_in_set = ne_in_set[ss_index];
  
  const int * const * ss_arr = ms->getMSPP(ms_lt::Mesh_Specification::SIDE_SET_ELEMENTS);
  for(int i = 0; i < num_fcs_in_set; i ++)side_set_elem_list[i] = ss_arr[ss_index][i];

  const int * const * ssf_arr = ms->getMSPP(ms_lt::Mesh_Specification::SIDE_SET_FACES);
...
/*****************************************************************************/
{
  ...
  const int * const * ssnc = ms->getMSPP(ms_lt::Mesh_Specification::SIDE_SET_NODE_COUNTER);
  for(int i = 0; i < num_fcs_in_set; i ++)side_set_node_cnt_list[i] = ssnc[ss_index][i];
  
  const int * nn_in_sset = ms->getMSP(ms_lt::Mesh_Specification::NUM_NODES_IN_SIDE_SET);
  int nn = nn_in_sset[ss_index];
  
  const int * const * ssn = ms->getMSPP(ms_lt::Mesh_Specification::SIDE_SET_NODES);
