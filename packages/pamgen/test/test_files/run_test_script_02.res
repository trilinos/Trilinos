...
X 0.002452 Y 0.000000 Z -0.000750 
coord name 0 X
coord name 1 Y
coord name 2 Z
A tast of map
...
global el num  i=0, val=55
global el num  i=1, val=56
global el num  i=2, val=57
global el num  i=3, val=58
global el num  i=4, val=59
global el num  i=5, val=60
global el num  i=6, val=61
global el num  i=7, val=62
global el num  i=8, val=63
global el num  i=9, val=64
A tast of global elem numbers
global node num  i=0, val=55
global node num  i=1, val=56
global node num  i=2, val=57
global node num  i=3, val=58
global node num  i=4, val=59
global node num  i=5, val=60
global node num  i=6, val=61
global node num  i=7, val=62
global node num  i=8, val=63
global node num  i=9, val=64
block i = 0 has id 1 
block i = 0
block id 1
element_type HEX
...
node_cmap_id i=1 = 1 comm_node_ids = 28 comm_node_proc_ids = 1
node_cmap_id i=2 = 1 comm_node_ids = 55 comm_node_proc_ids = 1
node_cmap_id i=3 = 1 comm_node_ids = 82 comm_node_proc_ids = 1
node_cmap_id i=4 = 1 comm_node_ids = 109 comm_node_proc_ids = 1
node_cmap_id i=5 = 1 comm_node_ids = 136 comm_node_proc_ids = 1
node_cmap_id i=6 = 1 comm_node_ids = 163 comm_node_proc_ids = 1
node_cmap_id i=7 = 1 comm_node_ids = 190 comm_node_proc_ids = 1
node_cmap_id i=8 = 1 comm_node_ids = 217 comm_node_proc_ids = 1
node_cmap_id i=9 = 1 comm_node_ids = 244 comm_node_proc_ids = 1
elem_cmap_id i=0 = 1 comm_elem_ids = 1 comm_side_ids = 4 comm_elem_proc_ids = 1
elem_cmap_id i=1 = 1 comm_elem_ids = 27 comm_side_ids = 4 comm_elem_proc_ids = 1
elem_cmap_id i=2 = 1 comm_elem_ids = 53 comm_side_ids = 4 comm_elem_proc_ids = 1
elem_cmap_id i=3 = 1 comm_elem_ids = 79 comm_side_ids = 4 comm_elem_proc_ids = 1
elem_cmap_id i=4 = 1 comm_elem_ids = 105 comm_side_ids = 4 comm_elem_proc_ids = 1
elem_cmap_id i=5 = 1 comm_elem_ids = 131 comm_side_ids = 4 comm_elem_proc_ids = 1
elem_cmap_id i=6 = 1 comm_elem_ids = 157 comm_side_ids = 4 comm_elem_proc_ids = 1
elem_cmap_id i=7 = 1 comm_elem_ids = 183 comm_side_ids = 4 comm_elem_proc_ids = 1
elem_cmap_id i=8 = 1 comm_elem_ids = 209 comm_side_ids = 4 comm_elem_proc_ids = 1
elem_cmap_id i=9 = 1 comm_elem_ids = 235 comm_side_ids = 4 comm_elem_proc_ids = 1
