...
/*****************************************************************************/
void Element_Density_Function::Display_Class(std::ostream& s, const std::string &indent)
/*****************************************************************************/
{
  s << std::endl 
...
/*****************************************************************************/
Element_Density_Function::Element_Density_Function(const std::string & funcBody,
