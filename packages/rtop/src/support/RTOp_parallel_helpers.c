...
void RTOp_parallel_calc_overlap(
  Teuchos_Index global_dim_in, Teuchos_Index local_sub_dim_in, Teuchos_Index local_offset_in
  ,const Teuchos_Index first_ele_in, const Teuchos_Index sub_dim_in, const Teuchos_Index global_offset_in
  ,Teuchos_Index* overlap_first_local_ele, Teuchos_Index* overalap_local_sub_dim
  ,Teuchos_Index* overlap_global_offset
  )
{
