...
//
void BlockedMappingStrategy::copyEpetraIntoThyra(
...
//
void BlockedMappingStrategy::copyThyraIntoEpetra(
...
//
const Teuchos::RCP<Thyra::BlockedLinearOpBase<double> > BlockedMappingStrategy::buildBlockedThyraOp(
...
//
void BlockedMappingStrategy::rebuildBlockedThyraOp(
