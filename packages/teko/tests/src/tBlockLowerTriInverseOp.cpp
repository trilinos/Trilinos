...
int tBlockLowerTriInverseOp::runTest(int verbosity,std::ostream & stdstrm,std::ostream & failstrm,int & totalrun)
{
   bool allTests = true;
   bool status;
   int failcount = 0;
...
bool tBlockLowerTriInverseOp::test_alphabeta(int verbosity,std::ostream & os)
{
   ...
   LinearOp invTri = createNewBlockLowerTriInverseOp(U,invDiag_);
...
bool tBlockLowerTriInverseOp::test_apply(int verbosity,std::ostream & os)
{
   ...
   RCP<const Thyra::LinearOpBase<double> > invTri = createNewBlockLowerTriInverseOp(U,invDiag_);
