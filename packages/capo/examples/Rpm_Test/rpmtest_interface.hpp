...
#ifndef Capo_RPMTEST_INTERFACE_H
#define Capo_RPMTEST_INTERFACE_H

/************************************************************ 
File:      rpmtest_interface.hpp
...
public:
  ...
  //!Constructor:
  ThyraIntegrator(Teuchos::RefCountPtr<RpmtestIntegrator> problem);
  ...
  bool Integrate(const Teuchos::RefCountPtr<Thyra::VectorBase<Scalar> >& y, 
		 ...
		 const double lambda);
private:
  Teuchos::RefCountPtr<RpmtestIntegrator> AppIntegrator;
