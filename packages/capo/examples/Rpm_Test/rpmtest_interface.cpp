...
/************************************************************ 
File:      rpmtest_interface.cpp
Purpose:   Create a class to wrap A. Salinger's integrator.
Date:      7-01-05
...
//------------------------------------------------------------------
ThyraIntegrator::ThyraIntegrator(Teuchos::RefCountPtr<RpmtestIntegrator> problem)
{
