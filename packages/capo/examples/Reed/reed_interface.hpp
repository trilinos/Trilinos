...
#ifndef Capo_REED_INTERFACE_H
#define Capo_REED_INTERFACE_H

/************************************************************ 
File:      reed_interface.hpp
...
public:
  ...
  //!Constructor:
  ThyraIntegrator(Teuchos::RefCountPtr<ReedIntegrator> problem);
  ...
  bool Integrate(const Teuchos::RefCountPtr<Thyra::VectorBase<Scalar> >& y, 
		 ...
		 const double lambda);
private:
  Teuchos::RefCountPtr<ReedIntegrator> AppIntegrator;
