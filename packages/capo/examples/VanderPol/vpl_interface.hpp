...
#ifndef Capo_VPL_INTERFACE_H
#define Capo_VPL_INTERFACE_H

/************************************************************ 
File:      vpl_interface.hpp
...
public:
  ...
  //!Constructor:
  ThyraIntegrator(Teuchos::RefCountPtr<VplIntegrator> problem);
  ...
  bool Integrate(const Teuchos::RefCountPtr<Thyra::VectorBase<Scalar> >& y, 
		 ...
		 const double lambda);
private:
  Teuchos::RefCountPtr<VplIntegrator> AppIntegrator;
