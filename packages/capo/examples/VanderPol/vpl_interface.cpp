...
/************************************************************ 
File:      vpl_interface.cpp
Purpose:   Create a class to wrap the vanderpol integrator.
Date:      6-30-05
...
//------------------------------------------------------------------
ThyraIntegrator::ThyraIntegrator(Teuchos::RefCountPtr<VplIntegrator> problem)
{
