...
// Destructor
Tcubed_FiniteElementProblem::~Tcubed_FiniteElementProblem()
{
  delete AA;
  delete A;
...
bool 
Tcubed_FiniteElementProblem::evaluate(FillType f, 
...
Epetra_Vector& 
Tcubed_FiniteElementProblem::getSolution()
{
  return *initialSolution;
}
  
Epetra_CrsMatrix& 
Tcubed_FiniteElementProblem::getJacobian()
{
  return *A;
}
...
Tcubed_FiniteElementProblem::setParameter(string label, double value)
{
  if (label == "Nonlinear Factor")
    ...
    cout << "ERROR: Tcubed_FiniteElementProblem::setParameter() - label is invalid "
...
Epetra_CrsGraph& 
Tcubed_FiniteElementProblem::generateGraph(Epetra_CrsGraph& AAA)
{
