...
#ifndef Capo_EXAMPLE_INTERFACE_H
#define Capo_EXAMPLE_INTERFACE_H

/************************************************************ 
File:      Example_Interface.hpp
...
public:
  ...
  //!Constructor:
  ThyraIntegrator(Teuchos::RefCountPtr<const Epetra_Map> EMap,Teuchos::RefCountPtr<ExampleIntegrator> problem);
...
private:
  ...
  Teuchos::RefCountPtr<ExampleIntegrator> AppIntegrator;
