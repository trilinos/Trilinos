...
#ifndef Capo_SOLVER_UNP_H
#define Capo_SOLVER_UNP_H

/************************************************************ 
File:      Capo_Unp.hpp
Purpose:   The Underdetermined Newton--Picard method
Date:      7-21-05
...
namespace CAPO {
  ...
  */
  ...
  public:
    //! Constructor
    Unp(const Teuchos::RefCountPtr<Parameter_List>& ParamList, \
  ...
  private:
    ...
    */
    bool Solve_Linear(double *Mat,double *rhs, bool resolve, int m, int n, int nrhs);
