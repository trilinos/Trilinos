...
#ifndef SIERRA_Ioss_ShellLine2D3_h
#define SIERRA_Ioss_ShellLine2D3_h
...
namespace Ioss {
  class ShellLine2D3 : public Ioss::ElementTopology {
  ...
  private:
    ...
    ShellLine2D3(const ShellLine2D3&); // Do not implement
  };
}

#endif // SIERRA_Ioss_ShellLine2D3_h
