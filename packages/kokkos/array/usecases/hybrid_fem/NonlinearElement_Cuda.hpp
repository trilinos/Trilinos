...
template<>
struct ElementComputation< FEMesh< double , 27 , KokkosArray::Cuda > , double >
{
  ...
  typedef KokkosArray::View< double[][FunctionCount][FunctionCount] , device_type > elem_matrices_type ;
  typedef KokkosArray::View< double[][FunctionCount] , device_type > elem_vectors_type ;
  typedef KokkosArray::View< double[] , device_type > value_vector_type ;
