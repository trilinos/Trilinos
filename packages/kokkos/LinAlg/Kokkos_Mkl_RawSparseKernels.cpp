...
template<>
void Kokkos::Mkl::RawSparseKernels<float, MKL_INT>::
...
template<>
void Kokkos::Mkl::RawSparseKernels<double, MKL_INT>::
csrmv (const char* const transa,
       const MKL_INT m, // Number of rows in A
       const MKL_INT k, // Number of columns in A
       const double& alpha,
...
template<>
void Kokkos::Mkl::RawSparseKernels<std::complex<float>, MKL_INT>::
csrmv (const char* const transa,
       const MKL_INT m, // Number of rows in A
       const MKL_INT k, // Number of columns in A
...
{
  mkl_ccsrmv ((char*) transa, (MKL_INT*) &m, (MKL_INT*) &k,
              (MKL_Complex8*) &alpha, (char*) matdescra,
              (MKL_Complex8*) val, (MKL_INT*) ind, (MKL_INT*) ptrBegin, (MKL_INT*) ptrEnd,
              (MKL_Complex8*) x, (MKL_Complex8*) &beta, y);
}
...
csrmm (const char* const transa,
       ...
       const MKL_INT LDC)
{
  mkl_ccsrmm ((char*) transa, (MKL_INT*) &m, (MKL_INT*) &n, (MKL_INT*) &k,
              (MKL_Complex8*) &alpha, (char*) matdescra,
              (MKL_Complex8*) val, (MKL_INT*) ind, (MKL_INT*) ptrBegin, (MKL_INT*) ptrEnd,
              (MKL_Complex8*) B, (MKL_INT*) &LDB, (MKL_Complex8*) &beta, C, (MKL_INT*) &LDC);
}
...
csrsv (const char* const transa,
       ...
       std::complex<float>* const y)
{
  mkl_ccsrsv ((char*) transa, (MKL_INT*) &m, (MKL_Complex8*) &alpha, (char*) matdescra,
              (MKL_Complex8*) val, (MKL_INT*) ind, (MKL_INT*) ptrBegin, (MKL_INT*) ptrEnd,
              (MKL_Complex8*) x, y);
}
...
csrsm (const char* const transa,
       ...
       const MKL_INT LDC)
{
  mkl_ccsrsm ((char*) transa, (MKL_INT*) &m, (MKL_INT*) &n,
              (MKL_Complex8*) &alpha, (char*) matdescra,
              (MKL_Complex8*) val, (MKL_INT*) ind, (MKL_INT*) ptrBegin, (MKL_INT*) ptrEnd,
              (MKL_Complex8*) B, (MKL_INT*) &LDB, C, (MKL_INT*) &LDC);
}
...
template<>
void Kokkos::Mkl::RawSparseKernels<std::complex<double>, MKL_INT>::
csrmv (const char* const transa,
       const MKL_INT m, // Number of rows in A
       const MKL_INT k, // Number of columns in A
...
{
  mkl_zcsrmv ((char*) transa, (MKL_INT*) &m, (MKL_INT*) &k,
              (MKL_Complex16*) &alpha, (char*) matdescra,
              (MKL_Complex16*) val, (MKL_INT*) ind, (MKL_INT*) ptrBegin, (MKL_INT*) ptrEnd,
              (MKL_Complex16*) x, (MKL_Complex16*) &beta, y);
}
...
csrmm (const char* const transa,
       ...
       const MKL_INT LDC)
{
  mkl_zcsrmm ((char*) transa, (MKL_INT*) &m, (MKL_INT*) &n, (MKL_INT*) &k,
              (MKL_Complex16*) &alpha, (char*) matdescra,
              (MKL_Complex16*) val, (MKL_INT*) ind, (MKL_INT*) ptrBegin, (MKL_INT*) ptrEnd,
              (MKL_Complex16*) B, (MKL_INT*) &LDB, (MKL_Complex16*) &beta, C, (MKL_INT*) &LDC);
}
...
csrsv (const char* const transa,
       ...
       std::complex<double>* const y)
{
  mkl_zcsrsv ((char*) transa, (MKL_INT*) &m, (MKL_Complex16*) &alpha, (char*) matdescra,
              (MKL_Complex16*) val, (MKL_INT*) ind, (MKL_INT*) ptrBegin, (MKL_INT*) ptrEnd,
              (MKL_Complex16*) x, y);
}
...
csrsm (const char* const transa,
       ...
       const MKL_INT LDC)
{
  mkl_zcsrsm ((char*) transa, (MKL_INT*) &m, (MKL_INT*) &n,
              (MKL_Complex16*) &alpha, (char*) matdescra,
              (MKL_Complex16*) val, (MKL_INT*) ind, (MKL_INT*) ptrBegin, (MKL_INT*) ptrEnd,
              (MKL_Complex16*) B, (MKL_INT*) &LDB, C, (MKL_INT*) &LDC);
}
