...
FUNCTION(kokkos_option CAMEL_SUFFIX DEFAULT TYPE DOCSTRING)
  ...
  SET(KOKKOS_OPTION_KEYS ${KOKKOS_OPTION_KEYS} CACHE INTERNAL "" FORCE)
  LIST(APPEND KOKKOS_OPTION_VALUES "${DOCSTRING}")
  SET(KOKKOS_OPTION_VALUES ${KOKKOS_OPTION_VALUES} CACHE INTERNAL "" FORCE)
  LIST(APPEND KOKKOS_OPTION_TYPES ${TYPE})
  SET(KOKKOS_OPTION_TYPES ${KOKKOS_OPTION_TYPES} CACHE INTERNAL "" FORCE)
