...
#ifndef KOKKOS_F77FUNC_H
#define KOKKOS_F77FUNC_H
...
/* Define fcd (Fortran kokkos_fcd descriptor) for non-standard situations */
...
#include <fortran.h>
#define PREFIX
#define kokkos_fcd fcd

#elif defined(INTEL_CXML)

#define PREFIX __stdcall
#define kokkos_fcd char *, unsigned int

#elif defined(INTEL_MKL)

#define PREFIX
#define kokkos_fcd char *
...
#else /* Define kokkos_fcd for all other machines */
