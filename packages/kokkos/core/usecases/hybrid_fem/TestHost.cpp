                        ...
                        size_t nx , size_t ny , size_t nz )
{
  ...
  test_box_fixture<Kokkos::Host>( machine , gang_count , nx , ny , nz );
...
{
  Kokkos::Host::initialize( gang_count , gang_worker_count );
  HybridFEM::Implicit::driver<double,Kokkos::Host>( "Host" , machine , gang_count , elem_count_begin , elem_count_end , count_run );
  Kokkos::Host::finalize();
}
...
{
  Kokkos::Host::initialize( gang_count , gang_worker_count );
  Explicit::driver<double,Kokkos::Host>( "Host" , machine , gang_count , elem_count_begin , elem_count_end , count_run );
  Kokkos::Host::finalize();
}
