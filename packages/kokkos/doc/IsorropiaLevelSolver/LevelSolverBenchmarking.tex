...
\begin{figure}[htbp]
     \centering
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/inline_1_serial.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/F1_serial.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/boneS10_serial.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/bmwcra_serial.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/bmw7_serial.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/bmw3_2_serial.png}}
...
\begin{figure}[htbp]
     \centering
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/inline_1_tpi.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/F1_tpi.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/boneS10_tpi.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/bmwcra_tpi.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/bmw7_tpi.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/bmw3_2_tpi.png}}
...
\begin{figure}[htbp]
     \centering
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/inline_1_tbb.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/F1_tbb.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/boneS10_tbb.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/bmwcra_tbb.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/bmw7_tbb.png}}
      \subfigure[cap]{ %\label{lbl}
          \includegraphics[width=8.9cm]{data/bmw3_2_tbb.png}}
