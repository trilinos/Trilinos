...
bool MV_Multiply_DoMKL(typename KokkosArray::Impl::enable_if<
...
template<typename T, class RangeVector,class CrsMatrix,class DomainVector>
bool MV_Multiply_DoMKL(typename KokkosArray::Impl::enable_if<KokkosArray::Impl::is_same<T,double>::value, double  >::type s_b
...
template<typename T, class RangeVector,class CrsMatrix,class DomainVector>
bool MV_Multiply_DoMKL(typename KokkosArray::Impl::enable_if<KokkosArray::Impl::is_same<T,float>::value, float  >::type s_b
...
bool MV_Multiply_Try_MKL( typename RangeVector::scalar_type s_b,const RangeVector & y, typename DomainVector::scalar_type s_a,
		const CrsMatrix & A , const DomainVector & x)
{
  if(!(KokkosArray::Impl::is_same<typename RangeVector::device_type,typename KokkosArray::Host>::value ||
	   KokkosArray::Impl::is_same<typename RangeVector::device_type,typename KokkosArray::OpenMP>::value)  ) return false;
