...
#ifndef GALERI_ONES_H
#define GALERI_ONES_H
...
inline
Epetra_CrsMatrix* Ones(const Epetra_Map* Map, const double value)
{
...
Epetra_CrsMatrix* Ones(const Epetra_Map* Map, const double value)
{
  ...
  if(Map->GlobalIndicesInt()) {
	  return Ones<int>(Map, value);
  }
  else
#endif
#ifndef EPETRA_NO_64BIT_GLOBAL_INDICES
  if(Map->GlobalIndicesLongLong()) {
	  return Ones<long long>(Map, value);
  }
  else
#endif
    throw "Galeri::Matrices::Ones: GlobalIndices type unknown";
}
