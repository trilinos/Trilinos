...
class Problem_Helmholtz : public Problem<Map, Matrix, MultiVector> {
 public:
  Problem_Helmholtz(Teuchos::ParameterList& list)
    : Problem<Map, Matrix, MultiVector>(list) {}
  Problem_Helmholtz(Teuchos::ParameterList& list, const Teuchos::RCP<const Map>& map)
