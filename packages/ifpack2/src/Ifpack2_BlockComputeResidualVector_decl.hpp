...
template <typename MatrixType>
struct ComputeResidualVector<MatrixType, BlockTriDiContainerDetails::ImplSimdTag> {
...
template <typename MatrixType>
struct ComputeResidualVector<MatrixType, BlockTriDiContainerDetails::ImplNotAvailTag> {
  using impl_type        = BlockHelperDetails::ImplType<MatrixType>;
  using node_device_type = typename impl_type::node_device_type;
  using execution_space  = typename impl_type::execution_space;
  using memory_space     = typename impl_type::memory_space;
