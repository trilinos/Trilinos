...
template <class MatrixType>
bool TriDiSolver<MatrixType, false>::isInitialized() const {
  return isInitialized_;
}

template <class MatrixType>
bool TriDiSolver<MatrixType, false>::isComputed() const {
  return isComputed_;
}

template <class MatrixType>
int TriDiSolver<MatrixType, false>::getNumInitialize() const {
  return numInitialize_;
}

template <class MatrixType>
int TriDiSolver<MatrixType, false>::getNumCompute() const {
  return numCompute_;
}

template <class MatrixType>
int TriDiSolver<MatrixType, false>::getNumApply() const {
  return numApply_;
}
...
void TriDiSolver<MatrixType, false>::factor(Teuchos::SerialTriDiMatrix<int, scalar_type>& A,
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "Ifpack2::Details::TriDiSolver::factor: "
      "LAPACK's _GTTRF (tridiagonal LU factorization with partial pivoting) "
      "reports that the computed U factor is exactly singular.  U("
          << INFO << "," << INFO << ") (one-based index i) is exactly zero.  This probably "
...
void TriDiSolver<MatrixType, false>::
  ...
  if (alpha == STS::zero()) {  // don't need to solve the linear system
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(
        ...
        "with partial pivoting) failed with INFO = "
            << INFO << " != 0.");
...
template <class MatrixType>
bool TriDiSolver<MatrixType, true>::isInitialized() const {
  TEUCHOS_TEST_FOR_EXCEPTION(true, std::logic_error, "Not implemented");
}

template <class MatrixType>
bool TriDiSolver<MatrixType, true>::isComputed() const {
  TEUCHOS_TEST_FOR_EXCEPTION(true, std::logic_error, "Not implemented");
}

template <class MatrixType>
int TriDiSolver<MatrixType, true>::getNumInitialize() const {
  TEUCHOS_TEST_FOR_EXCEPTION(true, std::logic_error, "Not implemented");
}

template <class MatrixType>
int TriDiSolver<MatrixType, true>::getNumCompute() const {
  TEUCHOS_TEST_FOR_EXCEPTION(true, std::logic_error, "Not implemented");
}

template <class MatrixType>
int TriDiSolver<MatrixType, true>::getNumApply() const {
  TEUCHOS_TEST_FOR_EXCEPTION(true, std::logic_error, "Not implemented");
}
