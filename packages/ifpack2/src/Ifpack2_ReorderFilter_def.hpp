...
void ReorderFilter<MatrixType>::
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      localRow == OTLO::invalid(), std::invalid_argument,
      "Ifpack2::Reorder"
      "Filter::getGlobalRowCopy: The given global row index "
          << globalRow
...

{
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "long enough to store all the data in the given row "
          << LocalRow
