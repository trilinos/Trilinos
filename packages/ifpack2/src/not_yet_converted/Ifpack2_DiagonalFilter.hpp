...
#ifndef IFPACK2_DIAGONALFILTER_HPP
#define IFPACK2_DIAGONALFILTER_HPP
...
*/
class Ifpack2_DiagonalFilter : public virtual Tpetra_RowMatrix {

public:
  //! Constructor.
  Ifpack2_DiagonalFilter(const Teuchos::RCP<Tpetra_RowMatrix>& Matrix,
                        double AbsoluteThreshold,
                        double RelativeThreshold);
  
  //! Destructor.
  virtual ~Ifpack2_DiagonalFilter() {};
...
#endif /* IFPACK2_DIAGONALFILTER_HPP */
