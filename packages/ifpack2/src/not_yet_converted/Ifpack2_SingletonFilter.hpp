...
#ifndef IFPACK2_SINGLETONFILTER_HPP
#define IFPACK2_SINGLETONFILTER_HPP
...
//
class Ifpack2_SingletonFilter : public virtual Tpetra_RowMatrix {

public:
  //! Constructor.
  Ifpack2_SingletonFilter(const Teuchos::RCP<Tpetra_RowMatrix>& Matrix);

  //! Destructor.
  virtual ~Ifpack2_SingletonFilter() {};
...
#endif /* IFPACK2_SINGLETONFILTER_HPP */
