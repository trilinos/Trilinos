...
static const string PrintMsg_ = "(Ifpack2_OvPartitioner) ";

//==============================================================================
Ifpack2_OverlappingPartitioner::
...
//==============================================================================
Ifpack2_OverlappingPartitioner::~Ifpack2_OverlappingPartitioner()
{
}

//==============================================================================
int Ifpack2_OverlappingPartitioner::SetParameters(Teuchos::ParameterList& List)
{
...
//==============================================================================
int Ifpack2_OverlappingPartitioner::Compute()
{

  if (NumLocalParts_ < 1)
    IFPACK2_CHK_ERR(-1); // incorrect value
  ...
  if (Graph_->Filled() == false)
    IFPACK2_CHK_ERR(-4); // need FillComplete() called

  if (Graph_->NumGlobalRows() != Graph_->NumGlobalCols())
    IFPACK2_CHK_ERR(-3); // can partition square matrices only

  if (NumLocalParts_ < 1)
    IFPACK2_CHK_ERR(-2); // value not valid
 
  // 3.- perform non-overlapping partition
 
  IFPACK2_CHK_ERR(ComputePartitions());

  // 4.- compute the partitions with overlapping
  
  IFPACK2_CHK_ERR(ComputeOverlappingPartitions());
...
// ======================================================================
int Ifpack2_OverlappingPartitioner::ComputeOverlappingPartitions()
{
...
//============================================================================
int Ifpack2_OverlappingPartitioner::NumMyRows() const
{
  return(Graph_->NumMyRows());
}

//============================================================================
int Ifpack2_OverlappingPartitioner::NumMyNonzeros() const
{
  return(Graph_->NumMyNonzeros());
}

//============================================================================
int Ifpack2_OverlappingPartitioner::NumGlobalRows() const
{
  return(Graph_->NumGlobalRows());
}

//============================================================================
int Ifpack2_OverlappingPartitioner::MaxNumEntries() const
{
  return(Graph_->MaxMyNumEntries());
}

//============================================================================
const Tpetra_Comm& Ifpack2_OverlappingPartitioner::Comm() const
{
  return(Graph_->Comm());
}

// ======================================================================
ostream& Ifpack2_OverlappingPartitioner::Print(ostream & os) const
{
  ...
  os << "================================================================================" << endl;
  os << "Ifpack2_OverlappingPartitioner" << endl;
