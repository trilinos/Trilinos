...
//! Tifpack_SPARSKIT: A class for constructing and using an SPARSKIT's incomplete factorizations.

class Tifpack_SPARSKIT: public Tifpack_Preconditioner {
      
 public:
  //! Tifpack_SPARSKIT constuctor with variable number of indices per row.
  Tifpack_SPARSKIT(Tpetra_RowMatrix* A);
  
  //! Tifpack_SPARSKIT Destructor
  virtual ~Tifpack_SPARSKIT();
