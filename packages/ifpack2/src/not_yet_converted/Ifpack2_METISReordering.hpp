...
#ifndef IFPACK2_METISREORDERING_HPP
#define IFPACK2_METISREORDERING_HPP
...
//! Ifpack2_METISReordering: A class to reorder a graph using METIS.

class Ifpack2_METISReordering : public Ifpack2_Reordering {

public:

  //! Constructor.
  Ifpack2_METISReordering();

  //! Destructor.
  virtual ~Ifpack2_METISReordering() {};
...
}; // class Ifpack2_METISReordering

#endif // IFPACK2_METISREORDERING_HPP
