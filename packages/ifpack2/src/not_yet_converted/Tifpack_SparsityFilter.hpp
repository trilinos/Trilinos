...
#ifndef TIFPACK_SPARSITYFILTER_HPP
#define TIFPACK_SPARSITYFILTER_HPP
...
//! Tifpack_SparsityFilter: a class to drop based on sparsity.
...
public:
  ...
  virtual ~Tifpack_SparsityFilter() {};
...
#endif /* TIFPACK_SPARSITYFILTER_HPP */
