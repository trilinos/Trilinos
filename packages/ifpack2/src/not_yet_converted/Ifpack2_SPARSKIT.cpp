...
//==============================================================================
Ifpack2_SPARSKIT::Ifpack2_SPARSKIT(Tpetra_RowMatrix* A) :
  A_(*A),
  Comm_(A->Comm()),
  UseTranspose_(false),
  lfil_(0),
...
//==============================================================================
Ifpack2_SPARSKIT::~Ifpack2_SPARSKIT()
{
}

//==========================================================================
int Ifpack2_SPARSKIT::SetParameters(Teuchos::ParameterList& List)
{
  ...
  Label_ = "TIFPACK SPARSKIT (Type=" + Type_ + ", fill=" +
    Ifpack2_toString(lfil_) + ")";

  return(0);
}

//==========================================================================
int Ifpack2_SPARSKIT::Initialize()
{
  IsInitialized_ = true;
  IsComputed_    = false;
  return(0);
...
int Ifpack2_SPARSKIT::ApplyInverse(const Tpetra_MultiVector<Scalar,LocalOrdinal,GlobalOrdinal,Node>& X, 
...
//=============================================================================
double Ifpack2_SPARSKIT::Condest(const Ifpack2_CondestType CT, 
                                ...
                                Tpetra_RowMatrix* Matrix)
{
  ...
  if (Condest_ == -1.0)
    Condest_ = Ifpack2_Condest(*this, CT, MaxIters, Tol, Matrix);
...
//=============================================================================
std::ostream&
Ifpack2_SPARSKIT::Print(std::ostream& os) const
{
  if (!Comm().MyPID()) {
    os << endl;
    os << "================================================================================" << endl;
    os << "Ifpack2_SPARSKIT: " << Label() << endl << endl;
