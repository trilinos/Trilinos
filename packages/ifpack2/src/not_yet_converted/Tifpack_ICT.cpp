...
Tifpack_ICT::Tifpack_ICT(const Tpetra_RowMatrix* A) :
  A_(*A),
  Comm_(A_.Comm()),
  Condest_(-1.0),
  Athresh_(0.0),
...
//==============================================================================
Tifpack_ICT::~Tifpack_ICT()
{
  Destroy();
}

//==============================================================================
void Tifpack_ICT::Destroy()
{
  IsInitialized_ = false;
  IsComputed_ = false;
}
...
//==========================================================================
int Tifpack_ICT::SetParameters(Teuchos::ParameterList& List)
{
  ...
  try
  {
    ...
    // set label
    Label_ = "ICT (fill=" + Tifpack_toString(LevelOfFill())
...
int Tifpack_ICT::Compute() 
{
  ...
  TIFPACK_CHK_ERR(A_.ExtractMyRowCopy(0,Length,RowNnz,
  ...
  TIFPACK_CHK_ERR(H_->FillComplete());
...
//=============================================================================
double Tifpack_ICT::Condest(const Tifpack_CondestType CT, 
...
//=============================================================================
std::ostream&
Tifpack_ICT::Print(std::ostream& os) const
{
  if (!Comm().MyPID()) {
    os << endl;
    os << "================================================================================" << endl;
    os << "Tifpack_ICT: " << Label() << endl << endl;
