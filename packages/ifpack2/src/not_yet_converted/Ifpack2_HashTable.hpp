...
************************************************************************
              ...
              TIFPACK: Robust Algebraic Preconditioning Package
...
/* \file Ifpack2_HashTable.hpp
 *
 * \brief HashTable used in Ifpack2_ICT and Ifpack2_ILUT.
 *
...
#ifndef IFPACK2_HPPASHTABLE_HPP
#define IFPACK2_HPPASHTABLE_HPP
...
//    Hash.reset();
//
// \author Michael Heroux, ETHZ/COLAB
//
// \date 30-Jun-06
// ============================================================================ 

class Ifpack2_HashTable 
{
  public:
    //! constructor.
    Ifpack2_HashTable(const int n_keys = 1031, const int n_sets = 1)
    {
      n_keys_ = n_keys;
      n_sets_ = n_sets;
      seed_ = (2654435761U);
