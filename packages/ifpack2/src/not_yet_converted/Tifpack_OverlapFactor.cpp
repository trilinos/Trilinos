...
#include "Tifpack_OverlapFactor.hpp"
...
//==============================================================================
Tifpack_OverlapFactor::Tifpack_OverlapFactor(const Tifpack_OverlapGraph * OverlapGraph) 
  : Factored_(false),
    Allocated_(false),
...
//==============================================================================
Tifpack_OverlapFactor::Tifpack_OverlapFactor(const Tpetra_RowMatrix * UserMatrix) 
  : Factored_(false),
    Allocated_(false),
    ValuesInitialized_(false),
    OverlapGraph_(0),
...
//==============================================================================
Tifpack_OverlapFactor::Tifpack_OverlapFactor(const Tifpack_OverlapFactor & Source) 
...
//==============================================================================
int Tifpack_OverlapFactor::InitValues(const Tpetra_RowMatrix * UserMatrix) {
...
//==============================================================================
int Tifpack_OverlapFactor::Factor() {
