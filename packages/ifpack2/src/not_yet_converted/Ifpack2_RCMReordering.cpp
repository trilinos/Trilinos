...
//==============================================================================
Ifpack2_RCMReordering& Ifpack2_RCMReordering::
operator=(const Ifpack2_RCMReordering& RHS)
{
  if (this == &RHS) {
    return (*this);
  }
...
//==============================================================================
int Ifpack2_RCMReordering::Compute(const Tpetra_RowMatrix& Matrix)
{
...
//==============================================================================
int Ifpack2_RCMReordering::Compute(const Ifpack2_Graph& Graph)
{
  IsComputed_ = false;
  ...
  while (tmp.size()) {
    ...
    for (int i = 0 ; i < (int)tmp.size() ; ++i) {
      int NumEntries;
      IFPACK2_CHK_ERR(Graph.ExtractMyRowCopy(tmp[i], Length,
...
//==============================================================================
int Ifpack2_RCMReordering::Reorder(const int i) const
{
#ifdef IFPACK2_ABC
  if (!IsComputed())
    IFPACK2_CHK_ERR(-1);
...
//==============================================================================
int Ifpack2_RCMReordering::InvReorder(const int i) const
{
#ifdef IFPACK2_ABC
  if (!IsComputed())
    IFPACK2_CHK_ERR(-1);
...
//==============================================================================
int Ifpack2_RCMReordering::P(const Tpetra_MultiVector<Scalar,LocalOrdinal,GlobalOrdinal,Node>& Xorig,
...
//==============================================================================
int Ifpack2_RCMReordering::Pinv(const Tpetra_MultiVector<Scalar,LocalOrdinal,GlobalOrdinal,Node>& Xorig,
			       Tpetra_MultiVector<Scalar,LocalOrdinal,GlobalOrdinal,Node>& X) const
{
  int NumVectors = X.NumVectors();
...
//==============================================================================
ostream& Ifpack2_RCMReordering::Print(std::ostream& os) const
{
  os << "*** Ifpack2_RCMReordering" << endl << endl;
  if (!IsComputed())
