...
#ifndef IFPACK2_LOCALFILTER_HPP
#define IFPACK2_LOCALFILTER_HPP
 ...
 */ 
class Ifpack2_LocalFilter : public virtual Tpetra_RowMatrix {

public:
  //@{ \name Constructor.
  //! Constructor
  Ifpack2_LocalFilter(const Teuchos::RCP<const Tpetra_RowMatrix>& Matrix);

  //@}
  //@{ \name Destructor.
  //! Destructor
  virtual ~Ifpack2_LocalFilter() {};
