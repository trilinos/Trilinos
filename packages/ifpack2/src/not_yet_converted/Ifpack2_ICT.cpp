...
int Ifpack2_ICT::SetParameters(Teuchos::ParameterList& List) {
  try {
    ...
    // set label
    Label_ = "ICT (fill=" + Ifpack2_toString(LevelOfFill()) + ", athr=" + Ifpack2_toString(AbsoluteThreshold()) + ", rthr=" + Ifpack2_toString(RelativeThreshold()) + ", relax=" + Ifpack2_toString(RelaxValue()) + ", droptol=" + Ifpack2_toString(DropTolerance()) + ")";
