...
\ccc{block relaxation: dofs per node}
    {int}
    {1}
    {How many matrix rows correspond to a mesh node. This is not required
     if the problem uses a BlockCrsMatrix, since
     the block size is included in the matrix.}
