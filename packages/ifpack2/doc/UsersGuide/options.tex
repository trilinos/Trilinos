...
\ccc{chebyshev: algorithm}
    ...
    {The algorithm for the Chebyshev polynomial. Currently supports
     ...
     Chebyshev smoothing via the fourth-kind ("fourth") and optimized fourth-kind ("opt\_fourth")
     ...
     However, the "first", "fourth", and "opt\_fourth" kinds are preferred.
     Currently supported: "first", "fourth", "opt\_fourth", and "textbook".
     Generally, the "fourth" and "opt\_fourth" provide better smoothing properties
