...
\ccc{chebyshev: eigenvalue tol}
    {double}
    {0.0}
    {Tolerance used in power method heuristic to stop early. If it is not
     provided by a user, the heuristic is disabled. While the best value depends on a
     problem, it is recommended to start with 0.1 and then adjust.}
