...
The semi-coarsening is provided by the **SemiCoarsenPFactory** for generating the semi-coarsening transfer operators in combination with the **LineDetectionFactory** which performs the line detection, i.e. it searchs for the vertical node lines along the extrusion axis of the 2D mesh.
