...
\newcommand{\kokkos}       {\textsc{Kokkos}\xspace}
...
\newcommand{\muemex}       {\textsc{MueMex}\xspace}
\newcommand{\nox}          {\textsc{NOX}\xspace}
...
\newcommand{\mlcba}[4]{\choicebox{\texttt{#1}}{[{\texttt #2}] #4 {\bf Compatibility:~}#3.}}
\newcommand{\mlcbb}[5]{\choicebox{\texttt{#1}}{[{\texttt #2}] #5 {\bf Default:~}#3 {\bf Compatibility:~}#4.}}
...
\newcommand{\wip}[1]{\textcolor{red}{\textbf{#1}}}
