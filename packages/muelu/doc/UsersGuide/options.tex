...
\noindent
Some examples on how to write hierarchy data are as follows, with explanations.
...
<ParameterList name="MueLu">
  ...
  <ParameterList name="export data">
    ...
    <Parameter name="R"  type="string" value="{1}"/>
    <Parameter name="export frequency"  type="int" value="2"/>
    <Parameter name="total"  type="int" value="3"/>
  </ParameterList>

</ParameterList>
\end{lstlisting}

The matrices $A_0$, $A_1$, $A_2$ will be output, along with the grid transfer $R_1$.
Writing will occur at every second hierarchy construction, for at most three hierarchy constructions.
...
<ParameterList name="MueLu">
  ...
  <ParameterList name="export data">
    ...
    <Parameter name="R"  type="string" value="{1}"/>
    <Parameter name="export frequency"  type="int" value="2"/>
    <Parameter name="export first system" type="bool" value="true"/>
  </ParameterList>
...
The matrices $A_0$, $A_1$, $A_2$ will be output, along with the grid transfer $R_1$.
Writing will start with the first hierarchy construction, and every second one thereafter without limit, i.e.,
construction $0, 2, 4, \dots$.

It is possible to reset the internal hierarchy export counters via the call
