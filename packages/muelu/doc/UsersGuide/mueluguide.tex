...
\cbb{verbosity}                          {int}       {"high"}        {Controll of the amount of printed information. Possible values: "none", "low",
                                                                     "medium", "high", "extreme".}
...
\cbb{aggregation: Dirichlet detection}   {bool}      {true}          {Dirichlet row detection (Dirichlet rows are rows with a single nonzero element on
                                                                     a diagonal.}
...
% \cbb{smoother: pre or post}              {string}    {"both"}        {}
% \cbb{smoother: pre type}                 {string}    {}              {}
% \cbb{smoother: post type}                {string}    {}              {}
\cba{smoother: params}                   {\parameterlist}            {Smoother parameters. For standard smoothers, \muelu passes them directly to \stratimikos.}
% \cba{smoother: pre params}               {string}                    {}
% \cba{smoother: post params}              {string}                    {}
\cbc{smoother: sweeps}                   {int}       {2}             {Number of smoother sweeps.}
% \cbb{smoother: pre sweeps}               {int}       {}
% \cbb{smoother: post sweeps}              {int}       {}

\cbc{coarse: type}                       {string}    {"SuperLU"}     {Coarse solver. Possible values: see Table~\ref{t:coarse_solvers}.}
