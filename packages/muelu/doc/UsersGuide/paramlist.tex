...
\cbb{sa: use edge matrix for smoothing}{bool}{false}{If true, smooth the edge prolongator with the edge matrix (mass + curl curl). In general this does violate the commuting relationship. If false smooth with the user provided CurlCurl matrix.}
