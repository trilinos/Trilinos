...
\cbb{aggregation: coloring algorithm}{string}{Zoltan2}{Choice of distance 2 coloring algorithm used by Uncoupled Aggregation. Currently set by default to COLORING\_D2\_SERIAL.}
