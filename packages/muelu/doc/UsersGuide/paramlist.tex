...
<<<<<<< HEAD
\cbb{aggregate qualities: algorithm}{string}{forward}{Algorithm to use ``forward'' or ``reverse.''}
          
\cbb{aggregate qualities: zero threshold}{double}{1e-12}{The zero threshold for the reverse algorithm.}
=======
\cbb{aggregate qualities: percentiles}{Array(double)}{{.5}}{Percentiles of aggregate qualities to report (in a [0,1] range).}
>>>>>>> muelu-mean-agg-quality
