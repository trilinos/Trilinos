...
\cbb{aggregation: zero drop tol after level}{int}{0}{If positive, set the drop tol to zero when the level exceeds the specified level. Otherwise, this has no effect. }
