...
\cbb{aggregation: phase3 avoid singletons}{bool}{false}{Causes phase 3 aggregation to try and group any vertices that remain
      unaggregated with any other on-rank vertex (even if it is not a neighbor) to define an aggregate.  This only
      works for Uncoupled Aggregation.}
