...
\cba{avatar: decision tree strings}{\parameterlist}{Decision trees (stored as strings) for Avatar}
        
\cba{avatar: decision tree files}{\parameterlist}{Names of Avatar decision tree files}
        
\cba{avatar: problem features}{\parameterlist}{Problem features as computed by the application}
        
\cba{avatar: muelu parameter mapping}{\parameterlist}{Mapping of MueLu to Avatar Parameters}
