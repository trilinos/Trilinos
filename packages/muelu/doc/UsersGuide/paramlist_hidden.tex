...
\cbb{filtered matrix: lumping choice}{string}{"diag lumping"}{Can be no lumping (no modification to kept entries), diag lumping (modify diagonal to maintain row sums), or distributred lumping (modify kept nonzeros in a fashion proportional to their magnitude to preserve row sums). }
