...
\cbb{rap: shift array}{Array(double)}{{0.0}}{Effective shift at each level to use in the RAPShiftFactory (the string must be interpretable as an array by Teuchos).}
