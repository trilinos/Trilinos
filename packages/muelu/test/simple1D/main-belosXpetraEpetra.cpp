...
#define JG_TODO
  ...
  // Use AMG as a preconditioner in Belos
  {
    ...
    // Vectors  
    RCP<MV> belosX     = MueLu::Utils<SC,LO,GO,NO,LMO>::MV2NonConstEpetraMV(X);
    RCP<MV> belosRHS   = MueLu::Utils<SC,LO,GO,NO,LMO>::MV2NonConstEpetraMV(RHS);
    RCP<MV> belosResid = MueLu::Utils<SC,LO,GO,NO,LMO>::MV2NonConstEpetraMV(resid);
