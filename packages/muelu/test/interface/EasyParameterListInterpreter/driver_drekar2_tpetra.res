...
Level 3
 ...
 Smoother (level 0) both : Ifpack2::Chebyshev{status = initialized, computed, "Ifpack2::Details::Chebyshev":{degree: 2, lambdaMax: 1.9506, alpha: 20, lambdaMin: 0.0975299}, global rows = 9999, global cols = 9999, global nnz  = 29995}
 
 Smoother (level 1) both : Ifpack2::Chebyshev{status = initialized, computed, "Ifpack2::Details::Chebyshev":{degree: 2, lambdaMax: 1.94379, alpha: 20, lambdaMin: 0.0971895}, global rows = 3333, global cols = 3333, global nnz  = 9997}
 
 Smoother (level 2) both : Ifpack2::Chebyshev{status = initialized, computed, "Ifpack2::Details::Chebyshev":{degree: 2, lambdaMax: 1.94989, alpha: 20, lambdaMin: 0.0974946}, global rows = 1111, global cols = 1111, global nnz  = 3331}
