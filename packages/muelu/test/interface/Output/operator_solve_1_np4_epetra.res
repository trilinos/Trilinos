 ...
 Prolongator smoothing (MueLu::SaPFactory)
  Matrix filtering (MueLu::FilteredAFactory)
   Build (MueLu::CoalesceDropFactory)
    ...
    Number of dropped entries in unamalgamated matrix graph: 0/49600 (0%)
  ...
  Build (MueLu::TentativePFactory)
   Build (MueLu::UncoupledAggregationFactory)
    ...
    Algo "Phase 1 (main)"
     BuildAggregates (Phase 1 (main))
       aggregated : 8332 (phase), 8332/10000 [83.32%] (total)
       remaining  : 1668
       aggregates : 1700 (phase), 1700 (total)
    Algo "Phase 2 (cleanup)"
     BuildAggregates (Phase 2 (cleanup))
       aggregated : 1668 (phase), 10000/10000 [100.00%] (total)
       remaining  : 0
       aggregates : 0 (phase), 1700 (total)
    ...
    Algo "Phase - (isolated)"
     BuildAggregates (Phase - (isolated))
       ...
       remaining  : 0
       aggregates : 0 (phase), 1700 (total)
    "UC": MueLu::Aggregates{nGlobalAggregates = 1700}
   ...
   Ptent size =  10000 x 1700, nnz = 10000
   Ptent Load balancing info
   Ptent   # active processes: 4/4
   Ptent   # rows per proc   : avg = 2.50e+03,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
   Ptent   #  nnz per proc   : avg = 2.50e+03,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
  Eigenvalue estimate
   Calculating max eigenvalue estimate now (max iters = 10)
   Prolongator damping factor = 0.70 (1.33 / 1.90)
  Fused (I-omega*D^{-1} A)*Ptent
  P size =  10000 x 1700, nnz = 24864
  P Load balancing info
  P   # active processes: 4/4
  P   # rows per proc   : avg = 2.50e+03,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
  P   #  nnz per proc   : avg = 6.22e+03,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
  P Communication info
  P   # num export send : avg =     0.00,  dev =   0.00,  min =    0.0 ,  max =    0.0
  P   # num import send : avg = 4.20e+01,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
  P   # num msgs        : avg =     2.00,  dev =   0.00,  min =    2.0 ,  max =    2.0
  P   # min msg size    : avg = 1.70e+01,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
  P   # max msg size    : avg = 2.50e+01,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
