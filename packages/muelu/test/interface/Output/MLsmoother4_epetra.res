...
Level 1
 ...
 Setup Smoother (MueLu::IfpackSmoother{type = Chebyshev})
  ...
  chebyshev: max eigenvalue (calculated by Ifpack) = 1.95
  "Ifpack Chebyshev polynomial": {Initialized: true, Computed: true, degree: 2, lambdaMax: 1.94628, alpha: 20, lambdaMin: 0.0973139}
Level 2
 Prolongator smoothing (MueLu::SaPFactory)
  Build (MueLu::TentativePFactory)
   Build (MueLu::UncoupledAggregationFactory)
 ...
 Setup Smoother (MueLu::IfpackSmoother{type = Chebyshev})
  ...
  "Ifpack Chebyshev polynomial": {Initialized: true, Computed: true, degree: 2, lambdaMax: 1.94472, alpha: 20, lambdaMin: 0.0972362}
Level 3
 Prolongator smoothing (MueLu::SaPFactory)
  Build (MueLu::TentativePFactory)
   Build (MueLu::UncoupledAggregationFactory)
 ...
 Setup Smoother (MueLu::IfpackSmoother{type = Chebyshev})
  chebyshev: ratio eigenvalue (computed) = 20.00
  chebyshev: max eigenvalue (calculated by Ifpack) = 1.95
  "Ifpack Chebyshev polynomial": {Initialized: true, Computed: true, degree: 2, lambdaMax: 1.95199, alpha: 20, lambdaMin: 0.0975994}
Level 4
 Prolongator smoothing (MueLu::SaPFactory)
  Build (MueLu::TentativePFactory)
   Build (MueLu::UncoupledAggregationFactory)
...
Smoother (level 1) both : "Ifpack Chebyshev polynomial": {Initialized: true, Computed: true, degree: 2, lambdaMax: 1.94628, alpha: 20, lambdaMin: 0.0973139}

Smoother (level 2) both : "Ifpack Chebyshev polynomial": {Initialized: true, Computed: true, degree: 2, lambdaMax: 1.94472, alpha: 20, lambdaMin: 0.0972362}

Smoother (level 3) both : "Ifpack Chebyshev polynomial": {Initialized: true, Computed: true, degree: 2, lambdaMax: 1.95199, alpha: 20, lambdaMin: 0.0975994}
