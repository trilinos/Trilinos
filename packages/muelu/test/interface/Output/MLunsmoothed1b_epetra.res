ML ParameterList: 
aggregation: damping factor = 0   [unused]

MueLu ParameterList: 
max levels = 10   [unused]
cycle type = V   [unused]
sa: damping factor = 0   [unused]
...
Level 2
 Prolongator smoothing (MueLu::SaPFactory)
  ...
  P size =  3333 x 1111, nnz = 3333
  P Load balancing info
  P   # active processes: 1/1
  P   # rows per proc   : avg = 3.33e+03,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
  P   #  nnz per proc   : avg = 3.33e+03,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
 Transpose P (MueLu::TransPFactory)
...
Level 3
 Prolongator smoothing (MueLu::SaPFactory)
  ...
  P size =  1111 x 371, nnz = 1111
  P Load balancing info
  P   # active processes: 1/1
  P   # rows per proc   : avg = 1.11e+03,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
  P   #  nnz per proc   : avg = 1.11e+03,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
 Transpose P (MueLu::TransPFactory)
...
Level 4
 Prolongator smoothing (MueLu::SaPFactory)
  ...
  P size =  371 x 124, nnz = 371
  P Load balancing info
  P   # active processes: 1/1
  P   # rows per proc   : avg = 3.71e+02,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
  P   #  nnz per proc   : avg = 3.71e+02,  dev =   0.0%,  min =   +0.0%,  max =   +0.0%
 Transpose P (MueLu::TransPFactory)
