...
namespace Cthulhu {
  ...
  static const Tpetra::Map<LocalOrdinal,GlobalOrdinal,Node> & toTpetra(const Cthulhu::Map<LocalOrdinal,GlobalOrdinal,Node> &map);
  ...
  */
  ...
  public:
    ...
    inline GlobalOrdinal getMaxAllGlobalIndex() const { return map_->getMaxAllGlobalIndex(); }
    ...
    Cthulhu::LookupStatus getRemoteIndexList(const Teuchos::ArrayView< const GlobalOrdinal > &GIDList, const Teuchos::ArrayView< int > &nodeIDList, const Teuchos::ArrayView< LocalOrdinal > & LIDList) const { 
      return toCthulhu(map_->getRemoteIndexList(GIDList, nodeIDList, LIDList)); 
    }
    ...
    /** 
      \returns IDNotPresent indicates that at least one global ID was not present in the directory. 
               Otherwise, returns AllIDsPresent.
     */
    Cthulhu::LookupStatus getRemoteIndexList(const Teuchos::ArrayView<const GlobalOrdinal> &GIDList, const Teuchos::ArrayView< int > &nodeIDList) const { return toCthulhu(map_->getRemoteIndexList(GIDList, nodeIDList)); }
