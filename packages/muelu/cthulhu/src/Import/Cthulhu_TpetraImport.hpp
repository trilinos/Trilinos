...
namespace Cthulhu {
  ...
  */
  ...
  public:
    ...
    inline Distributor & getDistributor() const {  return import_->getDistributor(); }
#endif

#ifdef CTHULHU_NOT_IMPLEMENTED
    //! Assignment operator
    inline Import<LocalOrdinal,GlobalOrdinal,Node>& operator = (const Import<LocalOrdinal,GlobalOrdinal,Node> & Source) {  return }
