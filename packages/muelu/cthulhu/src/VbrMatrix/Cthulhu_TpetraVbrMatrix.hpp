...
class TpetraVbrMatrix : public Cthulhu::VbrMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node> {
 public:
...
//       void solve(const MultiVector<RangeScalar,LocalOrdinal,GlobalOrdinal,Node> & Y, MultiVector<DomainScalar,LocalOrdinal,GlobalOrdinal,Node> &X, Teuchos::ETransp trans) const;
  ...
  */
  //TODO:Vector  inline void getLocalDiagCopy(Cthulhu::Vector<Scalar,LocalOrdinal,GlobalOrdinal,Node>& diag) const { mtx_->getLocalDiagCopy(diag); }
