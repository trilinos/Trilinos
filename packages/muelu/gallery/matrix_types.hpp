/*
  Direct translation of parts of Galeri to use Tpetra rather than Epetra.
*/
...
TriDiag(Teuchos::RCP<const Tpetra::Map<LocalOrdinal,GlobalOrdinal,Node> > Map,
        const GlobalOrdinal nx,
        const Scalar a, const Scalar b, const Scalar c)
{
  Teuchos::RCP< Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node> > Matrix;

  Matrix = Teuchos::rcp(new Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node>(Map,  3));
...
Cross2D(Teuchos::RCP<const Tpetra::Map<LocalOrdinal,GlobalOrdinal,Node> > Map,
        const GlobalOrdinal nx, const GlobalOrdinal ny,
        const Scalar a, const Scalar b, const Scalar c, 
        const Scalar d, const Scalar e)
{
  ...
  Matrix = Teuchos::rcp(new Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node>(Map,  5));
...
Teuchos::RCP< Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node> >
Star2D(Teuchos::RCP<const Tpetra::Map<LocalOrdinal,GlobalOrdinal,Node> > Map,
        const GlobalOrdinal nx, const GlobalOrdinal ny,
        const Scalar a, const Scalar b, const Scalar c, 
        const Scalar d, const Scalar e,
        ...
        const Scalar z3, const Scalar z4)
{
  ...
  Matrix = Teuchos::rcp(new Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node>(Map,  9));
...
Teuchos::RCP< Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node> >
BigStar2D(Teuchos::RCP<const Tpetra::Map<LocalOrdinal,GlobalOrdinal,Node> > Map,
          const GlobalOrdinal nx, const GlobalOrdinal ny,
          const Scalar a, const Scalar b, const Scalar c, 
          const Scalar d, const Scalar e,
          const Scalar z1, const Scalar z2,
          ...
          const Scalar bb, const Scalar cc, const Scalar dd, const Scalar ee)
{
  ...
  Matrix = Teuchos::rcp(new Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node>(Map,  13));
...
Teuchos::RCP< Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node> >
Cross3D(Teuchos::RCP<const Tpetra::Map<LocalOrdinal,GlobalOrdinal,Node> > Map,
        const GlobalOrdinal nx, const GlobalOrdinal ny, const GlobalOrdinal nz,
        const Scalar a, const Scalar b, const Scalar c, 
        const Scalar d, const Scalar e,
        const Scalar f, const Scalar g)
{
  ...
  Matrix = Teuchos::rcp(new Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node>(Map,  7));
...
Teuchos::RCP< Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node> >
Brick3D(Teuchos::RCP<const Tpetra::Map<LocalOrdinal,GlobalOrdinal,Node> > Map,
        const GlobalOrdinal nx, const GlobalOrdinal ny, const GlobalOrdinal nz,
        const Scalar a, const Scalar b, const Scalar c, 
        const Scalar d, const Scalar e,
        const Scalar f, const Scalar g)
{
  ...
  Matrix = Teuchos::rcp(new Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node>(Map,  27));
