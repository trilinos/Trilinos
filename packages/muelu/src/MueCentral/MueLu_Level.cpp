...
//   //
  ...
  // std::cout << "MueLu::Level("<< levelID_ << ")::GetFactory(" << varname << ", " << factory << "): " << std::endl; //TMP
  ...
  const FactoryBase* Level::GetFactory(const std::string& varname, const FactoryBase* factory) const {
    ...
    if (factory == NULL) {
      ...
      if(factoryManager_ != null && factoryManager_->IgnoreUserData() == true) {
        std::cout << "MueLu::Level("<< levelID_ << ")::GetFactory(" << varname << ", " << factory << "): IgnoreUserData=true" << std::endl; //TMP
       ...
       {
         std::cout << "MueLu::Level("<< levelID_ << ")::GetFactory(" << varname << ", " << factory << "): IgnoreUserData=false" << std::endl; //TMP
          ...
          if (IsAvailable(varname, NoFactory::get()) && IsKept(varname, NoFactory::get(), MueLu::UserData)) {
            std::cout << "MueLu::Level("<< levelID_ << ")::GetFactory(" << varname << ", " << factory << "): provided by user" << std::endl; //TMP
            return NoFactory::get();
          } else {
            std::cout << "MueLu::Level("<< levelID_ << ")::GetFactory(" << varname << ", " << factory << "): calling factory manager" << std::endl; //TMP
      ...
      std::cout << "MueLu::Level("<< levelID_ << ")::GetFactory(" << varname << ", " << factory << "): input not NULL" << std::endl; //TMP
      return factory;
    }
  }
