...
namespace MueLu {
  ...
  */
  ...
  public:
    ...
    // JG: FIXME:
    //        - The TEST_FOR_EXCEPTION is now wrong (cf. following error messge). Behavior of Delete() have been incorrectly changed.
    ...
    void Delete(const std::string & ename, const FactoryBase* factory) {
      TEST_FOR_EXCEPTION(!keepTable_.IsKey(ename, factory), Exceptions::RuntimeError, "MueLu::Needs::Delete(): " + ename + " not found in keepTable_");
