      ...
      if( bA != Teuchos::null) {
        ...
        if (implicitTranspose_) {
          ...
          if ( coarseLevel.IsAvailable("A",PFact_.get()) ) {
            ...
            if ( coarseLevel.IsAvailable("Importer",RFact_.get()) ) {
              GetOStream(Runtime0, 0) << "Now changing Ac's rowmap, domain map, and range map." << std::endl;
          ...
          sumAll(comm, (GO)((Ac->getNodeNumRows() > 0) ? 1 : 0), numActiveProcesses);
