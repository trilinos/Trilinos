...
#define MUELU_COALESCE_DROP_ALLOW_DEPRECATED_PARAMETERS 1
...
#ifdef MUELU_COALESCE_DROP_ALLOW_DEPRECATED_PARAMETERS
...
#ifndef MUELU_COALESCE_DROP_ALLOW_DEPRECATED_PARAMETERS
