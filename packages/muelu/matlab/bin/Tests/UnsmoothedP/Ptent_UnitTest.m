...
mueluProblem = muelu('setup', A, 'xml parameter file', 'Tests/UnsmoothedP/mueluParams.xml');
%Set up the problem using a Matlab TwoLevelFactory for Ptent
matlabProblem = muelu('setup', A, 'xml parameter file', 'Tests/UnsmoothedP/matlabParams.xml');
