...
#ifndef AMESOS_CHOLMOD_INTERNAL_H
#define AMESOS_CHOLMOD_INTERNAL_H
...
#define CHOLMOD(name) amesos_cholmod_l_ ## name
#define LONG
#define DOUBLE
...
/* double, int */
EXTERN int amesos_cholmod_dump ;
EXTERN int amesos_cholmod_dump_malloc ;
UF_long amesos_cholmod_dump_sparse (cholmod_sparse  *, char *, cholmod_common *) ;
int  amesos_cholmod_dump_factor (cholmod_factor  *, char *, cholmod_common *) ;
int  amesos_cholmod_dump_triplet (cholmod_triplet *, char *, cholmod_common *) ;
int  amesos_cholmod_dump_dense (cholmod_dense   *, char *, cholmod_common *) ;
int  amesos_cholmod_dump_subset (int *, size_t, size_t, char *, cholmod_common *) ;
int  amesos_cholmod_dump_perm (int *, size_t, size_t, char *, cholmod_common *) ;
int  amesos_cholmod_dump_parent (int *, size_t, char *, cholmod_common *) ;
void amesos_cholmod_dump_init (char *, cholmod_common *) ;
int  amesos_cholmod_dump_mem (char *, UF_long, cholmod_common *) ;
void amesos_cholmod_dump_real (char *, Real *, UF_long, UF_long, int, int,
	cholmod_common *) ;
void amesos_cholmod_dump_super (UF_long, int *, int *, int *, int *, double *, int,
	cholmod_common *) ;
int  amesos_cholmod_dump_partition (UF_long, int *, int *, int *, int *, UF_long,
	cholmod_common *) ;
int  amesos_cholmod_dump_work(int, int, UF_long, cholmod_common *) ;

/* double, UF_long */
EXTERN int amesos_cholmod_l_dump ;
EXTERN int amesos_cholmod_l_dump_malloc ;
UF_long amesos_cholmod_l_dump_sparse (cholmod_sparse  *, char *, cholmod_common *) ;
int  amesos_cholmod_l_dump_factor (cholmod_factor  *, char *, cholmod_common *) ;
int  amesos_cholmod_l_dump_triplet (cholmod_triplet *, char *, cholmod_common *) ;
int  amesos_cholmod_l_dump_dense (cholmod_dense   *, char *, cholmod_common *) ;
int  amesos_cholmod_l_dump_subset (UF_long *, size_t, size_t, char *,
    cholmod_common *) ;
int  amesos_cholmod_l_dump_perm (UF_long *, size_t, size_t, char *, cholmod_common *) ;
int  amesos_cholmod_l_dump_parent (UF_long *, size_t, char *, cholmod_common *) ;
void amesos_cholmod_l_dump_init (char *, cholmod_common *) ;
int  amesos_cholmod_l_dump_mem (char *, UF_long, cholmod_common *) ;
void amesos_cholmod_l_dump_real (char *, Real *, UF_long, UF_long, int, int,
	cholmod_common *) ;
void amesos_cholmod_l_dump_super (UF_long, UF_long *, UF_long *, UF_long *, UF_long *,
        double *, int, cholmod_common *) ;
int  amesos_cholmod_l_dump_partition (UF_long, UF_long *, UF_long *, UF_long *,
	UF_long *, UF_long, cholmod_common *) ;
int  amesos_cholmod_l_dump_work(int, int, UF_long, cholmod_common *) ;

#define DEBUG_INIT(s)  { CHOLMOD(dump_init)(s, Common) ; }
#define PK_DEBUG_INIT(s,Common)  { CHOLMOD(dump_init)(s, Common) ; }
