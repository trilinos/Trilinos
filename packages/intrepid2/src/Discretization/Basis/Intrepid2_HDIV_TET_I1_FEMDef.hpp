...
/** \file   Intrepid2_HDIV_TET_I1_FEMDef.hpp
...
namespace Intrepid2 {
  ...
  Basis_HDIV_TET_I1_FEM<DT,OT,PT>::
  Basis_HDIV_TET_I1_FEM() {
    ...
    dofCoeffs(1,0) =  1.0;   dofCoeffs(1,1) =  1.0;   dofCoeffs(1,2) =  1.0;
...
#define HDIV_TET_I1_FEM_INSTANT(DEVICE, OUTPUT_TYPE, POINT_TYPE, EXTERN)       \
  EXTERN template class Intrepid2::Basis_HDIV_TET_I1_FEM<DEVICE, OUTPUT_TYPE,  \
                                                         POINT_TYPE>;

INTREPID2_ETI_DEVICE_DEF(HDIV_TET_I1_FEM_INSTANT);
