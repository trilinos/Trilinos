...
/** \file   Intrepid2_HGRAD_QUAD_C1_FEM.hpp
    \brief  Header file for the Intrepid2::Basis_HGRAD_QUAD_C1_FEM class.
...
namespace Intrepid2 {
  ...
  */
  ...
  namespace Impl {
    ...
    /**
      \brief See Intrepid2::Basis_HGRAD_QUAD_C1_FEM
    */
      ...
      */
      ...
      struct Functor {
        ...
        void operator()(const ordinal_type pt) const {
          ...
          else if constexpr ((opType == OPERATOR_GRAD) || (opType == OPERATOR_CURL) || (opType == OPERATOR_D2) || (opType == OPERATOR_MAX)) {
  ...
  public:
    ...
    getDofCoeffs( ScalarViewType dofCoeffs ) const override {
      ...
      INTREPID2_TEST_FOR_EXCEPTION( rank(dofCoeffs) != 1, std::invalid_argument,
                                    ">>> ERROR: (Intrepid2::Basis_HGRAD_QUAD_C1_FEM::getdofCoeffs) rank = 1 required for dofCoeffs array");
      // Verify 0th dimension of output array.
      INTREPID2_TEST_FOR_EXCEPTION( static_cast<ordinal_type>(dofCoeffs.extent(0)) != this->getCardinality(), std::invalid_argument,
                                    ">>> ERROR: (Intrepid2::Basis_HGRAD_QUAD_C1_FEM::getdofCoeffs) mismatch in number of dof and 0th dimension of dofCoeffs array");
#endif
    ...
    getHostBasis() const override {
      return Teuchos::rcp(new Basis_HGRAD_QUAD_C1_FEM<typename Kokkos::HostSpace::device_type,outputValueType,pointValueType>());
    }  
  };
}// namespace Intrepid2
