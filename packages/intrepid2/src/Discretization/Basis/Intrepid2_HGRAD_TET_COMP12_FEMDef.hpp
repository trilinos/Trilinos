...
#define HGRAD_TET_COMP12_FEM_INSTANT(DEVICE, OUTPUT_TYPE, POINT_TYPE, EXTERN)      \
  EXTERN template class Intrepid2::Basis_HGRAD_TET_COMP12_FEM<DEVICE, OUTPUT_TYPE, \
                                                          POINT_TYPE>;

INTREPID2_ETI_DEVICE_DEF(HGRAD_TET_COMP12_FEM_INSTANT);
