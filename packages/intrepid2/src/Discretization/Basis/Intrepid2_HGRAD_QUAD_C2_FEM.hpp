      ...
      */
      ...
      struct Functor {
        ...
        void operator()(const ordinal_type pt) const {
          ...
          else if constexpr ((opType == OPERATOR_GRAD) || (opType == OPERATOR_CURL) || (opType == OPERATOR_D1) || (opType == OPERATOR_D2) || (opType == OPERATOR_D3) || (opType == OPERATOR_D4) || (opType == OPERATOR_MAX)) {
