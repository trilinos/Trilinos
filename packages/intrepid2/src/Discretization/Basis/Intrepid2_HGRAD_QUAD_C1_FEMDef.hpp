...
/** \file   Intrepid2_HGRAD_QUAD_C1_FEMDef.hpp
    \brief  Definition file for FEM basis functions of degree 1 for H(grad) functions on QUAD cells.
    \author Created by P. Bochev and D. Ridzal.
            Kokkorized by Kyungjoo Kim
*/

#ifndef __INTREPID2_HGRAD_QUAD_C1_FEM_DEF_HPP__
#define __INTREPID2_HGRAD_QUAD_C1_FEM_DEF_HPP__
...
#define HGRAD_QUAD_C1_FEM_INSTANT(DEVICE, OUTPUT_TYPE, POINT_TYPE, EXTERN)     \
  EXTERN template class Intrepid2::Basis_HGRAD_QUAD_C1_FEM<                    \
      DEVICE, OUTPUT_TYPE, POINT_TYPE>;

INTREPID2_ETI_DEVICE_DEF(HGRAD_QUAD_C1_FEM_INSTANT);
