...
#define INTREPID2_CUBATUREPOLYLIB_INSTANT(DEVICE, POINT_VALUE_TYPE, WEIGHT_VALUE_TYPE, EXTERN)      \
  EXTERN template class Intrepid2::CubaturePolylib<DEVICE, POINT_VALUE_TYPE, WEIGHT_VALUE_TYPE>;

INTREPID2_ETI_DEVICE_DEF(INTREPID2_CUBATUREPOLYLIB_INSTANT);
