...
//==============================================================================
void Ifpack_SymGaussSeidel::SetLabel()
{
  sprintf(Label_,"Ifpack SymGaussSeidel, sweeps = %d",
	  NumSweeps());
}

//==============================================================================
int Ifpack_SymGaussSeidel::
ApplyInverse(const Epetra_MultiVector& X, Epetra_MultiVector& Y) const
{
  ...
  if ((NumSweeps() == 1) && ZeroStartingSolution_
      && (PrintFrequency() != 0)) {
    IFPACK_CHK_ERR(ApplySymGaussSeidel(Y));
    return(0);
  }
  ...
  for (int j = 0; j < NumSweeps() ; j++) {
    ...
    IFPACK_CHK_ERR(ApplySymGaussSeidel(AX));
...
//==============================================================================
int Ifpack_SymGaussSeidel::
ApplySymGaussSeidel(Epetra_MultiVector& X) const
{
