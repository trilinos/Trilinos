...
#ifndef IFPACK_GICT_H
#define IFPACK_GICT_H
...
//! Ifpack_gIct: A class for constructing and using an incomplete Cholesky factorization of a given Epetra_RowMatrix.

/*! The Ifpack_gIct class computes a threshold based incomplete 
...
class Ifpack_gIct: public Ifpack_Preconditioner {
      
 public:
  //! Ifpack_gIct constuctor with variable number of indices per row.
  /*! Creates a Ifpack_gIct object and allocates storage.  
  ...
  */
  Ifpack_gIct(Epetra_RowMatrix* A);
  
  //! Ifpack_gIct Destructor
  virtual ~Ifpack_gIct();
  ...
  */
  ...
  //! Returns the result of a Ifpack_gIct forward/back solve on a Epetra_MultiVector X in Y.
  /*! 
    \param In
