...
//! Ifpack_LocalRowMatrix: a class for light-weight extraction of the submatrix corresponding to local rows and columns.

/*! Class Ifpack_LocalRowMatrix enables a light-weight contruction of an
 ...
 Ifpack_LocalRowMatrix LocalA(A);
 \endcode
 ...
 */ 
class Ifpack_LocalRowMatrix : public virtual Epetra_RowMatrix {

public:
  //@{ \name Constructor.
  //! Constructor
  Ifpack_LocalRowMatrix(const Epetra_RowMatrix* Matrix);

  //@}
  //@{ \name Destructor.
  //! Destructor
  virtual ~Ifpack_LocalRowMatrix();
