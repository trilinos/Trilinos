...
#ifndef IFPACK_VRILUK_H
#define IFPACK_VRILUK_H
...
//! Ifpack_vRiluk: A class for constructing and using an incomplete Cholesky factorization of a given Epetra_RowMatrix.
// FIXME: role of Threshold ?? Athresh ? Rthresh??

class Ifpack_vRiluk: public Ifpack_Preconditioner {
      
 public:
  //! Ifpack_Riluk constuctor with variable number of indices per row.
  /*! Creates a Ifpack_Riluk object and allocates storage.  
  ...
  */
  Ifpack_vRiluk(const Epetra_RowMatrix* A);
  
  Ifpack_vRiluk(const Ifpack_vRiluk& rhs);

  Ifpack_vRiluk& operator=(const Ifpack_vRiluk& rhs);

  //! Ifpack_Riluk Destructor
  virtual ~Ifpack_vRiluk();
  ...
  */
  ...
  //! Returns the result of a Ifpack_Riluk forward/back solve on a Epetra_MultiVector X in Y.
  /*! 
    \param In
