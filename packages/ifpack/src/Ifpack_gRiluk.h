...
<b>Constructing Ifpack_gRiluk objects</b>

Constructing Ifpack_gRiluk objects is a multi-step process.  The basic steps are as follows:
<ol>
  <li> Create Ifpack_gRiluk instance, including storage,  via constructor.
...
Each Ifpack_gRiluk object keep track of the number
