#!/bin/csh
#
#  TestSpoolesJanusPara.csh, the Direct Sparse Solver Regresion Test, tests and times 
#  SpoolesOO() 
#
...
echo "COMMENT Start TestSpoolesJanusPara.csh, the Direct Sparse Solver Regresion Test" > SST.summary 
...
#
yod -sz 3 cxx_AME_mpi.exe SPOOLES SuperLU.rua 0 1 1 0 1e-15 1e-14  >>SST.stdout
yod -sz 3 cxx_AME_mpi.exe SPOOLES SuperLU.rua 0 1 1 1 1e-15 1e-14  >>SST.stdout
#
...
#
yod -sz 3 cxx_AME_mpi.exe SPOOLES   ImpcolA.rua 0 1 1 0 1e-11 1e-12  >>SST.stdout
yod -sz 3 cxx_AME_mpi.exe SPOOLES   ImpcolA.rua 0 1 1 1 1e-11 1e-12  >>SST.stdout
yod -sz 3 cxx_AME_mpi.exe SPOOLES   ImpcolB.rua 0 1 1 0 1e-10 1e-14  >>SST.stdout
yod -sz 3 cxx_AME_mpi.exe SPOOLES   ImpcolC.rua 0 1 1 0 1e-13 1e-13  >>SST.stdout
yod -sz 3 cxx_AME_mpi.exe SPOOLES   ImpcolD.rua 0 1 1 0 1e-12 1e-13  >>SST.stdout
yod -sz 3 cxx_AME_mpi.exe SPOOLES   ImpcolE.rua 0 1 1 0 1e-11 1e-11  >>SST.stdout
#
...
# Comment this seems to hang on Janus  yod -sz 4 cxx_AME_mpi.exe SPOOLES   bcsstk18.rsa 0 1 1 0 1e-9 1e-4  >>SST.stdout

#
#  Test some tranpose solves
#
yod -sz 4 cxx_AME_mpi.exe SPOOLES   ImpcolB.rua 0 1 1 1 1e-10 1e-12  >>SST.stdout
...
#
yod -sz 3 cxx_AME_mpi.exe SPOOLES SuperLU.triU 0 1 1 0 1e-14 1e-14 >>SST.stdout

yod -sz 2 cxx_AME_mpi.exe SPOOLES K4989.triS 0 1 1 0 1e-10 1e-8 >>SST.stdout

yod -sz 6 cxx_AME_mpi.exe SPOOLES K5000.triS 0 1 1 0 1e-10 1e-8 >>SST.stdout
...
echo "\nCOMMENT End TestSpoolesJanusPara.csh" >> SST.summary 

#
#  Make sure that the tests ran 
#
set expected_lines = `grep yod TestSpoolesJanusPara.csh | grep -v COMMENT | wc`
