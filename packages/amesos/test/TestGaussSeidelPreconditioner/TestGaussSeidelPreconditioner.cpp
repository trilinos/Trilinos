...
int main(int argc, char *argv[])
{
  ...
  Epetra_Operator* GaussSeidelPrec;
  
  // ===================================== //
  // create the GaussSeidel preconditioner //
  // ===================================== //
  ...
  if (Comm.MyPID() == 0)
    cout << "2-Norm after GaussSeidel = " << Norm << endl;
