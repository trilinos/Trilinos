...
yod -sz 1 cxx_AME_mpi.exe SPOOLES   ImpcolB.rua 0 1 1 0 1e-11 1e-13 >>SST.stdout
yod -sz 3 cxx_AME_mpi.exe SPOOLES   ImpcolB.rua 0 1 1 0 1e-11 1e-14  >>SST.stdout
...
yod -sz 4 cxx_AME_mpi.exe SPOOLES   bcsstk18.rsa 0 1 1 0 1e-9 1e-4  >>SST.stdout

#
#  Test some tranpose solves
#
yod -sz 4 cxx_AME_mpi.exe SPOOLES   ImpcolB.rua 0 1 1 1 1e-11 1e-12  >>SST.stdout
