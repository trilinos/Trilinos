...
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist SuperLU.rua 0 1 1 0 1e-15 1e-14  >>SST.stdout
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist SuperLU.rua 0 1 1 1 1e-15 1e-14  >>SST.stdout
#
...
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist   fidapm05.rua 1 1 1 0 100000000 1  >>SST.stdout
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist   fidapm05.rua 1 1 1 1 100000000 1  >>SST.stdout
#
#  Test some more small matrices
#
mpirun -np 1 cxx_DSS_mpi.exe SuperLUdist   ImpcolA.rua 0 1 1 0 1e-11 1e-12 >>SST.stdout
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist   ImpcolA.rua 0 1 1 0 1e-11 1e-12  >>SST.stdout
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist   ImpcolA.rua 0 1 1 1 1e-11 1e-12  >>SST.stdout
mpirun -np 1 cxx_DSS_mpi.exe SuperLUdist   ImpcolB.rua 0 1 1 0 1e-11 1e-13 >>SST.stdout
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist   ImpcolB.rua 0 1 1 0 1e-11 1e-14  >>SST.stdout
mpirun -np 1 cxx_DSS_mpi.exe SuperLUdist   ImpcolC.rua 0 1 1 0 1e-13 1e-13 >>SST.stdout
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist   ImpcolC.rua 0 1 1 0 1e-13 1e-13  >>SST.stdout
mpirun -np 1 cxx_DSS_mpi.exe SuperLUdist   ImpcolD.rua 0 1 1 0 1e-13 1e-13 >>SST.stdout
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist   ImpcolD.rua 0 1 1 0 1e-13 1e-13  >>SST.stdout
mpirun -np 1 cxx_DSS_mpi.exe SuperLUdist   ImpcolE.rua 0 1 1 0 1e-12 1e-11 >>SST.stdout
mpirun -np 3 cxx_DSS_mpi.exe SuperLUdist   ImpcolE.rua 0 1 1 0 1e-12 1e-11  >>SST.stdout
#
...
mpirun -np 4 cxx_DSS_mpi.exe SuperLUdist   bcsstk24.rsa 1 1 1 0 1e-6  1e-1 >>SST.stdout
mpirun -np 1 cxx_DSS_mpi.exe SuperLUdist   bcsstk18.rsa 1 1 1 0 1e-9 1e-4  >>SST.stdout
mpirun -np 4 cxx_DSS_mpi.exe SuperLUdist   bcsstk18.rsa 0 1 1 0 1e-9 1e-4  >>SST.stdout
...
mpirun -np 5 cxx_DSS_mpi.exe SuperLUdist   ImpcolB.rua 0 1 4 0 1e-11 1e-14  >>SST.stdout
mpirun -np 2 cxx_DSS_mpi.exe SuperLUdist   ImpcolE.rua 0 1 6 0 1e-12 1e-11  >>SST.stdout
mpirun -np 4 cxx_DSS_mpi.exe SuperLUdist   bcsstk24.rsa 0 1 3 0 1e-6  1e-1 >>SST.stdout
mpirun -np 1 cxx_DSS_mpi.exe SuperLUdist   bcsstk18.rsa 0 1 5 0 1e-9 1e-4  >>SST.stdout
mpirun -np 4 cxx_DSS_mpi.exe SuperLUdist   bcsstk18.rsa 0 1 32 0 1e-9 1e-4  >>SST.stdout
#
#  Test multiple right hand sides
#
mpirun -np 1 cxx_DSS_mpi.exe SuperLUdist   ImpcolC.rua 0 1 -1 0 1e-13 1e-13 >>SST.stdout
mpirun -np 5 cxx_DSS_mpi.exe SuperLUdist   ImpcolD.rua 0 1 -2 0 1e-13 1e-13  >>SST.stdout
mpirun -np 2 cxx_DSS_mpi.exe SuperLUdist   ImpcolE.rua 0 1 -3 0 1e-12 1e-11  >>SST.stdout
mpirun -np 4 cxx_DSS_mpi.exe SuperLUdist   bcsstk24.rsa 0 1 -4 0 1e-6  1e-1 >>SST.stdout
mpirun -np 1 cxx_DSS_mpi.exe SuperLUdist   bcsstk18.rsa 0 1 -5 0 1e-9 1e-4  >>SST.stdout
mpirun -np 4 cxx_DSS_mpi.exe SuperLUdist   bcsstk18.rsa 0 1 -3 0 1e-9 1e-4  >>SST.stdout

#
#  Test some solves on Aztec
#
mpirun -np 1 cxx_DSS_mpi.exe AZTEC   SuperLU.rua  0 1 1 0 1e-14 1e-13 >>SST.stdout
