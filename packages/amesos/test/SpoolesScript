...
#COMMENT       mpirun -np 1 cxx_AME_mpi.exe SPOOLES SuperLU.rua 0 1 1 0 1e-14 1e-14
#  where:
...
#
mpirun -np 1 cxx_AME_mpi.exe SPOOLES   fidapm05.rua 0 1 1 0 1000 1e-12 >>SST.stdout
#
#  Test some more small matrices
#
mpirun -np 1 cxx_AME_mpi.exe SPOOLES   ImpcolA.rua 0 1 1 0 1e-11 1e-12 >>SST.stdout
...
mpirun -np 3 cxx_AME_mpi.exe SPOOLES   ImpcolD.rua 0 1 1 0 1e-12 1e-13  >>SST.stdout
mpirun -np 1 cxx_AME_mpi.exe SPOOLES   ImpcolE.rua 0 1 1 0 1e-11 1e-11 >>SST.stdout
mpirun -np 3 cxx_AME_mpi.exe SPOOLES   ImpcolE.rua 0 1 1 0 1e-11 1e-11  >>SST.stdout
#
...
#
mpirun -np 1 cxx_AME_mpi.exe SPOOLES   bcsstk24.rsa 0 1 1 0 1e-6  1e-1 >>SST.stdout
# Comment DISTRIBUTED MATRIX mpirun -np 4 cxx_AME_mpi.exe SPOOLES   bcsstk24.rsa 1 1 1 0 1e-6  1e-1 >>SST.stdout
# Comment DISTRIBUTED MATRIX mpirun -np 1 cxx_AME_mpi.exe SPOOLES   bcsstk18.rsa 1 1 1 0 1e-9 1e-4  >>SST.stdout
mpirun -np 4 cxx_AME_mpi.exe SPOOLES   bcsstk18.rsa 0 1 1 0 1e-9 1e-4  >>SST.stdout
...
#
# Comment Spooles does not handle MRHS yet - mpirun -np 1 cxx_AME_mpi.exe SPOOLES   ImpcolC.rua 0 1 -1 0 1e-13 1e-13 >>SST.stdout
# Comment Spooles does not handle MRHS yet - mpirun -np 5 cxx_AME_mpi.exe SPOOLES   ImpcolD.rua 0 1 -2 0 1e-13 1e-13  >>SST.stdout
# Comment Spooles does not handle MRHS yet - mpirun -np 2 cxx_AME_mpi.exe SPOOLES   ImpcolE.rua 0 1 -3 0 1e-12 1e-11  >>SST.stdout
...
#
mpirun -np 1 cxx_AME_mpi.exe SPOOLES SuperLU.triU 0 1 1 0 1e-14 1e-14 >>SST.stdout
mpirun -np 3 cxx_AME_mpi.exe SPOOLES SuperLU.triU 0 1 1 0 1e-14 1e-14 >>SST.stdout

mpirun -np 1 cxx_AME_mpi.exe SPOOLES K4989.triS 0 1 1 0 1e-10 1e-8 >>SST.stdout
mpirun -np 2 cxx_AME_mpi.exe SPOOLES K4989.triS 0 1 1 0 1e-10 1e-8 >>SST.stdout

mpirun -np 1 cxx_AME_mpi.exe SPOOLES K5000.triS 0 1 1 0 1e-10 1e-8 >>SST.stdout
mpirun -np 6 cxx_AME_mpi.exe SPOOLES K5000.triS 0 1 1 0 1e-10 1e-8 >>SST.stdout


mpirun -np 1 cxx_AME_mpi.exe SPOOLES Khead.triS 0 1 1 0 1e-13 1e-9 >>SST.stdout

#
#  Spooles completes, but returns a permuted answer for Khead.triS
#
mpirun -np 4 cxx_AME_mpi.exe SPOOLES Khead.triS 0 1 1 0 -2    -2 >>SST.stdout
...
#
set expected_lines = `grep mpirun TestSpooles.csh | grep -v COMMENT | wc`
