...
#
# COMMENT mpirun -np 1 amesos_test.exe DSCPACK SuperLU.rua 0 1 1 0 1e-14 1e-14 >>SST.stdout
#  COMMENT fails on atlantis, sometimes janus    mpirun -np 3 amesos_test.exe DSCPACK SuperLU.rua 0 1 1 0 1e-15 1e-14  >>SST.stdout
#  COMMENT fails on atlantis, sometimes janus    mpirun -np 3 amesos_test.exe DSCPACK SuperLU.rua 0 1 1 1 1e-15 1e-14  >>SST.stdout
#
#  Test one process, three processes and three processes transposes, tiny distributed matrix, on DSCPACK
#
# COMMENT mpirun -np 1 amesos_test.exe DSCPACK Diagonal.mtx 0 1 1 0 100000000 1 >>SST.stdout
# COMMENT mpirun -np 3 amesos_test.exe DSCPACK   fidapm05.rua 1 1 1 0 100000000 1  >>SST.stdout
# COMMENT mpirun -np 3 amesos_test.exe DSCPACK   fidapm05.rua 1 1 1 1 100000000 1  >>SST.stdout
#
...
#
 mpirun -np 1 amesos_test.exe DSCPACK Diagonal.mtx 0 1 1 0 1e-15 1e-15 >>SST.stdout
mpirun -np 1 amesos_test.exe DSCPACK KheadK.mtx 0 1 1 0 1e-15 1e-8 >>SST.stdout
 mpirun -np 1 amesos_test.exe DSCPACK KheadSorted.mtx 0 1 1 0 1e-15 1e-8 >>SST.stdout
 ...
 mpirun -np 2 amesos_test.exe DSCPACK Diagonal.mtx 0 1 1 0 1e-15 1e-15 >>SST.stdout
# KheadK.mtx fails on cygwingcc 
 mpirun -np 2 amesos_test.exe DSCPACK KheadK.mtx 0 1 1 0 1e-15 1e-8 >>SST.stdout 
 mpirun  -np 4 amesos_test.exe DSCPACK KheadSorted.mtx 0 1 1 0 1e-15 1e-8 >>SST.stdout
...
#
# COMMENT mpirun -np 4 amesos_test.exe DSCPACK   ImpcolB.rua 0 1 1 1 1e-11 1e-12  >>SST.stdout
# COMMENT mpirun -np 4 amesos_test.exe DSCPACK   ImpcolA.rua 1 1 1 1 1e-11 1e-12  >>SST.stdout


#
#  Test blocked right hand sides
#
 mpirun -np 2 amesos_test.exe DSCPACK KheadK.mtx 0 1 4 0 1e-15 1e-8 >>SST.stdout 
 mpirun  -np 4 amesos_test.exe DSCPACK KheadSorted.mtx 0 1 4 0 1e-15 1e-8 >>SST.stdout
...
#
 mpirun -np 2 amesos_test.exe DSCPACK KheadK.mtx 0 1 -3 0 1e-15 1e-8 >>SST.stdout 
 mpirun  -np 4 amesos_test.exe DSCPACK KheadSorted.mtx 0 1 -10 0 1e-15 1e-8 >>SST.stdout
...
#
set expected_lines = `grep mpirun AmesosDscpack.exe | grep -v COMMENT | wc`
