...
#COMMENT       $mpigo 1 amesos_test.exe UMFPACK SuperLU.rua 0 1 1 0 1e-14 1e-14
#  where:
...
#
$mpigo 1 amesos_test.exe UMFPACK SuperLU.rua 0 1 1 0 1e-14 1e-14 >>SST.stdout
#  COMMENT fails on atlantis, sometimes janus    $mpigo 3 amesos_test.exe UMFPACK SuperLU.rua 0 1 1 0 1e-14 1e-14  >>SST.stdout
#  COMMENT fails on atlantis, sometimes janus    $mpigo 3 amesos_test.exe UMFPACK SuperLU.rua 0 1 1 1 1e-14 1e-14  >>SST.stdout
#
#  Test one process, three processes and three processes transposes, tiny distributed matrix, on UMFPACK
#
$mpigo 1 amesos_test.exe UMFPACK   fidapm05.rua 0 1 1 0 1000000000000000 1 >>SST.stdout
$mpigo 3 amesos_test.exe UMFPACK   fidapm05.rua 1 1 1 0 1000000000000000 1  >>SST.stdout
$mpigo 3 amesos_test.exe UMFPACK   fidapm05.rua 1 1 1 1 1000000000000000 1  >>SST.stdout
#
