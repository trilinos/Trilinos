...
#
#  AmesosKluSerial.exe, the Direct Sparse Solver Regresion Test, tests and times 
#  KLU 
#
...
# COMMENT       ./amesos_test.exe KLU SuperLU.rua 0 1 1 0 1e-14 1e-13
#  where:
...
echo "COMMENT Start AmesosKluSerial.exe, the Direct Sparse Solver Regresion Test" > SST.summary 
...
#
#  Test one process tiny serial matrix, on KLU
#
./amesos_test.exe KLU SuperLU.rua 0 1 1 0 1e-14 1e-13 >>SST.stdout

./amesos_test.exe KLU   fidapm05.rua 0 1 1 0 1000000000000000 1e-1 >>SST.stdout
#
...
#
# COMMENT ./amesos_test.exe KLU   bcsstk18.rsa 0 0 1 0 1e-9 1e-4  >>SST.stdout

echo "" >> SST.summary 
echo "COMMENT End AmesosKluSerial.exe" >> SST.summary 
