...
#include "Epetra_CrsMatrix.h"
  ...
  if ( factor ) { 
...
#endif
      assert( NumGlobalCols == numrows ) ; 
      cout << " NumLocalCols = " << NumLocalCols << " NumLocalStructs = " << NumLocalStructs << endl ; 
      assert( NumLocalCols == NumLocalStructs ) ; 
    }
    ...
    cout << " Before call to DscMat() " << endl ; 
    cout << " DscMat() returns " << DscMat.MaxNumEntries() << endl; 
    cout << " Before call to DscMap() " << endl ; 
    cout << " DscMap() returns " << DscMap.NumMyElements() << endl; 
    cout << " here after all " << endl ; 
