...
//==============================================================================
int Amesos_OverlappingSchwarzPreconditioner::ExtractSubmatrices()
{
  ...
  Partitioner_ = new Amesos_Partitioner(&(Matrix_->Graph()),
					&(OverlappingMatrix_->Graph()),
					List_);
...
//==============================================================================
int Amesos_OverlappingSchwarzPreconditioner::
...
//==============================================================================
char* Amesos_OverlappingSchwarzPreconditioner::Label() const
{
...
//==============================================================================
const Epetra_Comm& Amesos_OverlappingSchwarzPreconditioner::
Comm() const
{
  return(Matrix_->Comm());
}
...
//==============================================================================
const Epetra_Map& Amesos_OverlappingSchwarzPreconditioner::
