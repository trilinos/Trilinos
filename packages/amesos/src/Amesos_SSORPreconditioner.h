#ifndef AMESOS_SSORPRECONDITIONER_H
#define AMESOS_SSORPRECONDITIONER_H
...
class Amesos_SSORPreconditioner : public Epetra_Operator {
...
#endif // AMESOS_SSORPRECONDITIONER_H
