...
class Amesos_ComponentBaseSolver: public virtual Amesos_BaseSolver {
  ...
  */
    ...
    /*! 
     ...
     \return Integer error code, set to 0 if successful, -1 if unimplimented.
  */
  */
  ...
  */
    ...
    //! Solves U X = B (or U<SUP>T</SUP> x = B) 
    /*! 
    ...
    */
    ...
    //! Solves the triangular part of U X1 = B (or L<SUP>T</SUP> x = B) 
    /*! 
