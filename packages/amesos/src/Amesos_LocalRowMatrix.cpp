...
//==============================================================================
Amesos_LocalRowMatrix::Amesos_LocalRowMatrix(Epetra_RowMatrix* Matrix) :
  Matrix_(Matrix)
{
  Label_ = new char[80];
  sprintf(Label_,"Amesos_LocalRowMatrix");
...
//==============================================================================
Amesos_LocalRowMatrix::~Amesos_LocalRowMatrix()
{
  if (Label_)
    delete Label_;
}
...
//==============================================================================
int Amesos_LocalRowMatrix::ExtractDiagonalCopy(Epetra_Vector & Diagonal) const
{
...
//==============================================================================
int Amesos_LocalRowMatrix::Apply(const Epetra_MultiVector& X,
...
//==============================================================================
int Amesos_LocalRowMatrix::ApplyInverse(const Epetra_MultiVector& X,
		 Epetra_MultiVector& Y) const
{
  AMESOS_CHK_ERR(-1); // not implemented
}
