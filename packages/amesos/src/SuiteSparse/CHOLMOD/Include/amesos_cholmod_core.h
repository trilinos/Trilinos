...
#ifndef AMESOS_CHOLMOD_CORE_H
#define AMESOS_CHOLMOD_CORE_H
...
size_t amesos_cholmod_maxrank	/* returns validated value of Common->maxrank */
(
    /* ---- input ---- */
...
int amesos_cholmod_allocate_work
(
    /* ---- input ---- */
...
UF_long amesos_cholmod_clear_flag
(
    cholmod_common *Common
) ;
...
double amesos_cholmod_dbound	/* returns modified diagonal entry of D or L */
(
    /* ---- input ---- */
...
int amesos_cholmod_divcomplex		/* return 1 if divide-by-zero, 0 otherise */
(
    /* ---- input ---- */
...
cholmod_sparse *amesos_cholmod_allocate_sparse
(
    /* ---- input ---- */
...
cholmod_sparse *amesos_cholmod_l_allocate_sparse (size_t, size_t, size_t, int, int,
...
int amesos_cholmod_free_sparse
(
    /* ---- in/out --- */
...
int amesos_cholmod_reallocate_sparse
(
    /* ---- input ---- */
...
cholmod_sparse *amesos_cholmod_speye
(
    /* ---- input ---- */
    size_t nrow,	/* # of rows of A */
    size_t ncol,	/* # of columns of A */
...
cholmod_sparse *amesos_cholmod_spzeros
(
    /* ---- input ---- */
    size_t nrow,	/* # of rows of A */
    size_t ncol,	/* # of columns of A */
...
cholmod_sparse *amesos_cholmod_l_spzeros (size_t, size_t, size_t, int,
    cholmod_common *) ;
...
cholmod_sparse *amesos_cholmod_transpose
(
    /* ---- input ---- */
...
int amesos_cholmod_transpose_unsym
(
    /* ---- input ---- */
    cholmod_sparse *A,	/* matrix to transpose */
    int values,		/* 0: pattern, 1: array transpose, 2: conj. transpose */
...
int amesos_cholmod_l_transpose_unsym (cholmod_sparse *, int, UF_long *, UF_long *,
...
int amesos_cholmod_transpose_sym
(
    /* ---- input ---- */
    cholmod_sparse *A,	/* matrix to transpose */
    int values,		/* 0: pattern, 1: array transpose, 2: conj. transpose */
...
int amesos_cholmod_l_transpose_sym (cholmod_sparse *, int, UF_long *, cholmod_sparse *,
    cholmod_common *) ;
...
cholmod_sparse *amesos_cholmod_ptranspose
(
    /* ---- input ---- */
    cholmod_sparse *A,	/* matrix to transpose */
    int values,		/* 0: pattern, 1: array transpose, 2: conj. transpose */
...
cholmod_sparse *amesos_cholmod_l_ptranspose (cholmod_sparse *, int, UF_long *,
...
cholmod_sparse *amesos_cholmod_band
(
    /* ---- input ---- */
...
cholmod_sparse *amesos_cholmod_l_band (cholmod_sparse *, UF_long, UF_long, int,
    cholmod_common *) ;
...
int amesos_cholmod_band_inplace
(
    /* ---- input ---- */
    UF_long k1,		/* ignore entries below the k1-st diagonal */
    UF_long k2,		/* ignore entries above the k2-nd diagonal */
...
int amesos_cholmod_l_band_inplace (UF_long, UF_long, int, cholmod_sparse *,
    cholmod_common *) ;
...
cholmod_sparse *amesos_cholmod_aat
(
    /* ---- input ---- */
...
cholmod_sparse *amesos_cholmod_l_aat (cholmod_sparse *, UF_long *, size_t, int,
    cholmod_common *) ;
...
cholmod_sparse *amesos_cholmod_copy_sparse
(
    /* ---- input ---- */
...
cholmod_sparse *amesos_cholmod_copy 
(
    /* ---- input ---- */
    cholmod_sparse *A,	/* matrix to copy */
...
cholmod_sparse *amesos_cholmod_add
(
    /* ---- input ---- */
...
cholmod_sparse *amesos_cholmod_l_add (cholmod_sparse *, cholmod_sparse *, double *,
...
int amesos_cholmod_sparse_xtype
(
    /* ---- input ---- */
...
cholmod_factor *amesos_cholmod_allocate_factor
(
    /* ---- input ---- */
    size_t n,		/* L is n-by-n */
    /* --------------- */
...
int amesos_cholmod_free_factor
(
    /* ---- in/out --- */
...
int amesos_cholmod_reallocate_factor
(
    /* ---- input ---- */
...
int amesos_cholmod_change_factor
(
    /* ---- input ---- */
...
int amesos_cholmod_l_change_factor ( int, int, int, int, int, cholmod_factor *,
    cholmod_common *) ;
...
int amesos_cholmod_pack_factor
(
    /* ---- in/out --- */
    cholmod_factor *L,	/* factor to modify */
    /* --------------- */
...
int amesos_cholmod_reallocate_column
(
    /* ---- input ---- */
...
int amesos_cholmod_l_reallocate_column (size_t, size_t, cholmod_factor *,
    cholmod_common *) ;
...
cholmod_sparse *amesos_cholmod_factor_to_sparse
(
    /* ---- in/out --- */
...
cholmod_factor *amesos_cholmod_copy_factor
(
    /* ---- input ---- */
...
int amesos_cholmod_factor_xtype
(
    /* ---- input ---- */
...
cholmod_dense *amesos_cholmod_allocate_dense
(
    /* ---- input ---- */
...
cholmod_dense *amesos_cholmod_l_allocate_dense (size_t, size_t, size_t, int,
    cholmod_common *) ;
...
cholmod_dense *amesos_cholmod_zeros
(
    /* ---- input ---- */
    size_t nrow,	/* # of rows of matrix */
    size_t ncol,	/* # of columns of matrix */
...
cholmod_dense *amesos_cholmod_ones
(
    /* ---- input ---- */
    size_t nrow,	/* # of rows of matrix */
    size_t ncol,	/* # of columns of matrix */
...
cholmod_dense *amesos_cholmod_eye
(
    /* ---- input ---- */
    size_t nrow,	/* # of rows of matrix */
    size_t ncol,	/* # of columns of matrix */
...
cholmod_dense *amesos_cholmod_sparse_to_dense
(
    /* ---- input ---- */
    cholmod_sparse *A,	/* matrix to copy */
    /* --------------- */
...
cholmod_sparse *amesos_cholmod_dense_to_sparse
(
    /* ---- input ---- */
...
cholmod_sparse *amesos_cholmod_l_dense_to_sparse (cholmod_dense *, int,
    cholmod_common *) ;
...
cholmod_dense *amesos_cholmod_copy_dense
(
    /* ---- input ---- */
    cholmod_dense *X,	/* matrix to copy */
    /* --------------- */
...
int amesos_cholmod_copy_dense2
(
    /* ---- input ---- */
    cholmod_dense *X,	/* matrix to copy */
    /* ---- output --- */
...
int amesos_cholmod_dense_xtype
(
    /* ---- input ---- */
    int to_xtype,	/* requested xtype (real, complex,or zomplex) */
    /* ---- in/out --- */
...
cholmod_triplet *amesos_cholmod_allocate_triplet
(
    /* ---- input ---- */
...
cholmod_triplet *amesos_cholmod_l_allocate_triplet (size_t, size_t, size_t, int, int,
    cholmod_common *) ;
...
int amesos_cholmod_free_triplet
(
    /* ---- in/out --- */
...
int amesos_cholmod_reallocate_triplet
(
    /* ---- input ---- */
...
cholmod_triplet *amesos_cholmod_sparse_to_triplet
(
    /* ---- input ---- */
    cholmod_sparse *A,	/* matrix to copy */
    /* --------------- */
...
cholmod_sparse *amesos_cholmod_triplet_to_sparse
(
    /* ---- input ---- */
...
cholmod_sparse *amesos_cholmod_l_triplet_to_sparse (cholmod_triplet *, size_t,
    cholmod_common *) ;
...
cholmod_triplet *amesos_cholmod_copy_triplet
(
    /* ---- input ---- */
    cholmod_triplet *T,	/* matrix to copy */
    /* --------------- */
...
int amesos_cholmod_triplet_xtype
(
    /* ---- input ---- */
...
void *amesos_cholmod_malloc	/* returns pointer to the newly malloc'd block */
(
    /* ---- input ---- */
...
void *amesos_cholmod_calloc	/* returns pointer to the newly calloc'd block */
(
    /* ---- input ---- */
    size_t n,		/* number of items */
    size_t size,	/* size of each item */
...
void *amesos_cholmod_free	/* always returns NULL */
(
    /* ---- input ---- */
    size_t n,		/* number of items */
    size_t size,	/* size of each item */
...
void *amesos_cholmod_realloc	/* returns pointer to reallocated block */
(
    /* ---- input ---- */
...
int amesos_cholmod_realloc_multiple
(
    /* ---- input ---- */
...
int amesos_cholmod_l_realloc_multiple (size_t, int, int, void **, void **, void **,
