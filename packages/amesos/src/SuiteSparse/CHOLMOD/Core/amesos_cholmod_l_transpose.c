...
)
{
    ...
    {
	ok = amesos_p_cholmod_transpose_unsym (A, Perm, fset, nf, F, Common) ;
    }
    else if (F->xtype == CHOLMOD_REAL)
    {
	ok = amesos_r_cholmod_transpose_unsym (A, Perm, fset, nf, F, Common) ;
    }
	...
	{
	    /* array transpose */
	    ok = amesos_ct_cholmod_transpose_unsym (A, Perm, fset, nf, F, Common) ;
	}
	else
	{
	    /* complex conjugate transpose */
	    ok = amesos_c_cholmod_transpose_unsym (A, Perm, fset, nf, F, Common) ;
	}
    }
	...
	{
	    /* array transpose */
	    ok = amesos_zt_cholmod_transpose_unsym (A, Perm, fset, nf, F, Common) ;
	}
	else
	{
	    /* complex conjugate transpose */
	    ok = amesos_z_cholmod_transpose_unsym (A, Perm, fset, nf, F, Common) ;
	}
    }
...
)
{
	...
	ok = amesos_p_cholmod_transpose_sym (A, Perm, F, Common) ;
    }
    else if (F->xtype == CHOLMOD_REAL)
    {
	PRINT2 (("\n:::: r_transpose_sym Perm %p\n", Perm)) ;
	ok = amesos_r_cholmod_transpose_sym (A, Perm, F, Common) ;
    }
    else if (F->xtype == CHOLMOD_COMPLEX)
    {
	if (values == 1)
	{
	    ...
	    ok = amesos_ct_cholmod_transpose_sym (A, Perm, F, Common) ;
	}
	else
	{
	    /* complex conjugate transpose */
	    PRINT2 (("\n:::: c_transpose_sym Perm %p\n", Perm)) ;
	    ok = amesos_c_cholmod_transpose_sym (A, Perm, F, Common) ;
	}
    }
    else if (F->xtype == CHOLMOD_ZOMPLEX)
    {
	if (values == 1)
	{
	    ...
	    ok = amesos_zt_cholmod_transpose_sym (A, Perm, F, Common) ;
	}
	else
	{
	    /* complex conjugate transpose */
	    PRINT2 (("\n:::: z_transpose_sym Perm %p\n", Perm)) ;
	    ok = amesos_z_cholmod_transpose_sym (A, Perm, F, Common) ;
	}
    }
