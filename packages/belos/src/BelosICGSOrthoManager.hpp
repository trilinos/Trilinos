...
#define BELOS_TPETRA_ICGSORTHOMANAGER_NOEXTERN_CALL(SC, LO, GO, NT)            \
  BELOS_TPETRA_CALL(Belos::ICGSOrthoManager, SC, LO, GO, NT)

#define BELOS_TPETRA_ICGSORTHOMANAGER_EXTERN_CALL(SC, LO, GO, NT)              \
  BELOS_TPETRA_EXTERN_CALL(Belos::ICGSOrthoManager, SC, LO, GO, NT)

TPETRA_INSTANTIATE_SLGN_NO_ORDINAL_SCALAR(BELOS_TPETRA_ICGSORTHOMANAGER_EXTERN_CALL)
#endif
