...
#ifndef BELOS_STATUS_TYPE_HPP
#define BELOS_STATUS_TYPE_HPP

/*! \file BelosStatusType.hpp 
    \brief Enumerated list for Belos::StatusTest return types.
 */
