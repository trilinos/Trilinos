...
void register_BiCGStab_KDV_tmpl (const bool verbose)
{
...
void register_BiCGStab_KDV (const bool verbose)
{
  TPETRA_ETI_MANGLING_TYPEDEFS()

#ifdef BELOS_TPETRA_REGISTER_BICGSTAB_KDV
#  undef BELOS_TPETRA_REGISTER_BICGSTAB_KDV
#endif // BELOS_TPETRA_REGISTER_BICGSTAB_KDV
#define BELOS_TPETRA_REGISTER_BICGSTAB_KDV( SC, LO, GO, NT ) register_BiCGStab_KDV_tmpl<SC, LO, GO, NT> (verbose);

  TPETRA_INSTANTIATE_SLGN_NO_ORDINAL_SCALAR( BELOS_TPETRA_REGISTER_BICGSTAB_KDV )
