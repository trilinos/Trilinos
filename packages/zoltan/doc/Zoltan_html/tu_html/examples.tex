...
This chapter begins with a very simple example of using the Zoltan
...
If you have the Zoltan source code, and you have already built the
Zoltan library, you can compile and run these examples.
In the \textbf{examples}/C directory, do

\begin{verbatim}
make ZOLTAN_ARCH={my zoltan arch} all
\end{verbatim}

This will build 
\textbf{examples/C/simpleSIMPLE},
\textbf{examples/C/simpleRCB},
...
Some text here will introduce this example.
...
\clearpage
\section{A Geometric, Graph and Hypergraph Example}
