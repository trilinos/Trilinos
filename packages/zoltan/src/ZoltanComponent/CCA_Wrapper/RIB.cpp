...
void ZoltanSpace::RIB_LB::init()
{
  prop["RIB_OVERALLOC"] = "1.0" ;
  prop["RIB_OUTPUT_LEVEL"] = "0";
  prop["CHECK_GEOM"] = "1" ;
  prop["KEEP_CUTS"] = "0" ;
...
int ZoltanSpace::RIB_LB::IncrementalAssignPoint(double *coords, int ndims, int *proc)
{
...
int ZoltanSpace::RIB_LB::IncrementalAssignBox(double *lbbc, double *ubbc, int ndim, 
