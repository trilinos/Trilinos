...
int ZoltanSpace::RIB_LB::SetParameter(char *key, char *val)
{
...
int ZoltanSpace::RIB_LB::GetParameter(char *key, char **val)
{
...
int ZoltanSpace::RIB_LB::SetParameter(char *key, double d)
{
...
int ZoltanSpace::RIB_LB::GetParameter(char *key, double *d)
{
...
int ZoltanSpace::RIB_LB::SetParameter(char *key, bool b)
{
...
int ZoltanSpace::RIB_LB::GetParameter(char *key, bool *b)
{
...
int ZoltanSpace::RIB_LB::SetParameter(char *key, int i)
{
...
int ZoltanSpace::RIB_LB::GetParameter(char *key, int *i)
{
...
int ZoltanSpace::RIB_LB::PrintKeywordsToScreen()
{
