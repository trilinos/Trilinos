...
int ZoltanSpace::OctTree_LB::SetParameter(char *key, char *val)
{
...
int ZoltanSpace::OctTree_LB::GetParameter(char *key, char **val)
{
...
int ZoltanSpace::OctTree_LB::SetParameter(char *key, double d)
{
...
int ZoltanSpace::OctTree_LB::GetParameter(char *key, double *d)
{
...
int ZoltanSpace::OctTree_LB::SetParameter(char *key, bool b)
{
...
int ZoltanSpace::OctTree_LB::GetParameter(char *key, bool *b)
{
...
int ZoltanSpace::OctTree_LB::SetParameter(char *key, int i)
{
...
int ZoltanSpace::OctTree_LB::GetParameter(char *key, int *i)
{
...
int ZoltanSpace::OctTree_LB::PrintKeywordsToScreen()
{
