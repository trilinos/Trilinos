...
int ZoltanSpace::ParMetis_LB::SetParameter(char *key, char *val)
{
...
int ZoltanSpace::ParMetis_LB::GetParameter(char *key, char **val)
{
...
int ZoltanSpace::ParMetis_LB::SetParameter(char *key, double d)
{
...
int ZoltanSpace::ParMetis_LB::GetParameter(char *key, double *d)
{
...
int ZoltanSpace::ParMetis_LB::SetParameter(char *key, bool b)
{
...
int ZoltanSpace::ParMetis_LB::GetParameter(char *key, bool *b)
{
...
int ZoltanSpace::ParMetis_LB::SetParameter(char *key, int i)
{
...
int ZoltanSpace::ParMetis_LB::GetParameter(char *key, int *i)
{
...
int ZoltanSpace::ParMetis_LB::PrintKeywordsToScreen()
{
