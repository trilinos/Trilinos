...
int ZoltanSpace::HSFC_LB::IncrementalAssignPoint(double *coords, int ndims, int *proc)
{
...
int ZoltanSpace::HSFC_LB::IncrementalAssignBox(double *lbbc, double *ubbc, int ndim, 
