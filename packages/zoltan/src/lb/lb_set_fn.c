...
{
  zz->Migrate.Get_Obj_Size = fn;
  zz->Migrate.Get_Obj_Size_Data = data;
  return ZOLTAN_OK;
}
...
{
  zz->Migrate.Pack_Obj = fn;
  zz->Migrate.Pack_Obj_Data = data;
  return ZOLTAN_OK;
}
...
{
  zz->Migrate.Unpack_Obj = fn;
  zz->Migrate.Unpack_Obj_Data = data;
  return ZOLTAN_OK;
}
