...
/* -- Zoltan : UF_long defined in ccolamd.h, Ufconfig.h no longer required -- */
/* define UF_long */
/*#include "UFconfig.h"*/

/* ----------------------------------------------------------------------------
 * Zoltan specific changes : All user callable functions will have the prefix 
 * Zoltan_ to the original function names. 
 * -------------------------------------------------------------------------- */
#ifdef DLONG
...
#define CCOLAMD_recommended Zoltan_ccolamd_l_recommended
#define CCOLAMD_set_defaults Zoltan_ccolamd_l_set_defaults
#define CCOLAMD_2 Zoltan_ccolamd2_l
#define CCOLAMD_MAIN Zoltan_ccolamd_l
#define CCOLAMD_apply_order Zoltan_ccolamd_l_apply_order
#define CCOLAMD_postorder Zoltan_ccolamd_l_postorder
#define CCOLAMD_post_tree Zoltan_ccolamd_l_post_tree
#define CCOLAMD_fsize Zoltan_ccolamd_l_fsize
#define CSYMAMD_MAIN Zoltan_csymamd_l
#define CCOLAMD_report Zoltan_ccolamd_l_report
#define CSYMAMD_report Zoltan_csymamd_l_report
...
#define CCOLAMD_recommended Zoltan_ccolamd_recommended
#define CCOLAMD_set_defaults Zoltan_ccolamd_set_defaults
#define CCOLAMD_2 Zoltan_ccolamd2
#define CCOLAMD_MAIN Zoltan_ccolamd
#define CCOLAMD_apply_order Zoltan_ccolamd_apply_order
#define CCOLAMD_postorder Zoltan_ccolamd_postorder
#define CCOLAMD_post_tree Zoltan_ccolamd_post_tree
#define CCOLAMD_fsize Zoltan_ccolamd_fsize
#define CSYMAMD_MAIN Zoltan_csymamd
#define CCOLAMD_report Zoltan_ccolamd_report
#define CSYMAMD_report Zoltan_csymamd_report
