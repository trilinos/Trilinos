...
void Zoltan_Transform_Point( double *p, double (*m)[3], int d,
  int ndims, double *v);
void Zoltan_Transform_Box(double *lo, double *hi, double (*m)[3], int d, int ndims);
void Zoltan_Transform_Box_Points(
  double *lo, double *hi, double (*m)[3], int d, int ndims, double (*v)[3]);
