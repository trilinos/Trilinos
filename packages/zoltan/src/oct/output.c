...
#if 0
{
  ...
  MPI_Allreduce(&tweight,&wttot,1,MPI_DOUBLE,MPI_SUM,lb->Communicator);
  MPI_Allreduce(&tweight,&wtmin,1,MPI_DOUBLE,MPI_MIN,lb->Communicator);
  MPI_Allreduce(&tweight,&wtmax,1,MPI_DOUBLE,MPI_MAX,lb->Communicator);
  ...
  MPI_Allreduce(&mweight,&wtmax,1,MPI_DOUBLE,MPI_MAX,lb->Communicator);
