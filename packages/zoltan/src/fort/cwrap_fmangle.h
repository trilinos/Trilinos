...
#define Zfw_Initialize                 F77_FUNC_(zfw_initialize,ZFW_INITIALIZE)
#define Zfw_Initialize1                F77_FUNC_(zfw_initialize1,ZFW_INITIALIZE1)
#define Zfw_Create                     F77_FUNC_(zfw_create,ZFW_CREATE)
#define Zfw_Copy                       F77_FUNC_(zfw_copy,ZFW_COPY)
#define Zfw_Copy_To                    F77_FUNC_(zfw_copy_to,ZFW_COPY_TO)
#define Zfw_Destroy                    F77_FUNC_(zfw_destroy,ZFW_DESTROY)
#define Zfw_Align                      F77_FUNC_(zfw_align,ZFW_ALIGN)
#define Zfw_Memory_Stats               F77_FUNC_(zfw_memory_stats,ZFW_MEMORY_STATS)
#define Zfw_Set_Fn0f                   F77_FUNC_(zfw_set_fn0f,ZFW_SET_FN0F)
#define Zfw_Set_Fn1f                   F77_FUNC_(zfw_set_fn1f,ZFW_SET_FN1F)
#define Zfw_Set_Fn2f                   F77_FUNC_(zfw_set_fn2f,ZFW_SET_FN2F)
#define Zfw_Set_Fn3f                   F77_FUNC_(zfw_set_fn3f,ZFW_SET_FN3F)
#define Zfw_Set_Fn4f                   F77_FUNC_(zfw_set_fn4f,ZFW_SET_FN4F)
#define Zfw_Set_Fn5f                   F77_FUNC_(zfw_set_fn5f,ZFW_SET_FN5F)
#define Zfw_Set_Fn6f                   F77_FUNC_(zfw_set_fn6f,ZFW_SET_FN6F)
#define Zfw_Set_Fn7f                   F77_FUNC_(zfw_set_fn7f,ZFW_SET_FN7F)
#define Zfw_Set_Fn8f                   F77_FUNC_(zfw_set_fn8f,ZFW_SET_FN8F)
#define Zfw_Set_Fn9f                   F77_FUNC_(zfw_set_fn9f,ZFW_SET_FN9F)
#define Zfw_Set_FnAf                   F77_FUNC_(zfw_set_fnaf,ZFW_SET_FNAF)
#define Zfw_Set_FnBf                   F77_FUNC_(zfw_set_fnbf,ZFW_SET_FNBF)
#define Zfw_Set_Fn0s                   F77_FUNC_(zfw_set_fn0s,ZFW_SET_FN0S)
#define Zfw_Set_Fn1s                   F77_FUNC_(zfw_set_fn1s,ZFW_SET_FN1S)
#define Zfw_Set_Fn2s                   F77_FUNC_(zfw_set_fn2s,ZFW_SET_FN2S)
#define Zfw_Set_Fn3s                   F77_FUNC_(zfw_set_fn3s,ZFW_SET_FN3S)
#define Zfw_Set_Fn4s                   F77_FUNC_(zfw_set_fn4s,ZFW_SET_FN4S)
#define Zfw_Set_Fn5s                   F77_FUNC_(zfw_set_fn5s,ZFW_SET_FN5S)
#define Zfw_Set_Fn6s                   F77_FUNC_(zfw_set_fn6s,ZFW_SET_FN6S)
#define Zfw_Set_Fn7s                   F77_FUNC_(zfw_set_fn7s,ZFW_SET_FN7S)
#define Zfw_Set_Fn8s                   F77_FUNC_(zfw_set_fn8s,ZFW_SET_FN8S)
#define Zfw_Set_Fn9s                   F77_FUNC_(zfw_set_fn9s,ZFW_SET_FN9S)
#define Zfw_Set_FnAs                   F77_FUNC_(zfw_set_fnas,ZFW_SET_FNAS)
#define Zfw_Set_FnBs                   F77_FUNC_(zfw_set_fnbs,ZFW_SET_FNBS)
#define Zfw_Set_Param                  F77_FUNC_(zfw_set_param,ZFW_SET_PARAM)
#define Zfw_Set_Param_Vec              F77_FUNC_(zfw_set_param_vec,ZFW_SET_PARAM_VEC)
#define Zfw_LB_Partition               F77_FUNC_(zfw_lb_partition,ZFW_LB_PARTITION)
#define Zfw_LB_Eval                    F77_FUNC_(zfw_lb_eval,ZFW_LB_EVAL)
#define Zfw_LB_Set_Part_Sizes          F77_FUNC_(zfw_lb_set_part_sizes,ZFW_LB_SET_PART_SIZES)
#define Zfw_LB_Point_Assign            F77_FUNC_(zfw_lb_point_assign,ZFW_LB_POINT_ASSIGN)
#define Zfw_LB_Point_PP_Assign         F77_FUNC_(zfw_lb_point_pp_assign,ZFW_LB_POINT_PP_ASSIGN)
#define Zfw_LB_Box_Assign              F77_FUNC_(zfw_lb_box_assign,ZFW_LB_BOX_ASSIGN)
#define Zfw_LB_Box_PP_Assign           F77_FUNC_(zfw_lb_box_pp_assign,ZFW_LB_BOX_PP_ASSIGN)
#define Zfw_Invert_Lists               F77_FUNC_(zfw_invert_lists,ZFW_INVERT_LISTS)
#define Zfw_Compute_Destinations       F77_FUNC_(zfw_compute_destinations,ZFW_COMPUTE_DESTINATIONS)
#define Zfw_Migrate                    F77_FUNC_(zfw_migrate,ZFW_MIGRATE)
#define Zfw_Help_Migrate               F77_FUNC_(zfw_help_migrate,ZFW_HELP_MIGRATE)
#define Zfw_Order                      F77_FUNC_(zfw_order,ZFW_ORDER)
#define Zfw_Color                      F77_FUNC_(zfw_color,ZFW_COLOR)
#define Zfw_Color_Test                 F77_FUNC_(zfw_color_test,ZFW_COLOR_TEST)
#define Zfw_Generate_Files             F77_FUNC_(zfw_generate_files,ZFW_GENERATE_FILES)
#define Zfw_RCB_Box                    F77_FUNC_(zfw_rcb_box,ZFW_RCB_BOX)
#define Zfw_Register_Fort_Malloc       F77_FUNC_(zfw_register_fort_malloc,ZFW_REGISTER_FORT_MALLOC)
#define Zfw_Get_Address_int            F77_FUNC_(zfw_get_address_int,ZFW_GET_ADDRESS_INT)
#define Zfw_Get_Address_struct         F77_FUNC_(zfw_get_address_struct,ZFW_GET_ADDRESS_STRUCT)
#define Zfw_Get_Wgt_Dim                F77_FUNC_(zfw_get_wgt_dim,ZFW_GET_WGT_DIM)
#define Zfw_Get_Comm_Dim               F77_FUNC_(zfw_get_comm_dim,ZFW_GET_COMM_DIM)
#define Zfw_Reftree_Get_Child_Order    F77_FUNC_(zfw_reftree_get_child_order,ZFW_REFTREE_GET_CHILD_ORDER)
