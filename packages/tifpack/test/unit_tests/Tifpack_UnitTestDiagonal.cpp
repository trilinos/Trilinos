...
/*! \file Tifpack_UnitTestDiagonal.cpp

\brief Tifpack Unit test for the Diagonal template.
*/
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL(TifpackDiagonal, Test0, Scalar, LocalOrdinal, GlobalOrdinal)
{
...
//Teuchos::FancyOStream& out, bool& success
  ...
  Tifpack::Diagonal<Tpetra::CrsMatrix<Scalar,LocalOrdinal,GlobalOrdinal,Node> > prec(crsmatrix);
