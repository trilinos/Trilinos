...
/*! \file Tifpack_UnitTestCrsRiluk.cpp

\brief Tifpack Unit test for the CrsRiluk template.
*/
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL(TifpackCrsRiluk, Test0, Scalar, LocalOrdinal, GlobalOrdinal)
{
...
#define UNIT_TEST_GROUP_SCALAR_ORDINAL(Scalar,LocalOrdinal,GlobalOrdinal) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( TifpackCrsRiluk, Test0, Scalar, LocalOrdinal,GlobalOrdinal) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( TifpackCrsRiluk, Test1, Scalar, LocalOrdinal,GlobalOrdinal)
