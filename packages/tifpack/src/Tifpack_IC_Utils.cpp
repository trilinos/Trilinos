...
void Tifpack_AIJMatrix_alloc(Tifpack_AIJMatrix *a, int n, int nnz)
{
...
void Tifpack_AIJMatrix_dealloc(Tifpack_AIJMatrix *a)
{
    delete [] (a->val);
    delete [] (a->col);
    delete [] (a->ptr);
    ...
    double **pdiag)
{
    ...
    *pdiag = diag;
    ...
    Tifpack_AIJMatrix_alloc(L,  n, lfil*n);
