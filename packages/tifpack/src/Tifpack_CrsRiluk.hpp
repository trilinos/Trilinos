...
#include "Tifpack_ConfigDefs.h"
#include "Tifpack_ScalingType.h"
#include "Tifpack_IlukGraph.h"
...
<b>Constructing Tifpack_CrsRiluk objects</b>

Constructing Tifpack_CrsRiluk objects is a multi-step process.  The basic steps are as follows:
<ol>
  <li> Create Tifpack_CrsRiluk instance, including storage,  via constructor.
...
Each Tifpack_CrsRiluk object keep track of the number
...
class Tifpack_CrsRiluk: public Epetra_Object, public Epetra_CompObject, public virtual Epetra_Operator {
      
  // Give ostream << function some access to private and protected data/functions.

  friend ostream& operator << (ostream& os, const Tifpack_CrsRiluk& A);

 public:
  //! Tifpack_CrsRiluk constuctor with variable number of indices per row.
  /*! Creates a Tifpack_CrsRiluk object and allocates storage.  
    
    \param In
           Graph_in - Graph generated by Tifpack_IlukGraph.
  */
  Tifpack_CrsRiluk(const Tifpack_IlukGraph & Graph_in);
  
  //! Copy constructor.
  Tifpack_CrsRiluk(const Tifpack_CrsRiluk & Matrix);

  //! Tifpack_CrsRiluk Destructor
  virtual ~Tifpack_CrsRiluk();
