...
#ifndef TIFPACK_IKLU_HPP
#define TIFPACK_IKLU_HPP
...
//! Tifpack_IKLU: A class for constructing and using an incomplete Cholesky factorization of a given Tpetra_RowMatrix.

/*! The Tifpack_IKLU class computes a "Relaxed" IKLU factorization with level k fill 
...
*/    
class Tifpack_IKLU: public Tifpack_Preconditioner {
      
public:
  // @{ Constructors and Destructors
  //! Tifpack_IKLU constuctor with variable number of indices per row.
  Tifpack_IKLU(const Tpetra_RowMatrix* A);
  
  //! Tifpack_IKLU Destructor 
  virtual ~Tifpack_IKLU();
  ...
  */
  ...
  //! Returns the result of a Tifpack_IKLU forward/back solve on a Tpetra_MultiVector X in Y.
  /*! 
    \param 
...
private:
  ...
  Tifpack_IKLU(const Tifpack_IKLU& RHS) :
    A_(RHS.Matrix()),
    Comm_(RHS.Comm()),
    Time_(Comm())
  {};
  ...
  Tifpack_IKLU& operator=(const Tifpack_IKLU& RHS)
  {
    return(*this);
  }
