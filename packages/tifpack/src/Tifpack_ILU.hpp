...
#ifndef TIFPACK_ILU_HPP
#define TIFPACK_ILU_HPP
...
private:
	...
	//! Returns the address of the Tifpack_IlukGraph associated with this factored matrix.
					  ...
					  Tpetra::MultiVector& Y) const
{
	...
	TIFPACK_CHK_ERR(Solve(ILU::UseTranspose(), *Xcopy, Y));
...
//=============================================================================
double ILU::Condest(const Tifpack_CondestType CT, 
