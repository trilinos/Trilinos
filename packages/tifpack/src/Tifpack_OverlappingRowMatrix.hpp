...
#ifndef TIFPACK_OVERLAPPINGROWMATRIX_HPP
#define TIFPACK_OVERLAPPINGROWMATRIX_HPP
...
//! Tifpack_OverlappingRowMatrix: matrix with ghost rows, based on Tpetra_RowMatrix
//
class Tifpack_OverlappingRowMatrix : public virtual Tpetra_RowMatrix {
...
int ExportMultiVector(const Tpetra_MultiVector& OvX,
  ...
  inline Tpetra_CrsMatrix& B() const
  {
    return(*ExtMatrix_);
  }
#endif
...
private: 
  ...
  inline Tpetra_RowMatrix& B() const;
...
}; // class Tifpack_OverlappingRowMatrix

#endif // TIFPACK_OVERLAPPINGROWMATRIX_HPP
