...
#ifndef TIFPACK_DROPFILTER_HPP
#define TIFPACK_DROPFILTER_HPP
...
//! Tifpack_DropFilter: Filter based on matrix entries.
/*!
Tifpack_DropFilter enables the dropping of all elements whose
...
// and Apply()
Tifpack_DropFilter DropA(LocalA,DropTol)
\endcode

<P>It is supposed that Tifpack_DropFilter is used on localized matrices.
...
*/
class Tifpack_DropFilter : public virtual Tpetra_RowMatrix {
