...
#ifndef TIFPACK_AMESOS_HPP
#define TIFPACK_AMESOS_HPP
...
//! Tifpack_Amesos: a class to use Amesos' factorizations as preconditioners.
/*!
Class Tifpack_Amesos enables the use of Amesos' factorizations as 
Tifpack_Preconditioners.

Tifpack_Amesos is just a bare-bone wrap to Amesos. Currently, the
...
process, that is, either serial matrices, or Tifpack_LocalFilter'd matrices.
...
*/
class Tifpack_Amesos : public Tifpack_Preconditioner {
...
public:
  ...
  //! Constructor.
  Tifpack_Amesos(Tpetra_RowMatrix* Matrix);

  //! Copy constructor.
  Tifpack_Amesos(const Tifpack_Amesos& rhs);

  //! Operator=.
  Tifpack_Amesos& operator=(const Tifpack_Amesos& rhs);

  //@{ \name Destructor.
  //! Destructor
  virtual ~Tifpack_Amesos() {};
