...
#ifndef TIFPACK_GRAPH_HPP
#define TIFPACK_GRAPH_HPP
class Tpetra_Comm;

//! Tifpack_Graph: a pure virtual class that defines graphs for TIFPACK.
/*!
Class Tifpack_Graph defines the abstract interface to use graphs in
TIFPACK. This class contains all the functions that are required by
TIFPACK classes.
...
public:
  ...
  virtual const Tpetra_Comm& Comm() const = 0;
...
inline ostream& operator<<(ostream& os, const Tifpack_Graph& obj)
{
  return(obj.Print(os));
}

#endif // iFPACK_GRAPH_HPP
