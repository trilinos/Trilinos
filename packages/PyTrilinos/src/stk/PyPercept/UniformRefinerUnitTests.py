...
class UniformRefinerUnitTests(unittest.TestCase):
  ...
  def test_break_quad_to_tri_6(self):
    ...
    if p_size == 1 or p_size == 3:
      ...
      breaker.setRemoveOldElements(False)                
      breaker.doBreak()
      eMesh.saveAs("square_quad4_out.e")
  ...
  def test_break_quad_to_tri_4(self):
    ...
    if p_size == 1 or p_size == 3:
      ...
      breaker.setRemoveOldElements(False)
      breaker.doBreak()
      eMesh.saveAs("square_quad4_tri3_4_out.e")
  ...
  def test_break_quad_to_quad(self):
    ...
    if p_size == 1 or p_size == 3:
      ...
      breaker.setIgnoreSideSets(True)
      breaker.doBreak()
      eMesh.saveAs("square_quad4_ref_out.e")
  ...
  def test_break_quad_to_quad_sierra_unit1(self):
    ...
    if p_size == 1 or p_size == 3:
      ...
      eMesh.printInfo("quad mesh")
      breaker.doBreak()
      eMesh.saveAs("square_quad4_sierra_ref_out.e")
  ...
  def test_break_quad_to_quad_sierra_sidesets(self):
    ...
    if p_size == 1 or p_size == 2:
      ...
      breaker.doBreak()
      eMesh.saveAs("quad_sidesets_sierra_out.e")
  ...
  def test_break_hex8_tet4_24_1(self):
    ...
    breaker.doBreak()
    eMesh.saveAs("hex_tet_24_cube1x1x1.e")
  ...
  def test_hex8_tet4_6_12_1(self):
    ...
    breaker.setRemoveOldElements(True)
    breaker.doBreak()
    eMesh.saveAs("hex_tet_6_12_cube1x1x1.e")
  ...
  def test_quad4_quad4_test_1(self):
    ...
    if p_size <= 3:
      ...
      eMesh.saveAs("quad_fixture_test_1.e")
  ...
  def test_break_quad_to_quad_sierra_1_unit1(self):
    ...
    if p_size <= 3:
       ...
       while i < 2:
         ...
         scalarDimension = 0
         proc_rank_field = eMesh1.addField("proc_rank", eMesh.element_rank(), scalarDimension)
         breaker = Refiner(eMesh1, QUAD4_QUAD4_4_SIERRA, proc_rank_field)
         eMesh1.commit()
         breaker.doBreak()
         eMesh1.saveAs("quad_fixture_" + str(i+1) + ".e")
         eMesh1.close()
         i = i + 1
  ...
  def test_break_quad_to_quad_sierra_2(self):
    ...
    if p_size <= 3:
       ...
       eMesh.commit()
       fixture.generate_mesh()
       eMesh.saveAs("quad_fixture_mbreak_0.e")
       eMesh.close()
       ...
       while i < 2:
         print "\n\n\n ================ tmp Refine Pass = ", i
         breaker.doBreak()
         eMesh1.saveAs("quad_fixture_mbreak_" + str(i) + ".e")
         i = i + 1
  ...
  def test_break_quad4_to_quad9(self):
    ...
    if p_size <= 3:
       ...
       eMesh.commit()
       fixture.generate_mesh()
       eMesh.saveAs("quad_fixture_quad9_0.e")
       breaker.doBreak()
       eMesh.saveAs("quad_fixture_quad9_1.e")
  ...
  def test_break_quad4_to_quad9(self):
    ...
    if p_size <= 3:
       ...
       eMesh.commit()
       fixture.generate_mesh()
       eMesh.saveAs("quad_fixture_quad8_0.e")
       breaker.doBreak()
       eMesh.saveAs("quad_fixture_quad8_1.e")
       eMesh.saveAs("quad_fixture_quad8_quad8_0.e")
  ...
  def test_quad8_to_quad8(self):
    ...
    if p_size <= 3:
      ...
      breaker.doBreak()
      eMesh.saveAs("quad_fixture_quad8_quad8_1.e")
  ...
  def test_break_quad4_to_quad9_to_quad9_0(self):
    ...
    if p_size <= 1:
      ...
      fixture.generate_mesh()
      breaker.doBreak()
      eMesh.saveAs("quad_1x1x_quad9_quad9_0.e")
     
      em1 = PerceptMesh(2)
      em1.open("quad_1x1x_quad9_quad9_0.e")
      proc_rank_field = em1.addField("proc_rank", eMesh.element_rank(), scalarDimension)
      breaker = Refiner(em1, QUAD9_QUAD9_4, proc_rank_field)
      em1.commit()
      breaker.setIgnoreSideSets(True)
      breaker.doBreak()
      em1.saveAs("quad_1x1x_quad9_quad9_1.e")
  ...
  def test_break_quad4_to_quad9_to_quad9(self):
    ...
    if p_size <= 3:
      ...
      fixture.generate_mesh()
      breaker.doBreak()
      eMesh.saveAs("quad_fixture_quad9_quad9_0.e")
      ...
      em1.commit()
      breaker.doBreak()
      em1.saveAs("quad_fixture_quad9_quad9_1.e")
  ...
  def test_break_tri_to_tri_sierra_1(self):
    ...
    if p_size <= 3:
      ...
      scalarDimension = 0
      proc_rank_field = eMesh.addField("proc_rank", eMesh.element_rank(), scalarDimension)
      eMesh.addField("proc_rank_ede", eMesh.edge_rank(), scalarDimension)
      breaker = Refiner(eMesh, TRI3_TRI3_4, proc_rank_field)
      eMesh.commit()
      fixture.generate_mesh()
      eMesh.printInfo("tri mesh")
      eMesh.saveAs("quad_fixture_tri3_0.e")
      breaker.doBreak()
      eMesh.printInfo("tri mesh refined")
      eMesh.saveAs("quad_fixture_tri3_1.e")
  ...
  def test_break_tri3_to_tri6_sierra(self):
    ...
    if p_size <= 3:
      ...
      eMesh.saveAs("quad_fixture_tri3_tri6_0.e")
      breaker.doBreak()
      eMesh.printInfo("tri mesh enriched")
      eMesh.saveAs("quad_fixture_tri6_tri6_0.e")
      eMesh.saveAs("quad_fixture_tri3_tri6_1.e")
  ...
  def test_break_tri3_to_tri6_to_tri6_sierra(self):
    ...
    if p_size <= 3:
      ...
      breaker.doBreak()
      eMesh.printInfo("tri mesh refined")
      eMesh.saveAs("quad_fixture_tri6_tri6_1.e")
  ...
  def test_break_tet4_tet4_1(self):
    ...
    if p_size == 1 or p_size == 3:
      eMesh = PerceptMesh(3)
      eMesh.openReadOnly("tet_fixture.e")
      eMesh.saveAs("tet_from_hex_fixture_0.e")
    if p_size == 1 or p_size == 3:
      eMesh = PerceptMesh(3)
      ...
      breaker.doBreak()
      eMesh.saveAs("tet4_refined_1.e")
      breaker.doBreak()
      eMesh.saveAs("tet4_refined_2.e")
  ...
  def test_hex8_hex8_8_1_unit1(self):
    ...
    eMesh.commit()
    eMesh.printInfo()
    eMesh.saveAs("hex_hex_cube1x1x" + str(p_size) + "-orig.e")
    breaker.setRemoveOldElements(True)
    breaker.doBreak()
    eMesh.saveAs( "hex_hex_cube1x1x" + str(p_size)+".e")
  ...
  def test_hex8_hex8_8_2_unit1(self):
    ...
    if p_size == 1 or p_size == 3:
      ...
      eMesh.commit()
      eMesh.printInfo()
      eMesh.saveAs("hex8_0.e")
      breaker.doBreak()
      eMesh.saveAs("hex8_1.e")
      breaker.doBreak()
      eMesh.saveAs("hex8_2.e")
  ...
  def test_hex8_hex27_1_2(self):
    ...
    if p_size == 1 or p_size == 3:
      ...
      eMesh.commit()
      eMesh.printInfo()
      eMesh.saveAs("hex27_0.e")
      breaker.doBreak()
      eMesh.saveAs("hex27_1.e")
  ...
  def test_hex08_hex20_1_1(self):
    ...
    eMesh.commit()
    eMesh.printInfo()
    eMesh.saveAs("hex8_hex_20_cube1x1x"+str(p_size) + "-orig.e")
    breaker.setRemoveOldElements(True)
    breaker.doBreak()
    eMesh.saveAs("hex8_hex20_cube1x1x"+str(p_size) + ".e")
    eMesh.saveAs("hex20_hex20_cube1x1x"+str(p_size) + "_0.e")
  ...
  def test_hex08_hex20_1_2(self):
    ...
    if p_size == 1 or p_size == 3:
      ...
      eMesh.commit()
      eMesh.printInfo()
      eMesh.saveAs("hex20_0.e")
      breaker.doBreak()
      eMesh.saveAs("hex20_1.e")
      eMesh.saveAs("hex20_hex20_0.e")
  ...
  def test_hex20_hex20_1(self):
    ...
    if p_size <= 3:
      ...
      breaker.setRemoveOldElements(True)
      breaker.doBreak()
      eMesh.saveAs("hex20_hex20_cube1x1x" + str(p_size) + "_1.e")
  ...
  def test_hex27_hex27_0(self):
    ...
    eMesh.commit()
    eMesh.printInfo()
    eMesh.saveAs("hex27_hex27_cube1x1x" + str(p_size) + "-orig.e")
    breaker.setRemoveOldElements(True)
    breaker.doBreak()
    eMesh.saveAs("hex27_hex27_cube1x1x" + str(p_size) + "_0.e")
    
    em1 = PerceptMesh(3)
    p_size = em1.getParallelSize()
    ...
    breaker.setRemoveOldElements(True)
    breaker.doBreak()
    em1.saveAs("hex27_hex27_cube1x1x" + str(p_size) + "_1.e")
  ...
  def test_hex27_hex27_1(self):
    ...
    if p_size == 1 or p_size == 3:
      ...
      eMesh.commit()
      eMesh.printInfo()
      eMesh.saveAs("hex8_hex27_0.e")
      breaker.doBreak()
      eMesh.saveAs("hex8_27_1.e")
    if p_size == 1 or p_size == 3:
      eMesh = PerceptMesh(3)
      ...
      breaker.setRemoveOldElements(True)
      breaker.doBreak()
      eMesh.saveAs("hex8_hex27_hex27_1.e")
  ...
  def test_wedge6_enrich_1(self):
    ...
    if p_size == 1:
      ...
      eMesh.commit()
      breaker.doBreak()
      eMesh.saveAs("swept-wedge_enrich_1.e")
      eMesh.saveAs("swept-wedge_enrich_refine_0.e")
  ...
  def test_wedge6_enrich_refine(self):
    ...
    if p_size == 1:
      ...
      eMesh.commit()
      breaker.doBreak()
      eMesh.saveAs("swept-wedge_2_enrich_refine_0.e")
    if p_size == 1:
      eMesh = PerceptMesh(3)
      ...
      breaker.setIgnoreSideSets(True)
      breaker.doBreak()
      eMesh.saveAs("swept-wedge_2_enrich_refine_1.e")
