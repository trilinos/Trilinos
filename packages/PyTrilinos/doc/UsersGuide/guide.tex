...
interactively, and you must create a script file. Then, the script can be
...
MPI\_COMM\_WORLD communicator. Start-up operations like a call to MPI\_Init()
  ...
  as last Python instruction. Using this approach, 
...
Module EpetraExt contains several utilities to read and write Epetra objects,
  in particular maps, vectors, and matrices.
...
>>> ver.SetAztecOption(AztecOO.AZ_overalp, 1)
