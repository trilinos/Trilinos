...
\"Initial Guess\" -- how should initial vector be selected: \"Random\"
or \"User\". If \"User,\" the value in problem->getInitVec() will be
used. Default: \"Random\".

\"Print Number of Ritz Values\" -- an int specifying how many Ritz
values should be printed at each iteration. Default: \"NEV\".
...
\"Maximum Restarts\" -- an int specifying the maximum number of
restarts the underlying solver is allowed to perform. Default: 20
...
\"Relative Convergence Tolerance\" -- a bool specifying whether
residual norms should be scaled by the magnitude of the corresponding
Ritz value. Care should be taken when performing scaling for problems
where the eigenvalue can be very large or very small. Default:
\"false\".
...
// File: dir_c742b309b9c1f4b7adf79592815397b1.xml


// File: dir_6c5268d21de8ba7ec3dec659aa07dca1.xml
