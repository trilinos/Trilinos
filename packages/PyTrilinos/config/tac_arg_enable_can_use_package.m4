# @synopsis TAC_ARG_ENABLE_CAN_USE_PACKAGE(PACKAGE_NAME, OPTIONAL_PACKAGE_DEPENDENCY_NAME, AC_DEFINE, AM_CONDITIONAL, ALLOW_IMPLICIT_ENABLE, HELP_STRING, IMPLICIT_HELP_STRING)
# 
