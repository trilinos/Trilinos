...
#ifndef adapt_UniformRefinerPattern_ShellLine3_ShellLine3_2_sierra_hpp
#define adapt_UniformRefinerPattern_ShellLine3_ShellLine3_2_sierra_hpp
...
#include <adapt/sierra_element/StdMeshObjTopologies.hpp>
  ...
  namespace percept {
    ...
    template <>
    class UniformRefinerPattern<shards::ShellLine<3>, shards::ShellLine<3>, 2, SierraPort > : public URP<shards::ShellLine<3>, shards::ShellLine<3>  >
    {
    public:
