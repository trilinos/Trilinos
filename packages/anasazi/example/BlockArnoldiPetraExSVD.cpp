...
int main(int argc, char *argv[]) {
	...
	*/
	...
	Anasazi::PetraVec<double> ivec(ColMap, block);
	ivec.MvRandom();

	// Call the constructor for the (A^T*A) operator
	Anasazi::PetraSymOp<double> Amat(A);	
	...
	Anasazi::PetraVec<double> evecr(ColMap, nev);
	...
	//
	Anasazi::PetraVec<double> Av(RowMap,nev), u(RowMap,nev);
