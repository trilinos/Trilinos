...
// @HEADER
//
#ifndef ANASAZI_DENSE_MATRIX_TRAITS_HPP
#define ANASAZI_DENSE_MATRIX_TRAITS_HPP
...
*/
  ...
  struct UndefinedDenseMatrixTraits
  {
    ...
    */
    static inline ScalarType notDefined() { return DV::this_type_is_missing_a_specialization(); };
  };
...
#endif // end file ANASAZI_DENSE_MATRIX_TRAITS_HPP
