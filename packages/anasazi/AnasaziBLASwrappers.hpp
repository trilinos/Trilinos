...
#define Anasazi_fcd char *, unsigned int
...
#else /* Define Anasazi_fcd for all other machines */
...
void PREFIX DGEMV_F77(Anasazi_fcd, int* m, int* n, double* alpha, double A[], int* lda,
		       double x[], int* incx, double* beta, double y[], int* incy);
void PREFIX DTRMV_F77(Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, int *n, 
...
void PREFIX SGEMV_F77(Anasazi_fcd, int* m, int* n, float* alpha, float A[], int* lda,
		       float x[], int* incx, float* beta, float y[], int* incy);
void PREFIX STRMV_F77(Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, int *n, 
...
void PREFIX DGEMM_F77(Anasazi_fcd, Anasazi_fcd, int *m, int *
		      n, int *k, double *alpha, double *a, int *lda, 
		      double *b, int *ldb, double *beta, double *c, int *ldc);
void PREFIX DSYMM_F77(Anasazi_fcd, Anasazi_fcd, int *m, int * n,
		      double *alpha, double *a, int *lda, 
		      double *b, int *ldb, double *beta, double *c, int *ldc);
void PREFIX DTRMM_F77(Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, 
		      int *m, int *n, double *alpha, double *a, int * lda, double *b, int *ldb);
void PREFIX DTRSM_F77(Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, 
		      int *m, int *n, double *alpha, double *a, int *
		      lda, double *b, int *ldb);

/* Single precision BLAS 3 */
void PREFIX SGEMM_F77(Anasazi_fcd, Anasazi_fcd, int *m, int *
		      n, int *k, float *alpha, float *a, int *lda, 
		      float *b, int *ldb, float *beta, float *c, int *ldc);
void PREFIX SSYMM_F77(Anasazi_fcd, Anasazi_fcd, int *m, int * n,
		      float *alpha, float *a, int *lda, 
		      float *b, int *ldb, float *beta, float *c, int *ldc);
void PREFIX STRMM_F77(Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, 
		      int *m, int *n, float *alpha, float *a, int * lda, float *b, int *ldb);
void PREFIX STRSM_F77(Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, Anasazi_fcd, 
		      int *m, int *n, float *alpha, float *a, int *
		      lda, float *b, int *ldb);

void PREFIX XERBLA_F77(Anasazi_fcd, int *info);
