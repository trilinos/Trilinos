...
options = ANASAZI_INCLUDES.split()    + \
          ANASAZI_LIBS.split()
...
# _Anasazi extension module
_Anasazi = Extension("PyTrilinos._Anasazi",
                     [anasaziWrap],
...
# PyTrilinos.Anasazi setup
setup(name         = "PyTrilinos.Anasazi",
      version      = version,
      description  = "Python Interface to Trilinos Package Anasazi",
      author       = "Heidi Thornquist",
      author_email = "hkthorn@sandia.gov",
      package_dir  = {"PyTrilinos" : "."},
      packages     = ["PyTrilinos"],
      ext_modules  = [ _Anasazi ]
      )
