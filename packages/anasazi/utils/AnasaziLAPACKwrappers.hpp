...
void PREFIX DGETRS_F77(Anasazi_fcd, int* n, int* nrhs, double* a,
                       int* lda, int* ipiv, double* x , int* ldx, int* info);
void PREFIX DGESVD_F77(Anasazi_fcd, Anasazi_fcd, int* m, int* n, double* a,
...
void PREFIX DGECON_F77(Anasazi_fcd norm, int* n, double* a, int* lda, 
...
void PREFIX DGERFS_F77(Anasazi_fcd, int * n, int * nrhs, double * a, 
                       int * lda, double * af, int * ldaf, int*ipiv, 
                       double * b, int * ldb, double * x, int * ldx, 
                       double * ferr, double * berr, double * work, 
                       int * iwork, int * info);
void PREFIX DGESVX_F77(Anasazi_fcd, Anasazi_fcd, int * n, int * nrhs, double * a, 
                       int * lda, double * af, int * ldaf, int*ipiv, Anasazi_fcd, 
                       double * r, double *c, double * b, int * ldb, double * x, int * ldx, 
                       double * rcond, double * ferr, double * berr, double * work, 
                       int * iwork, int * info);

void PREFIX DPOTRF_F77(Anasazi_fcd, int* n, double* a, int* lda, int* info); 
void PREFIX DPOTRS_F77(Anasazi_fcd, int * n, int * nrhs, double* a,
                       int* lda, double*x , int* ldx, int* info);
void PREFIX DPOTRI_F77(Anasazi_fcd, int* n, double* a, int* lda, int* info); 
void PREFIX DPOCON_F77(Anasazi_fcd, int* n, double* a, int* lda, 
                       double * anorm, double * rcond, double * work,
                       int * iwork, int* info); 
void PREFIX DPOSV_F77(Anasazi_fcd, int * n, int * nrhs, double* a,
                       int* lda, double*x , int* ldx, int* info);
void PREFIX DPOEQU_F77(int* n, double* a, int* lda, double * s, double * scond,
                       double * amax, int* info); 

void PREFIX DPORFS_F77(Anasazi_fcd, int * n, int * nrhs, double * a, 
                       int * lda, double * af, int * ldaf, 
                       double * b, int * ldb, double * x, int * ldx, 
                       double * ferr, double * berr, double * work, 
                       int * iwork, int * info);

void PREFIX DPOSVX_F77(Anasazi_fcd, Anasazi_fcd, int * n, int * nrhs, double * a, 
                       int * lda, double * af, int * ldaf, Anasazi_fcd, 
...
void PREFIX SGETRS_F77(Anasazi_fcd, int* n, int* nrhs, float* a,
                       int* lda, int* ipiv, float* x , int* ldx, int* info);
void PREFIX SGESVD_F77(Anasazi_fcd, Anasazi_fcd, int* m, int* n, float* a,
...
void PREFIX SGECON_F77(Anasazi_fcd norm, int* n, float* a, int* lda, 
...
void PREFIX SGEEQU_F77(int* m, int* n, float* a, int* lda, float * r, float * c, 
			...
			float * amax, int* info); 
void PREFIX SGERFS_F77(Anasazi_fcd, int * n, int * nrhs, float * a, 
                       int * lda, float * af, int * ldaf, int*ipiv, 
                       float * b, int * ldb, float * x, int * ldx, 
                       float * ferr, float * berr, float * work, 
                       int * iwork, int * info);
void PREFIX SGESVX_F77(Anasazi_fcd, Anasazi_fcd, int * n, int * nrhs, float * a, 
                       int * lda, float * af, int * ldaf, int*ipiv, Anasazi_fcd, 
                       float * r, float *c, float * b, int * ldb, float * x, int * ldx, 
                       float * rcond, float * ferr, float * berr, float * work, 
                       int * iwork, int * info);

void PREFIX SPOTRF_F77(Anasazi_fcd, int* n, float* a, int* lda, int* info); 
void PREFIX SPOTRS_F77(Anasazi_fcd, int * n, int * nrhs, float* a,
                       int* lda, float*x , int* ldx, int* info);
void PREFIX SPOTRI_F77(Anasazi_fcd, int* n, float* a, int* lda, int* info); 
void PREFIX SPOCON_F77(Anasazi_fcd, int* n, float* a, int* lda, 
                       float * anorm, float * rcond, float * work,
                       int * iwork, int* info); 
void PREFIX SPOSV_F77(Anasazi_fcd, int * n, int * nrhs, float* a,
                       int* lda, float*x , int* ldx, int* info);
void PREFIX SPOEQU_F77(int* n, float* a, int* lda, float * s, float * scond,
                       float * amax, int* info); 

void PREFIX SPORFS_F77(Anasazi_fcd, int * n, int * nrhs, float * a, 
                       int * lda, float * af, int * ldaf, 
                       float * b, int * ldb, float * x, int * ldx, 
                       float * ferr, float * berr, float * work, 
                       int * iwork, int * info);

void PREFIX SPOSVX_F77(Anasazi_fcd, Anasazi_fcd, int * n, int * nrhs, float * a, 
                       int * lda, float * af, int * ldaf, Anasazi_fcd, 
                       float * s, float * b, int * ldb, float * x, int * ldx, 
                       float * rcond, float * ferr, float * berr, float * work, 
                       int * iwork, int * info);

  /* Double precision LAPACK eigen solvers*/
void PREFIX DGELS_F77(Anasazi_fcd ch, int*, int*, int*,
                       double*, int*, double*, int*, double*, int*, int*);

void PREFIX DGEEV_F77(Anasazi_fcd, Anasazi_fcd, int*, double*, int*,
                      double*, double*, double*, int*, double*, int*,
                      double*, int*, int*);

void PREFIX DGEES_F77(Anasazi_fcd, Anasazi_fcd, int*, int*, double*, int*, int*,
                      double*, double*, double*, int*, double*, int*,
                      int*, int*);
...
void PREFIX DHSEQR_F77(Anasazi_fcd job, Anasazi_fcd, int * n, int * ilo, int * ihi,
...
void PREFIX DORMHR_F77(Anasazi_fcd, Anasazi_fcd, int * m, int * n, int * ilo,
                        int * ihi, double * a, int * lda, double * tau, double * c,
                        int * ldc, double * work, int * lwork, int * info);

void PREFIX DTREVC_F77(Anasazi_fcd, Anasazi_fcd, int * select, int * n, double * t,
                        int * ldt, double *vl, int * ldvl, double * vr, int * ldvr,
                        int * mm, int * m, double * work, int * info); 

void PREFIX DTREXC_F77(Anasazi_fcd, int * n, double * t, int * ldt, double * q,
                        int * ldq, int * ifst, int * ilst, double * work, int * info);

double PREFIX DLAMCH_F77(Anasazi_fcd);


  /* Single precision LAPACK eigen solvers*/
void PREFIX SGELS_F77(Anasazi_fcd, int*, int*, int*,
                       float*, int*, float*, int*, float*, int*, int*);

void PREFIX SGEEV_F77(Anasazi_fcd, Anasazi_fcd, int*, float*, int*,
                      float*, float*, float*, int*, float*, int*,
                      float*, int*, int*);

void PREFIX SGEES_F77(Anasazi_fcd, Anasazi_fcd, int*, int*, float*, int*, int*,
                      float*, float*, float*, int*, float*, int*,
                      int*, int*);
...
void PREFIX SHSEQR_F77(Anasazi_fcd job, Anasazi_fcd, int * n, int * ilo, int * ihi,
...
void PREFIX SORMHR_F77(Anasazi_fcd, Anasazi_fcd, int * m, int * n, int * ilo,
                        int * ihi, float * a, int * lda, float * tau, float * c,
                        int * ldc, float * work, int * lwork, int * info);

void PREFIX STREVC_F77(Anasazi_fcd, Anasazi_fcd, int * select, int * n, float * t,
                        int * ldt, float *vl, int * ldvl, float * vr, int * ldvr,
                        int * mm, int * m, float * work, int * info); 

void  PREFIX STREXC_F77(Anasazi_fcd, int * n, float * t, int * ldt, float * q,
                        int * ldq, int * ifst, int * ilst, float * work, int * info);

float  PREFIX SLAMCH_F77(Anasazi_fcd);

  /* Single precision LAPACK auxiliary routines */

float PREFIX SLAPY2_F77(float * x, float * y);

  /* Double precision LAPACK auxiliary routines */

double PREFIX DLAPY2_F77(double * x, double * y);
