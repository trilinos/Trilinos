  ...
  try {
    ...
    try {
      ...
      // Build the first solver manager
      {
        ...
        Anasazi::RTRSolMgr<ST,MV,OP> solverman1(problem, MyPL);
      ...
      // Build the second/1 solver manager
      {
        ...
        Anasazi::RTRSolMgr<ST,MV,OP> solverman21(problem, MyPL);
      ...
      // Build the second/2 solver manager
      {
        ...
        Anasazi::RTRSolMgr<ST,MV,OP> solverman22(problem, MyPL);
      ...
      // Build the second/3 solver manager
      {
        ...
        Anasazi::RTRSolMgr<ST,MV,OP> solverman23(problem, MyPL);
