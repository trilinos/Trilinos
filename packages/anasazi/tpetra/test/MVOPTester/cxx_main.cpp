...
// FINISH: this test is nowhere near close to compiling
// also, not finish: need to test different Ordinal,Scalar types
// first, need to write anasazi adapter
...
#ifdef HAVE_MPI
  Tpetra::MpiPlatform<int> platform(Teuchos::getComm());
#else
  Tpetra::SerialPlatform<int> platform;
#endif
