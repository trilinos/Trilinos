...
![Anasazi](doc/images/anasazi.png)
...
![eigensolver_table](doc/images/eigensolver_table.png)
...
Anasazi is part of the [Trilinos Project](https://trilinos.github.io), and additional information (e.g., examples, tutorials, and source code documentation) is available through [Anasazi's Doxygen webpages](https://trilinos.github.io/docs/Anasazi/index.html).
...
For Anasazi-specific copyright and license details, refer to the [anasazi/COPYRIGHT](COPYRIGHT) and [anasazi/LICENSE](LICENSE) files located in the `anasazi` directory. Additional copyright information may also be found in the headers of individual source files.
