...
#ifndef _snl_fei_MatrixTraits_SSMat_hpp_
#define _snl_fei_MatrixTraits_SSMat_hpp_

//This file defines vector traits for LinearSystemCore matrices
...
namespace snl_fei {
  ...
  struct MatrixTraits<SSMat> {
    ...
    */
    static int getNumRows(SSMat* mat, int& numRows)
    {
...
#endif // _snl_fei_MatrixTraits_SSMat_hpp_
