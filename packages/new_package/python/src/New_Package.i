...
// string
%define DOCSTRING
"The New_Package module allows access to The Trilinos package
New_Package.  Use the python help() facility for local documentation
...
%module(package="PyTrilinos", docstring=DOCSTRING) New_Package
...
// New_Package interface includes.  Create a %include line for every
// header file with a prototype you want wrapped.  In this example,
// New_Package_Version contains a function, Newp_Hello contains a
