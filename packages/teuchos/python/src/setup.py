...
options = TEUCHOS_INCLUDES.split() + \
          TEUCHOS_LIBS.split()
...
# PyTrilinos.Teuchos setup
setup(name         = "PyTrilinos.Teuchos",
      version      = version,
      description  = "Python Interface to Trilinos Package Teuchos",
      author       = "Bill Spotz",
      author_email = "wfspotz@sandia.gov",
      package_dir  = {"PyTrilinos" : "."},
      packages     = ["PyTrilinos"],
      ext_modules  = [ _Teuchos ]
      )
