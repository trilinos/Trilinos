   ...
   */
    ...
    */
    ...
    /*! 
      \return Integer error code, set to 0 if successful. Otherwise returns the LAPACK error code INFO.
    */
    virtual int computeEquilibrateScaling();
    
    //! Equilibrates the \e this matrix.
    /*! 
      \return Integer error code, set to 0 if successful. Otherwise returns the LAPACK error code INFO.
    */
    virtual int equilibrateMatrix();
    ...
    */
    ...
    /*! 
      ...
      \return Integer error code, set to 0 if successful. Otherwise returns the LAPACK error code INFO.
    */
    virtual int reciprocalConditionEstimate(MagnitudeType & Value);
    //@}
    ...
    std::vector<int> IPIV()  const {return(IPIV_);}
    ...
    std::vector<ScalarType> C()  const {return(C_);}
    //@}
