...
#ifndef TEUCHOS_THROW_EXCEPTION_H
#define TEUCHOS_THROW_EXCEPTION_H
 ...
 * for instance):
 ...
 THROW_EXCEPTION( n > 100, std::out_of_range
    , "Error, n = " << n << is bad" );
 \endverbatim
 ...
 * instead of:
 ...
 THROW_EXCEPTION( obj1->val() > obj2->val(), std::logic_error, "Oh no!" );
 \endverbatim
 * try:
 \verbatim

 double obj1_val = obj1->val(), obj2_val = obj2->val();
 THROW_EXCEPTION( obj1_val > obj2_val, std::logic_error, "Oh no!" );
 \endverbatim
 ...
 */
#define THROW_EXCEPTION(throw_exception_test,Exception,msg)         \
{                                                                   \
