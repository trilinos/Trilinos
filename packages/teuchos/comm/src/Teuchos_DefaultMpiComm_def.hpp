...
#ifndef TEUCHOS_MPI_COMM_DEF_HPP
#define TEUCHOS_MPI_COMM_DEF_HPP
...
MpiCommStatus<OrdinalType>::MpiCommStatus(MPI_Status status)
    : status_(status) {}

template <class OrdinalType> MpiCommStatus<OrdinalType>::~MpiCommStatus() {}

template <class OrdinalType>
OrdinalType MpiCommStatus<OrdinalType>::getSourceRank() {
  return status_.MPI_SOURCE;
}

template <class OrdinalType> OrdinalType MpiCommStatus<OrdinalType>::getTag() {
  return status_.MPI_TAG;
}

template <class OrdinalType>
OrdinalType MpiCommStatus<OrdinalType>::getError() {
...
template<class OrdinalType>
MpiCommRequestBase<OrdinalType>::MpiCommRequestBase () :
    rawMpiRequest_ (MPI_REQUEST_NULL)
  {}


template<class OrdinalType>
MpiCommRequestBase<OrdinalType>::MpiCommRequestBase (MPI_Request rawMpiRequest) :
    rawMpiRequest_ (rawMpiRequest)
  {}

template<class OrdinalType>
MPI_Request MpiCommRequestBase<OrdinalType>::releaseRawMpiRequest()
{
...
template<class OrdinalType>
bool MpiCommRequestBase<OrdinalType>::isNull() const {
  return rawMpiRequest_ == MPI_REQUEST_NULL;
}

template<class OrdinalType>
bool MpiCommRequestBase<OrdinalType>::isReady() {
...
template<class OrdinalType>
RCP<CommStatus<OrdinalType> >
MpiCommRequestBase<OrdinalType>::wait () {
  MPI_Status rawMpiStatus;
...
template<class OrdinalType>
RCP<CommStatus<OrdinalType> > MpiCommRequestBase<OrdinalType>::cancel () {
...
template<class OrdinalType>
MpiCommRequest<OrdinalType>::MpiCommRequest () :
  MpiCommRequestBase<OrdinalType> (MPI_REQUEST_NULL),
  numBytes_ (0)
{}

template<class OrdinalType>
MpiCommRequest<OrdinalType>::MpiCommRequest (MPI_Request rawMpiRequest,
...
template<class OrdinalType>
ArrayView<char>::size_type MpiCommRequest<OrdinalType>::numBytes () const {
  return numBytes_;
}

template<class OrdinalType>
MpiCommRequest<OrdinalType>::~MpiCommRequest () = default;
...
#endif // TEUCHOS_MPI_COMM_DEF_HPP
