...
# _Thyra extension module
_Thyra = Extension("PyTrilinos._Thyra",
                         [thyraWrap],
...
# PyTrilinos.Thyra setup
setup(name         = "PyTrilinos.Thyra",
      version      = version,
      description  = "Python Interface to Trilinos Package Thyra",
      author       = "Roscoe Bartlett",
      author_email = "rabartl@sandia.gov",
