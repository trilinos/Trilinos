...
#ifndef THYRA_VECTOR_SPACE_HPP
#define THYRA_VECTOR_SPACE_HPP
...
VectorSpaceBase<Scalar>::smallVecSpcFcty() const
{
...
VectorSpaceBase<Scalar>::createMembers(int numMembers) const
{
...
VectorSpaceBase<Scalar>::createMemberView( const RTOpPack::MutableSubVectorT<Scalar> &raw_v ) const
{
#ifdef _DEBUG
...
VectorSpaceBase<Scalar>::createMemberView( const RTOpPack::SubVectorT<Scalar> &raw_v ) const
{
#ifdef _DEBUG
  TEST_FOR_EXCEPT( raw_v.subDim() != this->dim() );
#endif
...
template<class Scalar>
Teuchos::RefCountPtr<MultiVectorBase<Scalar> >
VectorSpaceBase<Scalar>::createMembersView( const RTOpPack::MutableSubMultiVectorT<Scalar> &raw_mv ) const
{
#ifdef _DEBUG
...
VectorSpaceBase<Scalar>::createMembersView( const RTOpPack::SubMultiVectorT<Scalar> &raw_mv ) const
{
#ifdef _DEBUG
  TEST_FOR_EXCEPT( raw_mv.subDim() != this->dim() );
#endif
