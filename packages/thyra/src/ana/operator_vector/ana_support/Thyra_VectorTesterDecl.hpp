...
template<class Scalar>
inline
void VectorTester<Scalar>::warning_tol( const ScalarMag &warning_tol )
{
...
template<class Scalar>
inline
void VectorTester<Scalar>::error_tol( const ScalarMag &error_tol )
{
...
template<class Scalar>
inline
void VectorTester<Scalar>::num_random_vectors( const int num_random_vectors )
{
...
template<class Scalar>
inline
void VectorTester<Scalar>::show_all_tests( const bool show_all_tests )
{
...
template<class Scalar>
inline
void VectorTester<Scalar>::dump_all( const bool dump_all )
{
  dump_all_ = dump_all;
