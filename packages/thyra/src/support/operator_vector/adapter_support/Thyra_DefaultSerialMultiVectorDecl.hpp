 ...
 * <tt>DefaultSerialVectorSpace</tt> using the function
 * <tt>Thyra::DefaultSerialVectorSpace::createMembers()</tt>.
 *
...
class DefaultSerialMultiVector : virtual public SerialMultiVectorBase<Scalar> {
public:
...
}; // end class DefaultSerialMultiVector
