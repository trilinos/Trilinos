 ...
 * <tt>Thyra::DefaultMPIVectorSpace</tt> and using the function
 * <tt>Thyra::DefaultMPIVectorSpace::createMember()</tt>.
 *
...
class DefaultMPIVector : virtual public MPIVectorBase<Scalar> {
public:
...
template<class Scalar>
inline
Teuchos::RefCountPtr<Scalar> DefaultMPIVector<Scalar>::getRCPtr()
{
  return localValues_;
}
...
template<class Scalar>
inline
Teuchos::RefCountPtr<const Scalar> DefaultMPIVector<Scalar>::getRCPtr() const
{
  return localValues_;
}
...
template<class Scalar>
inline
Scalar* DefaultMPIVector<Scalar>::getPtr()
{
...
template<class Scalar>
inline
const Scalar* DefaultMPIVector<Scalar>::getPtr() const
{
  return localValues_.get();
}
...
template<class Scalar>
inline
Index DefaultMPIVector<Scalar>::getStride() const
{
  return stride_;
}	
