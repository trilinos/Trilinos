...
class MPIVectorSpaceFactoryStd : public VectorSpaceFactoryBase<Scalar> {
public:
  ...
  /** \brief Create a new locally-replicated <tt>MPIVectorSpaceStd</tt> object given its dimension!
   *
