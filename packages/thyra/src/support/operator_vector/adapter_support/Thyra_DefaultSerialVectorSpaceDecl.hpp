...
class DefaultSerialVectorSpace : public SerialVectorSpaceBase<Scalar> {
public:
   ...
   */
  DefaultSerialVectorSpace( int dim = 0 );
  ...
  Index dim() const;
  /// Returns a <tt>DefaultSerialVector</tt> object.
  Teuchos::RefCountPtr<VectorBase<Scalar> > createMember() const;
  /// Returns a <tt>DefaultSerialMultiVector</tt> object.
...
}; // end class DefaultSerialVectorSpace
