...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
RCP<TpetraVectorSpace<Scalar, LocalOrdinal, GlobalOrdinal, Node>>
TpetraVectorSpace<Scalar, LocalOrdinal, GlobalOrdinal, Node>::createLocallyReplicatedVectorSpace(int size) const {
...
bool TpetraVectorSpace<Scalar, LocalOrdinal, GlobalOrdinal, Node>::hasInCoreView(
  ...
  const Ordinal myLocalSubDim = tpetraMap_.is_null() ? static_cast<Ordinal>(0) : tpetraMap_->getLocalNumElements();
...
Ordinal TpetraVectorSpace<Scalar, LocalOrdinal, GlobalOrdinal, Node>::localSubDim() const {
  return tpetraMap_.is_null() ? static_cast<Ordinal>(0) : static_cast<Ordinal>(tpetraMap_->getLocalNumElements());
}
