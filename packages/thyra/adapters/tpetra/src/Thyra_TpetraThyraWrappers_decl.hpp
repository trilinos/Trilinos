...
Teuchos::RCP<Thyra::PreconditionerBase<Scalar>> initializePrec(
    ...
    const RCP<const Tpetra::Operator<Scalar, LocalOrdinal, GlobalOrdinal, Node>>
        &tpetraFwdOp,
    Teuchos::RCP<PreconditionerBase<Scalar>> prec = Teuchos::null,
...
Teuchos::RCP<Thyra::PreconditionerBase<Scalar>> initializePrec(
    const PreconditionerFactoryBase<Scalar> &precFactory,
    const RCP<const Tpetra::CrsMatrix<Scalar, LocalOrdinal, GlobalOrdinal,
                                      Node>> &tpetraFwdOp,
    Teuchos::RCP<PreconditionerBase<Scalar>> prec = Teuchos::null,
    const ESupportSolveUse supportSolveUse = SUPPORT_SOLVE_UNSPECIFIED);
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
RCP<LinearOpWithSolveBase<Scalar>> linearOpWithSolve(
 ...
 */
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
RCP<LinearOpWithSolveBase<Scalar>> initializePreconditionedOp(
    const LinearOpWithSolveFactoryBase<Scalar> &lowsFactory,
    const RCP<const Tpetra::Operator<Scalar, LocalOrdinal, GlobalOrdinal, Node>>
        &tpetraFwdOp,
...
solve(const LinearOpWithSolveBase<Scalar> &A, const EOpTransp A_trans,
      const RCP<const Tpetra::MultiVector<Scalar, LocalOrdinal, GlobalOrdinal,
                                          Node>> &tpetraB,
