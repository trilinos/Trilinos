...
class GetTpetraEpetraRowMatrixWrapper {
 public:
  ...
  static RCP<Tpetra::EpetraRowMatrix<TpetraMatrixType> >
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
void TpetraLinearOp<Scalar, LocalOrdinal, GlobalOrdinal, Node>::
...
void TpetraLinearOp<Scalar, LocalOrdinal, GlobalOrdinal, Node>::getRowStatImpl(
    ...
    const Ptr<VectorBase<Scalar> > &rowStatVec_in) const {
