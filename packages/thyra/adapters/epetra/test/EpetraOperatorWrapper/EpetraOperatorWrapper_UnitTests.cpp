...
TEUCHOS_UNIT_TEST( EpetraOperatorWrapper, basic )
{
   ...
   out << "\nRunning on " << comm.NumProc() << " processors" << std::endl;

   int nx = 39; // essentially random values
   int ny = 53;

   out << "Using Trilinos_Util to create test matrices" << std::endl;
   ...
   out << "Building block2x2 Thyra matrix ... wrapping in EpetraOperatorWrapper" << std::endl;
