...
struct dump_vec_spaces_t {
 public:
  dump_vec_spaces_t(
    ...
    : vec_space1(_vec_space1)
    , vec_space1_name(_vec_space1_name)
    , vec_space2(_vec_space2)
    , vec_space2_name(_vec_space2_name) {}
...
#define THYRA_ASSERT_MAT_MAT_SPACES(FUNC_NAME, M1, M1_T, M1_VS, M2, M2_T, M2_VS)                                                           \
  {                                                                                                                                        \
    ...
    THYRA_ASSERT_VEC_SPACES_NAMES(                                                                                                         \
        header,                                                                                                                            \
        ::Thyra::linear_op_op(M1, M1_T, M1_VS), M1_VS_name.str().c_str()::Thyra::linear_op_op(M2, M2_T, M2_VS), M2_VS_name.str().c_str()); \
  }
