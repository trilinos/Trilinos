 ...
 public:
  static bool checkComparableStdOps(
    ...
    if (!Teuchos::testRelErr<Scalar>(
            "min(*z)", min(*z), "scalarSmall", scalarSmall, "error_tol", error_tol, "warning_tol", warning_tol, out)) success = false;
    ...
    if (!Teuchos::testRelErr<Scalar>(
            "minEle", minEle, "scalarSmall", scalarSmall, "error_tol", error_tol, "warning_tol", warning_tol, out)) success = false;
    result = minIndex == 0;
    ...
    if (!Teuchos::testRelErr<Scalar>(
            "minEle", minEle, "scalarLarge", scalarLarge, "error_tol", error_tol, "warning_tol", warning_tol, out)) success = false;
    result = minIndex == 1;
    ...
    if (!Teuchos::testRelErr<Scalar>(
            "max(*z)", max(*z), "scalarLarge", scalarLarge, "error_tol", error_tol, "warning_tol", warning_tol, out)) success = false;
    ...
    if (!Teuchos::testRelErr<Scalar>(
            "maxEle", maxEle, "scalarLarge", scalarLarge, "error_tol", error_tol, "warning_tol", warning_tol, out)) success = false;
    result = maxIndex == 1;
    ...
    if (!Teuchos::testRelErr<Scalar>(
            "maxEle", maxEle, "scalarSmall", scalarSmall, "error_tol", error_tol, "warning_tol", warning_tol, out)) success = false;
    result = maxIndex == 0;
    ...
    if (nonnull(out)) *out << "\nTesting pair_wise_max(*v1, *v2, z0.ptr()) ...\n";
    {
      ...
      using Teuchos::outArg;
      using Teuchos::tuple;
      Teuchos::RCP<VectorBase<Scalar> > v1 = createMember(vecSpc);
      Teuchos::RCP<VectorBase<Scalar> > v2 = createMember(vecSpc);
      Teuchos::RCP<VectorBase<Scalar> > v3 = createMember(vecSpc);
      Teuchos::RCP<VectorBase<Scalar> > z0 = createMember(vecSpc);
      ...
      // z0 = alpha*max(v1_i, v2_i)
      pair_wise_max(alpha, *v1, *v2, z0.ptr());
      ...
      Vp_V(z0.ptr(), *v3, as<Scalar>(-ST::one()));  // z0 -= v3
      if (!testMaxErr<Scalar>(
              "norm_2(*z0)", norm_2(*z0), "error_tol", error_tol, "warning_tol", warning_tol, out.get())) success = false;
    }
...
bool VectorStdOpsTester<Scalar>::checkStdOps(
  ...
  ++tc;
  {
    ...
    if (!Teuchos::testRelErr<Scalar>(
            ...
            "error_tol", error_tol(), "warning_tol", warning_tol(), inOutArg(out))) success = false;
  }
  ...
  ++tc;
  {
    reciprocal(*v1, z.ptr());
    if (!Teuchos::testRelErr<Scalar>(
            "sum(*z)", sum(*z), "-0.5*vecSpc.dim()", as<Scalar>(-0.5) * as<Scalar>(vecSpc.dim()), "error_tol", error_tol(), "warning_tol", warning_tol(), inOutArg(out))) success = false;
  }
  ...
  ++tc;
  {
    assign(z.ptr(), as<Scalar>(2.0));
    if (!Teuchos::testRelErr<Scalar>(
            "norm_2(*z,*v2)", norm_2(*z, *v2), "sqrt(2.0*3.0*3.0*vecSpc.dim())", ST::magnitude(ST::squareroot(as<Scalar>(2.0 * 3.0 * 3.0) * as<Scalar>(vecSpc.dim()))), "error_tol", error_tol(), "warning_tol", warning_tol(), inOutArg(out))) success = false;

    if (!VectorStdOpsTesterComparable<ST::isComparable, Scalar>::checkComparableStdOps(
            vecSpc, z.ptr(), error_tol(), warning_tol(), inOutArg(out), dumpAll)) success = false;
  }
  ...
  ++tc;
  {
    ...
    if (!testMaxErr<Scalar>(
            "norm_alpha_v1 - alpha_norm_v1", ST::magnitude(norm_alpha_v1 - alpha_norm_v1), "error_tol", error_tol(), "warning_tol", warning_tol(), &out)) success = false;
#ifdef THYRA_VECTOR_STD_OPS_TESTER_DUMP
  ...
  ++tc;
  {
    ...
    if (!testMaxErr<Scalar>(
            "norm_2(*z)", norm_2(*z), "error_tol", error_tol(), "warning_tol", warning_tol(), &out)) success = false;
  }
  ...
  ++tc;
  {
    ...
    if (!testMaxErr<Scalar>(
            "norm_2(*v3)", norm_2(*v3), "error_tol", error_tol(), "warning_tol", warning_tol(), &out)) success = false;
  }
  ...
  ++tc;
  {
    ...
    if (!testMaxErr<Scalar>(
            "norm_2(*v2)", norm_2(*v2), "error_tol", error_tol(), "warning_tol", warning_tol(), &out)) success = false;
  }
  ...
  ++tc;
  {
    ...
    if (!testMaxErr<Scalar>(
            "norm_2(*x)", norm_2(*x), "error_tol", error_tol(), "warning_tol", warning_tol(), &out)) success = false;
  }
  ...
  ++tc;
  {
    ...
    Vp_V(x.ptr(), *z, as<Scalar>(-ST::one()));
    if (!testMaxErr<Scalar>(
            "norm_2(*x)", norm_2(*x), "10*error_tol", ScalarMag(ScalarMag(10) * error_tol()), "warning_tol", warning_tol(), &out)) success = false;
  }
