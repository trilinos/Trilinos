...
StateFuncModelEvaluatorBase<Scalar>::get_p_space(int /* l */) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      true, std::logic_error, "ModelEvaluator<" << Teuchos::ScalarTraits<Scalar>::name() << ">::get_p_space(l): "
...
StateFuncModelEvaluatorBase<Scalar>::get_p_names(int /* l */) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      true, std::logic_error, "ModelEvaluator<" << Teuchos::ScalarTraits<Scalar>::name() << ">::get_p_names(l): "
                                                                                            "Error, this function was not overridden in *this = \'"
                                                << this->description() << "\'!");
  TEUCHOS_UNREACHABLE_RETURN(Teuchos::null);
}
...
StateFuncModelEvaluatorBase<Scalar>::get_g_space(int /* j */) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      true, std::logic_error, "ModelEvaluator<" << Teuchos::ScalarTraits<Scalar>::name() << ">::get_g_space(j): "
...
StateFuncModelEvaluatorBase<Scalar>::get_g_names(int /* j */) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      true, std::logic_error, "ModelEvaluator<" << Teuchos::ScalarTraits<Scalar>::name() << ">::get_g_names(j): "
                                                                                            "Error, this function was not overridden in *this = \'"
                                                << this->description() << "\'!");
...
StateFuncModelEvaluatorBase<Scalar>::getNominalValues() const { return this->createInArgs(); }

template <class Scalar>
ModelEvaluatorBase::InArgs<Scalar>
StateFuncModelEvaluatorBase<Scalar>::getLowerBounds() const { return this->createInArgs(); }

template <class Scalar>
ModelEvaluatorBase::InArgs<Scalar>
StateFuncModelEvaluatorBase<Scalar>::getUpperBounds() const { return this->createInArgs(); }
