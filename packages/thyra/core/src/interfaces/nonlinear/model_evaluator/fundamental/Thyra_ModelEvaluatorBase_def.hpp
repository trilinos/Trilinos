...
inline RCP<const Thyra::VectorBase<Scalar> >
condCloneVec(
...
template <class Scalar>
inline RCP<const Thyra::MultiVectorBase<Scalar> >
condCloneMultiVec(
...
inline RCP<const Stokhos::ProductEpetraVector>
condCloneVec_mp(
...
template <class Scalar>
int ModelEvaluatorBase::InArgs<Scalar>::Np() const { return p_.size(); }

template <class Scalar>
int ModelEvaluatorBase::InArgs<Scalar>::Ng() const { return g_multiplier_.size(); }

template <class Scalar>
bool ModelEvaluatorBase::InArgs<Scalar>::supports(EInArgsMembers arg) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      int(arg) >= NUM_E_IN_ARGS_MEMBERS || int(arg) < 0, std::logic_error, "model = \'" << modelEvalDescription_ << "\': Error, arg=" << toString(arg) << " is invalid!");
...
void ModelEvaluatorBase::InArgs<Scalar>::set_x_dot_dot(
  ...
  assert_supports(IN_ARG_x_dot_dot);
...
void ModelEvaluatorBase::InArgs<Scalar>::set_x_dot_mp(
  ...
  assert_supports(IN_ARG_x_dot_mp);
  x_dot_mp_ = x_dot_mp;
}
...
void ModelEvaluatorBase::InArgs<Scalar>::set_x_dot_poly(
  ...
  assert_supports(IN_ARG_x_dot_poly);
  x_dot_poly_ = x_dot_poly;
}
...
void ModelEvaluatorBase::InArgs<Scalar>::set_W_x_dot_dot_coeff(Scalar W_x_dot_dot_coeff) {
  assert_supports(IN_ARG_W_x_dot_dot_coeff);
  W_x_dot_dot_coeff_ = W_x_dot_dot_coeff;
}
...
void ModelEvaluatorBase::InArgs<Scalar>::set_step_size(Scalar step_size) {
  assert_supports(IN_ARG_step_size);
...
Scalar ModelEvaluatorBase::InArgs<Scalar>::get_stage_number() const {
  assert_supports(IN_ARG_stage_number);
...
void ModelEvaluatorBase::InArgs<Scalar>::assertSameSupport(
    const InArgs<Scalar> &inArgs) const {
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(
        ...
        "Error, the input argument " << inArg_name << " with support " << inArgs.supports(inArg_arg) << "\n"
                                     ...
                                     << inArgs.modelEvalDescription() << "\n\n"
                                                                         "is not the same the argument "
                                     << inArg_name << " with support " << supports(inArg_arg) << "\n"
                                                                                                 "in the InArgs object for the model:\n\n"
                                                                                                 "  "
...
void ModelEvaluatorBase::InArgs<Scalar>::assert_supports(
    EInArgsMembers arg) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      !supports_[arg], std::logic_error, "Thyra::ModelEvaluatorBase::InArgs<" << Teuchos::ScalarTraits<Scalar>::name() << ">::assert_supports(arg): "
                                                                                                                          "model = \'"
                                                                              << modelEvalDescription_ << "\': Error, "
                                                                                                          "The argument arg = "
                                                                              << toString(arg) << " is not supported!");
}

template <class Scalar>
void ModelEvaluatorBase::InArgs<Scalar>::assert_supports(
    EInArgs_p_mp /* arg */, int l) const {
  assert_l(l);
  TEUCHOS_TEST_FOR_EXCEPTION(
      !supports_p_mp_[l], std::logic_error, "Thyra::ModelEvaluatorBase::InArgs<" << Teuchos::ScalarTraits<Scalar>::name() << ">::assert_supports(IN_ARG_p_mp,1): "
                                                                                                                             "model = \'"
                                                                                 << modelEvalDescription_ << "\': Error, "
                                                                                                             "The argument p_mp(l) with index l = "
                                                                                 << l << " is not supported!");
}
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      " model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The parameter l = "
          << l << " is not in the range [0," << Np() << ")!");
}
...
void ModelEvaluatorBase::InArgs<Scalar>::assert_j(int j) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The auxiliary function g("
          << j << ")"
...
template <class Scalar>
int ModelEvaluatorBase::OutArgs<Scalar>::Np() const { return DfDp_.size(); }

template <class Scalar>
int ModelEvaluatorBase::OutArgs<Scalar>::Ng() const { return g_.size(); }

template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgsMembers arg) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      int(arg) >= NUM_E_OUT_ARGS_MEMBERS || int(arg) < 0, std::logic_error, "model = \'" << modelEvalDescription_ << "\': Error, arg=" << toString(arg) << " is invalid!");
  return supports_[arg];
}
...
const ModelEvaluatorBase::DerivativeSupport &
ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgsDgDx_dot /* arg */, int j) const {
  assert_j(j);
...
const ModelEvaluatorBase::DerivativeSupport &
ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgsDgDp /* arg */, int j, int l) const {
  assert_j(j);
  assert_l(l);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_vec_prod_f_xp /* arg */, int l) const {
  assert_l(l);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_vec_prod_f_px /* arg */, int l) const {
  assert_l(l);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_vec_prod_f_pp /* arg */, int l1, int l2) const {
  assert_l(l1);
  assert_l(l2);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_vec_prod_g_xx /* arg */, int j) const {
  assert_j(j);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_vec_prod_g_xp /* arg */, int j, int l) const {
  assert_j(j);
  assert_l(l);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_vec_prod_g_px /* arg */, int j, int l) const {
  assert_j(j);
  assert_l(l);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_vec_prod_g_pp /* arg */, int j, int l1, int l2) const {
  assert_j(j);
  assert_l(l1);
  assert_l(l2);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_f_xp /* arg */, int l) const {
  assert_l(l);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_f_pp /* arg */, int l1, int l2) const {
  assert_l(l1);
  assert_l(l2);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_H_pp /* arg */, int l1, int l2) const {
  assert_l(l1);
  assert_l(l2);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_g_xx /* arg */, int j) const {
  assert_j(j);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_g_xp /* arg */, int j, int l) const {
  assert_j(j);
  assert_l(l);
...
template <class Scalar>
bool ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgs_hess_g_pp /* arg */, int j, int l1, int l2) const {
  assert_j(j);
  assert_l(l1);
  assert_l(l2);
...
const ModelEvaluatorBase::DerivativeSupport &
ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgsDfDp_mp /* arg */, int l) const {
  assert_l(l);
...
const ModelEvaluatorBase::DerivativeSupport &
ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgsDgDx_dot_mp /* arg */, int j) const {
  assert_j(j);
...
const ModelEvaluatorBase::DerivativeSupport &
ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgsDgDx_mp /* arg */, int j) const {
  assert_j(j);
...
const ModelEvaluatorBase::DerivativeSupport &
ModelEvaluatorBase::OutArgs<Scalar>::supports(
    EOutArgsDgDp_mp /* arg */, int j, int l) const {
  assert_j(j);
  assert_l(l);
...
void ModelEvaluatorBase::OutArgs<Scalar>::setArgs(
  ...
  for (int l = 0; l < min_Np; ++l) {
    ...
    if (!inputOutArgs.supports(OUT_ARG_DfDp, l).none() && !(DfDp_l = inputOutArgs.get_DfDp(l)).isEmpty()) {
  ...
  for (int l = 0; l < min_Np; ++l) {
    ...
    if (!inputOutArgs.supports(OUT_ARG_DfDp_mp, l).none() && !(DfDp_mp_l = inputOutArgs.get_DfDp_mp(l)).isEmpty()) {
  ...
  for (int j = 0; j < min_Ng; ++j) {
    ...
    if (!inputOutArgs.supports(OUT_ARG_DgDx_dot, j).none() && !(DgDx_dot_j = inputOutArgs.get_DgDx_dot(j)).isEmpty()) {
    ...
    if (!inputOutArgs.supports(OUT_ARG_DgDx, j).none() && !(DgDx_j = inputOutArgs.get_DgDx(j)).isEmpty()) {
  ...
  for (int j = 0; j < min_Ng; ++j) {
    ...
    if (!inputOutArgs.supports(OUT_ARG_DgDx_dot_mp, j).none() && !(DgDx_dot_mp_j = inputOutArgs.get_DgDx_dot_mp(j)).isEmpty()) {
    ...
    if (!inputOutArgs.supports(OUT_ARG_DgDx_mp, j).none() && !(DgDx_mp_j = inputOutArgs.get_DgDx_mp(j)).isEmpty()) {
  ...
  for (int l = 0; l < min_Np; ++l) {
    for (int j = 0; j < min_Ng; ++j) {
      ...
      if (!inputOutArgs.supports(OUT_ARG_DgDp, j, l).none() && !(DgDp_j_l = inputOutArgs.get_DgDp(j, l)).isEmpty()) {
  ...
  for (int l = 0; l < min_Np; ++l) {
    for (int j = 0; j < min_Ng; ++j) {
      ...
      if (!inputOutArgs.supports(OUT_ARG_DgDp_mp, j, l).none() && !(DgDp_mp_j_l = inputOutArgs.get_DgDp_mp(j, l)).isEmpty()) {
...
void ModelEvaluatorBase::OutArgs<Scalar>::assertSameSupport(
    const OutArgs<Scalar> &outArgs) const {
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(
        ...
        "Error, the output argument " << outArg_name << " with support " << outArgs.supports(outArg_arg) << "\n"
                                      ...
                                      << outArgs.modelEvalDescription() << "\n\n"
                                                                           "is not the same the argument "
                                      << outArg_name << " with support " << supports(outArg_arg) << "\n"
                                                                                                    "in the OutArgs object for the model:\n\n"
                                                                                                    "  "
                                      << modelEvalDescription() << "\n\n"
...
void ModelEvaluatorBase::OutArgs<Scalar>::describe(
  ...
  *out << "Ng = " << Ng() << "\n";
  ...
  for (int l = 0; l < Np(); ++l) {
    Deriv DfDp_l;
    if (
        !this->supports(OUT_ARG_DfDp, l).none() && !(DfDp_l = get_DfDp(l)).isEmpty()) {
      *out << "DfDp(" << l << ") = ";
  ...
  for (int j = 0; j < Ng(); ++j) {
    Deriv DgDx_dot_j;
    if (
        !this->supports(OUT_ARG_DgDx_dot, j).none() && !(DgDx_dot_j = get_DgDx_dot(j)).isEmpty()) {
      *out << "DgDx_dot(" << j << ") = ";
    ...
    Deriv DgDx_j;
    if (
        !this->supports(OUT_ARG_DgDx, j).none() && !(DgDx_j = get_DgDx(j)).isEmpty()) {
      *out << "DgDx(" << j << ") = ";
    ...
    for (int l = 0; l < Np(); ++l) {
      Deriv DgDp_j_l;
      if (
          !this->supports(OUT_ARG_DgDp, j, l).none() && !(DgDp_j_l = get_DgDp(j, l)).isEmpty()) {
        *out << "DgDp(" << j << "," << l << ") = ";
...
void ModelEvaluatorBase::OutArgs<Scalar>::_set_Np_Ng(int Np_in, int Ng_in) {
  if (Np_in) {
    ...
    DfDp_.resize(Np_in);
    std::fill_n(DfDp_.begin(), Np_in, Derivative<Scalar>());
  ...
  if (Ng_in) {
    g_.resize(Ng_in);
    std::fill_n(g_.begin(), Ng_in, Teuchos::null);
    supports_DgDx_dot_.resize(Ng_in);
    DgDx_dot_.resize(Ng_in);
    std::fill_n(DgDx_dot_.begin(), Ng_in, Derivative<Scalar>());
    ...
    DgDx_.resize(Ng_in);
    std::fill_n(DgDx_.begin(), Ng_in, Derivative<Scalar>());
    ...
    hess_vec_prod_g_xx_.resize(Ng_in);
    std::fill_n(hess_vec_prod_g_xx_.begin(), Ng_in, RCP<MultiVectorBase<Scalar> >());

    supports_hess_g_xx_.resize(Ng_in);
    hess_g_xx_.resize(Ng_in);
    std::fill_n(hess_g_xx_.begin(), Ng_in, RCP<LinearOpBase<Scalar> >());
#endif  // ifdef Thyra_BUILD_HESSIAN_SUPPORT

    g_mp_.resize(Ng_in);
    std::fill_n(g_mp_.begin(), Ng_in, Teuchos::null);
  ...
  if (Np_in) {
    ...
    hess_vec_prod_f_xp_.resize(Np);
    std::fill_n(hess_vec_prod_f_xp_.begin(), Np, RCP<MultiVectorBase<Scalar> >());

    supports_hess_vec_prod_f_px_.resize(Np);
    hess_vec_prod_f_px_.resize(Np);
    std::fill_n(hess_vec_prod_f_px_.begin(), Np, RCP<MultiVectorBase<Scalar> >());

    supports_hess_vec_prod_f_pp_.resize(NpNp);
    hess_vec_prod_f_pp_.resize(NpNp);
    std::fill_n(hess_vec_prod_f_pp_.begin(), NpNp, RCP<MultiVectorBase<Scalar> >());

    supports_hess_f_xp_.resize(Np);
    hess_f_xp_.resize(Np);
    std::fill_n(hess_f_xp_.begin(), Np, RCP<LinearOpBase<Scalar> >());

    supports_hess_f_pp_.resize(NpNp);
    hess_f_pp_.resize(NpNp);
    std::fill_n(hess_f_pp_.begin(), NpNp, RCP<LinearOpBase<Scalar> >());

    supports_H_xp_.resize(Np);
    H_xp_.resize(Np);
    std::fill_n(H_xp_.begin(), Np, RCP<LinearOpBase<Scalar> >());

    supports_H_pp_.resize(NpNp);
    H_pp_.resize(NpNp);
    std::fill_n(H_pp_.begin(), NpNp, RCP<LinearOpBase<Scalar> >());
  }
#endif  // ifdef Thyra_BUILD_HESSIAN_SUPPORT
  if (Np_in && Ng_in) {
    ...
    DgDp_.resize(NpNg);
    std::fill_n(DgDp_.begin(), NpNg, Derivative<Scalar>());
    ...
    hess_vec_prod_g_xp_.resize(NpNg);
    std::fill_n(hess_vec_prod_g_xp_.begin(), NpNg, RCP<MultiVectorBase<Scalar> >());

    supports_hess_vec_prod_g_px_.resize(NpNg);
    hess_vec_prod_g_px_.resize(NpNg);
    std::fill_n(hess_vec_prod_g_px_.begin(), NpNg, RCP<MultiVectorBase<Scalar> >());

    supports_hess_vec_prod_g_pp_.resize(NpNpNg);
    hess_vec_prod_g_pp_.resize(NpNpNg);
    std::fill_n(hess_vec_prod_g_pp_.begin(), NpNpNg, RCP<MultiVectorBase<Scalar> >());

    supports_hess_g_xp_.resize(NpNg);
    hess_g_xp_.resize(NpNg);
    std::fill_n(hess_g_xp_.begin(), NpNg, RCP<LinearOpBase<Scalar> >());

    supports_hess_g_pp_.resize(NpNpNg);
    hess_g_pp_.resize(NpNpNg);
    std::fill_n(hess_g_pp_.begin(), NpNpNg, RCP<LinearOpBase<Scalar> >());
#endif  // ifdef Thyra_BUILD_HESSIAN_SUPPORT
...
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(EOutArgsMembers arg) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument arg = "
          << toString(arg) << " is not supported!");
}

template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgsDfDp arg, int l, const Derivative<Scalar> &deriv) const {
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument DfDp("
          << l << ") = " << deriv.description() << "\n"
                                                   "is not supported!\n\n"
                                                   "The supported types include "
          << derivSupport.description() << "!");
}

template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgsDgDx_dot arg, int j, const Derivative<Scalar> &deriv) const {
...
template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgsDgDx arg, int j, const Derivative<Scalar> &deriv) const {
  const DerivativeSupport derivSupport = this->supports(arg, j);
  TEUCHOS_TEST_FOR_EXCEPTION(
      !deriv.isSupportedBy(derivSupport), std::logic_error,
...
template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgsDgDp arg, int j, int l, const Derivative<Scalar> &deriv) const {
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument DgDp("
          << j << "," << l << ") = " << deriv.description() << "\n"
                                                               "is not supported!\n\n"
                                                               "The supported types include "
          << derivSupport.description() << "!");
}
...
template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgs_hess_vec_prod_f_xx arg) const {
...
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument hess_vec_prod_f_xp("
          << l << ") is not supported!");
}
...
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument hess_vec_prod_f_px("
          << l << ") is not supported!");
}
...
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument hess_vec_prod_f_pp("
...
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument hess_vec_prod_g_xx("
          << j << ") is not supported!");
}
...
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument hess_vec_prod_g_xp("
          << j << "," << l << ") is not supported!");
}
...
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument hess_vec_prod_g_px("
          << j << "," << l << ") is not supported!");
}
...
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument hess_vec_prod_g_pp("
          << j << "," << l1 << "," << l2 << ") is not supported!");
}

template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgs_hess_f_xx arg) const {
  const bool support = this->supports(arg);
  TEUCHOS_TEST_FOR_EXCEPTION(
      !support, std::logic_error,
...
template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgsDfDp_mp arg, int l, const MPDerivative &deriv) const {
  const DerivativeSupport derivSupport = this->supports(arg, l);
  TEUCHOS_TEST_FOR_EXCEPTION(
      !deriv.isSupportedBy(derivSupport), std::logic_error,
...
template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgsDgDx_dot_mp arg, int j, const MPDerivative &deriv) const {
  const DerivativeSupport derivSupport = this->supports(arg, j);
  TEUCHOS_TEST_FOR_EXCEPTION(
      !deriv.isSupportedBy(derivSupport), std::logic_error,
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error, The argument DgDx_dot_mp("
          << j << ") = " << deriv.description() << "\n"
                                                   "is not supported!\n\n"
                                                   "The supported types include "
          << derivSupport.description() << "!");
...
template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgsDgDx_mp arg, int j, const MPDerivative &deriv) const {
  const DerivativeSupport derivSupport = this->supports(arg, j);
  TEUCHOS_TEST_FOR_EXCEPTION(
      !deriv.isSupportedBy(derivSupport), std::logic_error,
...
template <class Scalar>
void ModelEvaluatorBase::OutArgs<Scalar>::assert_supports(
    EOutArgsDgDp_mp arg, int j, int l, const MPDerivative &deriv) const {
  const DerivativeSupport derivSupport = this->supports(arg, j, l);
  TEUCHOS_TEST_FOR_EXCEPTION(
      !deriv.isSupportedBy(derivSupport), std::logic_error,
...
void ModelEvaluatorBase::OutArgs<Scalar>::assert_l(int l) const {
  TEUCHOS_TEST_FOR_EXCEPTION(
      ...
      "model = \'"
          << modelEvalDescription_ << "\':\n\n"
                                      "Error,  The parameter subvector p("
          << l << ")"
                  " is not in the range [0,"
          << Np() << ")!");
}
...
template <class Scalar>
void ModelEvaluatorBase::InArgsSetup<Scalar>::set_Np(int Np_in) { this->_set_Np_Ng(Np_in, 0); }

template <class Scalar>
void ModelEvaluatorBase::InArgsSetup<Scalar>::set_Np_Ng(int Np_in, int Ng_in) { this->_set_Np_Ng(Np_in, Ng_in); }

template <class Scalar>
void ModelEvaluatorBase::InArgsSetup<Scalar>::setSupports(EInArgsMembers arg, bool supports_in) { this->_setSupports(arg, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::InArgsSetup<Scalar>::setSupports(EInArgs_p_mp arg, int l, bool supports_in) { this->_setSupports(arg, l, supports_in); }
...
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setModelEvalDescription(
    const std::string &modelEvalDescription_in) { this->_setModelEvalDescription(modelEvalDescription_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_Np_Ng(int Np_in, int Ng_in) { this->_set_Np_Ng(Np_in, Ng_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgsMembers arg, bool supports_in) { this->_setSupports(arg, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgsDfDp arg, int l, const DerivativeSupport &supports_in) { this->_setSupports(arg, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgsDgDx_dot arg, int j, const DerivativeSupport &supports_in) { this->_setSupports(arg, j, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgsDgDx arg, int j, const DerivativeSupport &supports_in) { this->_setSupports(arg, j, supports_in); }

#ifdef Thyra_BUILD_HESSIAN_SUPPORT

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_vec_prod_f_xx arg, bool supports_in) { this->_setSupports(arg, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_vec_prod_f_xp arg, int l, bool supports_in) { this->_setSupports(arg, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_vec_prod_f_px arg, int l, bool supports_in) { this->_setSupports(arg, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_vec_prod_f_pp arg, int l1, int l2, bool supports_in) { this->_setSupports(arg, l1, l2, supports_in); }

#endif  // ifdef Thyra_BUILD_HESSIAN_SUPPORT

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgsDgDp arg, int j, int l, const DerivativeSupport &supports_in) { this->_setSupports(arg, j, l, supports_in); }

#ifdef Thyra_BUILD_HESSIAN_SUPPORT

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_vec_prod_g_xx arg, int j, bool supports_in) { this->_setSupports(arg, j, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_vec_prod_g_xp arg, int j, int l, bool supports_in) { this->_setSupports(arg, j, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_vec_prod_g_px arg, int j, int l, bool supports_in) { this->_setSupports(arg, j, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_vec_prod_g_pp arg, int j, int l1, int l2, bool supports_in) { this->_setSupports(arg, j, l1, l2, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_f_xx arg, bool supports_in) { this->_setSupports(arg, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_f_xp arg, int l, bool supports_in) { this->_setSupports(arg, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_f_pp arg, int l1, int l2, bool supports_in) { this->_setSupports(arg, l1, l2, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_g_xx arg, int j, bool supports_in) { this->_setSupports(arg, j, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_g_xp arg, int j, int l, bool supports_in) { this->_setSupports(arg, j, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_hess_g_pp arg, int j, int l1, int l2, bool supports_in) { this->_setSupports(arg, j, l1, l2, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_H_xx arg, bool supports_in) { this->_setSupports(arg, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_H_xp arg, int l, bool supports_in) { this->_setSupports(arg, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_H_pp arg, int l1, int l2, bool supports_in) { this->_setSupports(arg, l1, l2, supports_in); }

#endif  // ifdef Thyra_BUILD_HESSIAN_SUPPORT

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgs_g_mp arg, int j, bool supports_in) { this->_setSupports(arg, j, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgsDfDp_mp arg, int l, const DerivativeSupport &supports_in) { this->_setSupports(arg, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgsDgDx_dot_mp arg, int j, const DerivativeSupport &supports_in) { this->_setSupports(arg, j, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgsDgDx_mp arg, int j, const DerivativeSupport &supports_in) { this->_setSupports(arg, j, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    EOutArgsDgDp_mp arg, int j, int l, const DerivativeSupport &supports_in) { this->_setSupports(arg, j, l, supports_in); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_W_properties(
    const DerivativeProperties &properties) { this->_set_W_properties(properties); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_DfDp_properties(
    int l, const DerivativeProperties &properties) { this->_set_DfDp_properties(l, properties); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_DgDx_dot_properties(
    int j, const DerivativeProperties &properties) { this->_set_DgDx_dot_properties(j, properties); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_DgDx_properties(
    int j, const DerivativeProperties &properties) { this->_set_DgDx_properties(j, properties); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_DgDp_properties(
    int j, int l, const DerivativeProperties &properties) { this->_set_DgDp_properties(j, l, properties); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_DfDp_mp_properties(
    int l, const DerivativeProperties &properties) { this->_set_DfDp_mp_properties(l, properties); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_DgDx_dot_mp_properties(
    int j, const DerivativeProperties &properties) { this->_set_DgDx_dot_mp_properties(j, properties); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_DgDx_mp_properties(
    int j, const DerivativeProperties &properties) { this->_set_DgDx_mp_properties(j, properties); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::set_DgDp_mp_properties(
    int j, int l, const DerivativeProperties &properties) { this->_set_DgDp_mp_properties(j, l, properties); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setSupports(
    const OutArgs<Scalar> &inputOutArgs) { this->_setSupports(inputOutArgs); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setUnsupportsAndRelated(
    EInArgsMembers arg) { this->_setUnsupportsAndRelated(arg); }

template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setUnsupportsAndRelated(
    EOutArgsMembers arg) { this->_setUnsupportsAndRelated(arg); }

#ifdef Thyra_BUILD_HESSIAN_SUPPORT
template <class Scalar>
void ModelEvaluatorBase::OutArgsSetup<Scalar>::setHessianSupports(
    const bool supports) { this->_setHessianSupports(supports); }
#endif  // ifdef Thyra_BUILD_HESSIAN_SUPPORT
...
#define THYRA_MODEL_EVALUATOR_BASE_INSTANT(SCALAR)                                 \
  ...
  ModelEvaluatorBase::Derivative<SCALAR>::description() const;                     \
                                                                                   \
  template void ModelEvaluatorBase::Derivative<SCALAR>::describe(                  \
      Teuchos::FancyOStream &out, const Teuchos::EVerbosityLevel verbLevel) const; \
                                                                                   \
