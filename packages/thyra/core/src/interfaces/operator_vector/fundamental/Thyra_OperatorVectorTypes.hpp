 ...
 * \ingroup Thyra_Op_Vec_fundamental_interfaces_code_grp
 */
inline const char* toString(EConj conj) {
  switch (conj) {
 ...
 * \ingroup Thyra_Op_Vec_fundamental_interfaces_code_grp
 */
inline const char* toString(EOpTransp transp) {
  switch (transp) {
 ...
 * \ingroup Thyra_Op_Vec_fundamental_interfaces_code_grp
 */
inline EOpTransp real_trans(EOpTransp transp) {
  switch (transp) {
    case NOTRANS: return NOTRANS;
 ...
 * \ingroup Thyra_Op_Vec_fundamental_interfaces_code_grp
 */
inline EOpTransp not_trans(EOpTransp transp) {
  switch (transp) {
 ...
 * \ingroup Thyra_Op_Vec_fundamental_interfaces_code_grp
 */
inline EOpTransp trans_trans(EOpTransp trans1, EOpTransp trans2) {
  if (trans1 == trans2)
    return NOTRANS;
  if (trans1 == NOTRANS)
    return trans2;
 ...
 * \ingroup Thyra_Op_Vec_fundamental_interfaces_code_grp
 */
inline EConj transToConj(EOpTransp trans) {
  switch (trans) {
 ...
 * \ingroup Thyra_Op_Vec_fundamental_interfaces_code_grp
 */
inline EOpTransp applyConjToTrans(EConj conj) {
  switch (conj) {
 ...
 * \ingroup Thyra_Op_Vec_fundamental_interfaces_code_grp
 */
inline EOpTransp applyTransposeConjToTrans(EConj conj) {
  switch (conj) {
...
class OpNotSupported : public std::logic_error {
 public:
  OpNotSupported(const std::string& what_arg)
    : std::logic_error(what_arg) {}
};
