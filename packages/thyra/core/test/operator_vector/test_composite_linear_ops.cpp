...
bool run_composite_linear_ops_tests(
  ...
  if (useSpmd)
    space = Thyra::defaultSpmdVectorSpace<Scalar>(comm, n, -1);
  else
  ...
  RCP<Thyra::LinearOpBase<Scalar> >
      A4 = nonconstScale(
          as<Scalar>(0.25), nonconstAdjoint(
                                nonconstTranspose(
                                    nonconstAdjoint(
                                        nonconstScaleAndAdjoint(
                                            as<Scalar>(4.0), Thyra::TRANS, Teuchos::rcp_const_cast<Thyra::LinearOpBase<Scalar> >(origA))))));
  ...
  RCP<const Thyra::LinearOpBase<Scalar> >
      A5 = scale(
          as<Scalar>(0.25), adjoint(
                                transpose(
                                    adjoint(
                                        scaleAndAdjoint(
                                            as<Scalar>(4.0), Thyra::TRANS, origA)))));
  ...
  RCP<Thyra::LinearOpBase<Scalar> >
      A7 = nonconstMultiply(
          rcp_const_cast<Thyra::LinearOpBase<Scalar> >(adjoint(origA)), rcp_const_cast<Thyra::LinearOpBase<Scalar> >(A1));
  if (nonnull(out)) *out << "\nA7 =\n"
  ...
  A9_a->beginBlockFill(
      rcp_dynamic_cast<const Thyra::BlockedLinearOpBase<Scalar> >(A9, true)->productRange(), rcp_dynamic_cast<const Thyra::BlockedLinearOpBase<Scalar> >(A9, true)->productDomain());
