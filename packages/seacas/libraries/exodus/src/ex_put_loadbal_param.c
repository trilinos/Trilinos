                         ...
                         int64_t num_node_cmaps, int64_t num_elem_cmaps, int processor)
{
  ...
  if (num_int_elems > 0) {
    ...
    if ((status = nc_def_dim(exoid, DIM_NUM_INT_ELEMS, ltempsv, &dimid[0])) != EX_NOERR) {
  ...
  if (num_bor_elems > 0) {
    ...
    if ((status = nc_def_dim(exoid, DIM_NUM_BOR_ELEMS, ltempsv, &dimid[0])) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH, "ERROR: failed to dimension \"%s\" in file id %d",
  ...
  if (num_int_nodes > 0) {
    ...
    if ((status = nc_def_dim(exoid, DIM_NUM_INT_NODES, ltempsv, &dimid[0])) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH, "ERROR: failed to dimension \"%s\" in file id %d",
  ...
  if (num_bor_nodes > 0) {
    ...
    if ((status = nc_def_dim(exoid, DIM_NUM_BOR_NODES, ltempsv, &dimid[1])) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH, "ERROR: failed to dimension \"%s\" in file id %d",
  ...
  if (num_ext_nodes > 0) {
    ...
    if ((status = nc_def_dim(exoid, DIM_NUM_EXT_NODES, ltempsv, &dimid[2])) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH, "ERROR: failed to dimension \"%s\" in file id %d",
  ...
  if (num_node_cmaps > 0) {
    ...
    if ((status = nc_def_dim(exoid, DIM_NUM_N_CMAPS, ltempsv, &dimid[0])) != EX_NOERR) {
  ...
  if (num_elem_cmaps > 0) {
    ...
    if ((status = nc_def_dim(exoid, DIM_NUM_E_CMAPS, ltempsv, &dimid[0])) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH, "ERROR: failed to add dimension \"%s\" in file ID %d",
  ...
  */
  if (num_int_nodes == 0) {
    ...
    nmstat = 0;
    if ((status = nc_put_var_int(exoid, varid_nm[0], &nmstat)) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH,
  ...
  if (num_bor_nodes == 0) {
    ...
    nmstat = 0;
    if ((status = nc_put_var_int(exoid, varid_nm[1], &nmstat)) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH,
  ...
  if (num_ext_nodes == 0) {
    ...
    nmstat = 0;
    if ((status = nc_put_var_int(exoid, varid_nm[2], &nmstat)) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH,
  ...
  if (num_int_elems == 0) {
    ...
    nmstat = 0;
    if ((status = nc_put_var_int(exoid, varid_em[0], &nmstat)) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH,
  ...
  if (num_bor_elems == 0) {
    /* NULL set for internal elements */
    nmstat = 0;
    if ((status = nc_put_var_int(exoid, varid_em[1], &nmstat)) != EX_NOERR) {
      snprintf(errmsg, MAX_ERR_LENGTH,
