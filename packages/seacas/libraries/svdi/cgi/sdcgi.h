...
void cqchh2_ (f_integer *txp, f_integer *nreq, f_integer *first, f_integer *vstat,
	      f_integer *ntotal, f_integer *nlist, f_integer *chhit);
void ctx2_ (f_real *x, f_real *y, f_integer *text1, f_integer *length);
void cgtxx2_ ( f_real *x, f_real *y, f_integer *vstat,
	      f_integer *vconc, f_real *f_xconc, f_real *yconc, 
	      f_real *x1, f_real *y1, f_real *x2, f_real *y2,
	      f_real *x3, f_real *y3, f_real *x4, f_real *y4);
