...
c database read routines
      ...
      integer*8 num_df_in_set, num_sides_in_set, num_qa_rec,num_info
      integer*8 num_df_per_set(10)
      integer*8 num_dim, num_nodes, num_elem, num_elem_blk
      integer*8 num_elem_in_block(10), num_nodes_per_elem(10)
      integer*8 num_elem_per_set(10), num_nodes_per_set(10)
      integer*8 num_node_sets
      integer*8 num_nodes_in_set, num_elem_in_set
      integer*8 prop_value
      integer*8 num_side_sets
      integer*8 num_time_steps
...
C ... All integers passed through the API will be 64-bit integers
      call exsi64(exoid, EX_ALL_INT64_API, ierr)
...
c read global variables parameters and names
      ...
      write (iout, '("There are ",i8," global variables; their names ",
     1  "are :")')  num_glo_vars
