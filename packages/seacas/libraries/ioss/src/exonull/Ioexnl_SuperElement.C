...
Ioexnl::SuperElement::SuperElement(std::string filename, const std::string &my_name)
...
int64_t Ioexnl::SuperElement::internal_get_field_data(const Ioss::Field &field, void *data,
...
Ioexnl::SuperElement::~SuperElement()
{
  if (filePtr != 0) {
    nc_close(filePtr);
  }
...
int64_t Ioexnl::SuperElement::internal_put_field_data(const Ioss::Field & /* field */,
                                                      void * /* data */,
                                                      size_t /* data_size */) const
{
  return -1;
...
Ioss::Property Ioexnl::SuperElement::get_implicit_property(const std::string &the_name) const
{
