...
namespace Ioss {
  ...
  public:
    ...
    IOSS_NODISCARD std::string type_string() const override { return "NodeSet"; }
    IOSS_NODISCARD std::string short_type_string() const override { return "nodelist"; }
    IOSS_NODISCARD std::string contains_string() const override { return "Node"; }
    IOSS_NODISCARD EntityType  type() const override { return NODESET; }
