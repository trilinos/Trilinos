...
public:
  ...
  void InitializeGlobalPoints(int num_points,
                              int dimension,
                              const double* data);
  ...
  void CreateElementBlock(const char* elem_block_name,
                          int elem_block_id,
  ...
  void CreateElementVariable(std::vector<std::string>& component_names,
                             int elem_block_id,
                             vtkVariant& v,
                             const void* data);
  ...
  void CreateNodeSet(const char* node_set_name,
                     int node_set_id,
                     int num_ids,
                     vtkVariant&v,
                     const void* ids);
