...
namespace Ioss {
  ...
  public:
    ...
    IOSS_NODISCARD std::string type_string() const override { return "FaceSet"; }
    IOSS_NODISCARD std::string short_type_string() const override { return "facelist"; }
    IOSS_NODISCARD std::string contains_string() const override { return "Face"; }
    IOSS_NODISCARD EntityType  type() const override { return FACESET; }
