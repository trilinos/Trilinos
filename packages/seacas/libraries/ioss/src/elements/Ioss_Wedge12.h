...
namespace Ioss {
  ...
  public:
    ...
    static void factory();
    Wedge12(const Wedge12 &) = delete;

    IOSS_NODISCARD ElementShape shape() const override { return ElementShape::WEDGE; }
    ...
    IOSS_NODISCARD bool faces_similar() const override { return false; }
    IOSS_NODISCARD bool edges_similar() const override { return false; }
