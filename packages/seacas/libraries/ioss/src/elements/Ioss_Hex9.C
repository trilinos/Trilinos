...
namespace Ioss {
  const char *Hex9::name = "hex9";

  class St_Hex9 : public ElementVariableType
  {
  public:
    static void factory() { static St_Hex9 const registerThis; }

  protected:
    St_Hex9() : ElementVariableType(Ioss::Hex9::name, 9) {}
  };
} // namespace Ioss
...
void Ioss::Hex9::factory()
{
  static Ioss::Hex9 const registerThis;
  Ioss::St_Hex9::factory();
}
...
int Ioss::Hex9::number_nodes_edge(int /* edge */) const { return Constants::nedgenode; }

int Ioss::Hex9::number_nodes_face(int face) const
{
...
int Ioss::Hex9::number_edges_face(int face) const
{
  // face is 1-based.  0 passed in for all faces.
  assert(face >= 0 && face <= number_faces());
...
Ioss::IntVector Ioss::Hex9::face_connectivity(int face_number) const
{
...
Ioss::IntVector Ioss::Hex9::element_connectivity() const
{
...
Ioss::ElementTopology *Ioss::Hex9::face_type(int face_number) const
{
...
Ioss::ElementTopology *Ioss::Hex9::edge_type(int edge_number) const
{
...
Ioss::IntVector Ioss::Hex9::face_edge_connectivity(int face_number) const
{
