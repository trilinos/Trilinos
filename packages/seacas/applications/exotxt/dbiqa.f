...
C=======================================================================
      SUBROUTINE DBIQA (NDB, OPTION, NQAREC, QAREC, NINFO, INFO, IOERR)
C=======================================================================
C$Id: dbiqa.f,v 1.4 2007/10/17 18:46:09 gdsjaar Exp $
C$Log: dbiqa.f,v $
...
C
CRevision 1.3  1996/05/21 16:52:19  caforsy
CAdded read/write for property data.  Cleaned up exodusII error checks
C
CRevision 1.2  1995/11/07 15:01:33  gdsjaar
