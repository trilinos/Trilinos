...
/****************************************************************************/
    ...
    char* ThisElement;
    char Title[73], Key[8], Type[4] = "XXX\0", Rhstype[4];
    char Ptrfmt[17], Indfmt[17], Valfmt[21], Rhsfmt[21];
    char line[BUFSIZ];
...
/****************************************************************************/
    ...
    int Rhsflag;
    char *ThisElement;
    char Title[73], Key[9], Type[4] = "XXX\0", Rhstype[4];
    char Ptrfmt[17], Indfmt[17], Valfmt[21], Rhsfmt[21];
    char line[BUFSIZ];
...
/*           requested vectors                              */
    ...
    linel= strchr(line,'\n')-line;
    if ( sscanf(line,"%*s") < 0 )
       IOHBTerminate("iohb.c: Null (or blank) line in auxiliary vector data region of HB file.\n");
    col = 0;
/*  Skip to initial offset */
