...
/* undefine PACKAGE before reading AztecOO_config.h
 * in order to eliminate multiple definition warnings when
 * AztecOO is used with other Trilinos packages. KL 11/25/2002 */
