#ifndef _PETRA_RDP_MULTIVECTOR_H_
#define _PETRA_RDP_MULTIVECTOR_H_

//! Petra_RDP_MultiVector: A class for constructing and using dense multi-vectors, vectors and matrices in parallel.

/*! The Petra_RDP_MultiVector class enables the construction and use of real-valued, 
    ...
    multi-vectors is determined in part by a Petra_Comm object, a Petra_Map (or Petra_LocalMap
    or Petra_BlockMap) and the number of vectors passed to the constructors described below.

    There are several concepts that important for understanding the Petra_RDP_MultiVector class:
...
<b>Constructing Petra_RDP_MultiVectors</b>

Except for the basic constructor and copy constructor, Petra_RDP_MultiVector constructors
...
All Petra_RDP_MultiVector constructors require a map argument that describes the layout of elements
...
There are six different Petra_RDP_MultiVector constructors:
<ul>
  ...
  <li> Copy or make view of a list of vectors from another Petra_MultiVector object.
  <li> Copy or make view of a range of vectors from another Petra_MultiVector object.
</ul>

<b>Extracting Data from Petra_RDP_MultiVectors</b>

Once a Petra_RDP_MultiVector is constructed, it is possible to extract a copy of the values or create
a view of them.
...
<ul>
  ...
  <li> ExtractView - Set user-provided two-dimensional array parameters 
       to point to Petra_RDP_MultiVector data.
...
Once a Petra_RDP_MultiVector is constructed, a variety of mathematical functions can be applied to
...
Each Petra_RDP_MultiVector object keep track of the number
...
\warning A Petra_Map, Petra_LocalMap or Petra_BlockMap object is required for all 
  Petra_RDP_MultiVector constructors.
...
//==========================================================================
class Petra_RDP_MultiVector
{

  // Give ostream << function some access to private and protected data/functions.

  friend ostream& operator << (ostream& os, const Petra_RDP_MultiVector& A);
  public:

  //! Basic Petra_RDP_MultiVector constuctor.
  /*! Creates a Petra_RDP_MultiVector object and fills with zero values.  
    ...
    \return Pointer to a Petra_RDP_MultiVector.
  ...
  */
  Petra_RDP_MultiVector(Petra_DataAccess CV, const Petra_BlockMap& Map, 
  ...
  */
  ...
  /*!
    ...
    \return Integer error code, set to 0 if successful.
	   ...
	   See Detailed Description section for further discussion.
  */
  Petra_RDP_MultiVector(Petra_DataAccess CV,  
  ...
  */
  ...
  //! Imports a set of values from the input multivector using the Petra_Import object.
  /*!
    \param In
           A - Multi-vector from which values are imported into the "\e this" multivector.
    \param In
    ...
    \return Integer error code, set to 0 if successful.
  */
  int Import(const Petra_RDP_MultiVector& A, const Petra_Import & Importer, Petra_CombineMode CombineMode);

  //! Imports a set of values from the input multivector using the Petra_Export object.
  /*!
    \param In
           A - Multi-vector from which values are imported into the "\e this" multivector.
    \param In
    ...
    \return Integer error code, set to 0 if successful.
  */
  int Import(const Petra_RDP_MultiVector& A, const Petra_Export & Exporter, Petra_CombineMode CombineMode);

  //! Exports a set of values from the input multivector using the Petra_Import object.
  /*!
    \param In
           A - Multi-vector from which values are imported into the "\e this" multivector.
    \param In
    ...
    \return Integer error code, set to 0 if successful.
  */
  int Export(const Petra_RDP_MultiVector& A, const Petra_Import & Importer, Petra_CombineMode CombineMode);

  //! Exports a set of values from the input multivector using the Petra_Export object.
  /*!
    \param In
           A - Multi-vector from which values are imported into the "\e this" multivector.
    \param In
    ...
    \return Integer error code, set to 0 if successful.
  */
  int Export(const Petra_RDP_MultiVector& A, const Petra_Export & Exporter, Petra_CombineMode CombineMode);
  ...
  /*!
    ...
    \return Integer error code, set to 0 if successful.
  */
  int Dot(const Petra_RDP_MultiVector& A, double *Result) const;
  ...
  */
  int Abs(const Petra_RDP_MultiVector& A);
  ...
  */
  int Reciprocal(const Petra_RDP_MultiVector& A);
  ...
  */
  ...
  /*!
    ...
    \return Integer error code, set to 0 if successful.
  */
  int Scale(double ScalarA, const Petra_RDP_MultiVector& A);
  ...
  /*!
    ...
    \return Integer error code, set to 0 if successful.
  */
  int Update(double ScalarA, const Petra_RDP_MultiVector& A, double Scalar);
  ...
  /*!
    ...
    \return Integer error code, set to 0 if successful.
  */
  int Update(double ScalarA, const Petra_RDP_MultiVector& A, 
  ...
  */
  ...
  /*!
    ...
    \return Integer error code, set to 0 if successful.
  */
  int NormWeighted   (const Petra_RDP_MultiVector& Weights, double * Result) const;
...
\warning {Each multi-vector A, B and \e this is checked if it has constant stride using the
  ...
  */
  int Multiply(char TransA, char TransB, double ScalarAB, 
		       const Petra_RDP_MultiVector& A, const Petra_RDP_MultiVector& B,
		       double Scalar );
  ...
  /*! This function supports diagonal matrix multiply.  A is usually a single vector
      ...
      multiplication.
  */
  int Multiply(double ScalarAB, const Petra_RDP_MultiVector& A, const Petra_RDP_MultiVector& B,
		       double Scalar );
  ...
  /*! This function supports diagonal matrix scaling.  A is usually a single vector
      ...
      division.
  */
  int ReciprocalMultiply(double ScalarAB, const Petra_RDP_MultiVector& A, const Petra_RDP_MultiVector& B,
		       double Scalar );
  ...
  */
  ...
  /*!
    \param In
           A - Petra_RDP_MultiVector to copy.

    \return Petra_RDP_MultiVector.
  */
  Petra_RDP_MultiVector& operator = (const Petra_RDP_MultiVector& Source);
  ...
  */
  ...
  //! Returns the address of the Petra_BlockMap for this multi-vector.
  const Petra_BlockMap & Map() const {return(*Map_);};
 ...
 protected:
  ...
  //! Get pointer to RDP_MultiVector values
  ...
  // Internal utilities
  void Assign(const Petra_RDP_MultiVector& rhs);
  int CheckInput();

  int IndexBase_;
  double *Values_;    // local MultiVector coefficients
  double **Pointers_;        // Pointers to each vector;
  const Petra_BlockMap* Map_;
  mutable double Flops_;
  
  friend class Petra_RDP_DCRS_Matrix;
  friend class Petra_RDP_CRS_Matrix;
  friend class Petra_RDP_CRS_Level_Matrix;
  friend class Petra_RDP_VBR_Matrix;
  friend class Trilinos_LinearProblem;
  friend class Petra_RDP_SPD_DenseMatrix;
 private:
  ...
  int DoTransfer(const Petra_RDP_MultiVector& A, Petra_CombineMode CombineMode,
		 ...
		 int Nsend, int Nrecv,
		 int & LenExports, double * & Exports,
		 int & LenImports, double * & Imports,
#ifdef PETRA_MPI
		 GSComm_Plan & Plan, 
#endif
           bool DoReverse);
  
  int CopyAndPermute(double ** To, double ** From, int NumVectors, 
  ...
  int Pack(double ** From, int NumVectors, 
			 int MaxElementSize, bool ConstantElementSize, 
			 int * FromElementSizeList, 
			 int * FromFirstElementEntryList,
			 int NumSendIDs, int * SendLIDs, double * Sends);

  int UnpackAndCombine(double ** To, int NumVectors, 
		   int MaxElementSize, bool ConstantElementSize, 
...
#endif /* _PETRA_RDP_MULTIVECTOR_H_ */
