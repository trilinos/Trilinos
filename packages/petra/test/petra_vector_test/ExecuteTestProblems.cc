...
#include "BuildTestProblems.h"
  ...
  {
    Petra_RDP_Vector& A          = *new Petra_RDP_Vector(LocalMap);
    Petra_RDP_Vector& B          = *new Petra_RDP_Vector(LocalMap);
    Petra_LocalMap & Map2d = *new Petra_LocalMap(NumVectors, IndexBase, Comm);
    Petra_RDP_Vector& C          = *new Petra_RDP_Vector(Map2d);
    Petra_RDP_Vector& C_GEMM     = *new Petra_RDP_Vector(Map2d);

    double *App, *Bpp, *Cpp;
    
    Petra_RDP_Vector *Ap, *Bp, *Cp;
    ...
    Petra_RDP_Vector& A1 = *new Petra_RDP_Vector(View, LocalMap, App);
    Petra_RDP_Vector& B1 = *new Petra_RDP_Vector(View, LocalMap, Bpp);
    Petra_RDP_Vector& C1 = *new Petra_RDP_Vector(View, Map2d, Cpp);
    ...
    // Construct Vectors
  {
    Petra_RDP_Vector& A          = *new Petra_RDP_Vector(Map);
    Petra_RDP_Vector& B          = *new Petra_RDP_Vector(Map);
    Petra_LocalMap & Map2d = *new Petra_LocalMap(NumVectors, IndexBase, Comm);
    Petra_RDP_Vector& C          = *new Petra_RDP_Vector(Map2d);
    Petra_RDP_Vector& C_GEMM     = *new Petra_RDP_Vector(Map2d);
    ...
    // Construct Vectors
  {
    Petra_RDP_Vector& A          = *new Petra_RDP_Vector(Map);
    Petra_LocalMap & Map2d = *new Petra_LocalMap(NumVectors, IndexBase, Comm);
    Petra_RDP_Vector& B          = *new Petra_RDP_Vector(Map2d);
    Petra_RDP_Vector& C          = *new Petra_RDP_Vector(Map);
    Petra_RDP_Vector& C_GEMM     = *new Petra_RDP_Vector(Map);
...
int RDP_VectorTests(const Petra_BlockMap & Map, bool verbose)
{
  ...
  Petra_RDP_Vector& A             = *new Petra_RDP_Vector(Map);
  Petra_RDP_Vector& sqrtA         = *new Petra_RDP_Vector(Map);
  Petra_RDP_Vector& B             = *new Petra_RDP_Vector(Map);
  Petra_RDP_Vector& C             = *new Petra_RDP_Vector(Map);
  Petra_RDP_Vector& C_alphaA      = *new Petra_RDP_Vector(Map);
  Petra_RDP_Vector& C_alphaAplusB = *new Petra_RDP_Vector(Map);
  Petra_RDP_Vector& C_plusB       = *new Petra_RDP_Vector(Map);
  Petra_RDP_Vector& Weights       = *new Petra_RDP_Vector(Map);
  ...
  // Test alpha*A
  Petra_RDP_Vector& alphaA = *new Petra_RDP_Vector(A); // Copy of A
  ...
  // Test alpha*A + B
  Petra_RDP_Vector& alphaAplusB = *new Petra_RDP_Vector(A); // Copy of A
  ...
  // Test + B
  Petra_RDP_Vector& plusB = *new Petra_RDP_Vector(C); // Copy of C
