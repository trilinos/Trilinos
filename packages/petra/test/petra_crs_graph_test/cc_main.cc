...
int check(Petra_CRS_Graph& A, int NumMyRows1, int NumGlobalRows1, int NumMyNonzeros1,
 ...
 int main(int argc, char *argv[])
{
  ...
  // Create a Petra_CRS_Graph

  Petra_CRS_Graph& A = *new Petra_CRS_Graph(Copy, Map, NumNz);
  ...
  Petra_CRS_Graph & AA = *new Petra_CRS_Graph(Copy, Map, 5);
  ...
  Petra_CRS_Graph & B = *new Petra_CRS_Graph(AA);
  delete &AA;
  ...
  if (verbose1) {
    ...
    Petra_Map& Map1 = *new Petra_Map(NumGlobalEquations1, NumMyElements1, 1, Comm);
    ...
    // Create a Petra_Graph using 1-based arithmetic
    
    Petra_CRS_Graph& A1 = *new Petra_CRS_Graph(Copy, Map1, NumNz1);
