  ...
  public PHX::EvaluatorDerived<EvalT, Traits>
{
  public:
    ...
    /// \brief Averages this workset's vector-field component values over each cell's integration points and writes the (optionally scaled) result to the STK mesh.
    void
    evaluateFields(
