...
//  Main Driver for a transient sensitivity analysis simulation
...
int main(int argc, char *argv[])
{
  ...
  try {
     const auto stackedTimer = Teuchos::rcp(new Teuchos::StackedTimer("Panzer Main Driver Sensitivity Analysis"));
