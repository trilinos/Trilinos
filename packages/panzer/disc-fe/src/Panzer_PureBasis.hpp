...
namespace panzer {
  ...
  public:
    ...
    */
    ...
    getIntrepid2Basis() const
    { return panzer::createIntrepid2Basis<DeviceType,OutputValueType,PointValueType>(type(), order(), *(getCellTopology())); }
  ...
  private:
    ...
    Teuchos::RCP< Intrepid2::Basis<PHX::Device::device_type,double,double> > intrepid_basis_;
