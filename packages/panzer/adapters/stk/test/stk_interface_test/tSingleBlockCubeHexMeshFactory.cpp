...
/*
TEUCHOS_UNIT_TEST(tSingleBlockCubeHexMeshFactory, test_four)
{
...
TEUCHOS_UNIT_TEST(tSingleBlockCubeHexMeshFactory, element_counts)
{
   int colors[] = 
      { 1,
        2,2,
...
void test1(Teuchos::FancyOStream &out, bool &success, MPI_Comm & comm)
{
   ...
   SingleBlockCubeHexMeshFactory factory; 
...
void test4(Teuchos::FancyOStream &out, bool &success,MPI_Comm & comm)
{
   ...
   if(mesh->isWritable());
      mesh->writeToExodus("Cube_Weird.exo");
