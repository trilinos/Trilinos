...
TEUCHOS_UNIT_TEST(tEpetraScatter, constructor)
{
   ...
   {
      panzer::ScatterResidual_Epetra<Residual,panzer::Traits> scatterResidual(scatterParams);
   ...
   {
      panzer::ScatterResidual_Epetra<Jacobian,panzer::Traits> scatterJacobian(scatterParams);
