...
int main_(Teuchos::CommandLineProcessor &clp, int argc,char * argv[])
{
...

  {
    ...
    std::string xml = "";
    solverType solverValues[7] = {AUGMENTATION, MUELU, ML, CG, GMRES, MAXWELL1, MAXWELL1_EMIN};
    const char * solverNames[7] = {"Augmentation", "MueLu", "ML", "CG", "GMRES", "Maxwell1", "Maxwell1-Emin"};
