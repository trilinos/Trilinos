...
namespace mini_em {
  ...
  /** \brief An auxiliary equation set (not part of the physical
    ...
    * complement operator for the Maxwell E-field block and scatters
    * it to the global evaluation data container under the key
    * "AUX_<dof_name>_SchurComplement", for use by
  ...
  public:
    ...
    /// \brief Construct from the global evaluation data container to scatter the Schur complement operator into, and a ParameterList specifying the basis/integration order, permittivity, conductivity, and inverse permeability closure model names.
