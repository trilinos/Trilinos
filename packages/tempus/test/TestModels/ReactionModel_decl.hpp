...
#ifndef TEMPUS_TEST_REACTION_MODEL_DECL_HPP
#define TEMPUS_TEST_REACTION_MODEL_DECL_HPP
...
Scalar Lmat_[3][3];
  ...
  Scalar x2_ic_;  ///< Initial condition for x1
};

/// Non-member constructor
// Teuchos::RCP<ReactionModel> sineCosineModel(
//   Teuchos::RCP<Teuchos::ParameterList> pList_)
//{
//   Teuchos::RCP<ReactionModel> model = rcp(new ReactionModel(pList_));
//   return(model);
// }

}  // namespace Tempus_Test
#endif  // TEMPUS_TEST_REACTION_MODEL_DECL_HPP
