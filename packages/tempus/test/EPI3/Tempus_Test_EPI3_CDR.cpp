...
// ************************************************************
// ************************************************************
TEUCHOS_UNIT_TEST(EPI3, ConstructingFromDefaults)
{
  double dt = 0.1;
  ...
  for (const auto& option : options) {
    ...
    auto stepper = rcp(new Tempus::StepperEPI3<double>());
...
// for (int i = 0; i < n_n_n; ++i) {
//   std::cout << "v[" << i << "] = "
//             << Thyra::get_ele(*vec, i) << std::endl;
// }
  ...
  // xDot not yet available for EPI3.
