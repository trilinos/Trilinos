...
TEUCHOS_UNIT_TEST(NewmarkImplicitAForm, HarmonicOscillatorDamped_SecondOrder)
{
  ...
  RCP<ParameterList> pList =
    getParametersFromXmlFile("Tempus_Test_NewmarkImplicitAForm_HarmonicOscillator_Damped_SecondOrder.xml");
  ...
  for (int n=0; n<nTimeStepSizes; n++) {
    ...
    if (n == 0) {
      ...
      writeSolution("Tempus_Test_NewmarkImplicitAForm_HarmonicOscillator_Damped_SecondOrder.dat", solutionHistory);
      ...
      writeSolution("Tempus_Test_NewmarkImplicitAForm_HarmonicOscillator_Damped_SecondOrder-Ref.dat", solnHistExact);
    }
