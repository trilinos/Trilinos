...
TEUCHOS_UNIT_TEST(NewmarkExplicitAForm, HarmonicOscillatorDamped)
{
  ...
  RCP<ParameterList> pList = getParametersFromXmlFile(
      "Tempus_Test_NewmarkExplicitAForm_HarmonicOscillator_Damped.xml");
  ...
  for (int n = 0; n < nTimeStepSizes; n++) {
    ...
    if (n == 0) {
      ...
      writeSolution(
          "Tempus_Test_NewmarkExplicitAForm_HarmonicOscillator_Damped.dat",
          solutionHistory);
      ...
      writeSolution(
          "Tempus_Test_NewmarkExplicitAForm_HarmonicOscillator_Damped-Ref.dat",
          solnHistExact);
    }
  ...
  writeOrderError(
      "Tempus_Test_NewmarkExplicitAForm_HarmonicOscillator_Damped-Error.dat",
