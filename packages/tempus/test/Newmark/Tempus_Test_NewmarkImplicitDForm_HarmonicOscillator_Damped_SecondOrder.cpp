...
TEUCHOS_UNIT_TEST(NewmarkImplicitDForm, HarmonicOscillatorDamped_SecondOrder)
{
  ...
  RCP<ParameterList> pList = getParametersFromXmlFile(
      "Tempus_Test_NewmarkImplicitDForm_HarmonicOscillator_Damped_SecondOrder."
      "xml");
  ...
  for (int n = 0; n < nTimeStepSizes; n++) {
    ...
    if (n == 0) {
      ...
      writeSolution(
          "Tempus_Test_NewmarkImplicitDForm_HarmonicOscillator_Damped_"
          "SecondOrder.dat",
          solutionHistory);
  ...
  writeOrderError(
      "Tempus_Test_NewmarkImplicitDForm_HarmonicOscillator_Damped_SecondOrder_"
      "SinCos-Error.dat",
      stepper, StepSize, solutions, xErrorNorm, xSlope, solutionsDot,
