...
// ************************************************************
// ************************************************************
TEUCHOS_UNIT_TEST(SDIRK_5Stage4thOrder, Default_Construction)
{
  testDIRKAccessorsFullConstruction("SDIRK 5 Stage 4th order");
}
...
{
  testRKAppAction("SDIRK 5 Stage 4th order", out, success);
}
