...
public:
  ...
  */
  ...
  //@{
    ...
    virtual Teuchos::RCP<StepperEPI3AppAction<Scalar> > getAppAction() const
...
private:
  ...
  Teuchos::RCP<StepperEPI3AppAction<Scalar> > stepperEEAppAction_;
