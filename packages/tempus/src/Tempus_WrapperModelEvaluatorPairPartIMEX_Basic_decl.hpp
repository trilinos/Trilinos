...
class WrapperModelEvaluatorPairPartIMEX_Basic
 ...
 public:
  /// Default constructor -- Still requires setting the models and running
  /// initialize.
  ...
  /// Set parameter to switch wrapperME base functions between explicit and
  /// implicit functions.
  virtual void setUseImplicitModel(bool tf) { useImplicitModel_ = tf; }
  /// Get parameter to switch wrapperME base functions between explicit and
  /// implicit functions.
