 ...
 * Discretizations. World Scientific Press, London (2011)
 *
 *  See StepperExplicitRK for additional details.
 */
template <class Scalar>
 ...
 *                         (1/6)(3+\sqrt{3}) & 1/\sqrt{3}     & 1/(3+\sqrt{3})
 * \\   \hline & 1/2            & 1/2 \end{array} \f] Reference:  Gottlieb, S.,
 * Ketcheson, D.I., Shu, C.-W. Strong Stability Preserving Runge–Kutta and
 * Multistep Time Discretizations. World Scientific Press, London (2011)
 *
 *  See StepperDIRK for additional details.
 */
template <class Scalar>
 ...
 *    (6+9\sqrt{6})/35  & (-6+5\sqrt{6})/14            & (6-\sqrt{6})/10 & 0 & 0
 * & 0                \\
 *         1            & (888+607\sqrt{6})/2850       & (126-161\sqrt{6})/1425
 * & (6-\sqrt{6})/10         & 0                     & 0                \\
 *    (4-\sqrt{6})/10   & (3153-3082\sqrt{6})/14250    &
 * (3213+1148\sqrt{6})/28500   & (-267+88\sqrt{6})/500   & (6-\sqrt{6})/10 & 0
 * \\ (4+\sqrt{6})/10   & (-32583+14638\sqrt{6})/71250 &
 * (-17199+364\sqrt{6})/142500 & (1329-544\sqrt{6})/2500 & (-96+131\sqrt{6})/625
 * & (6-\sqrt{6})/10  \\ \hline &       0                      &       0 & 1/9
 * & (16-\sqrt{6})/36      & (16+\sqrt{6})/36 \end{array} \f]
 *
 *  Reference: Solving Ordinary Differential Equations II:
 *             Stiff and Differential-Algebraic Problems,
