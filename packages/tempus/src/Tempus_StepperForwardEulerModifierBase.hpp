 ...
 *    \State {\it modifier.execute(solutionHistory, stepper, BEGIN\_STEP)}                    
 *    \State Form $f(x_{n},t_{n})$                                                             
 *    \State {\it modifier.execute(solutionHistory, stepper, BEFORE\_EXPLICIT\_EVAL)}         
 *    \State Form $y \leftarrow x_{n} + \Delta t_n f(x_{n},t_n)$                               
 *    \State {\it modifier.execute(solutionHistory, stepper, AFTER\_EXPLICIT\_EVAL)}          
