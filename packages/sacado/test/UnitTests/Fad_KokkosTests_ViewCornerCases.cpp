...
TEUCHOS_UNIT_TEST(Kokkos_View_CornerCases, ViewOfUnmanagedView)
{
  ...
  using inner_t = Kokkos::View<fad_t*, Kokkos::MemoryTraits<Kokkos::Unmanaged>>;
  using outer_t = Kokkos::View<inner_t*>;

  Kokkos::View<fad_t*> data("data", 9, 4);
