...
#ifndef ELRDFADUNITTESTS_HPP
#define ELRDFADUNITTESTS_HPP
...
class ELRDFadOpsUnitTest : public CppUnit::TestFixture {

  CPPUNIT_TEST_SUITE( ELRDFadOpsUnitTest );
...
public:
  ...
  ELRDFadOpsUnitTest(int numComponents, double absolute_tolerance, 
