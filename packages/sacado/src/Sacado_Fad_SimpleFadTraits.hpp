...
namespace Sacado {
  ...
  struct ValueType< Fad::SimpleFad<ValueT,ScalarT> > {
   ...
   //! Specialization of %ScalarValueType to SimpleFad types
  template <typename ValueT, typename ScalarT>
  struct ScalarValueType< Fad::SimpleFad<ValueT,ScalarT> > {
...
namespace Teuchos {
  ...
  struct ScalarTraits< Sacado::Fad::SimpleFad<ValueT,ScalarT> > {
    typedef Sacado::Fad::SimpleFad<ValueT,ScalarT> FadType;

    typedef Sacado::Fad::SimpleFad<typename ScalarTraits<ValueT>::magnitudeType,
			      typename ScalarTraits<ScalarT>::magnitudeType> magnitudeType;
    typedef Sacado::Fad::SimpleFad<typename ScalarTraits<ValueT>::halfPrecision,
			      typename ScalarTraits<ScalarT>::halfPrecision> 
    halfPrecision;
    typedef Sacado::Fad::SimpleFad<typename ScalarTraits<ValueT>::doublePrecision,
