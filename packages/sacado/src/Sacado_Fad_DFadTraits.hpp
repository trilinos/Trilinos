...
namespace Sacado {
  ...
  template <typename T>
  class ADTraits< Fad::DFad<T>, Fad::DFad<T> > {
  public:

    typedef Fad::DFad<T> promote;
  };

  //! Specialization of ADTraits to DFad types
  template <typename L, typename R>
  class ADTraits< Fad::DFad<L>, R > {
  public:

    typedef typename Fad::DFad<L>::value_type value_type_l;
    typedef typename Promote<R>::value_type value_type_r;
    typedef typename ADTraits<value_type_l,value_type_r>::promote value_type;

    typedef Fad::DFad<value_type> promote;
  };

  //! Specialization of ADTraits to DFad types
  template <typename L, typename R>
  class ADTraits< L, Fad::DFad<R> > {
  public:

    typedef typename Promote<L>::value_type value_type_l;
    typedef typename Fad::DFad<R>::value_type value_type_r;
    typedef typename ADTraits<value_type_l,value_type_r>::promote value_type;
