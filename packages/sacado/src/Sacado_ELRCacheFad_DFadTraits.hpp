...
namespace Sacado {
  ...
  struct Promote< ELRCacheFad::DFad<ValueT>, ELRCacheFad::DFad<ValueT> > {
    typedef ELRCacheFad::DFad<ValueT> type;
  };

  //! Specialization of %Promote to DFad types
  template <typename ValueT, typename R>
  struct Promote< ELRCacheFad::DFad<ValueT>, R > {
    typedef typename ValueType< ELRCacheFad::DFad<ValueT> >::type value_type_l;
    typedef typename ValueType<R>::type value_type_r;
    typedef typename Promote<value_type_l,value_type_r>::type value_type;

    typedef ELRCacheFad::DFad<value_type> type;
  };
  ...
  public:
    ...
    typedef typename ValueType< ELRCacheFad::DFad<ValueT> >::type value_type_r;
    typedef typename Promote<value_type_l,value_type_r>::type value_type;
