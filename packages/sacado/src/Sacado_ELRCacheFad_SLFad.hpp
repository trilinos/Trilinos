...
struct AnalyzeShape< Sacado::ELRCacheFad::SLFad< ValueType, N > >
  : Shape< sizeof(Sacado::ELRCacheFad::SLFad< ValueType, N >) , 0 > // Treat as a scalar
{
public:

  typedef ViewSpecializeSacadoFad specialize ;

  typedef Shape< sizeof(Sacado::ELRCacheFad::SLFad< ValueType, N >) , 0 > shape ;

  typedef       Sacado::ELRCacheFad::SLFad< ValueType, N >        array_intrinsic_type ;
  typedef const Sacado::ELRCacheFad::SLFad< ValueType, N >  const_array_intrinsic_type ;
...
struct AnalyzeSacadoShape< Sacado::ELRCacheFad::SLFad< ValueType, N >, Layout >
