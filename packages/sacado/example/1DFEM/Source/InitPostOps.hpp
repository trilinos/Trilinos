...
#ifndef INITPOSTOPS_HPP
#define INITPOSTOPS_HPP
...
class ResidualOp : public AbstractInitPostOp<double> {
public:
...
class JacobianOp : public AbstractInitPostOp< Sacado::Fad::DFad<double> > {
public:
