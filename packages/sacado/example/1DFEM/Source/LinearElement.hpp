...
#ifndef LINEARELEMENT_HPP
#define LINEARELEMENT_HPP
 ...
 */
class LinearElement : public AbstractElement {
public:
  ...
  //1 Evaluate Jacobian of element transformation at a set of points in (-1,1)
  virtual void 
