...
ConstantDirichletBC::ConstantDirichletBC(unsigned int dof_GID, double value) :
  dof(dof_GID),
  val(value)
{
}

ConstantDirichletBC::~ConstantDirichletBC()
{
}

void
ConstantDirichletBC::applyResidual(const Epetra_Vector& x, 
...
void
ConstantDirichletBC::applyJacobian(const Epetra_Vector& x, Epetra_Vector& f,
