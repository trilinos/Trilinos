...
#ifndef _FROSCH_GEOMETRICTWOLEVELPRECONDITIONER_DECL_HPP
#define _FROSCH_GEOMETRICTWOLEVELPRECONDITIONER_DECL_HPP
...
namespace FROSch {
     ...
     *
     * The GeometricTwoLevelPreconditioner is a variance of the TwoLevelPrecondtioner that 
    ...
    class GeometricTwoLevelPreconditioner : public GeometricOneLevelPreconditioner<SC,LO,GO,NO> {
    ...
    protected:
        ...
        using GraphPtr                          = typename GeometricOneLevelPreconditioner<SC,LO,GO,NO>::GraphPtr;
        ...
        using GeometricOverlappingOperatorPtr   = typename GeometricOneLevelPreconditioner<SC,LO,GO,NO>::GeometricOverlappingOperatorPtr;
    ...
    public:
        ...
        /**
         * @brief Constructor for the GeometricTwoLevelPreconditioner class.
         *
         ...
         */
        GeometricTwoLevelPreconditioner(
            ConstXMatrixPtr  k,
            GraphPtr         dualGraph,
         ...
         */
        virtual int 
        initialize(bool useDefaultParameters = true) override;

        /**
         * @brief Initializes the GeometricTwoLevelPreconditioner.
         *
         * @param repeatedMap A map of the dofs that live on the interface between two ranks and 
         * there by belong to mutiple ranks.
         * @return Error code. 0 if successful.
         */
        int 
        initialize(ConstXMapPtr         repeatedMap);

        /**
         * @brief Initializes the GeometricTwoLevelPreconditioner.
         */
        int 
        initialize(UN                   dimension,
                   UN                   dofsPerNode,
                   XMapPtr              repeatedMap,
        ...
        /**
         * @brief Prints the description of the GeometricTwoLevelPreconditioner to a stream.
         *
         * This function prints a detailed description of the GeometricTwoLevelPreconditioner 
        ...
        virtual int 
        resetMatrix(ConstXMatrixPtr &k) override;
...
#endif // _FROSCH_GEOMETRICTWOLEVELPRECONDITIONER_DECL_HPP
