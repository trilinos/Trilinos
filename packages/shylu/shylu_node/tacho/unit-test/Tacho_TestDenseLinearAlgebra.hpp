  ...
  struct Functor_TeamGemm {
    ...
    void operator()(const MemberType &member) const {
      ::BlasTeam<value_type>::gemm(member,
                                  ...
                                  (const value_type*)_B.d_view.data(), (int)_B.d_view.stride_1(),
                                  _beta,
                                  (      value_type*)_C.d_view.data(), (int)_C.d_view.stride_1());
    }
  ...
  struct Functor_TeamGemv {
    ...
    void operator()(const MemberType &member) const {
      ::BlasTeam<value_type>::gemv(member,
                                  ...
                                  _alpha, 
                                  (const value_type*)_A.d_view.data(), (int)_A.d_view.stride_1(),
                                  (const value_type*)_x.d_view.data(), (int)_x.d_view.stride_0(),
                                  _beta,
                                  (      value_type*)_y.d_view.data(), (int)_y.d_view.stride_0());
    }
...
TEST( DenseLinearAlgebra, team_herk_un ) {
  ...
  Blas<value_type>::herk(uplo, trans,
                        n, k,
                        alpha, 
                        A2.h_view.data(), A2.h_view.stride_1(),
                        beta,
  ...
  struct Functor_TeamTrsv {
    ...
    void operator()(const MemberType &member) const {
      ::BlasTeam<value_type>::trsv(member,
                                  ...
                                  _m,
                                  (const value_type*)_A.d_view.data(), (int)_A.d_view.stride_1(),
                                  (      value_type*)_b.d_view.data(), (int)_b.d_view.stride_0());
    }
...
#define TEAM_TRSV_TEST_BODY {                                           \
    ...
    test.run();                                                         \
                                                                        \
    Blas<value_type>::trsv(uplo, trans, diag,                            \
                          m,                                            \
                          A2.h_view.data(), A2.h_view.stride_1(),       \
...
#define TEAM_TRSM_TEST_BODY {                                           \
    ...
    test.run();                                                         \
                                                                        \
    Blas<value_type>::trsm(side, uplo, trans, diag,                      \
                          m, n,                                         \
                          alpha,                                        \
                          A2.h_view.data(), A2.h_view.stride_1(),       \
                          B2.h_view.data(), B2.h_view.stride_1());      \
  ...
  struct Functor_TeamChol {
    ...
    void operator()(const MemberType &member) const {
      ...
      ::LapackTeam<value_type>::potrf(member,
                                     _uplo,
                                     _m,
                                     (value_type*)_A.d_view.data(), (int)_A.d_view.stride_1(),
                                     &r_val);
    }
...
TEST( DenseLinearAlgebra, team_chol_u ) {
  ...
  int r_val = 0;
  Lapack<value_type>::potrf(uplo,
                           m, 
                           (value_type*)A2.h_view.data(), (int)A2.h_view.stride_1(),
                           &r_val);
