...
// @HEADER
// clang-format on
#ifndef __TACHO_HERK_SERIAL_HPP__
#define __TACHO_HERK_SERIAL_HPP__

/// \file  Tacho_Herk_Serial.hpp
...
template <typename ArgUplo, typename ArgTrans> struct Herk<ArgUplo, ArgTrans, Algo::Serial> {
