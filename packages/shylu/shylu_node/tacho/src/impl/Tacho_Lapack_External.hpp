...
#if defined (TACHO_ENABLE_HIPSOLVER)
    static
    int potrf_buffersize(hipsolverHandle_t handle,
                         const hipblasFillMode_t uplo,
                         const int m,
                         T *a, const int lda,
                         int *lwork);
    static
    int potrf(hipsolverHandle_t handle,
              const hipblasFillMode_t uplo,
              const int m,
              T *a, const int lda,
              T *W, const int lwork,
...
#if defined (TACHO_ENABLE_HIPSOLVER)
    static
    int sytrf_buffersize(hipsolverHandle_t handle,
                         const int m,
                         T *a, const int lda,
                         int *lwork);
    static
    int sytrf(hipsolverHandle_t handle,
              const hipblasFillMode_t uplo,
              const int m,
              T *a, const int lda,
              int *ipiv,
...
#if defined (TACHO_ENABLE_HIPSOLVER)
    static
    int getrf_buffersize(hipsolverHandle_t handle,
                         const int m, const int n,
                         T *a, const int lda,
                         int *lwork);
    static
    int getrf(hipsolverHandle_t handle,
              const int m, const int n,
              T *a, const int lda,
              T *w,
              int *ipiv,
