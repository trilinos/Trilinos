...
namespace Tacho {
  ...
  Blas<float>::gemv(cublasHandle_t handle,
                    ...
                    const float beta,
                    /* */ float *c, int ldc) {
    const int r_val = cublasSgemv(handle, 
                                  trans,
                                  m, n,
                                  &alpha, 
                                  a, lda,
  ...
  Blas<float>::gemv(hipblasHandle_t handle,
                    ...
                    const float beta,
                    /* */ float *c, int ldc) {
    const int r_val = hipblasSgemv(handle, 
                                   trans,
                                   m, n,
                                   &alpha, 
                                   a, lda,
  ...
  Blas<float>::trsv(cublasHandle_t handle, 
                    ...
                    const float *a, int lda,
                    /* */ float *b, int ldb) {
    const int r_val = cublasStrsv(handle, 
                                  uplo, transa, diag,
                                  m, 
                                  a, lda,
                                  b, ldb);
  ...
  Blas<float>::trsv(hipblasHandle_t handle, 
                    ...
                    const hipblasOperation_t transa, 
                    const hipblasDiagType_t diag,
                    int m, 
                    const float *a, int lda,
                    /* */ float *b, int ldb) {
    const int r_val = hipblasStrsv(handle, 
                                   uplo, transa, diag,
                                   m, 
                                   a, lda,
                                   b, ldb);
  ...
  Blas<float>::gemm(hipblasHandle_t handle, 
                    const hipblasOperation_t transa, 
                    const hipblasOperation_t transb,
                    int m, int n, int k,
                    const float alpha,
                    const float *a, int lda,
                    const float *b, int ldb,
                    const float beta,
                    /* */ float *c, int ldc) {
    const int r_val = hipblasSgemm(handle,
                                   transa, transb,
                                   m, n, k, 
                                   &alpha,
                                   a, lda,
  ...
  Blas<float>::herk(cublasHandle_t handle,
                    ...
                    const float beta,
                    /* */ float *c, int ldc) {
    const int r_val = cublasSsyrk(handle,
                                  uplo, trans,
                                  n, k,
                                  &alpha,
                                  a, lda,
  ...
  Blas<float>::herk(hipblasHandle_t handle,
                    ...
                    const float beta,
                    /* */ float *c, int ldc) {
    const int r_val = hipblasSsyrk(handle,
                                   uplo, trans,
                                   n, k,
                                   &alpha,
                                   a, lda,
  ...
  Blas<float>::trsm(cublasHandle_t handle,
                    ...
                    const float *a, int lda,
                    /* */ float *b, int ldb) {
    const int r_val = cublasStrsm(handle, 
  ...
  Blas<float>::trsm(hipblasHandle_t handle,
                    ...
                    const hipblasOperation_t transa, const hipblasDiagType_t diag,
                    int m, int n, 
                    const float alpha, 
                    const float *a, int lda,
                    /* */ float *b, int ldb) {
    const int r_val = hipblasStrsm(handle, 
                                   side, uplo, transa, diag,
                                   m, n, 
                                   &alpha,
                                   a, lda,
  ...
  Blas<double>::gemv(cublasHandle_t handle,
                     ...
                     const double beta,
                     /* */ double *c, int ldc) {
    const int r_val = cublasDgemv(handle, 
                                  trans,
                                  m, n,
                                  &alpha, 
                                  a, lda,
  ...
  Blas<double>::gemv(hipblasHandle_t handle,
                     ...
                     const double beta,
                     /* */ double *c, int ldc) {
    const int r_val = hipblasDgemv(handle, 
                                   trans,
                                   m, n,
                                   &alpha, 
                                   a, lda,
  ...
  Blas<double>::trsv(cublasHandle_t handle, 
                     ...
                     const double *a, int lda,
                     /* */ double *b, int ldb) {
    const int r_val = cublasDtrsv(handle, 
                                  uplo, transa, diag,
                                  m, 
                                  a, lda,
                                  b, ldb);
  ...
  Blas<double>::trsv(hipblasHandle_t handle, 
                     ...
                     const double *a, int lda,
                     /* */ double *b, int ldb) {
    const int r_val = hipblasDtrsv(handle, 
                                   uplo, transa, diag,
                                   m, 
                                   a, lda,
                                   b, ldb);
  ...
  Blas<double>::gemm(hipblasHandle_t handle, 
                     ...
                     const double beta,
                     /* */ double *c, int ldc) {
    const int r_val = hipblasDgemm(handle,
                                   transa, transb,
                                   m, n, k, 
                                   &alpha,
                                   a, lda,
  ...
  Blas<double>::herk(cublasHandle_t handle,
                     ...
                     const double beta,
                     /* */ double *c, int ldc) {
    const int r_val = cublasDsyrk(handle,
                                  uplo, trans,
                                  n, k,
                                  &alpha,
                                  a, lda,
  ...
  Blas<double>::herk(hipblasHandle_t handle,
                     ...
                     const double beta,
                     /* */ double *c, int ldc) {
    const int r_val = hipblasDsyrk(handle,
                                   uplo, trans,
                                   n, k,
                                   &alpha,
                                   a, lda,
  ...
  Blas<double>::trsm(cublasHandle_t handle,
                     ...
                     const double *a, int lda,
                     /* */ double *b, int ldb) {
    const int r_val = cublasDtrsm(handle, 
                                  side, uplo, transa, diag,
                                  m, n, 
                                  &alpha,
                                  a, lda,
  ...
  Blas<double>::trsm(hipblasHandle_t handle,
                     ...
                     const double *a, int lda,
                     /* */ double *b, int ldb) {
    const int r_val = hipblasDtrsm(handle, 
                                   side, uplo, transa, diag,
                                   m, n, 
                                   &alpha,
                                   a, lda,
  ...
  Blas<Kokkos::complex<float> >::gemv(cublasHandle_t handle,
                                      ...
                                      const Kokkos::complex<float> beta,
                                      /* */ Kokkos::complex<float> *c, int ldc) {
    const int r_val = cublasCgemv(handle, 
                                  trans,
                                  m, n,
  ...
  Blas<Kokkos::complex<float> >::gemv(hipblasHandle_t handle,
                                      ...
                                      const Kokkos::complex<float> beta,
                                      /* */ Kokkos::complex<float> *c, int ldc) {
    const int r_val = hipblasCgemv(handle, 
                                   trans,
                                   m, n,
                                   (const hipFloatComplex*)&alpha, 
                                   (const hipFloatComplex*)a, lda,
                                   (const hipFloatComplex*)b, ldb,
                                   (const hipFloatComplex*)&beta,
                                   (hipFloatComplex*)c, ldc);
    return r_val;
  }
#endif
  ...
  Blas<Kokkos::complex<float> >::trsv(cublasHandle_t handle, 
                                      ...
                                      const Kokkos::complex<float> *a, int lda,
                                      /* */ Kokkos::complex<float> *b, int ldb) {
    const int r_val = cublasCtrsv(handle, 
                                  uplo, transa, diag,
                                  m, 
                                  (const cuComplex*)a, lda,
                                  (cuComplex*)b, ldb);
  ...
  Blas<Kokkos::complex<float> >::trsv(hipblasHandle_t handle, 
                                      ...
                                      const Kokkos::complex<float> *a, int lda,
                                      /* */ Kokkos::complex<float> *b, int ldb) {
    const int r_val = hipblasCtrsv(handle, 
                                   uplo, transa, diag,
                                   m, 
                                   (const hipFloatComplex*)a, lda,
  ...
  Blas<Kokkos::complex<float> >::gemm(hipblasHandle_t handle, 
                                      ...
                                      const Kokkos::complex<float>  beta,
                                      /* */ Kokkos::complex<float>  *c, int ldc) {
    const int r_val = hipblasCgemm(handle,
                                   transa, transb,
                                   m, n, k, 
                                   (const hipFloatComplex*)&alpha,
                                   (const hipFloatComplex*)a, lda,
  ...
  Blas<Kokkos::complex<float> >::herk(cublasHandle_t handle,
                                      ...
                                      const Kokkos::complex<float> beta,
                                      /* */ Kokkos::complex<float> *c, int ldc) {
    const int r_val = cublasCherk(handle,
                                  uplo, trans,
                                  n, k,
                                  (const float*)&alpha,
                                  (const cuComplex*)a, lda,
  ...
  Blas<Kokkos::complex<float> >::herk(hipblasHandle_t handle,
                                      ...
                                      const Kokkos::complex<float> beta,
                                      /* */ Kokkos::complex<float> *c, int ldc) {
    const int r_val = hipblasCherk(handle,
                                   uplo, trans,
                                   n, k,
                                   (const float*)&alpha,
                                   (const hipFloatComplex*)a, lda,
  ...
  Blas<Kokkos::complex<float> >::trsm(cublasHandle_t handle,
                                      ...
                                      const Kokkos::complex<float> *a, int lda,
                                      /* */ Kokkos::complex<float> *b, int ldb) {
    const int r_val = cublasCtrsm(handle, 
                                  side, uplo, transa, diag,
                                  m, n, 
                                  (const cuComplex*)&alpha,
                                  (const cuComplex*)a, lda,
  ...
  Blas<Kokkos::complex<float> >::trsm(hipblasHandle_t handle,
                                      ...
                                      const Kokkos::complex<float> *a, int lda,
                                      /* */ Kokkos::complex<float> *b, int ldb) {
    const int r_val = hipblasCtrsm(handle, 
                                   side, uplo, transa, diag,
                                   m, n, 
                                   (const hipFloatComplex*)&alpha,
                                   (const hipFloatComplex*)a, lda,
  ...
  Blas<Kokkos::complex<double> >::gemv(cublasHandle_t handle,
                                       ...
                                       const Kokkos::complex<double> beta,
                                       /* */ Kokkos::complex<double> *c, int ldc) {
    const int r_val = cublasZgemv(handle, 
                                  trans,
                                  m, n,
  ...
  Blas<Kokkos::complex<double> >::gemv(hipblasHandle_t handle,
                                       ...
                                       const Kokkos::complex<double> beta,
                                       /* */ Kokkos::complex<double> *c, int ldc) {
    const int r_val = hipblasZgemv(handle, 
                                   trans,
                                   m, n,
                                   (const hipDoubleComplex*)&alpha, 
                                   (const hipDoubleComplex*)a, lda,
                                   (const hipDoubleComplex*)b, ldb,
  ...
  Blas<Kokkos::complex<double> >::trsv(cublasHandle_t handle, 
                                       ...
                                       const Kokkos::complex<double> *a, int lda,
                                       /* */ Kokkos::complex<double> *b, int ldb) {
    const int r_val = cublasZtrsv(handle, 
                                  uplo, transa, diag,
                                  m, 
                                  (const cuDoubleComplex*)a, lda,
  ...
  Blas<Kokkos::complex<double> >::trsv(hipblasHandle_t handle, 
                                       ...
                                       const Kokkos::complex<double> *a, int lda,
                                       /* */ Kokkos::complex<double> *b, int ldb) {
    const int r_val = hipblasZtrsv(handle, 
                                   uplo, transa, diag,
                                   m, 
                                   (const hipDoubleComplex*)a, lda,
  ...
  Blas<Kokkos::complex<double> >::gemm(hipblasHandle_t handle, 
                                       ...
                                       const Kokkos::complex<double>  beta,
                                       /* */ Kokkos::complex<double>  *c, int ldc) {
    const int r_val = hipblasZgemm(handle,
                                   transa, transb,
                                   m, n, k, 
                                   (const hipDoubleComplex*)&alpha,
                                   (const hipDoubleComplex*)a, lda,
  ...
  Blas<Kokkos::complex<double> >::herk(cublasHandle_t handle,
                                       ...
                                       const Kokkos::complex<double> beta,
                                       /* */ Kokkos::complex<double> *c, int ldc) {
    const int r_val = cublasZherk(handle,
                                  uplo, trans,
                                  n, k,
                                  (const double*)&alpha,
                                  (const cuDoubleComplex*)a, lda,
  ...
  Blas<Kokkos::complex<double> >::herk(hipblasHandle_t handle,
                                       ...
                                       const Kokkos::complex<double> beta,
                                       /* */ Kokkos::complex<double> *c, int ldc) {
    const int r_val = hipblasZherk(handle,
                                   uplo, trans,
                                   n, k,
                                   (const double*)&alpha,
                                   (const hipDoubleComplex*)a, lda,
  ...
  Blas<Kokkos::complex<double> >::trsm(cublasHandle_t handle,
                                       ...
                                       const Kokkos::complex<double> *a, int lda,
                                       /* */ Kokkos::complex<double> *b, int ldb) {
    const int r_val = cublasZtrsm(handle, 
                                  side, uplo, transa, diag,
                                  m, n, 
                                  (const cuDoubleComplex*)&alpha,
                                  (const cuDoubleComplex*)a, lda,
  ...
  Blas<Kokkos::complex<double> >::trsm(hipblasHandle_t handle,
                                       ...
                                       const Kokkos::complex<double> *a, int lda,
                                       /* */ Kokkos::complex<double> *b, int ldb) {
    const int r_val = hipblasZtrsm(handle, 
                                   side, uplo, transa, diag,
                                   m, n, 
                                   (const hipDoubleComplex*)&alpha,
                                   (const hipDoubleComplex*)a, lda,
