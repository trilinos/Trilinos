#ifndef __TRSM_LEFT_UPPER_CONJTRANS_FOR_SUPERNODES_HPP__
#define __TRSM_LEFT_UPPER_CONJTRANS_FOR_SUPERNODES_HPP__

/// \file Tacho_Trsm_Left_Upper_ConjTrans_ForSuperNodes.hpp
...
namespace Tacho {
  ...
  Trsm<Side::Left,Uplo::Upper,Trans::ConjTranspose,
       AlgoTrsm::ForSuperNodes,Variant::One>
