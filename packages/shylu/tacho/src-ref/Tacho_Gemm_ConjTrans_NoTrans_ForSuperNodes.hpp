#ifndef __GEMM_CONJTRANS_NOTRANS_FOR_SUPERNODES_HPP__
#define __GEMM_CONJTRANS_NOTRANS_FOR_SUPERNODES_HPP__

/// \file Tacho_Gemm_ConjTrans_NoTrans_ForSuperNodes.hpp
...
namespace Tacho {
  ...
  Gemm<Trans::ConjTranspose,Trans::NoTranspose,
       AlgoGemm::ForSuperNodes,Variant::One>
