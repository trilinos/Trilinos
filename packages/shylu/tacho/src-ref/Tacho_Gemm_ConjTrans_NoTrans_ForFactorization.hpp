#ifndef __GEMM_CONJTRANS_NOTRANS_FOR_FACTORIZATION_HPP__
#define __GEMM_CONJTRANS_NOTRANS_FOR_FACTORIZATION_HPP__

/// \file Tacho_Gemm_ConjTrans_NoTrans_ForFactorization.hpp
...
namespace Tacho {
  ...
  Gemm<Trans::ConjTranspose,Trans::NoTranspose,
       AlgoGemm::ForFactorization,Variant::One>
