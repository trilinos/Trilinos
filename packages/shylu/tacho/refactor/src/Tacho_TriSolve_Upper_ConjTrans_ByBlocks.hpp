#ifndef __TACHO_TRI_SOLVE_UPPER_CONJTRANS_BY_BLOCKS_HPP__
#define __TACHO_TRI_SOLVE_UPPER_CONJTRANS_BY_BLOCKS_HPP__

/// \file Tacho_TriSolve_Upper_ConjTrans_ByBlocks.hpp
                ...
                case Variant::Two:
                  {
                    ...
                    TACHO_TEST_FOR_ABORT(f.is_null(),
                                         ">> Tacho::TriSolveByBlocks(Upper,ConjTrans) returns a null future (out of memory)");
                    bb.setFuture(f);
                    break;
                  }
                }
