...
int runTests(Epetra_Map & map, Epetra_CrsMatrix & A, Epetra_Vector & x, Epetra_Vector & b, Epetra_Vector & xexact, bool verbose) {
  ...
  EPETRA_CHK_ERR(EpetraExt::MultiVectorToMatrixMarketFile("Test_X.mm", X, "Official EpetraExt test initial guess", 
					      	          "This is the official EpetraExt test initial guess generated by the EpetraExt regression tests"));
  ...
  EPETRA_CHK_ERR(EpetraExt::MultiVectorToMatrixMarketFile("Test_Xexact.mm", Xexact, "Official EpetraExt test exact solution", 
						          "This is the official EpetraExt test exact solution generated by the EpetraExt regression tests"));
  ...
  EPETRA_CHK_ERR(EpetraExt::MultiVectorToMatrixMarketFile("Test_B.mm", B, "Official EpetraExt test right hand side", 
						          "This is the official EpetraExt test right hand side generated by the EpetraExt regression tests"));
  ...
  EPETRA_CHK_ERR(EpetraExt::MatrixMarketFileToMultiVector("Test_X.mm", *map1, X1));
  EPETRA_CHK_ERR(EpetraExt::MatrixMarketFileToMultiVector("Test_Xexact.mm", *map1, Xexact1));
  EPETRA_CHK_ERR(EpetraExt::MatrixMarketFileToMultiVector("Test_B.mm", *map1, B1));
