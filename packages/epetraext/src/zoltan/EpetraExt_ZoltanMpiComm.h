...
#ifndef EPETRAEXT_ZOLTANMPICOMM_H
...
class ZoltanMpiComm: public Epetra_Object, public virtual Epetra_Comm {
 ...
 public:
  ...
  /*! Creates a ZoltanMpiComm instance for use with MPI.  If no specialized
  ...
  */
  ...
  /*! Completely deletes a ZoltanMpiComm object.  
    ...
    on a ZoltanMpiComm instance should be destroyed prior to calling this
    function.
  */
