#ifndef ML_AMESOSSMOOTHER_H
#define ML_AMESOSSMOOTHER_H
#include "ml_config.h"
#include <iostream>
...
class AmesosSmoother : public Smoother {

public:

  AmesosSmoother(const Operator& Matrix,
    ...
    ApplyInverseTemp_(0)
  {
    ...
    ML_Gen_Smoother_Amesos(ml_handle_, 0, ML_AMESOS_KLU,-1);
