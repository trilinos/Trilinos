 ...
 * computed once, and reused in all the subsequent call to pzgssvx_ABglobal.
 *
 ...
 */
{
    ...
    *trans = 'N';
    ...
    /* Create compressed column matrix for A. */
    zCreate_CompCol_Matrix(&A, m, n, nnz, a1, asub1, xa1, NC, _Z, GE);
