 ...
 * Prototypes
 */
void ReadVector(FILE *, int_t, int_t *, int_t, int_t);
void zReadValues(FILE *, int_t, doublecomplex *, int_t, int_t);


void
zreadhb(int iam, FILE *fp, int_t *nrow, int_t *ncol, int_t *nonz,
...
int ParseIntFormat(char *buf, int_t *num, int_t *size)
{
    char *tmp;
...
int ParseFloatFormat(char *buf, int_t *num, int_t *size)
{
    char *tmp, *period;
...
void ReadVector(FILE *fp, int_t n, int_t *where, int_t perline, int_t persize)
{
...
void zReadValues(FILE *fp, int_t n, doublecomplex *destination,
