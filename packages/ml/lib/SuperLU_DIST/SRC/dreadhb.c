...
void dReadValues(FILE *, int_t, double *, int_t, int_t);
void FormFullA(int_t, int_t *, double **, int_t **, int_t **);

void
dreadhb(int iam, FILE *fp, int_t *nrow, int_t *ncol, int_t *nonz,
...
int dParseIntFormat(char *buf, int_t *num, int_t *size)
{
    char *tmp;
...
int dParseFloatFormat(char *buf, int_t *num, int_t *size)
{
    char *tmp, *period;
