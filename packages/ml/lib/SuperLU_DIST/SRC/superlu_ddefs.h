...
extern void    countnz (const int_t, int_t *, int_t *, int_t *,
			Glu_persist_t *, Glu_freeable_t *);
extern int_t   fixupL (const int_t, const int_t *, Glu_persist_t *,
		       Glu_freeable_t *);
extern int_t   *TreePostorder (int_t, int_t *);
extern void    dGenXtrue (int_t, int_t, double *, int_t);
extern void    dFillRHS (char *, int_t, double *, int_t, SuperMatrix *,
			double *, int_t);
...
extern void    SetIWork (int_t, int_t, int_t, int_t *, int_t **, int_t **,
			 int_t **, int_t **, int_t **, int_t **, int_t **);
...
extern void    dinf_norm_error (int_t, int_t, double*, int_t, double*, int_t);
extern void    super_stats (int_t, int_t *);
...
extern void  dreadhb (int, FILE *, int_t *, int_t *, int_t *, 
		      double **, int_t **, int_t **);
...
extern void  get_perm_c(int_t, int_t, SuperMatrix *, int_t *);
...
extern void  Destroy_LU(int_t, gridinfo_t *, LUstruct_t *);
extern void  *duser_malloc (int_t, int_t);
extern void  duser_free (int_t, int_t);
extern int_t QuerySpace(int_t, int_t, Glu_freeable_t *, mem_usage_t *);
extern int_t dQuerySpace(int_t, LUstruct_t *, gridinfo_t *, mem_usage_t *);
extern int   xerbla_ (char *, int *);
...
extern void  dPrint_CompCol_Matrix(SuperMatrix *);
extern void  dPrint_Dense_Matrix(SuperMatrix *);
