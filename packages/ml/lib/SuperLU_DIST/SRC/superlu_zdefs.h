...
extern void    zFillRHS (char *, int_t, doublecomplex *, int_t, SuperMatrix *,
			doublecomplex *, int_t);
...
extern void    zlaqgs (SuperMatrix *, double *, double *, double, double,
		       double, char *);
...
extern void    zinf_norm_error (int_t, int_t, doublecomplex*, int_t,
				doublecomplex*, int_t);
...
extern void  zreadhb (int, FILE *, int_t *, int_t *, int_t *, 
...
extern void  pzgstrs_Bglobal(int_t, LUstruct_t *, gridinfo_t *, doublecomplex*,
			     int_t, int, SuperLUStat_t *, int *);
...
extern void  get_diag_procs(int_t, Glu_persist_t *, gridinfo_t *, int_t *,
			    int_t **, int_t **);
extern void  pzgsmv_setup(SuperMatrix *, Glu_persist_t *, gridinfo_t *,
			  int_t *, int_t *[], doublecomplex *[], int *[],
			  int_t []);
extern void  pzgsmv(int_t, int_t [], doublecomplex [], int [],
		    doublecomplex [], doublecomplex []);
extern void  pzgsmv_abs(int_t, int_t [], doublecomplex [], int [],
...
extern int_t zQuerySpace(int_t, LUstruct_t *, gridinfo_t *, mem_usage_t *);
extern int   xerbla_ (char *, int *);
...
extern void  check_tempv(int_t, doublecomplex *);
...
extern void  zPrint_CompCol_Matrix(SuperMatrix *);
extern void  zPrint_Dense_Matrix(SuperMatrix *);
