...
cParseIntFormat(char *buf, int *num, int *size)
{
    char *tmp;
...
cParseFloatFormat(char *buf, int *num, int *size)
{
    char *tmp, *period;
...
cReadVector(FILE *fp, int n, int *where, int perline, int persize)
{
...
cReadValues(FILE *fp, int n, complex *destination, int perline, int persize)
{
