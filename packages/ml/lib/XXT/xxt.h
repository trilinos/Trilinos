...
ML beliefs/usage: move this to to ML_XXT_generate routine
...
Usage: 
**************************************xxt.h***********************************/
extern int XXT_generate(xxt_ADT xxt_handle,   /* prev. allocated xxt  handle */
...
Usage: XXT_solve(xxt_handle, double *b, double *x)
**************************************xxt.h***********************************/
extern void XXT_solve(xxt_ADT xxt_handle, int, double *b, int, double *x);
