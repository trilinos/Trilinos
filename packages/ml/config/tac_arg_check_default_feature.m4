dnl @synopsis TAC_ARG_CHECK_DEFAULT_FEATURE(FEATURE_NAME, FEATURE_DESCRIPTION, HAVE_NAME)
dnl
...
dnl  For example:
dnl
dnl TAC_ARG_CHECK_DEFAULT_FEATURE(epetra, [Build Epetra Adapters], EPETRA)
dnl 
...
dnl Modified by James Willenbring <jmwille@sandia.gov>
dnl
