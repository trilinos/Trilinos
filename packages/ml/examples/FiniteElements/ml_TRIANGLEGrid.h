#ifndef ML_TRIANGLEGRID_H
#define ML_TRIANGLEGRID_H
...
public:
    ...
    Comm_(Comm)
  {
    ...
    if (Comm_.NumProc() != 1)
      ML_THROW("TRIANGLEGrid can be used w/ 1 processor only", -1);
