...
\choicebox{\tt smoother: min size for coarse}{[{\tt int}] If the dimension of the coarsest grid operator is larger than this size, then fine level smoothers will be used instead of the coarse solve options. This address cases where coarsening is aborted early.}
