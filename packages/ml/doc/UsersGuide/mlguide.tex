...
must be passed as a pointer to {\tt void} via the parameter {\tt smoother: petsc ksp}.\\
\hline
\end{tabular}
...
\choicebox{\tt smoother: petsc ksp $\star$}{[{\tt void*}] A fully-constructed PETSc KSP
smoother. Can only be used on finest level with a matrix of type Epetra\_PETScAIJMatrix.}
