...
\verb!$ML_HOME/examples/ml_example_MultiLevelPreconditioner.cpp!.
...
\begin{itemize}
\item File \verb!ml_example_MultiLevelPreconditioner_viz.cpp! shows how to
visualize the effect of the \ML~cycle and each level's smoother on a random vector;
\item File \verb!ml_example_MultiLevelPreconditioner_analyze.cpp! shows who to
...
\end{verbatim}
(File \verb!ml_example_MultiLevelPreconditioner_viz.cpp! contains the compilable
