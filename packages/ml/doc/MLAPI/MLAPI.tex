...
both serial and (massively) parallel environments. The design of \MLAPI allows
it to be used as both a solver package and a framework for algorithm
development.
 ...
 object oriented (OO) classes and operator overloading for the top layer, and optimized
