...
\begin{abstract}
This paper presents \MLAPIns, a software framework that enables 
...
both serial and (massively) parallel environments. 
 ...
 object oriented (OO) classes and operator overloading for the top layer, and use of optimized
 FORTRAN and C code whenever possible. In particular, \MLAPI takes advantage
 of \ML~\cite{ml-guide}, 
...
and {\sl at the same time} efficient and scalable.  \MLAPI is not based on any
