...
FUNCTION(TPETRA_PROCESS_ONE_LGN_TEMPLATE OUTPUT_FILE TEMPLATE_FILE
  ...
  LO_MACRO_NAME GO_MACRO_NAME GO_MACRO_EXPR NT_MACRO_NAME)
  ...
  FOREACH(NT ${NODE_TYPES})
    ...
    FOREACH(GO ${GLOBALORDINAL_TYPES})
      ...
      FOREACH(LO ${LOCALORDINAL_TYPES})
        ...
        # Support for FixedHashTable that always has GO=int
        # Note: The only time this loop should get GO=int if we're not
        # instantiating on GO=int is for FixedHashTable
        IF("${GO}" STREQUAL "int" AND "${CLASS_MACRO_NAME}" STREQUAL "DETAILS_FIXEDHASHTABLE")
          SET(GO_MACRO_EXPR "")
        ELSE()
          SET(GO_MACRO_EXPR "&& defined (HAVE_TPETRA_INST_${LO_MACRO_NAME}_${GO_MACRO_NAME})")
        ENDIF()
        MESSAGE(INFO " GO = -${GO}- GO_MACRO_EXPR = -${GO_MACRO_EXPR}- CLASS_MACRO_NAME=${CLASS_MACRO_NAME}")
