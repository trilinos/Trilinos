...
#ifdef HAVE_TPETRA_DEBUG
  if (lclNumRows != 0) {
    TEUCHOS_TEST_FOR_EXCEPTION(X.extent(0) != lclNumRows, std::logic_error, prefix << "X.extent(0) = " << X.extent(0) << " != lclNumRows "
                                                                                                                         "= "
                                                                                   << lclNumRows << ".  "
                                                                                                    "Please report this bug to the Tpetra developers.");
    TEUCHOS_TEST_FOR_EXCEPTION(Y.extent(0) != lclNumRows, std::logic_error, prefix << "Y.extent(0) = " << Y.extent(0) << " != lclNumRows "
                                                                                                                         "= "
                                                                                   << lclNumRows << ".  "
                                                                                                    "Please report this bug to the Tpetra developers.");
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(constantStrideX &&
                                   (X.extent(0) != lclNumRows || X.extent(1) != numVecs),
                               std::logic_error, prefix << "X is " << X.extent(0) << " x " << X.extent(1) << " (constant stride), which differs from the "
                                                                                                             "local dimensions "
                                                        << lclNumRows << " x " << numVecs << ".  "
                                                                                             "Please report this bug to the Tpetra developers.");
    TEUCHOS_TEST_FOR_EXCEPTION(!constantStrideX &&
                                   (X.extent(0) != lclNumRows || X.extent(1) < numVecs),
                               std::logic_error, prefix << "X is " << X.extent(0) << " x " << X.extent(1) << " (NOT constant stride), but the local "
                                                                                                             "dimensions are "
                                                        << lclNumRows << " x " << numVecs << ".  "
                                                                                             "Please report this bug to the Tpetra developers.");
    TEUCHOS_TEST_FOR_EXCEPTION(constantStrideY &&
                                   (Y.extent(0) != lclNumRows || Y.extent(1) != numVecs),
                               std::logic_error, prefix << "Y is " << Y.extent(0) << " x " << Y.extent(1) << " (constant stride), which differs from the "
                                                                                                             "local dimensions "
                                                        << lclNumRows << " x " << numVecs << ".  "
                                                                                             "Please report this bug to the Tpetra developers.");
    TEUCHOS_TEST_FOR_EXCEPTION(!constantStrideY &&
                                   (Y.extent(0) != lclNumRows || Y.extent(1) < numVecs),
                               std::logic_error, prefix << "Y is " << Y.extent(0) << " x " << Y.extent(1) << " (NOT constant stride), but the local "
                                                                                                             "dimensions are "
                                                        << lclNumRows << " x " << numVecs << ".  "
                                                                                             "Please report this bug to the Tpetra developers.");
  }
