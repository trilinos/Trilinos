...
template <class LocalOrdinal,
          class GlobalOrdinal,
          class Node>
class Export : public ::Tpetra::Details::Transfer<LocalOrdinal, GlobalOrdinal, Node> {
 private:
...
createExport(const Teuchos::RCP<const Map<LocalOrdinal, GlobalOrdinal, Node> >& src,
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(src == Teuchos::null || tgt == Teuchos::null, std::runtime_error,
