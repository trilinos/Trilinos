...
void expertSetRemoteLIDsContiguous(Transfer<LO, GO, NT> transfer, bool contig);

/// \brief Expert function that messes with internals of Transfer.
/// Used for testing. Do not use unless you know what you are doing.
template <class LO, class GO, class NT>
void expertSetExportLIDsContiguous(Transfer<LO, GO, NT> transfer, bool contig);
#endif  // DOXYGEN_SHOULD_SKIP_THIS
...
class Transfer : public Teuchos::Describable {
 ...
 public:
  ...
  friend void expertSetRemoteLIDsContiguous<LO, GO, NT>(Transfer<LO, GO, NT> transfer, bool contig);

  //! Friend declaration for non-member function that allows setting a flag.
  friend void expertSetExportLIDsContiguous<LO, GO, NT>(Transfer<LO, GO, NT> transfer, bool contig);
#endif  // DOXYGEN_SHOULD_SKIP_THIS
