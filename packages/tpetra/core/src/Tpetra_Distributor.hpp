...
namespace Tpetra {
  ...
  public:
    ...
    typename std::enable_if<(Kokkos::is_view<ExpView>::value && Kokkos::is_view<ExpPacketsView>::value && 
                             Kokkos::is_view<ImpView>::value && Kokkos::is_view<ImpPacketsView>::value)>::type
