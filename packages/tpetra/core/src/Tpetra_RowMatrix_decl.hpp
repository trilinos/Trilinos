...
class RowMatrix : virtual public Operator<Scalar, LocalOrdinal, GlobalOrdinal, Node>,
 ...
 public:
  ...
  typedef typename Kokkos::View<LocalOrdinal*, typename Node::device_type>::const_type
  ...
  typedef typename Kokkos::View<GlobalOrdinal*, typename Node::device_type>::const_type
  ...
  typedef typename Kokkos::View<const size_t*, typename Node::device_type>::const_type
