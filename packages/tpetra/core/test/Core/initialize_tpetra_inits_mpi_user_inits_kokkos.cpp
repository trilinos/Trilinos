  ...
  {  // GlobalMPISession is in local scope so we can check MPI_Finalize
    ...
    if (!Kokkos::is_initialized()) {
      ...
      cout << "Kokkos::is_initialized() is false, "
              "after Kokkos::initialize was called."
           << endl;
      return;
    }
    ...
    if (!isMpiInitialized()) {
      ...
      cout << "MPI_Initialized claims MPI is not initialized, "
              "even after MPI_Init and Tpetra::initialize were called."
           << endl;
    ...
    if (!tpetraInitialized) {
      ...
      if (myRank == 0) {
        cout << "Tpetra::isInitialized() is false on at least one process, "
                "even after Tpetra::initialize() has been called."
             << endl;
      }
    }
    ...
    if (!Kokkos::is_initialized()) {
      ...
      cout << "Kokkos::is_initialized() is false, even after "
              "Kokkos::initialize and Tpetra::initialize were called."
           << endl;
    }
    ...
    if (!Kokkos::is_initialized()) {
      ...
      cout << "Tpetra::finalize was not supposed to call "
              "Kokkos::finalize, but apparently did."
           << endl;
      return;
    }
    ...
    if (Kokkos::is_initialized()) {
      success = false;
      cout << "Kokkos::is_initialized() is false "
              "even after calling Kokkos::finalize."
           << endl;
    }
