...
template <class ScalarType, class LocalOrdinalType, class GlobalOrdinalType, class NodeType>
bool testCrsMatrix(Teuchos::FancyOStream& out, const GlobalOrdinalType indexBase) {
  typedef ScalarType ST;
  typedef LocalOrdinalType LO;
  typedef GlobalOrdinalType GO;
  typedef NodeType NT;
...
template <class ScalarType, class LocalOrdinalType, class GlobalOrdinalType, class NodeType>
bool testCrsMatrixPerFile(Teuchos::FancyOStream& out, const GlobalOrdinalType indexBase) {
  typedef ScalarType ST;
  typedef LocalOrdinalType LO;
  typedef GlobalOrdinalType GO;
  typedef NodeType NT;
...
template <class ScalarType, class LocalOrdinalType, class GlobalOrdinalType, class NodeType>
bool testCrsMatrixPerFileNonContiguous(Teuchos::FancyOStream& out, const GlobalOrdinalType indexBase) {
  typedef ScalarType ST;
  typedef LocalOrdinalType LO;
  typedef GlobalOrdinalType GO;
  typedef NodeType NT;
