...
void sendPackSize(bool& success,
...
void recvPackSize(bool& success,
                  Teuchos::FancyOStream& out,
                  int& packSize,
                  const int srcProc,
                  const int tag,
...
void packAndSendTriples(bool& success,
                        Teuchos::FancyOStream& out,
...
void recvAndUnpackTriples(bool& success,
                          Teuchos::FancyOStream& out,
                          char inBuf[],
                          const int inBufSize,
