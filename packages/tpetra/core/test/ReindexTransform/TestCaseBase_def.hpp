...
template< class Scalar_t, class LocalId_t, class GlobalId_t, class Node_t > 
void
TestCaseBase<Scalar_t, LocalId_t, GlobalId_t, Node_t>::baseInstantiateLinearProblem( std::string const & matInputFileName
...
template< class Scalar_t, class LocalId_t, class GlobalId_t, class Node_t > 
bool
TestCaseBase<Scalar_t, LocalId_t, GlobalId_t, Node_t>::baseCheckAfterFwdRvs( Problem_t const * originalProblem ) const
{
  bool result(true);
...
template< class Scalar_t, class LocalId_t, class GlobalId_t, class Node_t > 
bool
TestCaseBase<Scalar_t, LocalId_t, GlobalId_t, Node_t>::baseCheckMatricesAreEqual( Matrix_t const & mat1
                                                                                , Matrix_t const & mat2
                                                                                ) const
{
  bool result(true);
