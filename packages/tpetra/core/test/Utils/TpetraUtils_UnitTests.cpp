...
TEUCHOS_UNIT_TEST_TEMPLATE_2_DECL(TpetraUtils, Sort2, T1, T2) {
  ...
  out << "before (arr1): ";
  std::copy(arr1.begin(), arr1.end(), ostream_iterator<T1>(out, " "));
  out << endl;
  out << "       (arr2): ";
  std::copy(arr2.begin(), arr2.end(), ostream_iterator<T2>(out, " "));
  out << endl;
...
TEUCHOS_UNIT_TEST_TEMPLATE_2_DECL(TpetraUtils, Sort3, T1, T2) {
  ...
  out << endl;
  out << "       (arr3): ";
  std::copy(arr3.begin(), arr3.end(), ostream_iterator<T1>(out, " "));
  out << endl;
