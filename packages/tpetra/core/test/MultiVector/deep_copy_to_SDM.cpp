...
bool serialDenseMatrix_multiVector_same(const Tpetra::MultiVector<ST, LO, GO, NT>& X,
...
void view1dIota(const Kokkos::View<ValueType*, LayoutType, DeviceType>& x,
...
template <class ST, class LO, class GO, class NT>
void multiVectorIota(Tpetra::MultiVector<ST, LO, GO, NT>& X,
                     const ST& startValue) {
  using MV  = Tpetra::MultiVector<ST, LO, GO, NT>;
  using IST = typename MV::impl_scalar_type;
