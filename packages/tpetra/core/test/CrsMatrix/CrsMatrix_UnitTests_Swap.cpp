 ...
 public:
  void execute(Teuchos::FancyOStream& out, bool& success) {
    ...
    if (0 == color) {
      ...
      // Swap matrix b and c
      //
      out << ">>> swap matrix_b and matrix_c" << std::endl
          << std::endl;
