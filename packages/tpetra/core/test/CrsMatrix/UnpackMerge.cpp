...
TEUCHOS_UNIT_TEST(CrsMatrix, UnpackMerge2) {
  ...
  std::vector<GO> srcGblColInds{{142944, 142945, 142946, 142947, 142948, 142949, 142950, 142951,
  ...
  std::vector<GO> tgtGblColInds{{166215, 166216, 166217, 166218, 166219, 166220, 166221, 166222,
  ...
  std::vector<Scalar> expectedTgtVals;
  if (myRank == 0) {
    std::vector<GO> intersectionGblColInds(std::min(srcGblColInds.size(), tgtGblColInds.size()));
    auto intersectionEnd =
        std::set_intersection(srcBeg, srcEnd, tgtBeg, tgtEnd,
                              intersectionGblColInds.begin());
    intersectionGblColInds.resize(intersectionEnd - intersectionGblColInds.begin());
