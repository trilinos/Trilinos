...
int main(int argc, char *argv[]) {
  ...
  Tpetra::initialize(&argc, &argv);
  {
    ...
    }
    {
      ...
      const Tpetra::global_size_t TpetraComputeGlobalNumElements = Teuchos::OrdinalTraits<Tpetra::global_size_t>::invalid();
      ...
      colidx_view_type colidx;
      {
        ...
        {
          LocalGraphConstruction local_graph_construction(sb, owned_gids,
