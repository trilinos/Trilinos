...
void benchmarkTpetra(RCP<const Comm<int> > comm,
...
#ifdef HAVE_TPETRACORE_EPETRA
void benchmarkEpetra(const Epetra_Comm& comm,
                     const int numIndPerProc,
                     const int indexBase,
                     const int numMapCreateTrials,
                     const int numVecCreateTrials,
...
int main(int argc, char* argv[]) {
  ...
  Tpetra::ScopeGuard tpetraScope(&argc, &argv);
  {
    ...
    cmdp.setOption("numIndsPerProc", &numIndsPerProc,
