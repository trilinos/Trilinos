...
TRIBITS_ETI_TYPE_EXPANSION(${PACKAGE_NAME}_ETI_EXCLUDE_SET_SPECIAL_ORDINAL_SCALAR "S=int|unsigned|unsigned int|long|unsigned long|long long|unsigned long long|Kokkos::Experimental::half_t" "LO=.*" "GO=.*" "N=.*")
...
TRIBITS_ETI_GENERATE_MACROS(
    "${${PACKAGE_NAME}_ETI_FIELDS}" "${${PACKAGE_NAME}_ETI_LIBRARYSET}"
    "${${PACKAGE_NAME}_ETI_EXCLUDE_SET};${${PACKAGE_NAME}_ETI_EXCLUDE_SET_SPECIAL_ORDINAL_SCALAR}"
    list_of_manglings eti_typedefs
    "TPETRA_INSTANTIATE_SLGN_NO_SPECIAL_NO_ORDINAL_SCALAR(S,LO,GO,N)" TPETRA_ETIMACRO_SLGN_NO_SPECIAL_NO_ORDINAL_SCALAR)
