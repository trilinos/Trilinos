...
global_verify(const LocalOrdinal nrows_local,
  ...
  MatView<LocalOrdinal, Scalar> Resid_view(nrows_local, ncols, Resid.data(), ld_resid);
  MatView<LocalOrdinal, const Scalar> A_view(nrows_local, ncols, A_local, lda_local);
