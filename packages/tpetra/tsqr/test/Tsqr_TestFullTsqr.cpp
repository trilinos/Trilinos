...
const char docString[] =
    "This program tests correctness, "
  ...
  read(int argc,
    ...
    try {
      ...
      cmdLineProc.setOption("numTrials",
                            &numTrials,
                            defaultParams->getEntry("numTrials").docString().c_str());
...
int main(int argc, char* argv[]) {
  ...
  TEUCHOS_STANDARD_CATCH_STATEMENTS(actually_print_caught_exceptions, err, success);
