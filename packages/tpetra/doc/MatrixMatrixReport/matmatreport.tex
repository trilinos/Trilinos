...
weak-scailing effciency as $TimeInSerial/TimeInParallel$.
...
we sort2 algorithm problem had been fixed and we removed the specific transpose mode kernels. 
...
routine and ML's Epetra matrix-matrix multiply routine). These tests were conducted in the same manner as our development stages comparison. 
