...
\begin{figure}
\centering
\includegraphics[scale=.4]{tpetraDevData/time.pdf}
...
\begin{figure}
\centering
\includegraphics[scale=.4]{tpetraDevData/eff.pdf}
...
\begin{figure}
\centering
\includegraphics[scale=.4]{allMatsData/time.pdf}
...
\begin{figure}
\centering
\includegraphics[scale=.4]{allMatsData/eff.pdf}
...
\begin{figure}
\centering
\includegraphics[scale=.4]{atransData/time.pdf}
...
\begin{figure}
\centering
\includegraphics[scale=.4]{atransData/eff.pdf}
