...
and use the AB kernel those matrices. This has \emph{significant} performance benefits when doing operations like $A^TB$.
...
routine was running in half the time it was originally.
