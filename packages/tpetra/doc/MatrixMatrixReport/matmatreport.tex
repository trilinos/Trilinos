...
\hypersetup{
  ...
  pdftitle = {Evaluation of Tpetra's Sparse Matrix-Matrix Multiplication Routine},
...
This routine is based the same algorithm that is used in EpetraExt with some modifications. Since it 
...
with some modifications. Since it achieved a working state, several major optimizations have been made in an 
