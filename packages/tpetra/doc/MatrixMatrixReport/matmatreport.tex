...
testing procedure as in the development stages comparison, except that we requested A be transposed. Figure~\ref{transtime}
...
understand it. Implementing this algorithm should not be all that difficult.
...
All matrix multiplication code was adapted from EpetraExt for use in Tpetra by Kurtis Nusbaum. Test code was written by Johnathan Hu, Chris Siefter, 
Jeremie Gaidamour, and Kurtis Nusbaum.
