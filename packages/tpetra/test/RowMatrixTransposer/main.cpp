...
int main(int argc, char* argv[]){
  ...
  A = Teuchos::rcp( new Tpetra::CrsMatrix<Scalar,Ordinal>(map, NumNz) );
  ...
  AT = Teuchos::rcp( new Tpetra::CrsMatrix<Scalar,Ordinal>(map, NumNz) );
  Teuchos::RCP< Tpetra::CrsMatrix<Scalar,Ordinal> > TestMatrix;
  //TestMatrix = Teuchos::rcp( new Tpetra::CrsMatrix<Scalar,Ordinal>(map, NumNz, Tpetra::StaticProfile) );
  TestMatrix = Teuchos::null;
  ...
  A->fillComplete(Tpetra::DoNotOptimizeStorage);
  AT->fillComplete(Tpetra::DoNotOptimizeStorage);
