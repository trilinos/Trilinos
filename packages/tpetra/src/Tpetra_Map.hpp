...
namespace Tpetra {
  ...
  Map<OrdinalType>::Map (OrdinalType numGlobalElements, OrdinalType indexBase) {
  }

  template<typename OrdinalType>
  Map<OrdinalType>::Map (OrdinalType numGlobalElements, OrdinalType numMyElements, OrdinalType indexBase) {
  }

  template<typename OrdinalType>
  Map<OrdinalType>::Map (OrdinalType numGlobalElements, OrdinalType numMyElements, std::vector< OrdinalType > const &elementList, OrdinalType indexBase) {
  }
  ...
  template<typename OrdinalType>
  Map<OrdinalType>& Map<OrdinalType>::operator = (Map<OrdinalType> const& Source) {
