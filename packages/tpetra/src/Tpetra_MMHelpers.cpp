...
CrsWrapper_Tpetra_CrsMatrix::CrsWrapper_Tpetra_CrsMatrix(Tpetra_CrsMatrix& epetracrsmatrix)
 : ecrsmat_(epetracrsmatrix)
{
}

CrsWrapper_Tpetra_CrsMatrix::~CrsWrapper_Tpetra_CrsMatrix()
{
}

const Tpetra_Map&
CrsWrapper_Tpetra_CrsMatrix::RowMap() const
{
  return ecrsmat_.RowMap();
}

bool CrsWrapper_Tpetra_CrsMatrix::Filled()
{
  return ecrsmat_.Filled();
}

int
CrsWrapper_Tpetra_CrsMatrix::InsertGlobalValues(int GlobalRow, int NumEntries, double* Values, int* Indices)
{
  return ecrsmat_.InsertGlobalValues(GlobalRow, NumEntries, Values, Indices);
}

int
CrsWrapper_Tpetra_CrsMatrix::SumIntoGlobalValues(int GlobalRow, int NumEntries, double* Values, int* Indices)
{
...
CrsWrapper_GraphBuilder::CrsWrapper_GraphBuilder(const Tpetra_Map& emap)
 : graph_(),
   rowmap_(emap),
   max_row_length_(0)
{
