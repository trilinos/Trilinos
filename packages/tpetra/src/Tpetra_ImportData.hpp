  ...
  public:
    ...
    ImportData(ElementSpace<OrdinalType> const& source, ElementSpace<OrdinalType> const& target)
      : Object("Tpetra::ImportData")
              // permuteToLIDs_, permuteFromLIDs_, remoteLIDs_, exportLIDs_, and exportImageIDs_ 
      ...
      , numSend_(Teuchos::OrdinalTraits<OrdinalType>::zero())
      , numRecv_(Teuchos::OrdinalTraits<OrdinalType>::zero())
      , source_(source)
      , target_(target)
    ...
    protected:
      ...
      OrdinalType numSend_;
      OrdinalType numRecv_;
