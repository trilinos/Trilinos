...
// ***********************************************************************
// @HEADER
#ifndef TPETRA_MATRIXMATRIX_HPP_
#define TPETRA_MATRIXMATRIX_HPP_
...
class MatrixMatrix {
  ...
  public:
    ...
    /** Given Tpetra_CrsMatrix objects A, B and C, form the product C = A*B.
    ...
    @return error-code, 0 if successful. non-zero returns may result if A or
             ...
             into C, etc.
     */
    static int Multiply(const Tpetra_CrsMatrix& A,
			bool transposeA,
    ...
    /** Given Tpetra_CrsMatrix objects A and B, form the sum B = a*A + b*B
    ...
    @return error-code, 0 if successful. non-zero returns may result if A is
             ...
             into B, etc.
     */
/*    static int Add(const Tpetra_CrsMatrix& A,
                   bool transposeA,
                   double scalarA,
                   Tpetra_CrsMatrix& B,
                   double scalarB);*/

    /** Given Tpetra_CrsMatrix objects A and B, form the sum C = a*A + b*B
