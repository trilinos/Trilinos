...
void Zoltan::LoadBalance::Set_Hypergraph()
{
  hypergraph_ = true;
}
...
int Zoltan::LoadBalance::Set_HG_Size_CS_Fn     ( ZOLTAN_HG_SIZE_CS_FN * fn_ptr,
                                                 void * data )
{
  return Zoltan_Set_HG_Size_CS_Fn( LoadBalance_Ptr_, fn_ptr, data );
}

int Zoltan::LoadBalance::Set_HG_CS_Fn     ( ZOLTAN_HG_CS_FN * fn_ptr,
                                                 void * data )
{
...
void Zoltan::LoadBalance::Register_Hypergraph_Query_Fns()
{
#ifdef ZOLTAN_OLD_CALLBACK
  Set_CallBack_Fn( ZOLTAN_HG_SIZE_CS_FN_TYPE,
	reinterpret_cast<void *> (Zoltan::QueryFunctions::HG_Size_CS),
	0 );
  Set_CallBack_Fn( ZOLTAN_HG_CS_FN_TYPE,
	reinterpret_cast<void *> (Zoltan::QueryFunctions::HG_CS),
	0 );
#else
