...
QueryObject<Node>::QueryObject( Teuchos::RCP<const ::Tpetra::CrsGraph<int,int,Node> > graph,
...
template <typename Node>
QueryObject<Node>::QueryObject(Teuchos::RCP<const ::Tpetra::RowMatrix<double,int,int,Node> > matrix,
	                       Teuchos::RCP<const Isorropia::Tpetra::CostDescriber<Node> > costs,
                               int inputType) 
  : haveGraph_(false),
    graph_(0),
    matrix_(matrix),
    coords_(0),
    rowMap_((const ::Tpetra::Map<int,int,Node> *)&(matrix->RowMatrixRowMap())),
    colMap_((const ::Tpetra::Map<int,int,Node> *)&(matrix->RowMatrixColMap())),
    costs_(costs),
    weights_(0),
    input_type_(inputType) 
{
  ...
  if (input_type_ == graph_input_ || input_type_ == hgraph_graph_input_)
  {
    ...
    if (matrix->NumMyDiagonals() > 0){
      ...
      ::Tpetra::Vector<double,int,int,Node> diagonal(matrix->RowMatrixRowMap());
...
template <typename Node>
QueryObject<Node>::QueryObject( Teuchos::RCP<const ::Tpetra::MultiVector<double,int,int,Node> > coords,
...
////////////////////////////////////////////////////////////////////////////////
template <typename Node>
QueryObject<Node>::QueryObject( Teuchos::RCP<const ::Tpetra::Map<int,int,Node> > input_map,
                                     int inputType) 
  : haveGraph_(false) ,
    graph_(0),
    matrix_(0),
...
template <typename Node>
void QueryObject<Node>::fill_procmap()
{
...
template <typename Node>
bool QueryObject<Node>::haveVertexWeights()
{
  return costs_->haveGlobalVertexWeights();
}

template <typename Node>
bool QueryObject<Node>::haveGraphEdgeWeights()
{
  return costs_->haveGlobalGraphEdgeWeights();
}

template <typename Node>
bool QueryObject<Node>::haveHypergraphEdgeWeights()
{
...
template <typename Node>
int QueryObject<Node>::Number_Objects(void *data, int *ierr)
{
  int numObj = 0;
...
template <typename Node>
void QueryObject<Node>::Object_List  ( void * data,
...
template <typename Node>
void QueryObject<Node>::Number_Edges_Multi  ( void * data,
	     int num_gid_entries, int num_lid_entries,
	     int num_obj,
	     ZOLTAN_ID_PTR global_ids, ZOLTAN_ID_PTR local_ids,
...
template <typename Node>
void QueryObject<Node>::Edge_List_Multi( void * data,
...
template <typename Node>
void QueryObject<Node>::HG_Size_CS ( void * data,
...
template <typename Node>
void QueryObject<Node>::HG_CS ( void * data,
...
template <typename Node>
void QueryObject<Node>::HG_Size_Edge_Weights(void * data,
			    int* num_edges, int* ierr)
{
  QueryObject *zq = (QueryObject *)data;
...
template <typename Node>
void QueryObject<Node>::HG_Edge_Weights(void * data,
...
template <typename Node>
int QueryObject<Node>::Number_Geom(void *data, int *ierr)
{
  int dim=0;
  QueryObject *zq = (QueryObject *)data;
...
template <typename Node>
void QueryObject<Node>::Geom_Multi(void *data, int num_gid_entries, int num_lid_entries,
...
template <typename Node>
int QueryObject<Node>::My_Number_Objects(int * ierr )
{
  *ierr = ZOLTAN_OK;
...
template <typename Node>
void QueryObject<Node>::My_Object_List(int num_gid_entries, int num_lid_entries,
		  ZOLTAN_ID_PTR global_ids, ZOLTAN_ID_PTR local_ids,
		  int weight_dim, float * object_weights, int * ierr )
{
  *ierr = ZOLTAN_OK;
...
template <typename Node>
void QueryObject<Node>::My_Number_Edges_Multi(int num_gid_entries, int num_lid_entries,
	     int num_obj,
	     ZOLTAN_ID_PTR global_ids, ZOLTAN_ID_PTR local_ids,
	     int *num_edges, int * ierr )
{
...
template <typename Node>
void QueryObject<Node>::My_Edge_List_Multi(int num_gid_entries, int num_lid_entries, int num_obj,
	       ZOLTAN_ID_PTR global_ids, ZOLTAN_ID_PTR local_ids, int *num_edges,
	       ZOLTAN_ID_PTR neighbor_global_ids, int * neighbor_procs,
	       int weight_dim, float * edge_weights, int * ierr )
{
...
template <typename Node>
void QueryObject<Node>::My_HG_Size_CS(int* num_lists, int* num_pins, int* format, int * ierr )
{
  *ierr = ZOLTAN_OK;
...
template <typename Node>
void QueryObject<Node>::My_HG_CS (int num_gid_entries, int num_row_or_col, int num_pins, int format,
	    ZOLTAN_ID_PTR vtxedge_GID, int* vtxedge_ptr, ZOLTAN_ID_PTR pin_GID,
				     int * ierr )
{
...
////////////////////////////////////////////////////////////////////////////////
template <typename Node>
void QueryObject<Node>::My_FGHG_CS (int num_gid_entries, int num_nonzeros, int num_pins, int format,
...
template <typename Node>
void QueryObject<Node>::My_HG_Size_Edge_Weights( int* num_edges, int* ierr)
{
...
template <typename Node>
void QueryObject<Node>::My_HG_Edge_Weights(
      int num_gid_entries, int num_lid_entries, int num_edges, int edge_weight_dim,
      ZOLTAN_ID_PTR edge_GID, ZOLTAN_ID_PTR edge_LID, float* edge_weights, int* ierr)
{
  *ierr = ZOLTAN_OK;
...
template <typename Node>
int QueryObject<Node>::My_Number_Geom(int *ierr)
{
  int dim = 0;
  *ierr = ZOLTAN_FATAL;
...
template <typename Node>
void QueryObject<Node>::My_Geom_Multi(int num_gid_entries, int num_lid_entries,
        int num_obj, ZOLTAN_ID_PTR gids, ZOLTAN_ID_PTR lids, int num_dim,
        double *geom_vec, int *ierr)
{
