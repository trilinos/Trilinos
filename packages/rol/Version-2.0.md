...
The second input argument to `update()` have changed.  In Version 1.0, the
second argument was a boolean.  In Version 2.0, the second argument is
an enumeration type.  The enumeration values and descriptions are listed
below
...
Here is a simple example demonstrating the use fo the new update function.
