    ...
    */
    ...
    void solve_circuit(ROL::Vector<Real> &I, const ROL::Vector<Real> &S){
      Teuchos::RCP<std::vector<Real> > Ip =
        Teuchos::rcp_const_cast<std::vector<Real> >((Teuchos::dyn_cast<ROL::StdVector<Real> >(I)).getVector());
      Teuchos::RCP<const std::vector<Real> > Sp =
        (Teuchos::dyn_cast<ROL::StdVector<Real> >(const_cast<ROL::Vector<Real> &>(S))).getVector();
