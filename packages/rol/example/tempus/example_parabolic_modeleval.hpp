...
/// --------------------------
template<class Real>
class ParabolicModelWop : virtual public Thyra::LinearOpWithSolveBase<Real> {
private:
...
public:
  ...
  ParabolicModelWop(const ROL::Ptr<ParabolicModel<Real>> &model) :
    model_(model),
  ...
  ROL::Ptr<const Thyra::LinearOpBase<Real>> clone() const {
    ROL::Ptr<ParabolicModelWop<Real>> op =
      ROL::makePtr<ParabolicModelWop<Real>>(model_);
    return op;
  }
  //@}
...
protected:
  ...
  void applyImpl(const Thyra::EOpTransp M_trans,
                 ...
                 const Real a,
                 const Real b) const {
    // Note:  The operator is symmetric, so the transpose application is the same.
  ...
  //@{
  bool solveSupportsImpl(Thyra::EOpTransp M_trans) const { return true; }
  ...
  Thyra::SolveStatus<Real> solveImpl(const Thyra::EOpTransp M_trans,
                                     ...
                                     const Teuchos::Ptr<const Thyra::SolveCriteria<Real>> solveCriteria) const
  {
    // Note:  The operator is symmetric, so the transpose inverse application is the same.
...
/// --------------------------
template<class Real>
class ParabolicModelMEWrapper : public Thyra::StateFuncModelEvaluatorBase<Real> {

public: // ParabolicModelMEWrapper methods.
...
private: // ParabolicModelMEWrapper methods.
...
private: // ParabolicModelMEWrapper data members.
...
/// ------------------------------------------
/// Implementation of ParabolicModelMEWrapper.
/// ------------------------------------------

template<class Real>
ParabolicModelMEWrapper<Real>::ParabolicModelMEWrapper(const ROL::Ptr<ParabolicModel<Real>> &model) :
  model_(model),
  Np_(1),
...
template<class Real>
Teuchos::RCP<const Thyra::VectorSpaceBase<Real>> ParabolicModelMEWrapper<Real>::get_x_space() const {
  return x_space_;
}


template<class Real>
Teuchos::RCP<const Thyra::VectorSpaceBase<Real>> ParabolicModelMEWrapper<Real>::get_f_space() const {
  return f_space_;
}
...
template<class Real>
Thyra::ModelEvaluatorBase::InArgs<Real> ParabolicModelMEWrapper<Real>::getNominalValues() const {
  TEUCHOS_TEST_FOR_EXCEPTION( !isInitialized_, std::logic_error,"Error, setupInOutArgs_ must be called first!\n");
  return nominalValues_;
}

template<class Real>
Thyra::ModelEvaluatorBase::InArgs<Real> ParabolicModelMEWrapper<Real>::createInArgs() const {
  setupInOutArgs_();
  return inArgs_;
}

template<class Real>
Thyra::ModelEvaluatorBase::OutArgs<Real> ParabolicModelMEWrapper<Real>::createOutArgsImpl() const {
  setupInOutArgs_();
  return outArgs_;
}

template<class Real>
ROL::Ptr<Thyra::LinearOpWithSolveBase<Real>> ParabolicModelMEWrapper<Real>::create_W() const {
...
template<class Real>
ROL::Ptr<Thyra::LinearOpBase<Real>> ParabolicModelMEWrapper<Real>::create_W_op() const {
...
template<class Real>
ROL::Ptr<Thyra::LinearOpBase<Real>> ParabolicModelMEWrapper<Real>::create_DfDp_op_impl(int l) const {
...
template<class Real>
void ParabolicModelMEWrapper<Real>::evalModelImpl(
  ...
  if (!is_null(W)) {
    (ROL::dynamicPtrCast<ParabolicModelWop<Real>>(W))->set_u(u);
    (ROL::dynamicPtrCast<ParabolicModelWop<Real>>(W))->set_alpha(alpha);
    (ROL::dynamicPtrCast<ParabolicModelWop<Real>>(W))->set_beta(beta);
  }

  if (!is_null(W_op)) {
    (ROL::dynamicPtrCast<ParabolicModelWop<Real>>(W_op))->set_u(u);
    (ROL::dynamicPtrCast<ParabolicModelWop<Real>>(W_op))->set_alpha(alpha);
    (ROL::dynamicPtrCast<ParabolicModelWop<Real>>(W_op))->set_beta(beta);
  }
...
template<class Real>
void ParabolicModelMEWrapper<Real>::setupInOutArgs_() const {
  if (isInitialized_) {
    return;
  }
