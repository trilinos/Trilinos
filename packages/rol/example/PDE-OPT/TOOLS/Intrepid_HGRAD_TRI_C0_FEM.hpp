#ifndef __INTREPID_HGRAD_TRI_C0_FEM_HPP__
#define __INTREPID_HGRAD_TRI_C0_FEM_HPP__

#include "Intrepid_Basis.hpp"

namespace Intrepid{
  template<class Scalar, class ArrayScalar>
  class Basis_HGRAD_TRI_C0_FEM : public Basis<Scalar, ArrayScalar>, public DofCoordsInterface<ArrayScalar> {
  private:
  ...
  public:
    ...
    /** \brief Constructor.
    */
    Basis_HGRAD_TRI_C0_FEM();
    /** \brief  FEM basis evaluation on a <strong>reference Triangle</strong> cell.
...
#include "Intrepid_HGRAD_TRI_C0_FEMDef.hpp"
#endif
