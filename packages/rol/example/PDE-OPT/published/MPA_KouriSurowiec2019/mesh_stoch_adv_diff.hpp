...
template <class Real>
class MeshManager_stoch_adv_diff : public MeshManager_Rectangle<Real> {
...
public: 
  ...
  MeshManager_stoch_adv_diff(Teuchos::ParameterList &parlist) : MeshManager_Rectangle<Real>(parlist)
  {
