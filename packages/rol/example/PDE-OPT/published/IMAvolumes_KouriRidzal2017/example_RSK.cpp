...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    auto sampler = ROL::makePtr<ROL::SparseGridGenerator<RealT>>(bman,info,false);
    auto vsampler = ROL::makePtr<ROL::SparseGridGenerator<RealT>>(bman,vinfo,adaptiveV);
    auto gsampler = ROL::makePtr<ROL::SparseGridGenerator<RealT>>(bman,ginfo,adaptiveG);
    /*************************************************************************/
