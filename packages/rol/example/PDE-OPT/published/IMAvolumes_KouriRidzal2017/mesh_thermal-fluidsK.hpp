...
class MeshManager_ThermalFluids : public MeshManager_Rectangle<Real,DeviceType> {
private:
  int nx_;
  int ny_;
...
public:
  ...
  MeshManager_ThermalFluids(ROL::ParameterList &parlist) : MeshManager_Rectangle<Real,DeviceType>(parlist) {
