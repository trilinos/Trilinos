...
#ifndef PDE_GINZBURGLANDAU_EX01K_HPP
#define PDE_GINZBURGLANDAU_EX01K_HPP

#include "pde_ginzburg-landauK.hpp"


template <class Real, class DeviceType>
class PDE_GinzburgLandau_ex01 : public PDE_GinzburgLandau<Real,DeviceType> {
public:
  PDE_GinzburgLandau_ex01(ROL::ParameterList &parlist) : PDE_GinzburgLandau<Real,DeviceType>(parlist) {}
