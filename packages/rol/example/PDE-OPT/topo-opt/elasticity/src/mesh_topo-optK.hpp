...
#ifndef MESHMANAGER_ELASTICITYK_HPP
#define MESHMANAGER_ELASTICITYK_HPP

#include "../../../TOOLS/meshmanagerK.hpp"

template <class Real, class DeviceType>
class MeshManager_TopoOpt : public MeshManager_Rectangle<Real,DeviceType> {
private:
  int nx_;
  int ny_;
  Real height_;
...
public: 
  ...
  MeshManager_TopoOpt(ROL::ParameterList &parlist) : MeshManager_Rectangle<Real,DeviceType>(parlist)
  {
