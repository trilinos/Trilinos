...
#ifndef MESHMANAGER_MULTIMAT_HPP
#define MESHMANAGER_MULTIMAT_HPP

#include "../../../TOOLS/meshmanager.hpp"

template <class Real>
class MeshManager_MultiMat : public MeshManager_Rectangle<Real> {
...
public: 
  ...
  MeshManager_MultiMat(Teuchos::ParameterList &parlist) : MeshManager_Rectangle<Real>(parlist)
  {
