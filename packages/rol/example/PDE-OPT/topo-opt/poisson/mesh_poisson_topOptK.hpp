...
class MeshManager_Poisson_TopOpt : public MeshManager_Rectangle<Real,DeviceType> {
...
public: 
  ...
  MeshManager_Poisson_TopOpt(ROL::ParameterList &parlist) : MeshManager_Rectangle<Real,DeviceType>(parlist)
  {
