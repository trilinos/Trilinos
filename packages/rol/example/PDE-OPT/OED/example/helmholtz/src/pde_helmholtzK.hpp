...
#ifndef PDE_HELMHOLTZ_OCT_REALK_HPP
#define PDE_HELMHOLTZ_OCT_REALK_HPP
...
class PDE_Helmholtz_OCT : public PDE<Real,DeviceType> {
public:
...
public:
  PDE_Helmholtz_OCT(ROL::ParameterList &parlist) {
  ...
  void Jacobian_1(scalar_view & jac,
    ...
    rst::scale(kappaN,static_cast<Real>(-1));

    /*** Evaluate weak form of the Jacobian. ***/
    fst::integrate(jac,kappaN,fe_->NdetJ(),false);
