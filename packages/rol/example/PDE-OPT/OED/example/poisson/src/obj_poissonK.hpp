...
#ifndef PDEOPT_QOI_OED_POISSONK_HPP
#define PDEOPT_QOI_OED_POISSONK_HPP
...
class QoI_Poisson_Observation : public QoI<Real,DeviceType> {
public:
...
public:
  QoI_Poisson_Observation(const ROL::Ptr<fe_type> &fe,ROL::ParameterList &parlist)
    : fe_(fe) {
