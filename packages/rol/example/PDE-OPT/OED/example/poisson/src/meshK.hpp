...
#ifndef OED_POISSON_MESHK_HPP
#define OED_POISSON_MESHK_HPP

#include "../../../../TOOLS/meshmanagerK.hpp"

template <class Real, class DeviceType>
class MeshManager_OED_Poisson : public MeshManager_Rectangle<Real,DeviceType> {
...
public: 
  ...
  MeshManager_OED_Poisson(ROL::ParameterList &parlist) : MeshManager_Rectangle<Real,DeviceType>(parlist)
  {
