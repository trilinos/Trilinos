...
class MeshManager_adv_diff : public MeshManager_Rectangle<Real,DeviceType> {
...
public: 
  ...
  MeshManager_adv_diff(ROL::ParameterList &parlist) : MeshManager_Rectangle<Real,DeviceType>(parlist)
  {
