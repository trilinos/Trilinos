  ...
  void gradient_1(scalar_view & grad,
    ...
    if (d==2) {
      ...
      for (int i = 0; i < d; ++i) {
        ...
        fst::integrate(G[i],curlU_vec[i2],feVel_->DNDdetJ(i1),true);
      }
    }
  ...
  void HessVec_11(scalar_view & hess,
    ...
    if (d==2) {
      ...
      for (int i = 0; i < d; ++i) {
        ...
        fst::integrate(H[i],curlV_vec[i2],feVel_->DNDdetJ(i1),true);
      }
    }
...
public:
  ...
  Real value(scalar_view & val,
    ...
    scalar_view gradUY_eval("gradUY_eval", p, d);
...
public:
  ...
  void HessVec_11(scalar_view & hess,
    ...
    scalar_view weighted_valVY_eval("valVY_eval", c, p);
