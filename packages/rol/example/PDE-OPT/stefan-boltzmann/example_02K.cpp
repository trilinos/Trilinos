...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    //  = ROL::makePtr<StochasticStefanBoltzmannMeshManager<RealT,DeviceT>>(*parlist);
    ...
    auto yz_ptr = ROL::makePtr<std::vector<RealT>>(controlDim);
    ...
    qoi_vec[1] = ROL::makePtr<QoI_AdvectionCost<RealT,DeviceT>>();
    auto std_obj = ROL::makePtr<StochasticStefanBoltzmannStdObjective<RealT>>(*parlist);
