...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    //auto qoi = ROL::makePtr<QoI_Velocity_NavierStokes<RealT,DeviceT>>(*parlist,
    //                                                                  pde->getVelocityFE(),
    //                                                                  pde->getPressureFE(),
    //                                                                  pde->getVelocityBdryFE(4),
    //                                                                  pde->getBdryCellLocIds(4),
    //                                                                  pde->getStateFieldInfo());
    auto qoi = ROL::makePtr<QoI_VelocityTracking_NavierStokes<RealT,DeviceT>>(*parlist,
                                                                              pde->getVelocityFE(),
                                                                              pde->getPressureFE(),
                                                                              pde->getStateFieldInfo());
