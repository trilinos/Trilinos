...
struct NodalBasis{
        ...
        NodalBasis(ROL::SharedPointer<Teuchos::LAPACK<int,Real> > lapack, const int ni, const int nq);    
        ~NodalBasis();
        ...
        ROL::SharedPointer<Lagrange<Real> > lagrange_; 
...
*/
template<class Real>
NodalBasis<Real>::NodalBasis(ROL::SharedPointer<Teuchos::LAPACK<int,Real> > const lapack, const int ni, const int nq): 
    ...
    lagrange_ = ROL::makeShared<Lagrange<Real>>(xi_,xq_);
