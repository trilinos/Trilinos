...
template<class Real>
void rec_jacobi( const Teuchos::LAPACK<int,Real> * const lapack,
                 const double alpha, 
                 const double beta,
                 std::vector<Real> &a,
                 std::vector<Real> &b ) {
...
template<class Real>
void gauss( const Teuchos::LAPACK<int,Real> * const lapack,
...
template<class Real>
void rec_lobatto( const Teuchos::LAPACK<int,Real> * const lapack,
                  const double xl1, 
                  const double xl2,
                  std::vector<Real> &a,
                  std::vector<Real> &b ) {
