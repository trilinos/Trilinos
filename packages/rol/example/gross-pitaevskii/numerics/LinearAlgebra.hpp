...
template<class Real>
void trisolve(ROL::SharedPointer<Teuchos::LAPACK<int,Real> > lapack,
 ...
 */
template<class Real>
void lusolve(ROL::SharedPointer<Teuchos::LAPACK<int,Real> > lapack,
             const std::vector<Real> &A,
             const std::vector<Real> &B,
                   std::vector<Real> &X) {
 ...
 */
template<class Real>
void cholsolve(ROL::SharedPointer<Teuchos::LAPACK<int,Real> > lapack,
               const std::vector<Real> &A,
               const std::vector<Real> &B,
                     std::vector<Real> &X) {
