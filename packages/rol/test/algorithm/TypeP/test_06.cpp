...
/*! \file  test_06.cpp
    \brief Validate inexact proximal Newton algorithm.
*/
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    ROL::Ptr<ROL::TypeP::InexactNewtonAlgorithm<RealT>> algo;
    ...
    *outStream << std::endl << "Random Diagonal LASSO Test Problem" << std::endl << std::endl;
    ...
    algo = ROL::makePtr<ROL::TypeP::InexactNewtonAlgorithm<RealT>>(list);
