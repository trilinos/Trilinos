...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    ROL::Ptr<ROL::TypeB::PrimalDualActiveSetAlgorithm<RealT>> algo;
    ...
    *outStream << std::endl << "Hock and Schittkowski Problem #41" << std::endl << std::endl;
    ...
    algo = ROL::makePtr<ROL::TypeB::PrimalDualActiveSetAlgorithm<RealT>>(list);
    ...
    *outStream << "  Max-Error = " << err << std::endl;
    ...
    list.sublist("General").sublist("Secant").set("Use as Hessian",false);
