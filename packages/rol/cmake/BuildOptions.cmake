...
SET_DEFAULT( ROL_BLAS          "Teuchos::BLAS"          )
...
IF( ROL_ParameterList STREQUAL "boost::property_tree")
  ...
  SET( USING_TEUCHOS_ALL OFF )
  SET( USING_TEUCHOS_ALL OFF PARENT_SCOPE )
ELSEIF( ROL_ParameterList STREQUAL "simple" ) 
  SET_PROPERTY( GLOBAL PROPERTY PARAMETERLIST_IMPL "simple" )
  SET_PROPERTY( GLOBAL PROPERTY PARAMETERLIST_DIR  "${DIR}/simple/parameterlist" )
  SET( USING_TEUCHOS_ALL OFF )
  SET( USING_TEUCHOS_ALL OFF PARENT_SCOPE )
ELSE()
...
# Set blas
IF( ROL_BLAS STREQUAL "simple")
  SET_PROPERTY( GLOBAL PROPERTY BLAS_IMPL "simple"       )
  SET_PROPERTY( GLOBAL PROPERTY BLAS_DIR  "${DIR}/simple/blas" )
  SET( USING_TEUCHOS_ALL OFF )
  SET( USING_TEUCHOS_ALL OFF PARENT_SCOPE )
ELSE()
  SET_PROPERTY( GLOBAL PROPERTY BLAS_IMPL "Teuchos::BLAS"       )
  SET_PROPERTY( GLOBAL PROPERTY BLAS_DIR  "${DIR}/teuchos/blas" )
ENDIF()
