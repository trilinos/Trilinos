...
SET_PROPERTY( GLOBAL PROPERTY TEUCHOS_MPI           "Teuchos::GlobalMPISession" )

SET_PROPERTY( GLOBAL PROPERTY BACKWARD_CPP          "backward-cpp"           )

SET_PROPERTY( GLOBAL PROPERTY SIMPLE_STACKTRACE     "simple"                 )
SET_PROPERTY( GLOBAL PROPERTY SIMPLE_MPI            "simple"                 )
...
SET_DEFAULT( ROL_MPI           "Teuchos::GlobalMPISession" )
...
IF( ROL_LinearAlgebra STREQUAL "Eigen")
  ...
  TRIBITS_INCLUDE_DIRECTORIES(${EIGEN3_INCLUDE_DIR})
  SET( USING_TEUCHOS_ALL OFF )
  SET( USING_TEUCHOS_ALL OFF PARENT_SCOPE )
ELSE()
...
# Set MPI
IF( ROL_MPI STREQUAL "simple")
  SET_PROPERTY( GLOBAL PROPERTY MPI_IMPL "simple"       )
  SET_PROPERTY( GLOBAL PROPERTY MPI_DIR  "${DIR}/simple/mpi" )
  SET( USING_TEUCHOS_ALL OFF )
  SET( USING_TEUCHOS_ALL OFF PARENT_SCOPE )
ELSE()
  SET_PROPERTY( GLOBAL PROPERTY MPI_IMPL "Teuchos::GlobalMPISession"       )
  SET_PROPERTY( GLOBAL PROPERTY MPI_DIR  "${DIR}/teuchos/mpi" )
ENDIF()
