...
echo "    MN///++oymNo          \`s  \` +:   sMM-       "
echo "    MN        oMy       \`\`.\`   /:   +MMM-       "
echo "    MN         NN\`  .odNNNNNh+\`.   :MmmM-       "
echo "    MN        /Md  sMd/\`   .+mN/  :Nm.dM-       "
echo "    MN  :://odNy\` oMs        \`dM--NN. dM-       "
echo "    MN  -dMm+:\`   hM:         sMyNN.  dM-       "
echo "    MN    oMd.    :Mm.       :NMMm.   dM-       " 
echo "    MN     -dN+    -dMh+::/odMMMd\`    dM-       "
echo "    MN       oMd.    .+shhys+hMy\`     dMmddddddd"
echo "    ym-       \`\`\`          -mM+       \`\`\`\`\`\`\`\`\`\`"
echo "    -NN:                 \`oMd-                  "
echo "     .dMs\`              /mNo                    "
echo "       +Nm/          \`+mMs\`                     "
