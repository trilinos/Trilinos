...
void bind_ROL_TypeB_Algorithm(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // ROL::TypeB::AlgorithmState file:ROL_TypeB_Algorithm.hpp line:62
		pybind11::class_<ROL::TypeB::AlgorithmState<double>, std::shared_ptr<ROL::TypeB::AlgorithmState<double>>, ROL::AlgorithmState<double>> cl(M("ROL::TypeB"), "AlgorithmState_double_t", "", pybind11::module_local());
	...
	{ // ROL::TypeB::Algorithm file:ROL_TypeB_Algorithm.hpp line:84
		pybind11::class_<ROL::TypeB::Algorithm<double>, std::shared_ptr<ROL::TypeB::Algorithm<double>>> cl(M("ROL::TypeB"), "Algorithm_double_t", "", pybind11::module_local());
	...
	{ // ROL::TypeB::GradientAlgorithm file:ROL_TypeB_GradientAlgorithm.hpp line:57
		pybind11::class_<ROL::TypeB::GradientAlgorithm<double>, std::shared_ptr<ROL::TypeB::GradientAlgorithm<double>>, PyCallBack_ROL_TypeB_GradientAlgorithm_double_t, ROL::TypeB::Algorithm<double>> cl(M("ROL::TypeB"), "GradientAlgorithm_double_t", "", pybind11::module_local());
	...
	{ // ROL::TypeB::NewtonKrylovAlgorithm file:ROL_TypeB_NewtonKrylovAlgorithm.hpp line:59
		pybind11::class_<ROL::TypeB::NewtonKrylovAlgorithm<double>, std::shared_ptr<ROL::TypeB::NewtonKrylovAlgorithm<double>>, PyCallBack_ROL_TypeB_NewtonKrylovAlgorithm_double_t, ROL::TypeB::Algorithm<double>> cl(M("ROL::TypeB"), "NewtonKrylovAlgorithm_double_t", "", pybind11::module_local());
		...
		cl.def( pybind11::init( [](class Teuchos::ParameterList & a0, const class std::shared_ptr<class ROL::Krylov<double> > & a1){ return new ROL::TypeB::NewtonKrylovAlgorithm<double>(a0, a1); }, [](class Teuchos::ParameterList & a0, const class std::shared_ptr<class ROL::Krylov<double> > & a1){ return new PyCallBack_ROL_TypeB_NewtonKrylovAlgorithm_double_t(a0, a1); } ), "doc");
		cl.def( pybind11::init<class Teuchos::ParameterList &, const class std::shared_ptr<class ROL::Krylov<double> > &, const class std::shared_ptr<class ROL::Secant<double> > &>(), pybind11::arg("list"), pybind11::arg("krylov"), pybind11::arg("secant") );
