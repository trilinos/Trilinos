...
{
	{ // ROL::TypeB::LinMoreAlgorithm file:ROL_TypeB_LinMoreAlgorithm.hpp line:61
		pybind11::class_<ROL::TypeB::LinMoreAlgorithm<double>, std::shared_ptr<ROL::TypeB::LinMoreAlgorithm<double>>, PyCallBack_ROL_TypeB_LinMoreAlgorithm_double_t, ROL::TypeB::Algorithm<double>> cl(M("ROL::TypeB"), "LinMoreAlgorithm_double_t", "", pybind11::module_local());
