...
void bind_std_postypes(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // std::fpos file:bits/postypes.h line:112
		pybind11::class_<std::fpos<__mbstate_t>, Teuchos::RCP<std::fpos<__mbstate_t>>> cl(M("std"), "fpos___mbstate_t_t", "");
	...
	{ // std::exception file:bits/exception.h line:60
		pybind11::class_<std::exception, Teuchos::RCP<std::exception>, PyCallBack_std_exception> cl(M("std"), "exception", "");
