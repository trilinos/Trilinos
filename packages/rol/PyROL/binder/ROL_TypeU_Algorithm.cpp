...
void bind_ROL_TypeU_Algorithm(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // ROL::TypeU::AlgorithmState file:ROL_TypeU_Algorithm.hpp line:60
		pybind11::class_<ROL::TypeU::AlgorithmState<double>, std::shared_ptr<ROL::TypeU::AlgorithmState<double>>, ROL::AlgorithmState<double>> cl(M("ROL::TypeU"), "AlgorithmState_double_t", "", pybind11::module_local());
	...
	{ // ROL::TypeU::Algorithm file:ROL_TypeU_Algorithm.hpp line:83
		pybind11::class_<ROL::TypeU::Algorithm<double>, std::shared_ptr<ROL::TypeU::Algorithm<double>>> cl(M("ROL::TypeU"), "Algorithm_double_t", "", pybind11::module_local());
