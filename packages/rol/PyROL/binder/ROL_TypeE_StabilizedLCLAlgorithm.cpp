...
{
	{ // ROL::TypeE::StabilizedLCLAlgorithm file:ROL_TypeE_StabilizedLCLAlgorithm.hpp line:62
		pybind11::class_<ROL::TypeE::StabilizedLCLAlgorithm<double>, std::shared_ptr<ROL::TypeE::StabilizedLCLAlgorithm<double>>, PyCallBack_ROL_TypeE_StabilizedLCLAlgorithm_double_t, ROL::TypeE::Algorithm<double>> cl(M("ROL::TypeE"), "StabilizedLCLAlgorithm_double_t", "", pybind11::module_local());
