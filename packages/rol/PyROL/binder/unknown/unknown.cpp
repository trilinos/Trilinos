#include <PyROL_clone_shared.hpp>
...
void bind_unknown_unknown(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // ROL::Vector_SimOpt file: line:30
		...
		cl.def("clone", (class std::shared_ptr<class ROL::Vector<double> > (ROL::Vector_SimOpt<double>::*)() const) &ROL::Vector_SimOpt<double>::clone, "C++: ROL::Vector_SimOpt<double>::clone() const --> class std::shared_ptr<class ROL::Vector<double> >");
		...
		cl.def("basis", (class std::shared_ptr<class ROL::Vector<double> > (ROL::Vector_SimOpt<double>::*)(const int) const) &ROL::Vector_SimOpt<double>::basis, "C++: ROL::Vector_SimOpt<double>::basis(const int) const --> class std::shared_ptr<class ROL::Vector<double> >", pybind11::arg("i"));
		...
		cl.def("get_1", (class std::shared_ptr<class ROL::Vector<double> > (ROL::Vector_SimOpt<double>::*)()) &ROL::Vector_SimOpt<double>::get_1, "C++: ROL::Vector_SimOpt<double>::get_1() --> class std::shared_ptr<class ROL::Vector<double> >");
		cl.def("get_2", (class std::shared_ptr<class ROL::Vector<double> > (ROL::Vector_SimOpt<double>::*)()) &ROL::Vector_SimOpt<double>::get_2, "C++: ROL::Vector_SimOpt<double>::get_2() --> class std::shared_ptr<class ROL::Vector<double> >");
	...
	{ // ROL::QuadraticObjective file: line:34
		pybind11::class_<ROL::QuadraticObjective<double>, std::shared_ptr<ROL::QuadraticObjective<double>>, PyCallBack_ROL_QuadraticObjective_double_t, ROL::Objective<double>> cl(M("ROL"), "QuadraticObjective_double_t", "", pybind11::module_local());
		cl.def( pybind11::init( [](const class std::shared_ptr<const class ROL::LinearOperator<double> > & a0, const class std::shared_ptr<const class ROL::Vector<double> > & a1){ return new ROL::QuadraticObjective<double>(a0, a1); }, [](const class std::shared_ptr<const class ROL::LinearOperator<double> > & a0, const class std::shared_ptr<const class ROL::Vector<double> > & a1){ return new PyCallBack_ROL_QuadraticObjective_double_t(a0, a1); } ), "doc");
		cl.def( pybind11::init<const class std::shared_ptr<const class ROL::LinearOperator<double> > &, const class std::shared_ptr<const class ROL::Vector<double> > &, double>(), pybind11::arg("H"), pybind11::arg("g"), pybind11::arg("c") );
