...
void bind_ROL_TypeE_Algorithm(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // ROL::TypeE::AlgorithmState file:ROL_TypeE_Algorithm.hpp line:60
		pybind11::class_<ROL::TypeE::AlgorithmState<double>, std::shared_ptr<ROL::TypeE::AlgorithmState<double>>, ROL::AlgorithmState<double>> cl(M("ROL::TypeE"), "AlgorithmState_double_t", "", pybind11::module_local());
	...
	{ // ROL::TypeE::Algorithm file:ROL_TypeE_Algorithm.hpp line:88
		pybind11::class_<ROL::TypeE::Algorithm<double>, std::shared_ptr<ROL::TypeE::Algorithm<double>>> cl(M("ROL::TypeE"), "Algorithm_double_t", "", pybind11::module_local());
