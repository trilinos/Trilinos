...
struct PyCallBack_Teuchos_basic_FancyOStream_buf_char_std_char_traits_char_t : public Teuchos::basic_FancyOStream_buf<char,std::char_traits<char>> {
	...
	class std::basic_streambuf<char> * setbuf(char * a0, long a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const Teuchos::basic_FancyOStream_buf<char,std::char_traits<char>> *>(this), "setbuf");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
	...
	class std::fpos<__mbstate_t> seekoff(long a0, enum std::_Ios_Seekdir a1, enum std::_Ios_Openmode a2) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const Teuchos::basic_FancyOStream_buf<char,std::char_traits<char>> *>(this), "seekoff");
		if (overload) {
	...
	class std::fpos<__mbstate_t> seekpos(class std::fpos<__mbstate_t> a0, enum std::_Ios_Openmode a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const Teuchos::basic_FancyOStream_buf<char,std::char_traits<char>> *>(this), "seekpos");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<class std::fpos<__mbstate_t>>::value) {
				static pybind11::detail::override_caster_t<class std::fpos<__mbstate_t>> caster;
...
// Teuchos::InvalidArrayStringRepresentation file:Teuchos_Array.hpp line:68
...
// Teuchos::EmptyXMLError file:Teuchos_XMLObject.hpp line:55
...
// Teuchos::ParameterListModifier file:Teuchos_ParameterListModifier.hpp line:68
...
void bind_Teuchos_FancyOStream(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Teuchos::basic_FancyOStream file:Teuchos_FancyOStream.hpp line:381
		...
		cl.def("setShowLinePrefix", (class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > & (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)(const bool)) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setShowLinePrefix, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setShowLinePrefix(const bool) --> class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &", pybind11::return_value_policy::automatic, pybind11::arg("showLinePrefix"));
		cl.def("setMaxLenLinePrefix", (class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > & (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)(const int)) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setMaxLenLinePrefix, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setMaxLenLinePrefix(const int) --> class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &", pybind11::return_value_policy::automatic, pybind11::arg("maxLenLinePrefix"));
		cl.def("setShowTabCount", (class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > & (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)(const bool)) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setShowTabCount, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setShowTabCount(const bool) --> class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &", pybind11::return_value_policy::automatic, pybind11::arg("showTabCount"));
		cl.def("setShowProcRank", (class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > & (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)(const bool)) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setShowProcRank, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setShowProcRank(const bool) --> class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &", pybind11::return_value_policy::automatic, pybind11::arg("showProcRank"));
		cl.def("setProcRankAndSize", (class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > & (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)(const int, const int)) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setProcRankAndSize, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setProcRankAndSize(const int, const int) --> class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &", pybind11::return_value_policy::automatic, pybind11::arg("procRank"), pybind11::arg("numProcs"));
		cl.def("setOutputToRootOnly", (class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > & (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)(const int)) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setOutputToRootOnly, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::setOutputToRootOnly(const int) --> class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &", pybind11::return_value_policy::automatic, pybind11::arg("rootRank"));
		cl.def("getOutputToRootOnly", (int (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)() const) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::getOutputToRootOnly, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::getOutputToRootOnly() const --> int");
		cl.def("copyAllOutputOptions", (void (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)(const class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &)) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::copyAllOutputOptions, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::copyAllOutputOptions(const class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &) --> void", pybind11::arg("oStream"));
		cl.def("pushTab", [](Teuchos::basic_FancyOStream<char,std::char_traits<char>> &o) -> void { return o.pushTab(); }, "");
		cl.def("pushTab", (void (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)(const int)) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::pushTab, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::pushTab(const int) --> void", pybind11::arg("tabs"));
		cl.def("getNumCurrTabs", (int (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)() const) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::getNumCurrTabs, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::getNumCurrTabs() const --> int");
		cl.def("popTab", (void (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)()) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::popTab, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::popTab() --> void");
		cl.def("pushLinePrefix", (void (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)(const std::string &)) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::pushLinePrefix, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::pushLinePrefix(const std::string &) --> void", pybind11::arg("linePrefix"));
		cl.def("popLinePrefix", (void (Teuchos::basic_FancyOStream<char,std::char_traits<char>>::*)()) &Teuchos::basic_FancyOStream<char, std::char_traits<char> >::popLinePrefix, "C++: Teuchos::basic_FancyOStream<char, std::char_traits<char> >::popLinePrefix() --> void");
	...
	{ // Teuchos::DescribableStreamManipulatorState file:Teuchos_Describable.hpp line:175
		...
		cl.def("__str__", [](Teuchos::DescribableStreamManipulatorState const &o) -> std::string { std::ostringstream s; Teuchos::operator<<(s, o); return s.str(); } );
	}
	...
	{ // Teuchos::InvalidArrayStringRepresentation file:Teuchos_Array.hpp line:68
		pybind11::class_<Teuchos::InvalidArrayStringRepresentation, Teuchos::RCP<Teuchos::InvalidArrayStringRepresentation>, PyCallBack_Teuchos_InvalidArrayStringRepresentation, std::logic_error> cl(M("Teuchos"), "InvalidArrayStringRepresentation", ".\n\n \n\n ", pybind11::module_local());
	...
	{ // Teuchos::Array file:Teuchos_Array.hpp line:194
		...
		cl.def("__str__", [](Teuchos::Array<Teuchos::XMLObject> const &o) -> std::string { std::ostringstream s; Teuchos::operator<<(s, o); return s.str(); } );
	}
	{ // Teuchos::Array file:Teuchos_Array.hpp line:194
		...
		cl.def("__str__", [](Teuchos::Array<std::string> const &o) -> std::string { std::ostringstream s; Teuchos::operator<<(s, o); return s.str(); } );
	}
	// Teuchos::extractDataFromISS(class std::basic_istringstream<char> &, std::string &) file:Teuchos_Array.hpp line:730
	M("Teuchos").def("extractDataFromISS", (void (*)(class std::basic_istringstream<char> &, std::string &)) &Teuchos::extractDataFromISS, "Extracts std::string data from an istringstream object\n \n\n This function overloads the templated  function\n         and is necessary for the proper extraction of std::string objects\n         by the  function.\n \n\n\n \n\nC++: Teuchos::extractDataFromISS(class std::basic_istringstream<char> &, std::string &) --> void", pybind11::arg("iss"), pybind11::arg("data"));

	// Teuchos::getArrayTypeNameTraitsFormat() file:Teuchos_Array.hpp line:748
	...
	{ // Teuchos::XMLObjectImplem file:Teuchos_XMLObjectImplem.hpp line:62
	...
	{ // Teuchos::EmptyXMLError file:Teuchos_XMLObject.hpp line:55
		pybind11::class_<Teuchos::EmptyXMLError, Teuchos::RCP<Teuchos::EmptyXMLError>, PyCallBack_Teuchos_EmptyXMLError, std::runtime_error> cl(M("Teuchos"), "EmptyXMLError", "Thrown when attempting to parse an empty XML std::string.", pybind11::module_local());
		cl.def( pybind11::init<const std::string &>(), pybind11::arg("what_arg") );
	...
	{ // Teuchos::XMLObject file:Teuchos_XMLObject.hpp line:62
		...
		cl.def("__str__", [](Teuchos::XMLObject const &o) -> std::string { std::ostringstream s; Teuchos::operator<<(s, o); return s.str(); } );
	}
	// Teuchos::toString(const class Teuchos::XMLObject &) file:Teuchos_XMLObject.hpp line:261
	...
	{ // Teuchos::ParameterEntry file:Teuchos_ParameterEntry.hpp line:67
	...
	{ // Teuchos::FilteredIterator file:Teuchos_FilteredIterator.hpp line:60
		pybind11::class_<Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>, Teuchos::RCP<Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>>> cl(M("Teuchos"), "FilteredIterator_std__Deque_iterator_Teuchos_StringIndexedOrderedValueObjectContainerBase_KeyObjectPair_Teuchos_ParameterEntry_Teuchos_StringIndexedOrderedValueObjectContainerBase_KeyObjectPair_Teuchos_ParameterEntry_&_Teuchos_StringIndexedOrderedValueObjectContainerBase_KeyObjectPair_Teuchos_ParameterEntry__star__Teuchos_StringIndexedOrderedValueObjectContainerBase_SelectActive_Teuchos_ParameterEntry_t", "", pybind11::module_local());
		cl.def( pybind11::init( [](){ return new Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>(); } ) );
		cl.def( pybind11::init( [](Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>> const &o){ return new Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>(o); } ) );
		cl.def("dereference", (class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> & (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)() const) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator*, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator*() const --> class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &", pybind11::return_value_policy::automatic);
		cl.def("arrow", (class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> * (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)() const) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator->, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator->() const --> class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *", pybind11::return_value_policy::automatic);
		cl.def("pre_increment", (class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > & (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)()) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator++, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator++() --> class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > &", pybind11::return_value_policy::automatic);
		cl.def("post_increment", (const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)(int)) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator++, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator++(int) --> const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> >", pybind11::arg(""));
		cl.def("pre_decrement", (class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > & (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)()) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator--, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator--() --> class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > &", pybind11::return_value_policy::automatic);
		cl.def("post_decrement", (const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)(int)) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator--, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator--(int) --> const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> >", pybind11::arg(""));
		cl.def("pred", (class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)() const) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::pred, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::pred() const --> class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry>");

		cl.def("__str__", [](Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>> const &o) -> std::string { std::ostringstream s; Teuchos::operator<<(s, o); return s.str(); } );
	}
	{ // Teuchos::FilteredIterator file:Teuchos_FilteredIterator.hpp line:60
		pybind11::class_<Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>, Teuchos::RCP<Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>>> cl(M("Teuchos"), "FilteredIterator_std__Deque_iterator_Teuchos_StringIndexedOrderedValueObjectContainerBase_KeyObjectPair_Teuchos_ParameterEntry_const_Teuchos_StringIndexedOrderedValueObjectContainerBase_KeyObjectPair_Teuchos_ParameterEntry_&_const_Teuchos_StringIndexedOrderedValueObjectContainerBase_KeyObjectPair_Teuchos_ParameterEntry__star__Teuchos_StringIndexedOrderedValueObjectContainerBase_SelectActive_Teuchos_ParameterEntry_t", "", pybind11::module_local());
		cl.def( pybind11::init( [](){ return new Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>(); } ) );
		cl.def( pybind11::init( [](Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>> const &o){ return new Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>(o); } ) );
		cl.def("assign", (class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > & (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)(const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > &)) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator=<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator=(const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > &) --> class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > &", pybind11::return_value_policy::automatic, pybind11::arg("rhs"));
		cl.def("dereference", (const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> & (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)() const) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator*, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator*() const --> const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &", pybind11::return_value_policy::automatic);
		cl.def("arrow", (const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> * (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)() const) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator->, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator->() const --> const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *", pybind11::return_value_policy::automatic);
		cl.def("pre_increment", (class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > & (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)()) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator++, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator++() --> class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > &", pybind11::return_value_policy::automatic);
		cl.def("post_increment", (const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)(int)) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator++, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator++(int) --> const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> >", pybind11::arg(""));
		cl.def("pre_decrement", (class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > & (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)()) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator--, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator--() --> class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > &", pybind11::return_value_policy::automatic);
		cl.def("post_decrement", (const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > (Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>>::*)(int)) &Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator--, "C++: Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>, Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry> >::operator--(int) --> const class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> >", pybind11::arg(""));
	...
	{ // Teuchos::StringIndexedOrderedValueObjectContainerBase file:Teuchos_StringIndexedOrderedValueObjectContainer.hpp line:59
	...
	{ // Teuchos::StringIndexedOrderedValueObjectContainer file:Teuchos_StringIndexedOrderedValueObjectContainer.hpp line:180
		...
		cl.def("setObj", (long (Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::*)(const std::string &, const class Teuchos::ParameterEntry &)) &Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::setObj, "C++: Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::setObj(const std::string &, const class Teuchos::ParameterEntry &) --> long", pybind11::arg("key"), pybind11::arg("obj"));
		...
		cl.def("nonconstBegin", (class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > (Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::*)()) &Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::nonconstBegin, "C++: Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::nonconstBegin() --> class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> >");
		cl.def("nonconstEnd", (class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > (Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::*)()) &Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::nonconstEnd, "C++: Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::nonconstEnd() --> class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> >");
		cl.def("begin", (class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > (Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::*)() const) &Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::begin, "C++: Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::begin() const --> class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> >");
		cl.def("end", (class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> > (Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::*)() const) &Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::end, "C++: Teuchos::StringIndexedOrderedValueObjectContainer<Teuchos::ParameterEntry>::end() const --> class Teuchos::FilteredIterator<struct std::_Deque_iterator<class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry>, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> &, const class Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<class Teuchos::ParameterEntry> *>, class Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<class Teuchos::ParameterEntry> >");
	...
	// Teuchos::EValidateUsed file:Teuchos_ParameterList.hpp line:69
...
;
	...
	// Teuchos::EValidateDefaults file:Teuchos_ParameterList.hpp line:81
...
;
	...
	{ // Teuchos::ParameterList file:Teuchos_ParameterList.hpp line:133
		...
		cl.def("__str__", [](Teuchos::ParameterList const &o) -> std::string { std::ostringstream s; Teuchos::operator<<(s, o); return s.str(); } );
	...
	// Teuchos::parameterList() file:Teuchos_ParameterList.hpp line:813
	...
	// Teuchos::parameterList(const std::string &) file:Teuchos_ParameterList.hpp line:824
	...
	// Teuchos::parameterList(const class Teuchos::ParameterList &) file:Teuchos_ParameterList.hpp line:835
	...
	// Teuchos::createParameterList() file:Teuchos_ParameterList.hpp line:846
	...
	// Teuchos::createParameterList(const std::string &) file:Teuchos_ParameterList.hpp line:857
	...
	{ // Teuchos::TypeNameTraits file:Teuchos_ParameterList.hpp line:868
		pybind11::class_<Teuchos::TypeNameTraits<Teuchos::ParameterList>, Teuchos::RCP<Teuchos::TypeNameTraits<Teuchos::ParameterList>>> cl(M("Teuchos"), "TypeNameTraits_Teuchos_ParameterList_t", "Traits specialization.\n\n \n\n ", pybind11::module_local());
		cl.def( pybind11::init( [](){ return new Teuchos::TypeNameTraits<Teuchos::ParameterList>(); } ) );
		cl.def_static("name", (std::string (*)()) &Teuchos::TypeNameTraits<Teuchos::ParameterList>::name, "C++: Teuchos::TypeNameTraits<Teuchos::ParameterList>::name() --> std::string");
		cl.def_static("concreteName", (std::string (*)(const class Teuchos::ParameterList &)) &Teuchos::TypeNameTraits<Teuchos::ParameterList>::concreteName, "C++: Teuchos::TypeNameTraits<Teuchos::ParameterList>::concreteName(const class Teuchos::ParameterList &) --> std::string", pybind11::arg(""));
	}
	// Teuchos::haveSameModifiers(const class Teuchos::ParameterList &, const class Teuchos::ParameterList &) file:Teuchos_ParameterList.hpp line:903
	...
	// Teuchos::haveSameValues(const class Teuchos::ParameterList &, const class Teuchos::ParameterList &, bool) file:Teuchos_ParameterList.hpp line:918
	...
	// Teuchos::haveSameValuesSorted(const class Teuchos::ParameterList &, const class Teuchos::ParameterList &, bool) file:Teuchos_ParameterList.hpp line:933
	...
	// Teuchos::getParameter(const class Teuchos::ParameterList &, const std::string &) file:Teuchos_ParameterList.hpp line:1332
	...
	// Teuchos::getParameterPtr(const class Teuchos::ParameterList &, const std::string &) file:Teuchos_ParameterList.hpp line:1362
	...
	// Teuchos::sublist(const class Teuchos::RCP<class Teuchos::ParameterList> &, const std::string &, bool, const std::string &) file:Teuchos_ParameterList.hpp line:1574
	...
	{ // Teuchos::InvalidDependencyException file:Teuchos_InvalidDependencyException.hpp line:53
		pybind11::class_<Teuchos::InvalidDependencyException, Teuchos::RCP<Teuchos::InvalidDependencyException>, PyCallBack_Teuchos_InvalidDependencyException, std::logic_error> cl(M("Teuchos"), "InvalidDependencyException", "Thrown when some aspect of a Dependency has been determined to be invalid.", pybind11::module_local());
		cl.def( pybind11::init<const std::string &>(), pybind11::arg("what_arg") );
