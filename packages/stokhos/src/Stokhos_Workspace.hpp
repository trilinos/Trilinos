...
#ifndef STOKHOS_WORKSPACE_HPP
#define STOKHOS_WORKSPACE_HPP
...
namespace Stokhos {
  ...
  //! Workspace class to store linear system for nonlinear SG operations
...
#include "Stokhos_WorkspaceImp.hpp"
      
#endif // STOKHOS_WORKSPACE_HPP
