...
#ifndef STOKHOS_MP_MEAN_BASED_PRECONDITIONER_HPP
#define STOKHOS_MP_MEAN_BASED_PRECONDITIONER_HPP
...
namespace Stokhos {
   ...
   * mean.
   */
  class MPMeanBasedPreconditioner : public Stokhos::MPPreconditioner {
