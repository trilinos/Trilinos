...
#ifndef STOKHOS_APPROX_JACOBI_EPETRA_OP_HPP
#define STOKHOS_APPROX_JACOBI_EPETRA_OP_HPP
...
namespace Stokhos {
   ...
   */
  class ApproxJacobiEpetraOp : public Epetra_Operator {
      
  public:

    //! Constructor 
  ApproxJacobiEpetraOp(
  ...
  private:
    ...
    ApproxJacobiEpetraOp(const ApproxJacobiEpetraOp&);
    
    //! Private to prohibit copying
    ApproxJacobiEpetraOp& operator=(const ApproxJacobiEpetraOp&);
  ...
  }; // class ApproxJacobiEpetraOp
  
} // namespace Stokhos

#endif // STOKHOS_APPROX_JACOBI_EPETRA_OP_HPP
