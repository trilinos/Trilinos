...
template <typename BasisT>
typename Stokhos::Workspace<BasisT>::ordinal_type
Stokhos::Workspace<BasisT>::
solve(typename Stokhos::Workspace<BasisT>::ordinal_type s,
      typename Stokhos::Workspace<BasisT>::ordinal_type nrhs)
{
  ordinal_type info;
