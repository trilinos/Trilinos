...
int block_lu_factor(cusp::array2d<ValueType,MemorySpace,Orientation>& A,
...
template <typename IndexType, typename ValueType, typename MemorySpace, typename Orientation>
int block_lu_solve(const cusp::array2d<ValueType,MemorySpace,Orientation>& A,
             const cusp::array1d<IndexType,MemorySpace>& pivot,
             const cusp::array2d<ValueType,MemorySpace>& b,
                   cusp::array2d<ValueType,MemorySpace>& x, 
		   cusp::array2d_format)
{
    const int n = A.num_rows;
