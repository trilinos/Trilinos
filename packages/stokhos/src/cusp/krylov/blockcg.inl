        ...
        Preconditioner& M)
{
    	...
    	// allocate workspace
    	cusp::array2d<ValueType,MemorySpace> y(N, numRHS, 0); 
    	cusp::array2d<ValueType,MemorySpace> r(N, numRHS, 0);
    	cusp::array2d<ValueType,MemorySpace> z(N, numRHS, 0);
	...
	cusp::array2d<ValueType,MemorySpace> p(N, numRHS,0);
	cusp::array2d<ValueType,MemorySpace> tmp(N, numRHS,0);
