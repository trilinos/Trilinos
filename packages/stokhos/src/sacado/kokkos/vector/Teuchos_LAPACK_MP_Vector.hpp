...
#ifndef _TEUCHOS_LAPACK_MP_VECTOR_HPP_
#define _TEUCHOS_LAPACK_MP_VECTOR_HPP_
...
namespace Teuchos {
  ...
  class LAPACK<OrdinalType, Sacado::MP::Vector<Storage> >
  {
  public:
  ...
  private:
    ...
    void throw_error(const char *func) const {
      TEUCHOS_TEST_FOR_EXCEPTION(
        ...
        func << ":  Not implemented for Sacado::MP::Vector scalar type!");
    }
...
#endif // _TEUCHOS_LAPACK__MP_VECTOR_HPP_
