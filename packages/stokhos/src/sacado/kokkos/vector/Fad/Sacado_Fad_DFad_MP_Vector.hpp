...
#ifndef SACADO_FAD_DFAD_MP_VECTOR_HPP
#define SACADO_FAD_DFAD_MP_VECTOR_HPP
...
namespace Sacado {
  ...
  namespace Fad {
    ...
    struct ExprSpec< DFad< Sacado::MP::Vector< Stokhos::StaticFixedStorage<Ord,Val,VecNum,Dev> > > > {
