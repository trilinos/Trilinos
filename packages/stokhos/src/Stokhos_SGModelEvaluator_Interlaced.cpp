  ...
  if (supports_x) {
	...
	dfdp_sg_blocks[i] = 
	  Teuchos::rcp(new Stokhos::EpetraMultiVectorOrthogPoly(
			 ...
			 me->get_f_map(), interlace_f_map, sg_comm, 
...
Teuchos::Array<int> 
Stokhos::SGModelEvaluator_Interlaced::get_p_sg_indices() const
{
...
Teuchos::Array<int> 
Stokhos::SGModelEvaluator_Interlaced::get_non_p_sg_indices() const
{
...
Teuchos::Array<int> 
Stokhos::SGModelEvaluator_Interlaced::get_g_sg_indices() const
{
...
Teuchos::Array<int> 
Stokhos::SGModelEvaluator_Interlaced::get_non_g_sg_indices() const
{
...
Stokhos::SGModelEvaluator_Interlaced::get_p_sg_base_maps() const
{
