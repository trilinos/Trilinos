...
#ifndef STOKHOS_APPROX_GAUSS_SEIDEL_PRECONDITIONER_HPP
#define STOKHOS_APPROX_GAUSS_SEIDEL_PRECONDITIONER_HPP
...
namespace Stokhos {
   ...
   */
  class ApproxGaussSeidelPreconditioner : public Stokhos::SGPreconditioner {
...
#endif // STOKHOS_APPROX_GAUSS_SEIDEL_PRECONDITIONER_HPP
