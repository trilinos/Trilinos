...
# rythmos directory, and srcDir is the path for the python source directory
...
versionHeader = os.path.join(pakDir,"src","Rythmos_Version.h")
try:
...
# Define the rythmos include path, library directory and library name
rythmosInc    = [os.path.join(pakDir, "src"),
                    os.path.join("..","..","src")]
rythmosLibDir = os.path.join("..", "..", "src")
rythmosLib    = "rythmos"
...
rythmosWrap = "Rythmos_wrap.cpp"

# _Rythmos extension module
_Rythmos = Extension("PyTrilinos._Rythmos",
                         [rythmosWrap],
                         include_dirs       = rythmosInc + [epetraInc, srcDir],
                         library_dirs       = [rythmosLibDir, epetraLibDir],
                         libraries          = [rythmosLib, epetraLib] + stdLibs,
                         extra_compile_args = extraCompileArgs,
                         extra_link_args    = extraLinkArgs
                         )

# PyTrilinos.Rythmos setup.  This is what tells the distutils module how to
# create the package.
setup(name         = "PyTrilinos.Rythmos",
      version      = version,
      description  = "Python Interface to Trilinos Package Rythmos",
      author       = "Bill Spotz",
      author_email = "wfspotz@sandia.gov",
      package_dir  = {"PyTrilinos" : "."},
      packages     = ["PyTrilinos"],
      ext_modules  = [ _Rythmos ]
      )
