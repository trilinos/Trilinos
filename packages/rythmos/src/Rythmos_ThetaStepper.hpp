...
#ifndef Rythmos_THETA_STEPPER_H
#define Rythmos_THETA_STEPPER_H
...
{
  return Teuchos::rcp(new ThetaStepper<Scalar>(model, solver));
}
...
template <class Scalar>
void ThetaStepper<Scalar>::initialize()
{
