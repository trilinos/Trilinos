...
#ifndef Rythmos_IMPLICITBDF_STEPPER_STEP_CONTROL_H
#define Rythmos_IMPLICITBDF_STEPPER_STEP_CONTROL_H

#include "Rythmos_ImplicitBDFStepperStepControlDecl.hpp"
...
int ImplicitBDFStepperStepControl<Scalar>::getMaxOrder() const
{
  TEST_FOR_EXCEPTION(
      stepControlState_ == UNINITIALIZED, std::logic_error,
      "Error, attempting to call getMaxOrder before intiialization!\n"
      );
  return(maxOrder_);
}

} // namespace Rythmos
#endif // Rythmos_IMPLICITBDF_STEPPER_STEP_CONTROL_H
