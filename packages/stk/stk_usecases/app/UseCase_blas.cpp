                        ...
                        bool performance_test)
{
...

  {
    ...
    for(int n=0; n<num_trials; ++n) {
      ...
      fill( *alg_runner, bulk_data , stk::mesh::MetaData::NODE_RANK , *fields.velocity_field, 0.2 );

      fill( *alg_runner, bulk_data , stk::mesh::MetaData::NODE_RANK , *fields.fint_field, 1.0 );

      axpby( *alg_runner, bulk_data , stk::mesh::MetaData::NODE_RANK ,
      ...
      dot1 = dot( *alg_runner, bulk_data, stk::mesh::MetaData::NODE_RANK ,
                  *fields.velocity_field, *fields.coordinates_field );

      double dot2 = dot( *alg_runner, bulk_data, stk::mesh::MetaData::NODE_RANK,
                         *fields.velocity_field, *fields.fint_field );

      double norm_1 = norm2(*alg_runner, bulk_data, stk::mesh::MetaData::NODE_RANK, *fields.velocity_field );

      double norm_2 = norm2(*alg_runner, bulk_data, stk::mesh::MetaData::NODE_RANK, *fields.coordinates_field );
