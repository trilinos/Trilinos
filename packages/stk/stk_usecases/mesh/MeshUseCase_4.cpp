...
UseCase_4_Mesh::UseCase_4_Mesh( stk::ParallelMachine comm, bool doCommit ) :
  ...
  , m_block_wedge18( stk::mesh::declare_part<Wedge18>( m_fem_metaData, "block_2"))
  ...
  , m_element_node_coordinates_field(m_fem_metaData.declare_field< ElementNodePointerFieldType >( "elem_node_coord" ) )
{
  ...
  m_fem_metaData.declare_part_relation(
    m_block_hex27 ,
    & element_node_stencil< Hex8, SpatialDim > ,
    m_part_vertex_nodes );
  ...
  m_fem_metaData.declare_part_relation(
    m_block_wedge18 ,
    & element_node_stencil< Wedge6, SpatialDim > ,
    m_part_vertex_nodes );
  ...
  m_fem_metaData.declare_field_relation(
    ...
    get_element_node_stencil(SpatialDim) ,
    m_coordinates_field
    );
                            ...
                            const mesh::Entity & side )
{
  ...
  const mesh::PairIterRelation rel = side.relations( MetaData::NODE_RANK );
                                 ...
                                 const VectorFieldType & boundary_field )
{
  ...
  const std::vector<Bucket*> & buckets = mesh.buckets( MetaData::NODE_RANK );
