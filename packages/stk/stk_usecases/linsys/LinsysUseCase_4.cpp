                        ...
                        const std::string& mesh_options )
{
...

  {
    ...
    stk::mesh::CellTopology qshell_top(shards::getCellTopologyData<shards::ShellQuadrilateral<> >());
    stk::mesh::set_cell_topology( block_hex, hex_top );
    stk::mesh::set_cell_topology( block_quad_shell, qshell_top );
    ...
    VectorFieldType & coordinates_field =
      stk::mesh::put_field(
        ...
        stk::mesh::MetaData::NODE_RANK , universal , SpatialDim );
...
//    ScalarFieldType & pressure_field =
    ...
    VectorFieldType & rotation_field =
      stk::mesh::put_field(
        ...
        stk::mesh::MetaData::NODE_RANK , block_quad_shell , SpatialDim );
    ...
    stk::mesh::BulkData mesh_bulk_data( fem_meta , comm );
    ...
    stk::linsys::add_connectivities(ls, element_rank, stk::mesh::MetaData::NODE_RANK,
    ...
    stk::linsys::dirichlet_bc(ls, mesh_bulk_data, bcpart, stk::mesh::MetaData::NODE_RANK,
	...
	gmesh.element_map( i, elem_map );
        ...
        if ( top_info.second == 8 ) {
          ...
          for ( size_t j = 0 ; j < num_elem ; ++j ) {
            ...
            stk::mesh::declare_element( mesh , quad_shell_block , elem_id , node_id );
