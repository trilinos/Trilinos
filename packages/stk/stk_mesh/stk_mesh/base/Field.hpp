 ...
 *           stk::mesh::put_field(field, MetaData::NODE_RANK, <part>);
 *
 ...
 *           stk::mesh::put_field(field, MetaData::NODE_RANK, <part>, Cartesian3d::Size);
 *
 ...
 *           stk::mesh::put_field(field, MetaData::NODE_RANK, <part>, Cartesian3d::Size, Cartesian3d::Size);
 *
 * Items of interest
