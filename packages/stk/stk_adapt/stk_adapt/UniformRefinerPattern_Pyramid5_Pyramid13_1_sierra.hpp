#ifndef stk_adapt_UniformRefinerPattern_Pyramid5_Pyramid13_1_sierra_hpp
#define stk_adapt_UniformRefinerPattern_Pyramid5_Pyramid13_1_sierra_hpp
...
#define FACE_BREAKER_P5_P13_1 1
...
namespace stk {
  namespace adapt {
    ...
    template <>
    class UniformRefinerPattern< shards::Pyramid<5>, shards::Pyramid<13>, 1, SierraPort > : public URP<shards::Pyramid<5> , shards::Pyramid<13> >
    {
