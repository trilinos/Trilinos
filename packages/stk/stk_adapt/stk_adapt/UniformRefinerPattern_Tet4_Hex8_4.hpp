#ifndef stk_adapt_UniformRefinerPattern_Tet4_Hex8_4_hpp
#define stk_adapt_UniformRefinerPattern_Tet4_Hex8_4_hpp
...
namespace stk {
  namespace adapt {
    ...
    public:
      ...
      virtual unsigned getNumNewElemPerElem() { return 4u; }
