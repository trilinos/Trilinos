#ifndef stk_adapt_UniformRefinerPattern_ShellTri3_ShellTri6_1_sierra_hpp
#define stk_adapt_UniformRefinerPattern_ShellTri3_ShellTri6_1_sierra_hpp


#include <stk_adapt/sierra_element/RefinementTopology.hpp>
#include <stk_adapt/sierra_element/StdMeshObjTopologies.hpp>

#define EDGE_TRI3_TRI6_1_BREAKER 1
#if EDGE_TRI3_TRI6_1_BREAKER
...
namespace stk {
  namespace adapt {
    ...
    template <>
    class UniformRefinerPattern<shards::ShellTriangle<3>, shards::ShellTriangle<6>, 1, SierraPort > :
      public URP<shards::ShellTriangle<3>,shards::ShellTriangle<6>  >
    {


#if EDGE_TRI3_TRI6_1_BREAKER
      UniformRefinerPattern<shards::ShellLine<2>, shards::ShellLine<3>, 1, SierraPort > * m_edge_breaker;
      UniformRefinerPattern<shards::Triangle<3>, shards::Triangle<6>, 1, SierraPort > * m_face_breaker;
#endif

    public:

      UniformRefinerPattern(percept::PerceptMesh& eMesh, BlockNamesType block_names = BlockNamesType()) :
        URP<shards::ShellTriangle<3>, shards::ShellTriangle<6>  >(eMesh)
      {
        ...
        if (m_eMesh.get_spatial_dim() == 3)
          {
            ...
            m_face_breaker = new UniformRefinerPattern<shards::Triangle<3>, shards::Triangle<6>, 1, SierraPort > (eMesh, block_names) ;
          }
#endif
