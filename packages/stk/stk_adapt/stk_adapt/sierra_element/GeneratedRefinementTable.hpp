...
template<> RefTopoX RefinementTopologyExtra< shards:: Pyramid<13>  > :: refinement_topology = {
  ...
  {	7,	1,	0,	5,	36,	{0,	1,	0} },
  {	8,	1,	0,	8,	36,	{-1,	0,	0} },
  {	9,	1,	0,	11,	36,	{-0.5,	-0.5,	0.5} },
  {	10,	1,	0,	14,	36,	{0.5,	-0.5,	0.5} },
  {	11,	1,	0,	17,	36,	{0.5,	0.5,	0.5} },
  {	12,	1,	0,	20,	36,	{-0.5,	0.5,	0.5} },
  {	13,	1,	0,	24,	36,	{0,	0,	0} },
  {	14,	1,	0,	0,	36,	{-0.5,	-1,	0} },
  {	15,	1,	0,	1,	36,	{0.5,	-1,	0} },
  {	16,	1,	0,	3,	36,	{1,	-0.5,	0} },
  ...
  {	19,	1,	0,	7,	36,	{-0.5,	1,	0} },
  {	20,	1,	0,	9,	36,	{-1,	0.5,	0} },
  {	21,	1,	0,	10,	36,	{-1,	-0.5,	0} },
  {	22,	2,	4,	7,	9,	{0,	0,	0.2} },
  {	23,	2,	4,	4,	9,	{0,	0,	0.2} },
  {	24,	2,	4,	6,	9,	{0,	0,	0.2} },
  {	25,	2,	4,	5,	9,	{0,	0,	0.2} },
  {	26,	1,	0,	12,	36,	{-0.75,	-0.75,	0.25} },
  {	27,	1,	0,	32,	36,	{-0.25,	-0.75,	0.25} },
  {	28,	2,	0,	0,	2,	{0.25,	-0.75,	0.25} },
  {	29,	1,	0,	15,	36,	{0.75,	-0.75,	0.25} },
  {	30,	2,	0,	1,	2,	{0,	-0.5,	0.5} },
  {	31,	1,	0,	34,	36,	{-0.75,	-0.25,	0.25} },
  {	32,	1,	0,	13,	36,	{-0.25,	-0.25,	0.75} },
  {	33,	1,	0,	16,	36,	{0.25,	-0.25,	0.75} },
  {	34,	2,	1,	0,	3,	{0.75,	-0.25,	0.25} },
  {	35,	2,	3,	0,	2,	{-0.5,	0,	0.5} },
  {	36,	2,	1,	2,	3,	{0.5,	0,	0.5} },
  {	37,	2,	3,	1,	2,	{-0.75,	0.25,	0.25} },
  {	38,	1,	0,	22,	36,	{-0.25,	0.25,	0.75} },
  {	39,	1,	0,	19,	36,	{0.25,	0.25,	0.75} },
  {	40,	2,	1,	1,	3,	{0.75,	0.25,	0.25} },
  {	41,	2,	2,	2,	3,	{0,	0.5,	0.5} },
  {	42,	1,	0,	21,	36,	{-0.75,	0.75,	0.25} },
  {	43,	2,	2,	1,	3,	{-0.25,	0.75,	0.25} },
  {	44,	2,	2,	0,	3,	{0.25,	0.75,	0.25} },
  {	45,	1,	0,	18,	36,	{0.75,	0.75,	0.25} },
  {	46,	1,	0,	28,	36,	{0,	-0.5,	0} },
  {	47,	1,	0,	33,	36,	{-0.25,	-0.25,	0.25} },
  {	48,	3,	0,	2,	8,	{0.25,	-0.25,	0.25} },
  {	49,	1,	0,	29,	36,	{-0.5,	0,	0} },
  {	50,	3,	0,	4,	8,	{0.5,	0,	0} },
  {	51,	3,	0,	5,	8,	{-0.25,	0.25,	0.25} },
  {	52,	3,	0,	6,	8,	{0.25,	0.25,	0.25} },
  {	53,	3,	0,	7,	8,	{0,	0.5,	0} } 
