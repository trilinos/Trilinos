#ifndef stk_adapt_UniformRefinerPattern_Wedge6_Hex8_6_hpp
#define stk_adapt_UniformRefinerPattern_Wedge6_Hex8_6_hpp
...
namespace stk {
  namespace adapt {
     ...
     *                   . /  19 \
     *                  . o-._ _.-o 13
     *   face: 17      . /14  *    \              {0, 8, 18, 6,  9, 17, 20, 15 }
     *   0253  \   11 * /     |     \             {1, 6, 18, 7,  10, 15, 20, 16 }
     *          \    . /      |12    \            {2, 7, 18, 8,  11, 16, 20, 17 }
     *           \  . o-------o-------o           {3, 12, 19, 14, 9, 15, 20, 17 }
     *             . . 3            .  4          {4, 13, 19, 12, 10, 16, 20, 15 }
     *          2 . * 9        16  .              {5, 14, 19, 13, 11, 17, 20, 16 }
     *           o .     X 20  /  .
     *          /.\             * 10
     *         /.  \    +15    .
     *        /. 18 \         .
     ...
     * unsigned child[6][8] =  {
     *  {0, 8, 18, 6,  9, 17, 20, 15 },
     *  {1, 6, 18, 7,  10, 15, 20, 16 },
     *  {2, 7, 18, 8,  11, 16, 20, 17 },
     *  {3, 12, 19, 14, 9, 15, 20, 17 },
     *  {4, 13, 19, 12, 10, 16, 20, 15 },
     *  {5, 14, 19, 13, 11, 17, 20, 16 } };
     *
