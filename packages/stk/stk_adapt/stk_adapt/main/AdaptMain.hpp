...
namespace stk {
  namespace adapt {
    ...
    static std::string s_docString = 
      ...
      "\n"
      "stk_adapt_exe --input_mesh=in.e --output_mesh=out.e --refine=DEFAULT\n"
      "\n"
      ...
      "be\n"
      "\n"
      "  stk_adapt_exe --input_mesh=in.e --output_mesh=out.e --refine=DEFAULT --input_geometry=in.3dm\n"
      "\n"
      ...
      "\n"
      "  stk_adapt_exe --input_mesh=in.e --output_mesh=out.e --refine=DEFAULT --number_refines=0\n"
      ...
      "\n"
      "  mpiexec -n P stk_adapt_exe --input_mesh=in.e --output_mesh=out.e\n"
      ...
      "\n"
      "  mpiexec -n P stk_adapt_exe --input_mesh=in.e --output_mesh=out.e --refine=DEFAULT\n"
