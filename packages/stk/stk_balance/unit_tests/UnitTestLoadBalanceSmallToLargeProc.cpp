...
protected:
    ...
    virtual const unsigned get_z() const { return 3; }

    virtual const unsigned get_num_procs_initial_decomp() const { return 2; }
    virtual const unsigned get_num_procs_target_decomp()  const { return 3; }
};
