#include "balanceCommandLine.hpp"
                                         ...
                                         MPI_Comm comm)
{
    ...
    ThrowRequireMsg(handle_output_directory(balanceOptions.outputDirectory, comm) == OK,
...
void print_running_msg(const std::string &execName, const ParsedOptions &balanceOptions, MPI_Comm comm)
{
    ...
    {
        sierra::Env::outputP0() << "\n";
        sierra::Env::outputP0() << "\tRunning: " << execName << " " << balanceOptions.m_inFile
