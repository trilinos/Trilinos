...
#ifndef TextMeshNodeset_hpp
#define TextMeshNodeset_hpp
...
template <typename EntityId>
class Nodesets : public EntityGroup<NodesetData<EntityId>>
{
 public:
  Nodesets() : EntityGroup<NodesetData<EntityId>>("NODESET", "NODELIST_", {"BLOCK_", "SURFACE_", "ASSEMBLY_"}) {}
};
