...
class ConservativeTransferUser
{
  public:
    ...
    virtual void interpolate_to_quad_pts(stk::middle_mesh::mesh::FieldPtr<double> functionSolValsPtr,
                                         stk::middle_mesh::mesh::FieldPtr<double> functionQuadValsPtr) = 0;

    virtual void finish_integration(stk::middle_mesh::mesh::FieldPtr<double> functionQuadValsPtr,
                                    stk::middle_mesh::mesh::FieldPtr<double> functionSolValsPtr) = 0;

    virtual void solve_linear_system(stk::middle_mesh::mesh::FieldPtr<double> linearSystemRhsPtr,
                                     stk::middle_mesh::mesh::FieldPtr<double> functionSolValsPtr) = 0;
};
