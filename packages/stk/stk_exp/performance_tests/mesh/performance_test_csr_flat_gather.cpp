...
void fast_gather(const fixture::flat_array_mesh& mesh,
...
TEST( Hex, CSR_flat_gather)
{
  ...
  setup_flat_array_mesh(fmesh, fixture.m_hex_part&!fixture.m_node_part, fixture.m_coordinates, *mesh);

  double end_setup_time = stk::cpu_time()-start_time;

  const int num_iters = 100;
  for(int t=0; t<num_iters; ++t) {
    fast_gather(fmesh, fixture.m_coordinates.field_data_flat_array(), avg_centroid);
