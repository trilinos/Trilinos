#ifndef SIERRA_SIERRA_MESH_ENTITY_KEY_HPP
#define SIERRA_SIERRA_MESH_ENTITY_KEY_HPP
...
typedef sierra::util::descriptor<details::entity_key_type> entity_key;
typedef sierra::util::descriptor_manager<details::entity_key_type> entity_key_manager;

} // details
} // mesh
} // sierra

#endif // SIERRA_SIERRA_MESH_DETAILS_ENTITY_KEY_HPP
