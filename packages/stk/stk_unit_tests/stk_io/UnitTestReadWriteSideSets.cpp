...
class StkIoSubset_legacy : public IOMeshFixture
{
protected:
...
TEST_F(StkIoSubset_legacy, outputOneOfTwoBlocks)
{
...
class StkIoSideset_legacy : public IOMeshFixture
{
protected:
...
TEST_F(StkIoSideset_legacy, field_QuadAndTriSides)
{
...
TEST_F(StkIoSideset_legacy, field_TriAndQuadSides)
{
  if (stk::parallel_machine_size(get_comm()) > 2) { GTEST_SKIP(); }
  unsigned bucketCapacity = 1;
  setup_empty_mesh(stk::mesh::BulkData::NO_AUTO_AURA, bucketCapacity);
...
TEST_F(StkIoSideset_legacy, field_QuadAndTriSides_restart)
{
  if (stk::parallel_machine_size(get_comm()) > 2) { GTEST_SKIP(); }
  unsigned bucketCapacity = 1;
  setup_empty_mesh(stk::mesh::BulkData::NO_AUTO_AURA, bucketCapacity);
...
TEST_F(StkIoSideset_legacy, field_TriAndQuadSides_restart)
{
  if (stk::parallel_machine_size(get_comm()) > 2) { GTEST_SKIP(); }
  unsigned bucketCapacity = 1;
  setup_empty_mesh(stk::mesh::BulkData::NO_AUTO_AURA, bucketCapacity);
...
TEST(StkIo_legacy, read_write_and_compare_exo_files_with_sidesets)
{
...
TEST(StkIo_legacy, read_write_and_compare_exo_files_with_sidesets_because_PMR_for_coincident_not_implemented_yet)
{
...
TEST(StkIo_legacy, test_side_membership)
{
...
TEST(StkIo_legacy, create_and_write_new_sideset)
{
...
TEST(StkIo_legacy, modify_sideset)
{
  stk::ParallelMachine pm = MPI_COMM_WORLD;
...
TEST(StkIo_legacy, parallel_transform_AA_to_ADA_to_ARA)
{
  stk::ParallelMachine pm = MPI_COMM_WORLD;
...
class ShellSidesets_legacy : public stk::unit_test_util::MeshFixture
{
protected:
...
TEST_F(ShellSidesets_legacy, testWriteThenRead)
{
...
class StkIoSubset : public stk::io::unit_test::simple_fields::IOMeshFixture
{
protected:
  void test_write_then_read(const std::vector<size_t>& expectedEntityCounts,
                            stk::mesh::Part* blockToExclude = nullptr)
...
class StkIoSideset : public stk::io::unit_test::simple_fields::IOMeshFixture
{
protected:
...
TEST(StkIo, create_and_write_new_sideset)
{
  ...
  if(p_size == 1)
  {
      simple_fields::test_create_and_write_new_sideset(pm, "Ae.e", "new_ADe.e", {{1, 5}, {2, 1}});
      simple_fields::test_create_and_write_new_sideset(pm, "Ae.e", "new_ALe.e", {{1, 5}        });
      simple_fields::test_create_and_write_new_sideset(pm, "Ae.e", "new_ARe.e", {        {2, 1}});

      simple_fields::test_create_and_write_new_sideset(pm, "AA.e", "new_ADA.e", {{1, 5}, {2, 4}});
      simple_fields::test_create_and_write_new_sideset(pm, "AA.e", "new_ALA.e", {{1, 5}        });
      simple_fields::test_create_and_write_new_sideset(pm, "AA.e", "new_ARA.e", {        {2, 4}});
  }
}
...
TEST(StkIo, modify_sideset)
{
  ...
  if(p_size == 1)
  {
      simple_fields::test_read_and_modify_sideset(pm, "ADe.e", "new_ARe.e", {{1, 5}, {2, 1}}, {{1, 5}        }, {{2, 1}});
      simple_fields::test_read_and_modify_sideset(pm, "ADe.e", "new_ALe.e", {{1, 5}, {2, 1}}, {        {2, 1}}, {{1, 5}});
      simple_fields::test_read_and_modify_sideset(pm, "ADe.e", "new_Ae.e",  {{1, 5}, {2, 1}}, {{1, 5}, {2, 1}}, {      });
  }
}
...
class ShellSidesets : public stk::unit_test_util::simple_fields::MeshFixture
{
protected:
