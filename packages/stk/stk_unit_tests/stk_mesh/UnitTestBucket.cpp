/*------------------------------------------------------------------------*/
/*         _        Copyright (c) 2013, Sandia Corporation.
/*         _        Under the terms of Contract DE-AC04-94AL85000 with Sandia Corporation,
/*         _        the U.S. Governement retains certain rights in this software.
/*         _        
/*         _        Redistribution and use in source and binary forms, with or without
/*         _        modification, are permitted provided that the following conditions are
/*         _        met:
/*         _        
/*         _            * Redistributions of source code must retain the above copyright
/*         _              notice, this list of conditions and the following disclaimer.
/*         _        
/*         _            * Redistributions in binary form must reproduce the above
/*         _              copyright notice, this list of conditions and the following
/*         _              disclaimer in the documentation and/or other materials provided
/*         _              with the distribution.
/*         _        
/*         _            * Neither the name of Sandia Corporation nor the names of its
/*         _              contributors may be used to endorse or promote products derived
/*         _              from this software without specific prior written permission.
/*         _        
/*         _        THIS SOFTWARE IS PROVIDED BY THE COPYRIGHT HOLDERS AND CONTRIBUTORS
/*         _        "AS IS" AND ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, BUT NOT
/*         _        LIMITED TO, THE IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR
/*         _        A PARTICULAR PURPOSE ARE DISCLAIMED. IN NO EVENT SHALL THE COPYRIGHT
/*         _        OWNER OR CONTRIBUTORS BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL,
/*         _        SPECIAL, EXEMPLARY, OR CONSEQUENTIAL DAMAGES (INCLUDING, BUT NOT
/*         _        LIMITED TO, PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES; LOSS OF USE,
/*         _        DATA, OR PROFITS; OR BUSINESS INTERRUPTION) HOWEVER CAUSED AND ON ANY
/*         _        THEORY OF LIABILITY, WHETHER IN CONTRACT, STRICT LIABILITY, OR TORT
/*         _        (INCLUDING NEGLIGENCE OR OTHERWISE) ARISING IN ANY WAY OUT OF THE USE
/*         _        OF THIS SOFTWARE, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGE.
/*         _        
