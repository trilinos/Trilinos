...
using NeighborCrsViewType = Kokkos::StaticCrsGraph<int, ngp::MemSpace>;
using ValueViewType = Kokkos::View<double*, ngp::MemSpace>;

class ParallelDataExchangeSymPackUnpackHandler
{
public:
  //STK_FUNCTION ParallelDataExchangeSymPackUnpackHandler(ngp::FieldManager & fieldManager)
