...
protected:
  ...
  void make_4_unit_quad_single_gap_mesh(double gapSize)
  {
    ...
    if (numProcs == 1) {
      ...
      if (rank == 0) {
        ...
        coordinates = {
          2+gapSize,0, 3+gapSize,0, 4+gapSize,0,
          2+gapSize,1, 3+gapSize,1, 4+gapSize,1
        };
      }
    }
    else if (numProcs == 3) {
      ...
      if (rank == 0) {
        ...
        coordinates = {
          2+gapSize,0, 3+gapSize,0,
          2+gapSize,1, 3+gapSize,1
        };
      }
      else if (rank == 2) {
        coordinates = {
          3+gapSize,0, 4+gapSize,0,
          3+gapSize,1, 4+gapSize,1
        };
      }
    }
    else if (numProcs == 4) {
  ...
  void make_4_unit_quad_all_gap_mesh(double gapSize)
  {
    ...
    if (numProcs == 1) {
      ...
      if (rank == 0) {
        coordinates = {
          0,0, 1,0, 1+gapSize,0, 2+gapSize,0,
          0,1, 1,1, 1+gapSize,1, 2+gapSize,1
        };
      }
      else if (rank == 1) {
        coordinates = {
          2+2*gapSize,0, 3+2*gapSize,0, 3+3*gapSize,0, 4+3*gapSize,0,
          2+2*gapSize,1, 3+2*gapSize,1, 3+3*gapSize,1, 4+3*gapSize,1
        };
      }
    }
    else if (numProcs == 3) {
      ...
      if (rank == 0) {
        ...
        coordinates = {
          2+2*gapSize,0, 3+2*gapSize,0,
          2+2*gapSize,1, 3+2*gapSize,1
        };
      }
      else if (rank == 2) {
        coordinates = {
          3+3*gapSize,0, 4+3*gapSize,0,
          3+3*gapSize,1, 4+3*gapSize,1
        };
      }
    }
    else if (numProcs == 4) {
      ...
      if (rank == 0) {
        ...
        coordinates = {
          1+gapSize,0, 2+gapSize,0,
          1+gapSize,1, 2+gapSize,1
        };
      }
      else if (rank == 2) {
        coordinates = {
  ...
  void make_6_unit_tri_single_gap_mesh(double gapSize)
  {
    ...
    if (numProcs == 1) {
      ...
      if (rank == 0) {
        ...
        coordinates = {
                       2+gapSize,0, 3+gapSize,0,
          1+gapSize,1, 2+gapSize,1, 3+gapSize,1
        };
      }
    }
    else if (numProcs == 3) {
