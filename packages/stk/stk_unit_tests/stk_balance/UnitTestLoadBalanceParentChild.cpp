...
protected:
    StkFieldWeightRebalance() = default;
...
protected:
    ...
    void register_fields()
    {
        ...
        stk::mesh::put_field_on_mesh(*m_elementWeightField, get_meta().universal_part(), (double*)nullptr);
        ...
        stk::mesh::put_field_on_mesh(coordinateField, get_meta().universal_part(), (double*)nullptr);
    }
    ...
    void allocate_meta()
    {
        ...
        m_metaData = new stk::mesh::MetaData(2, names);
    }
