...
//srkenno@sandia.gov: a gross workaround to get opennurbs to compile on PGI platform
//#if defined(__GNUG_) || defined(__GNUG__) || defined(__GNUC_) || defined(__GNUC__) || defined(_GNU_SOURCE) || defined(__GNU_SOURCE) 
#if defined(__GNUG_) || defined(__GNUG__) || defined(__GNUC_) || defined(__GNUC__) || defined(_GNU_SOURCE) || defined(__GNU_SOURCE) || defined(__PGI)
...
// srkenno@sandia.gov: verified PGI has long long = 64 bit int
