...
namespace stk {
  namespace percept {
    ...
    public:
      ...
      static bool facesConsistent1(percept::PerceptMesh& eMesh, stk::mesh::Entity& element1, stk::mesh::Entity& element2, bool checkTopoOnly=false);
      static bool facesConsistent(PerceptMesh& eMesh, bool checkTopoOnly=false);
