  ...
  namespace percept
  {
    ...
    public:
      ...
      virtual Teuchos::RCP<Function > derivative(MDArrayString& deriv_spec)
      {
        ...
        //int meta_dimension = mesh::MetaData::get_meta_data(mesh::MetaData::get(*m_bulkData)).get_spatial_dimension();
      ...
      {
        int meta_dimension = mesh::MetaData::get(*m_bulkData).spatial_dimension();
...
#define EXTRA_PRINT_FF_HELPER 0
                               ...
                               const BucketOrEntity& bucket_or_element, const MDArray& parametric_coordinates, double time_value_optional)
    {
      ...
      int spatialDim = mesh::MetaData::get(*m_bulkData).spatial_dimension();
