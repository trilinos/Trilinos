...
namespace stk{
  namespace percept {
      ...
      , m_volume_field( m_metaData.declare_field< ScalarFieldType >( "volume" ))
    {
      ...
      if (do_sidesets)
        {
          m_sideset_quad_subset = &m_metaData.declare_part(std::string("surface_pyramid5_quad2d2_1"), stk::mesh::MetaData::FACE_RANK);
          ...
          m_sideset_tri_subset = &m_metaData.declare_part(std::string("surface_pyramid5_tri2d2_1"), stk::mesh::MetaData::FACE_RANK);
