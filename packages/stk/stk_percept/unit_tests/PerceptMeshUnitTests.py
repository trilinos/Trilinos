...
#sys.path.insert(0,"/scratch/srkenno/usr/local/lib/python2.7/site-packages/PyTrilinos/")
#sys.path.insert(0,"/scratch/srkenno/usr/local/")
...
class PerceptMeshUnitTests(unittest.TestCase):
    ...
    def test_high_level_interface(self):
      ...
      if p_size <= 2:
        ...
        print "element= " , element, " element1= " , element1, " == ", (element==element1)
