...
STKUNIT_UNIT_TEST(stk_search, coarse_search2_3D)
{
  ...
  Box domain_box1(Point(double(rank) +0.1, 0.0, 0.0), Point(double(rank) + 0.9, 1.0, 1.0));
  Box domain_box2(Point(double(rank) +0.1, 2.0, 0.0), Point(double(rank) + 0.9, 3.0, 1.0));

  Box range_box1(Point(double(rank) +0.1 + 0.5, 0.5, 0.0), Point(double(rank) + 0.9 + 0.5, 1.5, 1.0));
  Box range_box2(Point(double(rank) +0.1 + 0.5, 2.5, 0.0), Point(double(rank) + 0.9 + 0.5, 3.5, 1.0));
