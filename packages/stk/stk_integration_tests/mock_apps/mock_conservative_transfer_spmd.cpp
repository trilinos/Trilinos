...
{
  public:
    ConservativeTransferSPMDStk(std::shared_ptr<mesh::Mesh> inputMesh1, std::shared_ptr<mesh::Mesh> inputMesh2,
...
int main(int argc, char* argv[])
{
...

  {
    ...
    ConservativeTransferSPMDStk transfer(inputMesh1, inputMesh2, user1, user2);
