...
TreeModel::TreeModel(Teuchos::RCP<Teuchos::ParameterList> validParameters, 
	...
	:QAbstractItemModel(parent)
{
	...
	connect(this,
		...
		this,
		SLOT(dataChangedListener(const QModelIndex&, const QModelIndex&)));
}
...
void TreeModel::insertParameterList(Teuchos::RCP<Teuchos::ParameterList> parameterList, Teuchos::ParameterEntry *listEntry, std::string name,  TreeItem *parent){
