...
m4_include([config/tac_arg_enable_compiler_options.m4])
m4_include([config/tac_arg_enable_explicit_can_use_package.m4])
...
m4_include([config/tac_arg_with_lapacklib.m4])
