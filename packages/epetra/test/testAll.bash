...
echo `uname -a` >> $file
DIRS="BlockMap Comm CrsGraph CrsMatrix RowMatrix CrsRectMatrix FECrsGraph FECrsMatrix FEVbrMatrix FEVector ImportExport Map MapColoring MultiVector Object VbrMatrix Vector"
for f in $DIRS
do
	cd "$f"
