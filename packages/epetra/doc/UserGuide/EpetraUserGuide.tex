...
user to the basic features of Epetra, and (ii) illustrate the use of
...
independently from the type of parallel computer being used,
...
in to the constructor of a single \map{} object and the result \map{}
