...
class EpetraIntSerialDenseVectorTestCase(unittest.TestCase):
    ...
    def testVectorConstructor2(self):
        ...
        for i in range(len(self.list)):
            self.assertEquals(isdv[i], self.list[i])
    ...
    def testVectorConstructor3(self):
        ...
        for i in range(len(list)):
            for j in range(len(list[i])):
                self.assertEquals(isdv[i,j], list[i][j])
    ...
    def testVectorConstructor5(self):
        ...
        list = [0,1.0,"e","pi"]
        self.assertRaises(ValueError,Epetra.IntSerialDenseVector,list)
    ...
    def testVectorRandom(self):
        ...
        maxInt = 2**31 - 1
        for i in range(self.size):
            self.assertEqual(isdv[i] >= 0     , True)
            self.assertEqual(isdv[i] <= maxInt, True)
