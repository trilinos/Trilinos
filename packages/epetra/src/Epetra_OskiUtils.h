...
/*! The Epetra_OskiUtils class is a helper class used to call OSKI functions that do not use matrix, vector or permutation objects.
	  It provides an interface to access the initialization and finalize routines of OSKI
		...
		multi-vector and permutation classes.
*/
...
class Epetra_OskiUtils {
  public:
	...
	*/
	...
	//oski_errhandler_t OskiGetErrorHandler (); This function is not added in at this point
	//void OskiSetErrorHandler (oski_errhandler_t NewErrorHandler); This function is not added in at this point
};
