...
#include "Epetra_SerialSpdDenseMatrix.h"
//=============================================================================
Epetra_SPD_DenseMatrix::Epetra_SPD_DenseMatrix(void)
  : Epetra_DenseMatrix(),
    Upper_(false),
    UPLO_('L'),
    SCOND_(-1.0)
...
//=============================================================================
Epetra_SPD_DenseMatrix::Epetra_SPD_DenseMatrix(Epetra_DataAccess CV, double *A, int LDA, int NumRowsCols)
...
//=============================================================================
Epetra_SPD_DenseMatrix::Epetra_SPD_DenseMatrix(const Epetra_SPD_DenseMatrix& Source)
...
//=============================================================================
Epetra_SPD_DenseMatrix::~Epetra_SPD_DenseMatrix()
{
}
//=============================================================================
int Epetra_SPD_DenseMatrix::Factor(void) {
...
//=============================================================================
int Epetra_SPD_DenseMatrix::Solve(void) {
  int ierr = 0;
...
//=============================================================================
int Epetra_SPD_DenseMatrix::ApplyRefinement(void)
{
  double DN = N_;
  double DNRHS = NRHS_;
...
//=============================================================================
int Epetra_SPD_DenseMatrix::ComputeEquilibrateScaling(void) {
...
//=============================================================================
int Epetra_SPD_DenseMatrix::Equilibrate_A(void)
{
  int i, j;
  int ierr = 0;
...
//=============================================================================
int Epetra_SPD_DenseMatrix::Equilibrate_B(void)
{
  int i, j;
  int ierr = 0;
...
//=============================================================================
int Epetra_SPD_DenseMatrix::Unequilibrate_X(void)
{
  int i, j;
...
//=============================================================================
int Epetra_SPD_DenseMatrix::Invert(void)
{
...
//=============================================================================
int Epetra_SPD_DenseMatrix::ReciprocalConditionEstimate(double & Value)
{
  int ierr = 0;
...
//=============================================================================
void Epetra_SPD_DenseMatrix::CopyUPLOMat(bool Upper, double * A, int LDA, int NumRows) {
