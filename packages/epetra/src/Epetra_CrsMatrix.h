...
#ifndef _EPETRA_CRSMATRIX_H_
#define _EPETRA_CRSMATRIX_H_
...
class Epetra_CrsMatrix: public Epetra_DistObject, public Epetra_CompObject, public Epetra_BLAS, 
