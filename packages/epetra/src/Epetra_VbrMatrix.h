  ...
  */
  ...
  //@{ \name Atribute access functions
    ...
    /*! Returns the quantity \f$ \| A \|_1\f$ such that
     ...
     \warning Changing underlying matrix values without calling a method that explicitly changes the underlying matrix will cause the value returned by NormOne() to be out-of-date.
