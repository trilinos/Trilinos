...
#include "Epetra_HardSerialSpdDenseProblem.h"
//=============================================================================
Epetra_HardSerialSpdDenseProblem::Epetra_HardSerialSpdDenseProblem(void)
  : Epetra_DenseMatrix(),
    Upper_(false),
    UPLO_('L'),
    SCOND_(-1.0)
...
//=============================================================================
Epetra_HardSerialSpdDenseProblem::Epetra_HardSerialSpdDenseProblem(Epetra_DataAccess CV, double *A, int LDA, int NumRowsCols)
  : Epetra_DenseMatrix(CV, A, LDA, NumRowsCols, NumRowsCols),
    Upper_(false),
    UPLO_('L'),
    SCOND_(-1.0)
...
//=============================================================================
Epetra_HardSerialSpdDenseProblem::Epetra_HardSerialSpdDenseProblem(const Epetra_HardSerialSpdDenseProblem& Source)
  : Epetra_DenseMatrix(Source),  
...
//=============================================================================
Epetra_HardSerialSpdDenseProblem::~Epetra_HardSerialSpdDenseProblem()
{
}
//=============================================================================
int Epetra_HardSerialSpdDenseProblem::Factor(void) {
...
//=============================================================================
int Epetra_HardSerialSpdDenseProblem::Solve(void) {
  int ierr = 0;
...
//=============================================================================
int Epetra_HardSerialSpdDenseProblem::ApplyRefinement(void)
{
  double DN = N_;
  double DNRHS = NRHS_;
...
//=============================================================================
int Epetra_HardSerialSpdDenseProblem::ComputeEquilibrateScaling(void) {
...
//=============================================================================
int Epetra_HardSerialSpdDenseProblem::Equilibrate_A(void)
{
  int i, j;
  int ierr = 0;
...
//=============================================================================
int Epetra_HardSerialSpdDenseProblem::Equilibrate_B(void)
{
  int i, j;
  int ierr = 0;
...
//=============================================================================
int Epetra_HardSerialSpdDenseProblem::Unequilibrate_X(void)
{
  int i, j;
...
//=============================================================================
int Epetra_HardSerialSpdDenseProblem::Invert(void)
{
...
//=============================================================================
int Epetra_HardSerialSpdDenseProblem::ReciprocalConditionEstimate(double & Value)
{
  int ierr = 0;
...
//=============================================================================
void Epetra_HardSerialSpdDenseProblem::CopyUPLOMat(bool Upper, double * A, int LDA, int NumRows) {
