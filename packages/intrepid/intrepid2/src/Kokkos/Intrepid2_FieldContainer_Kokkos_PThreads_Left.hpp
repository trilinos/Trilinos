...
class FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>{
index_type dim0=0;
index_type dim1=0;
index_type dim2=0;
index_type dim3=0;
...
FieldContainer_Kokkos(Kokkos::View<ScalarPoindex_typeer,Kokkos::LayoutLeft,Kokkos::Threads>& InContainer){
...
rankValue=Kokkos::View<ScalarPoindex_typeer,Kokkos::LayoutLeft,Kokkos::Threads>::Rank;
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::~FieldContainer_Kokkos(){
count_=count_-1;
if(count_==0 && intepidManaged){delete[] containerMemory;}
}
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>& inContainer){
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(const FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>& inContainer){
rankValue=inContainer.rankValue;
sizeValue=inContainer.sizeValue;
dim[0]=dim0=inContainer.dim0;
dim[1]=dim1=inContainer.dim1;
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(index_type dim_0){
count_=1;
dim0=dim[0]=dim_0;
rankValue=1;
intepidManaged=true;
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(index_type dim_0,index_type dim_1){
count_=1;
dim0=dim[0]=dim_0;
dim1=dim[1]=dim_1;
rankValue=2;
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(index_type dim_0,index_type dim_1,index_type dim_2){
count_=1;
dim0=dim[0]=dim_0;
dim1=dim[1]=dim_1;
dim2=dim[2]=dim_2;
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(index_type dim_0,index_type dim_1,index_type dim_2,index_type dim_3){
count_=1;
dim0=dim[0]=dim_0;
dim1=dim[1]=dim_1;
dim2=dim[2]=dim_2;
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(index_type dim_0,index_type dim_1,index_type dim_2,index_type dim_3,index_type dim_4){
count_=1;
dim0=dim[0]=dim_0;
dim1=dim[1]=dim_1;
dim2=dim[2]=dim_2;
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(index_type dim_0,index_type dim_1,index_type dim_2,index_type dim_3,index_type dim_4,index_type dim_5){
count_=1;
dim0=dim[0]=dim_0;
dim1=dim[1]=dim_1;
dim2=dim[2]=dim_2;
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(index_type dim_0,index_type dim_1,index_type dim_2,index_type dim_3,index_type dim_4,index_type dim_5,index_type dim_6){
count_=1;
dim0=dim[0]=dim_0;
dim1=dim[1]=dim_1;
dim2=dim[2]=dim_2;
...
template <class Scalar>
FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::FieldContainer_Kokkos(index_type dim_0,index_type dim_1,index_type dim_2,index_type dim_3,index_type dim_4,index_type dim_5,index_type dim_6,index_type dim_7){
count_=1;
dim0=dim[0]=dim_0;
dim1=dim[1]=dim_1;
dim2=dim[2]=dim_2;
...
template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0){
return containerMemory[i0];
}
template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1){
return containerMemory[dim0*i1+i0];
}
template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2){
return containerMemory[(dim1*i2+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3){
return containerMemory[((dim2*i3+i2)*dim1+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3,const index_type i4){
return containerMemory[(((dim3*i4+i3)*dim2+i2)*dim1+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3,const index_type i4,const index_type i5){
return containerMemory[((((dim4*i5+i4)*dim3+i3)*dim2+i2)*dim1+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3,const index_type i4,const index_type i5,const index_type i6){
return containerMemory[(((((dim5*i6+i5)*dim4+i4)*dim3+i3)*dim2+i2)*dim1+i1)*dim0+i0];
}
template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3,const index_type i4,const index_type i5,const index_type i6,const index_type i7){
return containerMemory[((((((dim6*i7+i6)*dim5+i5)*dim4+i4)*dim3+i3)*dim2+i2)*dim1+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0)const{
return containerMemory[i0];
}
template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1)const{
return containerMemory[dim0*i1+i0];
}
template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2)const{
return containerMemory[(dim1*i2+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3)const{
return containerMemory[((dim2*i3+i2)*dim1+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3,const index_type i4)const{
return containerMemory[(((dim3*i4+i3)*dim2+i2)*dim1+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3,const index_type i4,const index_type i5)const{
return containerMemory[((((dim4*i5+i4)*dim3+i3)*dim2+i2)*dim1+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3,const index_type i4,const index_type i5,const index_type i6)const{
return containerMemory[(((((dim5*i6+i5)*dim4+i4)*dim3+i3)*dim2+i2)*dim1+i1)*dim0+i0];
}

template <class Scalar>
inline Scalar& FieldContainer_Kokkos<Scalar,Kokkos::LayoutLeft,Kokkos::Threads>::operator() (const index_type i0,const index_type i1,const index_type i2,const index_type i3,const index_type i4,const index_type i5,const index_type i6,const index_type i7)const{
return containerMemory[((((((dim6*i7+i6)*dim5+i5)*dim4+i4)*dim3+i3)*dim2+i2)*dim1+i1)*dim0+i0];
}
