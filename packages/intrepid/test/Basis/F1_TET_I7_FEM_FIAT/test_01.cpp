...
/** \file test_01.cpp
\brief  Unit tests for the Intrepid::Basis_F1_TET_I7_FEM_FIAT class.
...
int main(int argc, char *argv[]) {
  ...
  *outStream \
    << "===============================================================================\n" \
    << "|                                                                             |\n" \
    << "|                 Unit Test (Basis_F1_TET_I7_FEM_FIAT)                                   |\n" \
    << "|                                                                             |\n" \
  ...
  *outStream \
  ...
  try{
	...
	if ( ( (fabscur < 1.236212e+13 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 1.236212e+13 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 1.236212e+13 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 1.236212e+13 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	...
	CURLfile >> cur;
	fabscur = std::fabs(cur);
	if ( ( (fabscur < 2.386655e+14 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 2.386655e+14 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 2.386655e+14 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 2.386655e+14 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	  *outStream << std::setw(70) << " Wrong basis values" << "\n";
	  *outStream << i << " " << vals[i] << " " << cur << "\n";
