...
/** \file test_01.cpp
\brief  Unit tests for the Intrepid::Basis_F0_TET_C2_FEM_FIAT class.
...
int main(int argc, char *argv[]) {
  ...
  *outStream \
    << "===============================================================================\n" \
    << "|                                                                             |\n" \
    << "|                 Unit Test (Basis_F0_TET_C2_FEM_FIAT)                                   |\n" \
    << "|                                                                             |\n" \
  ...
  elNodes.assign(10, tempPt);  
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  elNodes[0] = Point<double>( 0.000000000000000e+00 , 0.000000000000000e+00 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[1] = Point<double>( 5.000000000000000e-01 , 0.000000000000000e+00 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[2] = Point<double>( 1.000000000000000e+00 , 0.000000000000000e+00 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[3] = Point<double>( 0.000000000000000e+00 , 5.000000000000000e-01 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[4] = Point<double>( 5.000000000000000e-01 , 5.000000000000000e-01 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[5] = Point<double>( 0.000000000000000e+00 , 1.000000000000000e+00 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[6] = Point<double>( 0.000000000000000e+00 , 0.000000000000000e+00 , 5.000000000000000e-01 , FRAME_REFERENCE);
  elNodes[7] = Point<double>( 5.000000000000000e-01 , 0.000000000000000e+00 , 5.000000000000000e-01 , FRAME_REFERENCE);
  elNodes[8] = Point<double>( 0.000000000000000e+00 , 5.000000000000000e-01 , 5.000000000000000e-01 , FRAME_REFERENCE);
  elNodes[9] = Point<double>( 0.000000000000000e+00 , 0.000000000000000e+00 , 1.000000000000000e+00 , FRAME_REFERENCE);
#endif
  ...
  *outStream \
  ...
  try{
	...
	if ( ( (fabscur < 6.129373e+00 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 6.129373e+00 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 6.129373e+00 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 6.129373e+00 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	...
	GRADfile >> cur;
	fabscur = std::fabs(cur);
	if ( ( (fabscur < 2.124898e+01 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 2.124898e+01 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 2.124898e+01 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 2.124898e+01 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	  *outStream << std::setw(70) << " Wrong basis values" << "\n";
	  *outStream << i << " " << vals[i] << " " << cur << "\n";
	...
	D2file >> cur;
	fabscur = std::fabs(cur);
	if ( ( (fabscur < 7.366482e+01 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 7.366482e+01 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 7.366482e+01 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 7.366482e+01 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	  *outStream << std::setw(70) << " Wrong basis values" << "\n";
	  *outStream << i << " " << vals[i] << " " << cur << "\n";
      ...
      for (int i=0; i < vals.getSize(); i++) {
        if ( std::abs(vals[i])  > 2.553772e+02 * INTREPID_FIAT_TOL) {
          errorFlag++;
          *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
