...
/** \file test_01.cpp
\brief  Unit tests for the Intrepid::Basis_F2_TRI_I1_FEM_FIAT class.
...
int main(int argc, char *argv[]) {
  ...
  *outStream \
    << "===============================================================================\n" \
    << "|                                                                             |\n" \
    << "|                 Unit Test (Basis_F2_TRI_I1_FEM_FIAT)                                   |\n" \
    << "|                                                                             |\n" \
  ...
  *outStream \
  ...
  try{
	...
	if ( ( (fabscur < 1.421535e+00 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 1.421535e+00 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 1.421535e+00 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 1.421535e+00 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
