...
/** \file test_01.cpp
\brief  Unit tests for the Intrepid::Basis_F1_TRI_I4_FEM_FIAT class.
...
int main(int argc, char *argv[]) {
  ...
  *outStream \
    << "===============================================================================\n" \
    << "|                                                                             |\n" \
    << "|                 Unit Test (Basis_F1_TRI_I4_FEM_FIAT)                                   |\n" \
    << "|                                                                             |\n" \
  ...
  elNodes.assign(15, tempPt);  
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  elNodes[0] = Point<double>( 0.000000000000000e+00 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[1] = Point<double>( 2.500000000000000e-01 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[2] = Point<double>( 5.000000000000000e-01 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[3] = Point<double>( 7.500000000000000e-01 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[4] = Point<double>( 1.000000000000000e+00 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[5] = Point<double>( 0.000000000000000e+00 , 2.500000000000000e-01 , FRAME_REFERENCE);
  elNodes[6] = Point<double>( 2.500000000000000e-01 , 2.500000000000000e-01 , FRAME_REFERENCE);
  elNodes[7] = Point<double>( 5.000000000000000e-01 , 2.500000000000000e-01 , FRAME_REFERENCE);
  elNodes[8] = Point<double>( 7.500000000000000e-01 , 2.500000000000000e-01 , FRAME_REFERENCE);
  elNodes[9] = Point<double>( 0.000000000000000e+00 , 5.000000000000000e-01 , FRAME_REFERENCE);
  elNodes[10] = Point<double>( 2.500000000000000e-01 , 5.000000000000000e-01 , FRAME_REFERENCE);
  elNodes[11] = Point<double>( 5.000000000000000e-01 , 5.000000000000000e-01 , FRAME_REFERENCE);
  elNodes[12] = Point<double>( 0.000000000000000e+00 , 7.500000000000000e-01 , FRAME_REFERENCE);
  elNodes[13] = Point<double>( 2.500000000000000e-01 , 7.500000000000000e-01 , FRAME_REFERENCE);
  elNodes[14] = Point<double>( 0.000000000000000e+00 , 1.000000000000000e+00 , FRAME_REFERENCE);
#endif
  ...
  *outStream \
  ...
  try{
	...
	if ( ( (fabscur < 1.773809e+02 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 1.773809e+02 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 1.773809e+02 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 1.773809e+02 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	...
	CURLfile >> cur;
	fabscur = std::fabs(cur);
	if ( ( (fabscur < 1.504984e+03 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 1.504984e+03 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 1.504984e+03 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 1.504984e+03 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	  *outStream << std::setw(70) << " Wrong basis values" << "\n";
	  *outStream << i << " " << vals[i] << " " << cur << "\n";
