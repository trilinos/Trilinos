...
/** \file test_01.cpp
\brief  Unit tests for the Intrepid::Basis_F2_TRI_I3_FEM_FIAT class.
...
int main(int argc, char *argv[]) {
  ...
  *outStream \
    << "===============================================================================\n" \
    << "|                                                                             |\n" \
    << "|                 Unit Test (Basis_F2_TRI_I3_FEM_FIAT)                                   |\n" \
    << "|                                                                             |\n" \
  ...
  elNodes[1] = Point<double>( 3.333333333333333e-01 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[2] = Point<double>( 6.666666666666666e-01 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[3] = Point<double>( 1.000000000000000e+00 , 0.000000000000000e+00 , FRAME_REFERENCE);
  elNodes[4] = Point<double>( 0.000000000000000e+00 , 3.333333333333333e-01 , FRAME_REFERENCE);
  elNodes[5] = Point<double>( 3.333333333333333e-01 , 3.333333333333333e-01 , FRAME_REFERENCE);
  elNodes[6] = Point<double>( 6.666666666666666e-01 , 3.333333333333333e-01 , FRAME_REFERENCE);
  elNodes[7] = Point<double>( 0.000000000000000e+00 , 6.666666666666666e-01 , FRAME_REFERENCE);
  elNodes[8] = Point<double>( 3.333333333333333e-01 , 6.666666666666666e-01 , FRAME_REFERENCE);
  elNodes[9] = Point<double>( 0.000000000000000e+00 , 1.000000000000000e+00 , FRAME_REFERENCE);
#endif
  ...
  *outStream \
  ...
  try{
	...
	if ( ( (fabscur < 5.999939e+01 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 5.999939e+01 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 5.999939e+01 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 5.999939e+01 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	...
	DIVfile >> cur;
	fabscur = std::fabs(cur);
	if ( ( (fabscur < 3.453336e+02 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 3.453336e+02 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 3.453336e+02 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 3.453336e+02 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	  *outStream << std::setw(70) << " Wrong basis values" << "\n";
	  *outStream << i << " " << vals[i] << " " << cur << "\n";
