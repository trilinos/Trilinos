...
/** \file test_01.cpp
\brief  Unit tests for the Intrepid::Basis_F2_TRI_I2_FEM_FIAT class.
...
int main(int argc, char *argv[]) {
  ...
  *outStream \
    << "===============================================================================\n" \
    << "|                                                                             |\n" \
    << "|                 Unit Test (Basis_F2_TRI_I2_FEM_FIAT)                                   |\n" \
    << "|                                                                             |\n" \
  ...
  *outStream \
  ...
  try{
	...
	if ( ( (fabscur < 1.017752e+01 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 1.017752e+01 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 1.017752e+01 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 1.017752e+01 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	...
	DIVfile >> cur;
	fabscur = std::fabs(cur);
	if ( ( (fabscur < 3.381370e+01 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 3.381370e+01 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 3.381370e+01 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 3.381370e+01 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	  *outStream << std::setw(70) << " Wrong basis values" << "\n";
	  *outStream << i << " " << vals[i] << " " << cur << "\n";
