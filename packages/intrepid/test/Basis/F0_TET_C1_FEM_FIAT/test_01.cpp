...
/** \file test_01.cpp
\brief  Unit tests for the Intrepid::Basis_F0_TET_C1_FEM_FIAT class.
...
int main(int argc, char *argv[]) {
  ...
  *outStream \
    << "===============================================================================\n" \
    << "|                                                                             |\n" \
    << "|                 Unit Test (Basis_F0_TET_C1_FEM_FIAT)                                   |\n" \
    << "|                                                                             |\n" \
  ...
  *outStream \
  ...
  try{
	...
	if ( ( (fabscur < 2.449490e+00 * INTREPID_FIAT_TOL)
	       && (std::fabs(vals[i]) > 2.449490e+00 * INTREPID_FIAT_TOL ) ) 
	     || ( ( fabscur >= 2.449490e+00 * INTREPID_FIAT_TOL )
		  && ( std::fabs( vals[i] - cur ) / fabscur ) >= 2.449490e+00 * INTREPID_FIAT_TOL  ) ) {
	  errorFlag++;
	  *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
	...
	if ( ( (fabscur < 2.449490e+00 * INTREPID_FIAT_TOL)
	  ...
	  *outStream << i << " " << vals[i] << " " << cur << "\n";
      ...
      for (int i=0; i < vals.getSize(); i++) {
        if ( std::abs(vals[i])  > 2.449490e+00 * INTREPID_FIAT_TOL) {
          errorFlag++;
          *outStream << std::setw(70) << "^^^^----FAILURE!" << "\n";
