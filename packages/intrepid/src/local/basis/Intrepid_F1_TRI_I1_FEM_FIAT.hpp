#ifndef INTREPID_F1_TRI_I1_FEM_FIAT_HPP
#define INTREPID_F1_TRI_I1_FEM_FIAT_HPP
...
/** \class Intrepid::Basis_F1_TRI_I1_FEM_FIAT
  \brief Implementation of FIAT FEM basis functions of degree 1 for 1-forms on TRI cells. 
...
class Basis_F1_TRI_I1_FEM_FIAT: public Basis<Scalar> {
  private:
...
/* \brief Static data array that provides the Vandermonde and derivative matrices.  They need to
  ...
  static Scalar *get_vdm0_data () {
    static Scalar vdm0_data [] = { 5.000000000000001e-01 , -4.999999999999999e-01 , -5.000000000000001e-01 , 0.000000000000000e+00 , 0.000000000000000e+00 , 0.000000000000000e+00 , -4.999999999999999e-01 , -4.999999999999999e-01 , -4.999999999999999e-01 };
    return vdm0_data ;
  }

  static Scalar *get_vdm1_data () {
    static Scalar vdm1_data [] = { 2.500000000000002e-01 , 2.500000000000001e-01 , -7.500000000000000e-01 , 2.500000000000000e-01 , 2.500000000000001e-01 , 2.500000000000001e-01 , -2.499999999999999e-01 , -2.499999999999999e-01 , -2.500000000000000e-01 };
    return vdm1_data ;
  }
  ...
  /** \brief Constructor.
  */
  Basis_F1_TRI_I1_FEM_FIAT() : numDof_(3), isSet_(false) , vdm0_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F1_TRI_I1_FEM_FIAT::get_vdm0_data(),3,3,3) ) ),vdm1_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F1_TRI_I1_FEM_FIAT::get_vdm1_data(),3,3,3) ) ),dmats0_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F1_TRI_I1_FEM_FIAT::get_dmats0_data(),3,3,3) ) ),dmats1_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F1_TRI_I1_FEM_FIAT::get_dmats1_data(),3,3,3) ) ) { }
...
#include "Intrepid_F1_TRI_I1_FEM_FIATDef.hpp"
