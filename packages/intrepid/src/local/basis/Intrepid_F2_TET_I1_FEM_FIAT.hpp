#ifndef INTREPID_F2_TET_I1_FEM_FIAT_HPP
#define INTREPID_F2_TET_I1_FEM_FIAT_HPP
...
/** \class Intrepid::Basis_F2_TET_I1_FEM_FIAT
  \brief Implementation of FIAT FEM basis functions of degree 1 for 2-forms on TET cells. 
...
\verbatim
  ...
  |========|============|============|============|============|==================================|
  |    0   |     2      |     0      |     0      |     1      |L_0(u)=(u.n)(0.333333333333,0.0,0.333333333333)  |
  |========|============|============|============|============|==================================|
  |    1   |     2      |     1      |     0      |     1      |L_1(u)=(u.n)(0.333333333333,0.333333333333,0.333333333333)  |
  |========|============|============|============|============|==================================|
  |    2   |     2      |     2      |     0      |     1      |L_2(u)=(u.n)(0.0,0.333333333333,0.333333333333)  |
  |========|============|============|============|============|==================================|
  |    3   |     2      |     3      |     0      |     1      |L_3(u)=(u.n)(0.333333333333,0.333333333333,0.0)  |
  |========|============|============|============|============|==================================|
...
class Basis_F2_TET_I1_FEM_FIAT: public Basis<Scalar> {
  private:
...
/* \brief Static data array that provides the Vandermonde and derivative matrices.  They need to
  ...
  static Scalar *get_vdm0_data () {
    static Scalar vdm0_data [] = { 3.000000000000001e-01 , 2.999999999999999e-01 , -1.700000000000000e+00 , 3.000000000000000e-01 , 3.000000000000003e-01 , 3.000000000000002e-01 , 3.000000000000003e-01 , 3.000000000000002e-01 , -3.000000000000000e-01 , -2.999999999999999e-01 , -3.000000000000000e-01 , -2.999999999999999e-01 , -2.999999999999999e-01 , -2.999999999999998e-01 , -2.999999999999999e-01 , -2.999999999999998e-01 };
    return vdm0_data ;
  }

  static Scalar *get_vdm1_data () {
    static Scalar vdm1_data [] = { -1.500000000000000e+00 , 4.999999999999999e-01 , 4.999999999999999e-01 , 4.999999999999999e-01 , 1.463672932855435e-16 , 1.463672932855435e-16 , 1.463672932855435e-16 , 1.463672932855435e-16 , 6.000000000000000e-01 , 5.999999999999999e-01 , 6.000000000000000e-01 , 5.999999999999999e-01 , -2.999999999999999e-01 , -2.999999999999998e-01 , -2.999999999999999e-01 , -2.999999999999998e-01 };
    return vdm1_data ;
  }

  static Scalar *get_vdm2_data () {
    static Scalar vdm2_data [] = { 8.999999999999998e-01 , 9.000000000000001e-01 , 9.000000000000001e-01 , -1.100000000000000e+00 , 7.025630077706090e-17 , 7.025630077706088e-17 , 7.025630077706090e-17 , 7.025630077706088e-17 , 0.000000000000000e+00 , 0.000000000000000e+00 , 0.000000000000000e+00 , 0.000000000000000e+00 , 9.000000000000000e-01 , 8.999999999999999e-01 , 9.000000000000000e-01 , 8.999999999999998e-01 };
    return vdm2_data ;
  }
  ...
  /** \brief Constructor.
  */
  Basis_F2_TET_I1_FEM_FIAT() : numDof_(4), isSet_(false) , vdm0_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F2_TET_I1_FEM_FIAT::get_vdm0_data(),4,4,4) ) ),vdm1_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F2_TET_I1_FEM_FIAT::get_vdm1_data(),4,4,4) ) ),vdm2_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F2_TET_I1_FEM_FIAT::get_vdm2_data(),4,4,4) ) ),dmats0_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F2_TET_I1_FEM_FIAT::get_dmats0_data(),4,4,4) ) ),dmats1_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F2_TET_I1_FEM_FIAT::get_dmats1_data(),4,4,4) ) ),dmats2_( rcp( new Teuchos::SerialDenseMatrix<int,Scalar>(Teuchos::View,Basis_F2_TET_I1_FEM_FIAT::get_dmats2_data(),4,4,4) ) ) { }
...
#include "Intrepid_F2_TET_I1_FEM_FIATDef.hpp"
