...
/** \file   Intrepid_G_HEX_C1_FEM.hpp
    \brief  Header file for the Intrepid::G_HEX_C1_FEM class.
    \author Created by P. Bochev and D. Ridzal.
 */

#ifndef INTREPID_HGRAD_HEX_C1_FEM_HPP
#define INTREPID_HGRAD_HEX_C1_FEM_HPP
#include "Intrepid_Basis.hpp"

namespace Intrepid {
  
/** \class  Intrepid::Basis_HGRAD_HEX_C1_FEM
...
class Basis_HGRAD_HEX_C1_FEM : public Basis<Scalar, ArrayScalar> {
private:
