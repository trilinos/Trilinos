...
/**********************************************************************************/
    ...
    Epetra_CrsMatrix gl_StiffMatrix(Copy, ownedGraph);
    gl_StiffMatrix.FillComplete();
    Epetra_Vector gl_rhsVector(globalMapG);

    Epetra_CrsMatrix StiffMatrix(Copy, overlappedGraph);
    StiffMatrix.FillComplete();
    Epetra_Vector rhsVector(overlappedMapG);
