...
/**********************************************************************************/
   ...
   if(MyPID==0) {cout << "Getting cubature                            "
...
/**********************************************************************************/
   ...
   if(MyPID==0) {cout << msg << "Build global maps                           "
                 << Time.ElapsedTime() << " sec \n";  Time.ResetStartTime();}
...
/**********************************************************************************/
  ...
  // Vector for use in applying BCs
   ...
   if(MyPID==0) {cout << msg << "Get Dirichlet boundary values               "
                 << Time.ElapsedTime() << " sec \n\n"; Time.ResetStartTime();}
...
/**********************************************************************************/
 ...
 /**********************************************************************************/
   ...
   if(MyPID==0) {cout << msg << "Allocate arrays                             "
                 << Time.ElapsedTime() << " sec \n"; Time.ResetStartTime();}
 ...
 /**********************************************************************************/
   ...
   if(MyPID==0) {cout << msg << "Calculate Jacobians                         "
                 << Time.ElapsedTime() << " sec \n"; Time.ResetStartTime();}
 ...
 /**********************************************************************************/
   ...
   if(MyPID==0) {cout << msg << "Map to physical frame and get source term   "
                 << Time.ElapsedTime() << " sec \n"; Time.ResetStartTime();}
...
/**********************************************************************************/
 ...
 /**********************************************************************************/
   ...
   if(MyPID==0) {cout << msg << "Compute stiffness matrix                    "
                 << Time.ElapsedTime() << " sec \n"; Time.ResetStartTime();}
 ...
 /**********************************************************************************/
   ...
   if(MyPID==0) {cout << msg << "Compute right-hand side                     "
                  << Time.ElapsedTime() << " sec \n"; Time.ResetStartTime();}
...
/**********************************************************************************/
  ...
  rhsVector.GlobalAssemble();
   ...
   if(MyPID==0) {cout << msg << "Global assembly                             "
                 << Time.ElapsedTime() << " sec \n"; Time.ResetStartTime();}
...
/**********************************************************************************/
  ...
  // Update right-hand side
   ...
   if(MyPID==0) {cout << msg << "Adjust global matrix and rhs due to BCs     " << Time.ElapsedTime()
                  << " sec \n"; Time.ResetStartTime();}
...
/**********************************************************************************/
  ...
  if (MyPID == 0) {
   ...
   if(MyPID==0) {cout << msg << "Calculate error                             "
                  << Time.ElapsedTime() << " s \n"; Time.ResetStartTime();}
