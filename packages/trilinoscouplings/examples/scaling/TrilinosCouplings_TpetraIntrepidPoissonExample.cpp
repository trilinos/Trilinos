                            ...
                            const bool debug)
{
  ...
  *out << "Generating mesh (tpetra)" << endl;
  ...
  im_ne_get_init_global_l (id, &numNodesGlobal, &numElemsGlobal,
                           ...
                           &numSideSetsGlobal);
  MachineLearningStatistics_Hex3D<ST, LO, GO, Node> MLStatistics(numElemsGlobal);
...
/***************************** STATISTICS (Part IIb) ******************************/
/**********************************************************************************/
  MLStatistics.Phase2b(gl_StiffMatrix->getCrsGraph(),coords);

/**********************************************************************************/
/***************************** STATISTICS (Part III) ******************************/
/**********************************************************************************/
  MLStatistics.Phase3();
  problemStatistics = MLStatistics.GetStatistics();
