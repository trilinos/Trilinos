...
/**********************************************************************************/
  ...
  for(int i=0; i<numElems; i++) {
    ...
    // 3 - Stretch
    diag_length_max = distance2(nodeCoord, elemToNode(i, 0), elemToNode(i, 6));
    diag_length_min = distance2(nodeCoord, elemToNode(i, 0), elemToNode(i, 6));
    for (int j=0; j<4; j++) {
    ...
    node1 = elemToNode(i, 0);
    node2 = elemToNode(i, 1);
    node3 = elemToNode(i, 6);
    node4 = elemToNode(i, 7);
