/** \file  example_IntrepidPoisson_Pamgen_Tpetra.cpp
    ...
    \remark Usage:
    \code   ./intrepidExample Poisson.xml \endcode

    \remark Example driver may use XML input file named Poisson.xml
            with Pamgen formatted mesh description.  A version is
...
/**********************************************************************************/
  ...
  const std::pair<MT, MT> norms = exactResidualNorm (A, B, X_exact);
  ...
  *out << "||B - A*X_exact||_2 = " << norms.first << endl
       << "||B||_2 = " << norms.second << endl
       << "||A||_F = " << A->getFrobeniusNorm () << endl;
