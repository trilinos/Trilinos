...
#ifndef __TrilinosCouplings_Statistics_Intrepid2_hpp
#define __TrilinosCouplings_Statistics_Intrepid2_hpp
...
class MachineLearningStatistics_Hex3D {
  ...
  typedef Intrepid2::ScalarView<Scalar, memory_space> Intrepid2ScalarViewScalar;
