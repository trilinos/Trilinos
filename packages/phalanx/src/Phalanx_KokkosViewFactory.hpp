...
namespace PHX {
					       ...
					       const std::vector<PHX::index_size_type>& )
  {
    ...
    if (dl.rank() == 1)
      a = Kokkos::View<ScalarT*,Device>(t.identifier(),
					dl.dimension(0));
    else if (dl.rank() == 2)
      a = Kokkos::View<ScalarT**,Device>(t.identifier(),
					 dl.dimension(0),
  ...
  public:
	      ...
	      const std::vector<PHX::index_size_type>& derivative_dimensions)
    {
      ...
      if (dl.rank() == 1)
	a = Kokkos::View<Sacado::Fad::DFad<ScalarT>*,Device>(t.identifier(),
							      dl.dimension(0),
							      hDim);
      else if (dl.rank() == 2)
	a = Kokkos::View<Sacado::Fad::DFad<ScalarT>**,Device>(t.identifier(),
  ...
  public:
	      ...
	      const std::vector<PHX::index_size_type>& derivative_dimensions)
    {
      ...
      if (dl.rank() == 1)
	a = Kokkos::View<Sacado::ELRCacheFad::DFad<ScalarT>*,Device>(t.identifier(),
								     dl.dimension(0),
								     hDim);
      else if (dl.rank() == 2)
	a = Kokkos::View<Sacado::ELRCacheFad::DFad<ScalarT>**,Device>(t.identifier(),
  ...
  public:
	      ...
	      const std::vector<PHX::index_size_type>& derivative_dimensions)
    {
      ...
      if (dl.rank() == 1)
	a = Kokkos::View<Sacado::Fad::SLFad<ScalarT,N>*,Device>(t.identifier(),
							      dl.dimension(0),
							      hDim);
      else if (dl.rank() == 2)
	a = Kokkos::View<Sacado::Fad::SLFad<ScalarT,N>**,Device>(t.identifier(),
