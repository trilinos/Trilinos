...
int main(int argc, char *argv[]) 
{
  ...
  try {
	...
	Tag<ResScalarT> energy_flux("Energy_Flux", qp_vec);
	fm.requireField<MyTraits::Residual>(energy_flux);
	Tag<ResScalarT> source("Nonlinear Source", qp_scalar);
	...
	Tag<JacScalarT> energy_flux("Energy_Flux", qp_vec);
	fm.requireField<MyTraits::Jacobian>(energy_flux);
	Tag<JacScalarT> source("Nonlinear Source", qp_scalar);
