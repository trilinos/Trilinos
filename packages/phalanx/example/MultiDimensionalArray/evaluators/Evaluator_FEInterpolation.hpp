...
private:
  ...
  //! Values at nodes
  PHX::MDField<ScalarT,phdmesh::NaturalOrder,Cell,Node> val_node;

  //! Values at quadrature points
  PHX::MDField<ScalarT,phdmesh::NaturalOrder,Cell,QuadPoint> val_qp;

  //! Gradient values at quadrature points
  PHX::MDField<ScalarT,phdmesh::NaturalOrder,Cell,QuadPoint,Dim> val_grad_qp;
