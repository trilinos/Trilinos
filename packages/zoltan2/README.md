...
Zoltan2 also supports accelerators (GPUs) for some features via Kokkos. Although Zoltan2 provides similar functionality as Zoltan, it is not an exact replacement.
