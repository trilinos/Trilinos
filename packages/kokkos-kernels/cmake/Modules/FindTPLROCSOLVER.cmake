...
elseif(ROCSOLVER_LIBRARIES)
  ...
  kokkoskernels_find_imported(ROCSOLVER INTERFACE LIBRARIES ${ROCSOLVER_LIBRARIES} HEADER rocsolver.h)
elseif(ROCSOLVER_LIBRARY_DIRS)
  ...
  kokkoskernels_find_imported(ROCSOLVER INTERFACE
    ...
    LIBRARY_PATHS ${ROCSOLVER_LIBRARY_DIRS}
    HEADER        rocsolver.h)
elseif(ROCSOLVER_ROOT OR KokkosKernels_ROCSOLVER_ROOT
)# nothing specific provided, just ROOT
