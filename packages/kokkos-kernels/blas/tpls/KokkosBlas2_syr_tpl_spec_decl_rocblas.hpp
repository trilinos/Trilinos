...
#define KOKKOSBLAS2_DSYR_ROCBLAS(LAYOUT, EXEC_SPACE, ETI_SPEC_AVAIL)                                                  \
  ...
  struct SYR<EXEC_SPACE, Kokkos::View<const double*, LAYOUT, EXEC_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> >,   \
             ...
             ETI_SPEC_AVAIL> {                                                                                        \
    using SCALAR    = double;                                                                                         \
    using XViewType = Kokkos::View<const SCALAR*, LAYOUT, EXEC_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> >;      \
    using AViewType = Kokkos::View<SCALAR**, LAYOUT, EXEC_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> >;           \
                                                                                                                      \
