...
#define KOKKOSBLAS1_NRM1_ETI_SPEC_AVAIL(SCALAR, LAYOUT, EXEC_SPACE)                                    \
  template <>                                                                                          \
  struct nrm1_eti_spec_avail<                                                                          \
      EXEC_SPACE,                                                                                      \
...
// more .cpp files.
//
#define KOKKOSBLAS1_NRM1_ETI_SPEC_DECL(SCALAR, LAYOUT, EXEC_SPACE)                                     \
...
//
#define KOKKOSBLAS1_NRM1_ETI_SPEC_INST(SCALAR, LAYOUT, EXEC_SPACE)                                                   \
