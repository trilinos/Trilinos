...
#ifndef KOKKOSKERNELS_INNERPRODUCTSPACETRAITS_HPP
#define KOKKOSKERNELS_INNERPRODUCTSPACETRAITS_HPP

/// \file KokkosKernels_InnerProductSpaceTraits.hpp
...
///   Users beware!
///
/// \warning This class is an implementation detail of KokkosKernels and
...
///
/// \section KokkosKernels_IPST_math Mathematical definition
///
...
/// uses.
///
/// \section KokkosKernels_IPST_dev Use of class methods in device kernels
///
...
///
/// \section KokkosKernels_IPST_unsupp Unsupported types on CUDA devices
///
...
///
/// \section KokkosKernels_IPST_new Adding a specialization for a new type T
///
...
#endif  // KOKKOSKERNELS_INNERPRODUCTSPACETRAITS_HPP
