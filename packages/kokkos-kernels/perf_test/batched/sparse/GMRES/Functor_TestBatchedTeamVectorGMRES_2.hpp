...
struct Functor_TestBatchedTeamVectorGMRES_2 {
  ...
  Functor_TestBatchedTeamVectorGMRES_2(const ValuesViewType &D, const IntView &r, const IntView &c,
  ...
  KOKKOS_INLINE_FUNCTION
  Functor_TestBatchedTeamVectorGMRES_2(const ValuesViewType &D, const ValuesViewType &diag, const IntView &r,
