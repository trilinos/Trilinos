...
//   test_batched_team_trsv<TestDevice,float,float,param_tag_type,algo_tag_type>();
// }
...
//   ::Test::TeamTrsv::ParamTag<Uplo::Lower,Trans::NoTranspose,Diag::Unit>
//   param_tag_type; typedef Algo::Trsv::Blocked algo_tag_type;
//   test_batched_team_trsv<TestDevice,double,double,param_tag_type,algo_tag_type>();
// }
