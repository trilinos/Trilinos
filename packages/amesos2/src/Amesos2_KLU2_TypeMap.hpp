...
namespace Teuchos {
  ...
  template<>
  class ValueTypeConversionTraits<double, std::complex<double>>
  {
  public:
    static double convert( const std::complex<double> t )
    {                           // adapt conversion as necessary
      double ret = Teuchos::as<double>(t.real());
      return( ret );
    }

    static double safeConvert( const std::complex<double> t )
    {                           // adapt conversion as necessary
      double ret = Teuchos::as<double>(t.real());
      return( ret );
    }
  ...
  template<>
  class ValueTypeConversionTraits<double, std::complex<float>>
  {
  public:
    static double convert( const std::complex<float> t )
    {                           // adapt conversion as necessary
      double ret = Teuchos::as<double>(t.real());
      return( ret );
    }

    static double safeConvert( const std::complex<float> t )
    {                           // adapt conversion as necessary
      double ret = Teuchos::as<double>(t.real());
      return( ret );
    }
  ...
  template<>
  class ValueTypeConversionTraits<double, Kokkos::complex<double>>
  {
  public:
    static double convert( const Kokkos::complex<double> t )
    {                           // adapt conversion as necessary
      double ret = Teuchos::as<double>(t.real());
      return( ret );
    }

    static double safeConvert( const Kokkos::complex<double> t )
    {                           // adapt conversion as necessary
      double ret = Teuchos::as<double>(t.real());
      return( ret );
    }
  ...
  template<>
  class ValueTypeConversionTraits<double, Kokkos::complex<float>>
  {
  public:
    static double convert( const Kokkos::complex<float> t )
    {                           // adapt conversion as necessary
      double ret = Teuchos::as<double>(t.real());
      return( ret );
    }

    static double safeConvert( const Kokkos::complex<float> t )
    {                           // adapt conversion as necessary
      double ret = Teuchos::as<double>(t.real());
      return( ret );
    }
