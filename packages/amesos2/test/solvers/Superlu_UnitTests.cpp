...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Superlu, Solve, SCALAR, LO, GO )
{
  ...
  // 
  // /* Now create a random system.  The matrix A and MultiVector X are
  //  * randomized and multiplied to create MultiVector B.  We then solve the
  //  * system and check that the answer is identical to X.
  //  */
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Superlu, Dimensions, SCALAR, LO, GO )
{
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Superlu, CRS, SCALAR, LO, GO )
{
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Superlu, CCS, SCALAR, LO, GO )
{
