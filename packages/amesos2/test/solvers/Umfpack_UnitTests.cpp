...
namespace {
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, Initialization, SCALAR, LO, GO )
  {
    ...
    RCP<Amesos2::Solver<MAT,MV> > solver = Amesos2::create<MAT,MV>("Umfpack",eye,X,B);
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, SymbolicFactorization, SCALAR, LO, GO )
  {
    typedef ScalarTraits<SCALAR> ST;
    typedef CrsMatrix<SCALAR,LO,GO,Node> MAT;
    typedef MultiVector<SCALAR,LO,GO,Node> MV;
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, NumericFactorization, SCALAR, LO, GO )
  {
    typedef ScalarTraits<SCALAR> ST;
    typedef CrsMatrix<SCALAR,LO,GO,Node> MAT;
    typedef MultiVector<SCALAR,LO,GO,Node> MV;
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, Solve, SCALAR, LO, GO ) {
    typedef CrsMatrix<SCALAR,LO,GO,Node> MAT;
    typedef ScalarTraits<SCALAR> ST;
    typedef MultiVector<SCALAR,LO,GO,Node> MV;
    ...
    // Solve A*Xhat = B for Xhat using the Umfpack solver
    RCP<Amesos2::Solver<MAT,MV> > solver
      = Amesos2::create<MAT,MV>("Umfpack", A, Xhat, B );
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, SolveTrans, SCALAR, LO, GO )
  {
    typedef CrsMatrix<SCALAR,LO,GO,Node> MAT;
    typedef ScalarTraits<SCALAR> ST;
    typedef MultiVector<SCALAR,LO,GO,Node> MV;
    ...
    amesos2_params.sublist("Umfpack").set<bool>("Transpose",true,"Solve with transpose");
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, BaseOne, SCALAR, LO, GO )
  {
    typedef CrsMatrix<SCALAR,LO,GO,Node> MAT;
    typedef ScalarTraits<SCALAR> ST;
    typedef MultiVector<SCALAR,LO,GO,Node> MV;
    ...
    RCP<Amesos2::Solver<MAT,MV> > solver = Amesos2::create<MAT,MV>("Umfpack", A, X, B);
    solver->symbolicFactorization().numericFactorization().solve();
  ...
  //! @test Test for one-base
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, EmptySub, SCALAR, LO, GO )
  {
    typedef CrsMatrix<SCALAR,LO,GO,Node> MAT;
    typedef ScalarTraits<SCALAR> ST;
    typedef MultiVector<SCALAR,LO,GO,Node> MV;
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, ExtraCol, SCALAR, LO, GO )
  {
    typedef CrsMatrix<SCALAR,LO,GO,Node> MAT;
    typedef ScalarTraits<SCALAR> ST;
    typedef MultiVector<SCALAR,LO,GO,Node> MV;
    ...
    if (nProcs == 2) {
      ...
      RCP<Amesos2::Solver<MAT,MV> > solver = Amesos2::create<MAT,MV>("Umfpack", A, X, B);
      {
        ...
        Teuchos::ParameterList amesos2_params("Amesos2");
        amesos2_params.sublist("Umfpack").set("IsContiguous", false, "Are GIDs Contiguous");
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, Shuffle, SCALAR, LO, GO )
  {
    typedef CrsMatrix<SCALAR,LO,GO,Node> MAT;
    typedef ScalarTraits<SCALAR> ST;
    typedef MultiVector<SCALAR,LO,GO,Node> MV;
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, NonContigGID, SCALAR, LO, GO )
  {
    typedef CrsMatrix<SCALAR,LO,GO,Node> MAT;
    typedef ScalarTraits<SCALAR> ST;
    typedef MultiVector<SCALAR,LO,GO,Node> MV;
    ...
    if ( numProcs == 2 ) {
      ...
      TEUCHOS_TEST_FOR_EXCEPTION(
          ...
          std::logic_error,
          "Umfpack NonContigGID Test: The non-contiguous map claims to be contiguous.");
      ...
      TEUCHOS_TEST_FOR_EXCEPTION(
          ...
          std::logic_error,
          "Umfpack NonContigGID Test: The non-contiguous map of A claims to be contiguous.");
      ...
      TEUCHOS_TEST_FOR_EXCEPTION(
          ...
          std::logic_error,
          "Umfpack NonContigGID Test: The non-contiguous maps of X or B claims to be contiguous.");
  ...
  TEUCHOS_UNIT_TEST( Umfpack, NonContigGIDEpetra )
  {
    using SCALAR = double;
    using LO = int;
    using GO = int;
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, ComplexSolve, SCALAR, LO, GO )
  {
    ...
    // Create solver interface to Umfpack through Amesos2 factory method
    RCP<Amesos2::Solver<MAT,MV> > solver = Amesos2::create<MAT,MV>("Umfpack",A,Xhat,B);
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( Umfpack, ComplexSolve2, SCALAR, LO, GO )
  {
    typedef std::complex<SCALAR> cmplx;
    typedef CrsMatrix<cmplx,LO,GO,Node> MAT;
    typedef ScalarTraits<cmplx> ST;
...
#  define UNIT_TEST_GROUP_ORDINAL_COMPLEX_SCALAR(LO, GO, SCALAR)        \
  ...
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, Initialization, Complex##SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, SymbolicFactorization, Complex##SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, NumericFactorization, Complex##SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, ComplexSolve, SCALAR, LO, GO) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, ComplexSolve2, SCALAR, LO, GO)
...
#define UNIT_TEST_GROUP_ORDINAL_SCALAR( LO, GO, SCALAR )                \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, Initialization, SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, SymbolicFactorization, SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, NumericFactorization, SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, Solve, SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, SolveTrans, SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, NonContigGID, SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, BaseOne, SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, EmptySub, SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, ExtraCol, SCALAR, LO, GO ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( Umfpack, Shuffle, SCALAR, LO, GO )
