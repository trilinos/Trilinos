...
\begin{tikzpicture}
  ...
  \myclass[4cm]{($(matrixadapter) + (-3,-3.2)$)}{acmatadpte}{ACMatrixAdapter}{Epetra\_RM,Derived}{}{getGlobalRowCopy\_impl()}
  ...
  \draw[generalization] (acmatadpte) -- node[left]{$<$Derived$>$} (matrixadapter);
