...
namespace Tacho {
  ...
  public:
    CuSparseTriSolve() {
      ...
      _status = cusparseCreate(&_handle.first); checkStatus("cusparseCreate::Lower");
      _status = cusparseCreate(&_handle.second); checkStatus("cusparseCreate::Upper");
      _status = cusparseCreateMatDescr(&_desc.first); checkStatus("cusparseCreateMatDescr::Lower");
      _status = cusparseCreateMatDescr(&_desc.second); checkStatus("cusparseCreateMatDescr::Upper");
      _status = cusparseCreateCsrsv2Info(&_info.first); checkStatus("cusparseCreateCsrsv2Info::Lower");
      _status = cusparseCreateCsrsv2Info(&_info.second); checkStatus("cusparseCreateCsrsv2Info::Upper");
    ...
    virtual~CuSparseTriSolve() {
      _status = cusparseDestroyCsrsv2Info(_info.second); checkStatus("cusparseCreateCsrsv2Info::Upper");
      _status = cusparseDestroyCsrsv2Info(_info.first); checkStatus("cusparseCreateCsrsv2Info::Lower");
      _status = cusparseDestroyMatDescr(_desc.second); checkStatus("cusparseDestroyMatDescr::Upper");
      _status = cusparseDestroyMatDescr(_desc.first); checkStatus("cusparseDestroyMatDescr::Lower");
      _status = cusparseDestroy(_handle.second); checkStatus("cusparseDestroy::Upper");
      _status = cusparseDestroy(_handle.first); checkStatus("cusparseDestroy::Lower");
    ...
    int analyze(const ordinal_type m,
      ...
      _ax = Kokkos::create_mirror_view(exec_memory_space(), ax); Kokkos::deep_copy(_ax, ax);
      Kokkos::fence();
      ...
      ///
      _status = cusparseSetMatIndexBase(_desc.first, CUSPARSE_INDEX_BASE_ZERO); checkStatus("cusparseSetMatIndexBase::Lower");
      _status = cusparseSetMatFillMode(_desc.first, CUSPARSE_FILL_MODE_UPPER); checkStatus("cusparseSetMatFillMode::Lower");
      _status = cusparseSetMatDiagType(_desc.first, CUSPARSE_DIAG_TYPE_NON_UNIT); checkStatus("cusparseSetMatDiagType::Lower");
      _status = cusparseDcsrsv2_bufferSize(_handle.first,
                                           _trans.first,
                                           _m, _nnz,
                                           _desc.first,
                                           _ax.data(),
                                           ...
                                           _aj.data(),
                                           _info.first,
                                           &bufSizeInBytes.first); checkStatus("cusparseDcsrsv2_bufferSize::Lower");

      _status = cusparseSetMatIndexBase(_desc.second, CUSPARSE_INDEX_BASE_ZERO); checkStatus("cusparseSetMatIndexBase::Upper");
      _status = cusparseSetMatFillMode(_desc.second, CUSPARSE_FILL_MODE_UPPER); checkStatus("cusparseSetMatFillMode::Upper");
      _status = cusparseSetMatDiagType(_desc.second, CUSPARSE_DIAG_TYPE_NON_UNIT); checkStatus("cusparseSetMatDiagType::Upper");
      _status = cusparseDcsrsv2_bufferSize(_handle.second,
                                           _trans.second,
                                           _m, _nnz,
                                           _desc.second,
                                           _ax.data(),
                                           ...
                                           _aj.data(),
                                           _info.second,
                                           &bufSizeInBytes.second); checkStatus("cusparseDcsrsv2_bufferSize::Upper");
      ...
      _status = cusparseDcsrsv2_analysis(_handle.first,
                                         ...
                                         _info.first,
                                         _policy.first,
                                         _buf.data()); checkStatus("cusparseDcsrsv2_analysis::Lower");

      _status = cusparseDcsrsv2_analysis(_handle.second,
                                         _trans.second,
                                         _m, _nnz,
                                         _desc.second,
                                         _ax.data(),
                                         ...
                                         _info.second,
                                         _policy.second,
                                         _buf.data()); checkStatus("cusparseDcsrsv2_analysis::Upper");      
      Kokkos::fence();
    ...
    int solve(const value_type_matrix &x,
      ...
      for (ordinal_type i=0;i<nrhs;++i) {
        _status = cusparseDcsrsv2_solve(_handle.first,
                                        _trans.first,
                                        _m, _nnz, 
                                        (const double*)&one,
                                        _desc.first,
                                        (const double*)_ax.data(),
                                        (const int*)_ap_ordinal.data(),
                                        (const int*)_aj.data(),
                                        _info.first,
                                        (const double*)b.data()+i*len,
                                        (double*)t.data()+i*len,
                                        _policy.first,
                                        (void*)_buf.data()); checkStatus("cusparseDcsrsv2_solve::Lower");

        _status = cusparseDcsrsv2_solve(_handle.second,
                                        _trans.second,
                                        _m, _nnz, 
                                        (const double*)&one,
                                        _desc.second,
                                        ...
                                        (const int*)_aj.data(),
                                        _info.second,
                                        (const double*)t.data()+i*len,
                                        (double*)x.data()+i*len,
                                        _policy.second,
                                        (void*)_buf.data()); checkStatus("cusparseDcsrsv2_solve::Upper");
      }
      if (apply_fence)
        Kokkos::fence();
    ...
    int solve_capture(const value_type_matrix &x,
                      const value_type_matrix &b,
                      const value_type_matrix &t) {
