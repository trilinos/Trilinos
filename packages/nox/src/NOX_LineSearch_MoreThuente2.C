...
NOX::LineSearch::MoreThuente2::~MoreThuente2()
{
}
...
{ 
  ...
  if (choice == "Ared/Pred") 
    ...
    cout << "ERROR: NOX::LineSearch::MoreThuente2::reset() - the choice of "
...
bool NOX::LineSearch::MoreThuente2::compute(Abstract::Group& grp, double& step, 
...
int NOX::LineSearch::MoreThuente2::cstep(double& stx, double& fx, double& dx,
...
double NOX::LineSearch::MoreThuente2::min(double a, double b)
{
  return (a < b ? a : b);
}

double NOX::LineSearch::MoreThuente2::max(double a, double b)
{
  return (a > b ? a : b);
}


double NOX::LineSearch::MoreThuente2::absmax(double a, double b, double c)
{
  a = fabs(a);
  b = fabs(b);
  c = fabs(c);
