...
//   cout.precision(14);
  ...
  Teuchos::RefCountPtr<LOCA::Bifurcation::TPBord::ModifiedBorderingGroup> 
    tpgrp = Teuchos::rcp(new LOCA::Bifurcation::TPBord::ModifiedBorderingGroup
			 (grp, nullVec, nullVec, 0));
  ...
  // Get the answer
  const LOCA::Bifurcation::TPBord::ModifiedBorderingGroup& soln_tpgrp = 
    dynamic_cast<const LOCA::Bifurcation::TPBord::ModifiedBorderingGroup&>(solver.getSolutionGroup());
