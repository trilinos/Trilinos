...
int main()
{
  ...
  Teuchos::RefCountPtr<LOCA::Bifurcation::TPBord::ExtendedGroup> tpgrp = 
    Teuchos::rcp(new LOCA::Bifurcation::TPBord::ExtendedGroup(grp, 
							      nullVec, 
							      nullVec, 0));
  ...
  // Get the answer
  const LOCA::Bifurcation::TPBord::ExtendedGroup& soln_tpgrp = 
    dynamic_cast<const LOCA::Bifurcation::TPBord::ExtendedGroup&>(solver.getSolutionGroup());
