...
int main()
{
  ...
  try {
    ...
    ofstream outFile("ChanTPContinuation_NicDayModifiedBordering.dat");
    ...
    stepperList.setParameter("Relative Stopping Threshold", 0.9);
    ...
    bifurcationList.setParameter("Method", "Nic-Day Modified Turning Point");
