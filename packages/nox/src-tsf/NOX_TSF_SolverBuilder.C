...
#include "NOX_TSF_SolverBuilder.H"         
...
RefCountPtr<Solver::Manager> 
SolverBuilder::makeSolver(const ParameterList& params,
                          const TSFExtended::NonlinearOperator<double>& F)
{
  ...
  ParameterList solverSublist = params.sublist("Nonlinear Solver");
