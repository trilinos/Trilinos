...
class AbstractGroup(Continuation.AbstractGroup):
    ...
    def __repr__(self):
        return "<%s.%s; proxy of C++ LOCA::Homotopy::AbstractGroup instance at %s>" % (self.__class__.__module__, self.__class__.__name__, self.this,)
    def __del__(self, destroy=_Homotopy.delete_AbstractGroup):
        try:
            if self.thisown: destroy(self)
        except: pass

    def augmentJacobianForHomotopy(*args): return _Homotopy.AbstractGroup_augmentJacobianForHomotopy(*args)
...
_Homotopy.AbstractGroup_swigregister(AbstractGroupPtr)
