...
#include "LOCA_AdaptiveStepper.H"    // class definition
...
void
LOCA::AdaptiveStepper::setSolutionGroup(
...
bool
LOCA::AdaptiveStepper::eigensolverReset( Teuchos::RCP<Teuchos::ParameterList> & newEigensolverList ) {
...
LOCA::AdaptiveStepper::adapt(LOCA::Abstract::Iterator::StepStatus stepStatus)
{
...
LOCA::Abstract::Iterator::StepStatus
LOCA::AdaptiveStepper::preprocess(LOCA::Abstract::Iterator::StepStatus stepStatus)
{
...
LOCA::Abstract::Iterator::StepStatus
LOCA::AdaptiveStepper::postprocess(LOCA::Abstract::Iterator::StepStatus stepStatus)
{
...
LOCA::Abstract::Iterator::IteratorStatus
LOCA::AdaptiveStepper::stop(LOCA::Abstract::Iterator::StepStatus stepStatus)
{
      ...
      const Teuchos::RCP<LOCA::MultiContinuation::AbstractGroup>& grp)
{
  ...
  std::string methodName = "LOCA::AdaptiveStepper::buildConstrainedGroup()";
...
LOCA::Abstract::Iterator::StepStatus
LOCA::AdaptiveStepper::computeStepSize(LOCA::Abstract::Iterator::StepStatus stepStatus,
                   double& stepSz)
{
...
LOCA::AdaptiveStepper::getSolutionGroup() const
{
  return curGroupPtr->getBaseLevelUnderlyingGroup();
}

Teuchos::RCP<const LOCA::MultiContinuation::AbstractGroup>
LOCA::AdaptiveStepper::getBifurcationGroup() const
{
  return curGroupPtr->getUnderlyingGroup();
}

Teuchos::RCP<const Teuchos::ParameterList>
LOCA::AdaptiveStepper::getList() const
{
  return paramListPtr;
}

Teuchos::RCP<const NOX::Solver::Generic>
LOCA::AdaptiveStepper::getSolver() const
{
...
double
LOCA::AdaptiveStepper::getContinuationParameter() const
{
...
void
LOCA::AdaptiveStepper::printEndStep(LOCA::Abstract::Iterator::StepStatus stepStatus)
{
  if (stepStatus == LOCA::Abstract::Iterator::Successful) {
...
void
LOCA::AdaptiveStepper::printRelaxationEndStep(LOCA::Abstract::Iterator::StepStatus stepStatus)
{
  if (stepStatus == LOCA::Abstract::Iterator::Successful) {
    // Print results of successful continuation step
    if (globalData->locaUtils->isPrintType(NOX::Utils::StepperIteration)) {
