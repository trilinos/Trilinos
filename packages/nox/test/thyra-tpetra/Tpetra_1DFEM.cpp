...
TEUCHOS_UNIT_TEST(NOX_Tpetra_1DFEM, Broyden)
{
  Teuchos::TimeMonitor::zeroOutTimers();
  Teuchos::TimeMonitor::setStackedTimer(Teuchos::make_rcp<Teuchos::StackedTimer>("Broyden Test"));
  ...
  Teuchos::ParameterList& belosList = p->sublist("Linear Solver Types").sublist("Belos");
  belosList.set("Solver Type", "Pseudo Block GMRES");
  belosList.sublist("Solver Types").sublist("Pseudo Block GMRES").set<int>("Maximum Iterations", 99);
  belosList.sublist("Solver Types").sublist("Pseudo Block GMRES").set<int>("Num Blocks", 99);
  belosList.sublist("Solver Types").sublist("Pseudo Block GMRES").set("Verbosity", 0x7f);
  belosList.sublist("Solver Types").sublist("Pseudo Block GMRES").set("Output Frequency", 1);
  belosList.sublist("VerboseObject").set("Verbosity Level", "none");
  p->set("Preconditioner Type", "Ifpack2");
  builder.setParameterList(p);
  ...
  Teuchos::RCP<Teuchos::ParameterList> nl_params = Teuchos::parameterList();
  nl_params->set("Nonlinear Solver", "Line Search Based");
  nl_params->sublist("Direction").set("Method","Broyden");
  nl_params->sublist("Direction").sublist("Broyden").sublist("Linear Solver").set("Tolerance", 1.0e-4);
  nl_params->sublist("Direction").sublist("Broyden").set("Restart Frequency",100);
  nl_params->sublist("Direction").sublist("Broyden").set("Memory",100);
  nl_params->sublist("Line Search").set("Method","Polynomial");
  nl_params->sublist("Line Search").sublist("Polynomial").set("Sufficient Decrease Condition","Ared/Pred");
