...
int main(int argc, char *argv[])
{
  ...
  try {
    ...
    locaStepperList.setParameter("Bordered Solver Method", "Bordering");
    ...
    //nlPrintParams.setParameter("Output Precision", 9);
    if (verbose)
    ...
    constraintsList.setParameter("Bordered Solver Method", "Householder");
