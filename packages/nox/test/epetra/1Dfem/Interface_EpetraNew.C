...
{
  return evaluate(NOX::EpetraNew::Interface::Required::Jac, &x, 0, 0);
}

bool Interface::computePrecMatrix(const Epetra_Vector& x)
{
  return evaluate(NOX::EpetraNew::Interface::Required::Prec, &x, 0, 0);
}
...
bool Interface::evaluate(NOX::EpetraNew::Interface::Required::FillType flag, 
