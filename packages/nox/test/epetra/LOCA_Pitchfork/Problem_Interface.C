...
Problem_Interface::Problem_Interface(FiniteElementProblem& Problem) :
  ...
  paramLib()
{ 
  paramLib.addParameterEntry("lambda", problem, 
			     &FiniteElementProblem::lambda);
  paramLib.addParameterEntry("alpha", problem, 
			     &FiniteElementProblem::alpha);
  paramLib.addParameterEntry("beta", problem, 
			     &FiniteElementProblem::beta);
}
