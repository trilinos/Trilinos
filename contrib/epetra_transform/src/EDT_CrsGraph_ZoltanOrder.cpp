...
std::auto_ptr<Epetra_CrsGraph> CrsGraph_ZoltanOrder::operator()( const Epetra_CrsGraph & original )
{
  int err;
...
cout << "------------------------------\n";
  ...
  //Create New Graph
  std::auto_ptr<Epetra_CrsGraph> NewGraph( new Epetra_CrsGraph( Copy, *NewRowMap, 0 ) );
