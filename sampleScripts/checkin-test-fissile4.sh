...
EXTRA_REPOS_FULL_LIST="CASLBOA LIMEExt PSSDriversExt"
# CASLRAVE
...
-DVERA_COUPLED_ANCVIPRE:BOOL=OFF
-DDART_TESTING_TIMEOUT:STRING=660
" > VERA_INTEL_RELEASE.config
...
-DVERA_COUPLED_ANCVIPRE:BOOL=ON
-DDART_TESTING_TIMEOUT:STRING=660
" > VERA_INTEL_RELEASE_VERACOUPLINGS.config
