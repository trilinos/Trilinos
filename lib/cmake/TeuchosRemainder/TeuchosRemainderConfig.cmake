...
if(CMAKE_VERSION VERSION_LESS 3.3)
  set(${CMAKE_FIND_PACKAGE_NAME}_NOT_FOUND_MESSAGE
    "TeuchosRemainder requires CMake 3.3 or later for 'if (... IN_LIST ...)'"
    )
...
set(TeuchosRemainder_Fortran_COMPILER "/usr/bin/mpifort")
# Deprecated!
set(TeuchosRemainder_FORTRAN_COMPILER "/usr/bin/mpifort") 
...
set(TeuchosRemainder_CXX_FLAGS [[ -O3 -DNDEBUG]])

set(TeuchosRemainder_C_FLAGS [[  -pedantic -Wall -Wno-long-long -std=c99 -O3 -DNDEBUG]])
...
set(TeuchosRemainder_BUILD_SHARED_LIBS "FALSE")
...
set(TeuchosRemainder_INSTALL_DIR "/home/as/ThirdParty-v2406/Trilinos")

## List of package libraries
set(TeuchosRemainder_LIBRARIES TeuchosRemainder::all_libs)
...
set(TeuchosRemainder_ENABLE_TeuchosCore ON)
...
set(Trilinos_ENABLE_LINEAR_SOLVER_FACTORY_REGISTRATION "ON")
set(TRILINOS_HAVE_LINEAR_SOLVER_FACTORY_REGISTRATION "ON")
...
set(TeuchosRemainder_IS_TRIBITS_COMPLIANT TRUE)
set(TeuchosRemainder_TRIBITS_COMPLIANT_PACKAGE_CONFIG_FILE "${CMAKE_CURRENT_LIST_FILE}")
set(TeuchosRemainder_TRIBITS_COMPLIANT_PACKAGE_CONFIG_FILE_DIR "${CMAKE_CURRENT_LIST_DIR}")
...
set(TeuchosRemainder_EXPORTED_PACKAGE_LIBS_NAMES "teuchosremainder")

foreach(libname IN LISTS TeuchosRemainder_EXPORTED_PACKAGE_LIBS_NAMES)
  if (NOT TARGET ${libname})
    add_library(${libname} INTERFACE IMPORTED)
    target_link_libraries(${libname}
       INTERFACE TeuchosRemainder::${libname})
    set(deprecationMessage
      ...
      " new namespaced target 'TeuchosRemainder::${libname}', or better yet,"
      " 'TeuchosRemainder::all_libs' to be less sensitive to changes in the definition"
      " of targets in the package 'TeuchosRemainder'.  Or, to maintain compatibility with"
      " older or newer versions the project 'Trilinos', instead link against the"
      " libraries specified by the variable 'TeuchosRemainder_LIBRARIES'."
      )
