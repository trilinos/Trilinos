...
\begin{figure}
  ...
  \begin{lstlisting}
  <ParameterList>
    <Parameter name="String Parameter" type="string" docString="A string parameter"
      validatorId="1" />
      ...Other Parameters ....
    <Validators>
...
\begin{figure}
  ...
  \begin{lstlisting}
  <ParameterList>
    <Parameter name="Output File Name" type="string" docString="Name of the output file."
      validatorId="1" />
      ...Other Parameters ....
    <Validators>
...
\begin{figure}
  ...
  \begin{lstlisting}
  <ParameterList>
    <Parameter name="Output File Name" type="Array(string)" docString="Name of the output file."
      validatorId="1" />
      ...Other Parameters ....
    <Validators>
      <Validator type="ArrayValidator(StringValidator, string)" validatorId="1">
        <Validator type="stringValidator">
          <String stringValue="Option1"/>
          <String stringValue="Option2"/>
          <String stringValue="Option3"/>
          <String stringValue="Option4"/>
        </Validator>
      </Validator>
    </Validators>
  </ParameterList>
...
\subsection{Using Dependencies in Tandem}
