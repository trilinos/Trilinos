...
\DisplayCommand{gunzip trilinos-4.0.tar.gz}
\DisplayCommand{tar xf trilinos-4.0.tar}
For versions of Trilinos other than 4.0, the name of the file in the above
