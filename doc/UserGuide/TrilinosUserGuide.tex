...
Trilinos website at 
\InlineDirectory{http://software.sandia.gov/trilinos/capabilities.html}.
A summary of the packages included in every Trilinos release is also on
the website at 
\InlineDirectory{http://software.sandia.gov/trilinos/versions.html}.
...
\DisplayCommand{make runtests-mpi TRILINOS\_MPI\_GO="'mpiexec -np 2'"}
