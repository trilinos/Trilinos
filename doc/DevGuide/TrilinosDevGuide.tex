...
\begin{figure}
%\begin{center}
\includegraphics[height=6in,angle=270]{Trilinos_Packages_Diagram}
%\end{center}
...
If the configure stage completed successfully, just type \DisplayCommand{make}
 and if 
--prefix was specified, \DisplayCommand{make install}
...
In addition to listing package requirements, we also structure the
integration
...
package is finished, or even if it works.  In fact, we encourage
...
\begin{enumerate}
\item Set up necessary accounts on \InlineDirectory{software.sandia.gov}.
\item Establish Bugzilla Product and Component Definitions for the new
package, identifying who will be 
