...
Trilinos package that uses Autotools. 
...
cvs commit
\begin{verbatim}
Now, look at the list of files that are to be added or modified.  It is 
easy to inadvertantly commit files.  It is also easy to forget to add ...
  Finally, enter an appropriate log message, 
