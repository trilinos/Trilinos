...
% start reading Mike's stuff at 243
	...
	\section{Requirements \& Guildlines}
...
\bullet Checking Out a Working Copy
...
\bullet Influential Environmental Variables
...
\bullet Other important notes about the configure/build process.

\bullet Any code that links to Trilinos should define 'HAVE_CONFIG_H' (without
quotes).
