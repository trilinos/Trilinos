...
package to the Trilinos repository.  **(Not distributed at this point, should not conflict or even interact with the existing configure/build process.)**
...
on our experience with some common tools and process for software 
