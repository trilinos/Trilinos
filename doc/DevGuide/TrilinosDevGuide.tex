...
This process can be divided into eight steps:
...
in which the new files are located.  To remove files from the build process, 
...
The bootstrap should complete without any errors.
