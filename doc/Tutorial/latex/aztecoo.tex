...
\section{Basic Usage of AztecOO}
...
\verb!A.TransformToLocal()! has been called before attempting to solve
...
\section{One-level Domain Decomposition Preconditioners with AztecOO}
...
\section{Use of AztecOO Problems as a Preconditioner for AztecOO}
