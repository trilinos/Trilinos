...
Management in C++''.  In this document we discuss the templated
concrete C++ class {}\texttt{Teuchos::RefCountPtr<>} in more detail.
We expand on the proper use of this new data type and how it relates
to built-in C++ data types and other user-defined data types.  A
variety of other issues related to \texttt{Teuchos::RefCountPtr<>} are
also discussed.
%
\end{abstract}
%
