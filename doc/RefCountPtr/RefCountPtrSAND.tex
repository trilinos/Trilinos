...
Here we describe a very simple templated concrete C++ class called
\texttt{RefCountPtr<>} the combines the concepts of smart pointers and
reference counting to build a low-overhead but effective means for
